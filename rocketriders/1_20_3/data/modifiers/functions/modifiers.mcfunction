...
##Explosive
execute if entity @s[tag=Explosive,tag=!ClutterCollector] as @e[type=tnt,nbt={fuse:2s}] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:5,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"],Invulnerable:1b}
execute if entity @s[tag=Explosive,tag=!ClutterCollector] as @e[type=tnt,nbt={fuse:2s},tag=UtilKilled] at @s run data modify entity @e[type=creeper,tag=ExplosiveTNT,limit=1,sort=nearest,distance=..1] CustomName set from entity @s CustomName

execute if entity @s[tag=Explosive,tag=!ClutterCollector] run kill @e[type=tnt,nbt={fuse:2s}]
...
execute if entity @s[tag=ClutterCollector,tag=!Explosive,tag=Hardcore] as @e[type=tnt,nbt={fuse:2s},z=-62,dz=124,x=-160,dx=320,y=-20,dy=200] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:0,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"],Invulnerable:1b}
execute if entity @s[tag=ClutterCollector] as @e[type=tnt,nbt={fuse:2s},tag=UtilKilled] at @s run data modify entity @e[type=creeper,tag=ExplosiveTNT,limit=1,sort=nearest,distance=..1] CustomName set from entity @s CustomName
execute if entity @s[tag=ClutterCollector,tag=Explosive] run kill @e[type=tnt,nbt={fuse:2s}]
