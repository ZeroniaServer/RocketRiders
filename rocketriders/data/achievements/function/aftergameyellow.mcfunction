...
execute if predicate game:portal_type/normal as @a[x=0,predicate=custom:team/blue] store result score @s HasMissiles if items entity @s custom:player *[custom_data~{spawn_egg:{type:"missile"}}]
