...
execute if score Yellow SwissCheese matches 0 if score $game_duration global matches ..2400 run tag @a[x=0,predicate=custom:team/yellow] add SimpleAndClean
