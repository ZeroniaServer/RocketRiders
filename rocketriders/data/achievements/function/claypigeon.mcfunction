...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={servermode=-1..0},predicate=!rr:realms] run advancement grant @s only achievements:rr_challenges/pigeon
