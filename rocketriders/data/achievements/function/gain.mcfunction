...
execute as @a[x=0,predicate=custom:on_blue_or_yellow_team] if score @s PlayerDeaths < @s deaths run tag @s add probablyDied
execute as @a[x=0,predicate=custom:on_blue_or_yellow_team] if score @s respawn matches 1.. run tag @s add probablyDied
...
#All achievements
execute if entity @s[scores={servermode=0,gametime=3..},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:firewithin
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:getofflawn
execute if entity @s[scores={servermode=0,gametime=3..},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:graverevenge
execute if entity @s[scores={servermode=0,gametime=3..},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:underthesea
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:rainingmen
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:uphere
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:ballet
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:committed
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:newworld
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:lockdown
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:volcanichatred
execute if entity @s[scores={gametime=5..,servermode=0},tag=!realms,tag=!TimeOut] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:traveler
execute if entity @s[scores={servermode=0},tag=!noPortal,tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:fallaway
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:gravitationalshootout
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:veteran
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] at @s run function achievements:useful
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:moonwalker
execute if entity @s[scores={servermode=0},tag=!realms] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:sabotage
