...
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:rainingmen
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:uphere
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:ballet
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:committed
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:newworld
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:lockdown
execute if predicate rr:has_achievements if entity @s[tag=!TimeOut] as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:traveler
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:gravitationalshootout
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:veteran
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] at @s run function achievements:useful
execute if predicate rr:has_achievements run tag @a[x=0,predicate=custom:team/any_playing_team,predicate=achievements:fail_moonwalker] add FailedMoon
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:team/any_playing_team] run function achievements:sabotage
