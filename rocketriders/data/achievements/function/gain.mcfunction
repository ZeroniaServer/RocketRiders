...
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:committed
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:newworld
execute if predicate rr:has_achievements as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:lockdown
execute if predicate rr:has_achievements if entity @s[tag=!TimeOut] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:traveler
