...
#All achievements
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:rainingmen
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:uphere
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:ballet
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:committed
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:newworld
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:lockdown
execute if entity @s[tag=!realms,scores={servermode=-1..0,gametime=5..},tag=!TimeOut] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:traveler
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:gravitationalshootout
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:veteran
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] at @s run function achievements:useful
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:moonwalker
execute if entity @s[tag=!realms,scores={servermode=-1..0}] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run function achievements:sabotage
