...
execute if score @s Machina matches 22 at @s run tag @a[x=0,predicate=custom:team/blue] add DeusExMachina
...
execute at @s[predicate=!custom:machina_x,predicate=!custom:machina_y] if score @s Machina matches ..21 run function achievements:machinacheckblue