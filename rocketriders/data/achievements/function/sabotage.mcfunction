...
execute store result score $value var store result storage rocketriders:achievements sabotage.value int 1 run scoreboard players get @s minedTNT
function achievements:sabotage_loop with storage rocketriders:achievements sabotage
