...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={servermode=0},tag=!realms,tag=!SMCustom] run scoreboard players add @s[predicate=custom:fall_gravshot] gravShot 1
