...
execute if entity @e[x=0,type=armor_stand,tag=Selection,scores={servermode=0},tag=!realms,tag=!SMCustom] run scoreboard players add @s[scores={FallDistance=100..}] gravShot 1
