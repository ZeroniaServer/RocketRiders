...
#Ground Bound
execute as @a[team=Yellow,scores={jumps=..0}] at @s if entity @e[tag=YellowSpawnZone,distance=..50,limit=1,type=area_effect_cloud] run advancement grant @s only achievements:rr_challenges/groundbound
