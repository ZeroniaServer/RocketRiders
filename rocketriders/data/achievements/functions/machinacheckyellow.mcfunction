...
execute if score @s Machina matches 22 at @s run tag @a[team=Yellow] add DeusExMachina
...
execute at @s unless entity @s[x=-9,dx=0] unless entity @s[y=37,dy=0] if score @s Machina matches ..21 run function achievements:machinacheckyellow