##Operator function - grants advancement roots for executor
advancement grant @s only achievements:rr_aaaeasy/root
advancement grant @s only achievements:rr_aaaeasy/end_row1
advancement grant @s only achievements:rr_aaaeasy/end_row2
advancement grant @s only achievements:rr_aaaeasy/end_row3
...
advancement grant @s only aaaaaaaatutorial:root