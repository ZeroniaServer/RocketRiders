...
execute if entity @e[tag=Selection,type=armor_stand,scores={servermode=0},tag=!realms,tag=!SMCustom] run scoreboard players add @s[scores={FallDistance=100..}] gravShot 1
