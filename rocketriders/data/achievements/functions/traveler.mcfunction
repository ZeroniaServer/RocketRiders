...
execute as @a[team=Yellow,gamemode=survival] at @s if entity @s[x=-15,dx=24,y=33,dy=37,z=-74,dz=28] run tag @s add beenOnBlue
execute as @a[team=Blue,tag=beenOnYellow,gamemode=survival] at @s if entity @s[x=-15,dx=24,y=33,dy=37,z=-74,dz=28] run tag @s add beenOnBlue
execute as @a[team=Blue,gamemode=survival] at @s if entity @s[x=-15,dx=24,y=33,dy=37,z=46,dz=28] run tag @s add beenOnYellow
execute as @a[team=Yellow,tag=beenOnBlue,gamemode=survival] at @s if entity @s[x=-15,dx=24,y=33,dy=37,z=46,dz=28] run tag @s add beenOnYellow
