...
$execute positioned $(x) $(y) 0.0 unless predicate {type:"location_check",predicate:{position:{y:{min:176}}}} run fill ~ ~ $(min_z) ~3 ~3 $(max_z) air strict
$execute positioned $(x) $(y) 0.0 if predicate {type:"location_check",predicate:{position:{y:{min:176}}}} unless predicate {type:"location_check",predicate:{position:{y:{min:181}}}} run fill ~ ~ $(min_z) ~3 180 $(max_z) air strict
