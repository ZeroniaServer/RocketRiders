...
execute if score @s servermode matches 0 run scoreboard players set @a[x=0,team=Lobby] daytime -2
execute if score @s servermode matches 0 run scoreboard players enable @a[x=0,team=Lobby] daytime
