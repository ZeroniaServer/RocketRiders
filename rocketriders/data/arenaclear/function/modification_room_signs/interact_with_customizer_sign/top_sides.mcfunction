...
# cycle options
execute unless predicate custom:player_is_holding_shift run scoreboard players add $arena_details/top_sides config 1
execute if predicate custom:player_is_holding_shift run scoreboard players remove $arena_details/top_sides config 1
