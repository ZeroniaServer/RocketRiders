...
$execute if predicate game:game_rules/disable_item_category/$(category_id)/forced_on run return run tellraw @s {color:"dark_gray",italic:true,text:"Items from this category are incompatible with this game mode."}
...
$execute if predicate game:game_rules/disable_item/$(item_id)/forced_on run return run tellraw @s {color:"dark_gray",italic:true,text:"$(plural_item_name) are incompatible with this game mode."}
$execute if predicate game:game_rules/disable_item/$(item_id)/forced_off run return run tellraw @s {color:"dark_gray",italic:true,text:"$(plural_item_name) are required in this game mode."}
