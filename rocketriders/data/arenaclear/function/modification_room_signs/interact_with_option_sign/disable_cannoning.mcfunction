...
execute if predicate game:modifiers/instant_tnt/on run return run tellraw @s {color:"dark_gray",italic:true,text:"TNT Cannoning is not adjustable with the Instant TNT modifier enabled."}
