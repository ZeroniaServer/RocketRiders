...
execute if predicate game:game_rules/disable_tying/forced_on if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=ctfEnabled] run return run tellraw @s {color:"dark_gray",italic:true,text:"Overtime is incompatible with this game mode."}
execute if predicate game:game_rules/disable_tying/forced_on run return run tellraw @s {color:"dark_gray",italic:true,text:"Tiebreakers are incompatible with this game mode."}
execute if predicate game:game_rules/disable_tying/forced_off if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=ctfEnabled] run return run tellraw @s {color:"dark_gray",italic:true,text:"Overtime is required in this game mode."}
execute if predicate game:game_rules/disable_tying/forced_off run return run tellraw @s {color:"dark_gray",italic:true,text:"Tiebreakers are required in this game mode."}
