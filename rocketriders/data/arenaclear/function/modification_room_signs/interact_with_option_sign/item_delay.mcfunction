...
execute if predicate game:game_rules/item_delay/__locked run return run tellraw @s {"text":"Item Delay is not adjustable in this game mode.","color":"dark_gray","italic":true}
