...
execute if predicate game:game_rules/snipe_portals/forced_off run return run tellraw @s {color:"dark_gray",italic:true,text:"Snipe Portals is incompatible with this gamemode."}
execute if predicate game:game_rules/snipe_portals/forced_on run return run tellraw @s {color:"dark_gray",italic:true,text:"Snipe Portals required in this gamemode."}
