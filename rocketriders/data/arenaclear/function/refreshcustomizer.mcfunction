...
execute unless predicate game:match_components/duel_settings_locked if entity @s[predicate=!game:match_components/arena/no_base_details,predicate=!game:arena_details/castle] run data modify block -57 192 76 front_text.messages[3] set value {color:"gray",italic:true,text:"(Click for next)"}
execute unless predicate game:match_components/duel_settings_locked unless entity @s[predicate=!game:match_components/arena/no_base_details,predicate=!game:arena_details/castle] run data modify block -57 192 76 front_text.messages[3] set value {color:"white",bold:true,text:"Locked"}
...
execute unless predicate game:match_components/duel_settings_locked if entity @s[predicate=!game:match_components/arena/no_base_details,predicate=!game:arena_details/castle] run data modify block -58 192 71 front_text.messages[3] set value {color:"gray",italic:true,text:"(Click for next)"}
execute unless predicate game:match_components/duel_settings_locked unless entity @s[predicate=!game:match_components/arena/no_base_details,predicate=!game:arena_details/castle] run data modify block -58 192 71 front_text.messages[3] set value {color:"white",bold:true,text:"Locked"}
...
execute unless predicate game:match_components/duel_settings_locked if entity @s[predicate=!game:match_components/arena/no_base_details,predicate=!game:arena_details/castle] run data modify block -58 192 84 front_text.messages[3] set value {color:"gray",italic:true,text:"(Click for next)"}
execute unless predicate game:match_components/duel_settings_locked unless entity @s[predicate=!game:match_components/arena/no_base_details,predicate=!game:arena_details/castle] run data modify block -58 192 84 front_text.messages[3] set value {color:"white",bold:true,text:"Locked"}
...
execute unless predicate game:match_components/duel_settings_locked if entity @s[predicate=!game:match_components/arena/no_base_details,predicate=!game:arena_details/castle,predicate=!game:arena_details/middle/layered] run data modify block -57 192 80 front_text.messages[3] set value {color:"gray",italic:true,text:"(Click for next)"}
execute unless predicate game:match_components/duel_settings_locked unless entity @s[predicate=!game:match_components/arena/no_base_details,predicate=!game:arena_details/castle,predicate=!game:arena_details/middle/layered] run data modify block -57 192 80 front_text.messages[3] set value {color:"white",bold:true,text:"Locked"}
...
##Castle
execute if predicate game:match_components/arena/castle run place template lobby:castle -44 185 64 none none 1 0 strict
