...
#Hobbits
#TODO replace HobbitsOff with a proper score config disabler
execute if predicate game:config/hobbits if entity @s[scores={modifierID=18},tag=!HobbitsOff,tag=!settingsLocked] run setblock -69 191 75 warped_wall_sign[facing=east]
execute unless predicate game:config/hobbits if entity @s[scores={modifierID=18},tag=!settingsLocked] run setblock -69 191 75 crimson_wall_sign[facing=east]
execute if entity @s[scores={modifierID=18},tag=HobbitsOff,tag=!settingsLocked] run setblock -69 191 75 crimson_wall_sign[facing=east]
