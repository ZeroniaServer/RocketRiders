...
execute unless entity @s[predicate=!game:match_components/duel_settings_locked,predicate=!game:match_components/arena/no_base_details] run data modify block -57 192 78 front_text.messages[1] set value {"text":"Restore Default","color":"#888888","click_event":{"action":"run_command","command":"/tellraw @s {\"text\":\"This action cannot be performed in this gamemode.\",\"color\":\"dark_gray\",\"italic\":true}"}}
...
execute if predicate game:match_components/duel_settings_locked run data modify block -69 193 75 front_text.messages[1] set value {"text":"Disable All","color":"aqua","click_event":{"action":"run_command","command":"/tellraw @s {\"text\":\"This action cannot be performed in this gamemode.\",\"color\":\"dark_gray\",\"italic\":true}"}}
...
execute if predicate game:match_components/duel_settings_locked run data modify block -70 192 78 front_text.messages[1] set value {"text":"Restore Default","color":"yellow","click_event":{"action":"run_command","command":"/tellraw @s {\"text\":\"This action cannot be performed in this gamemode.\",\"color\":\"dark_gray\",\"italic\":true}"}}
...
execute if predicate game:match_components/duel_settings_locked run data modify block -69 192 82 front_text.messages[1] set value {"text":"Enable All","color":"black","bold":true,"click_event":{"action":"run_command","command":"/tellraw @s {\"text\":\"This action cannot be performed in this gamemode.\",\"color\":\"dark_gray\",\"italic\":true}"}}
