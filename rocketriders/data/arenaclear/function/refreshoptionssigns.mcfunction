...
####RESTORE DEFAULTS####
##Individual signs
execute if entity @s[predicate=!game:gamemode_components/duel_settings_locked,predicate=!game:gamemode_components/arena/no_base_details] run data modify block -57 192 78 front_text.messages[1] set value {"text":"Restore Default","color":"#888888","click_event":{"action":"run_command","command":"/tag @e[x=0,type=armor_stand,tag=Selection,limit=1] add RestoreDefault"}}
execute if entity @s[predicate=!game:gamemode_components/duel_settings_locked,predicate=!game:gamemode_components/arena/no_base_details] run data modify block -57 192 78 front_text.messages[2] set value {"text":"Base Details","color":"#888888","click_event":{"action":"run_command","command":"/execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed] run playsound ui.button.click master @a[x=0] ~ ~ ~ 1 1"}}
execute unless entity @s[predicate=!game:gamemode_components/duel_settings_locked,predicate=!game:gamemode_components/arena/no_base_details] run data modify block -57 192 78 front_text.messages[1] set value {"text":"Restore Default","color":"#888888","click_event":{"action":"run_command","command":"/tellraw @s {\"text\":\"This action cannot be performed in this gamemode.\",\"color\":\"dark_gray\",\"italic\":true}"}}
execute unless entity @s[predicate=!game:gamemode_components/duel_settings_locked,predicate=!game:gamemode_components/arena/no_base_details] run data modify block -57 192 78 front_text.messages[2] set value {"text":"Base Details","color":"#888888","click_event":{"action":"run_command","command":"/execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed] run playsound ui.button.click master @a[x=0] ~ ~ ~ 1 1"}}
...
execute if predicate game:game_rules/item_delay/locked unless predicate game:gamemode_components/no_item_timer run \
