...
#Hotbar Limit
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=doHotbarLimit,tag=!hotbarLimitOff] run setblock -70 191 78 warped_wall_sign[facing=east]
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=!doHotbarLimit,tag=!hotbarLimitOff] run setblock -70 191 78 crimson_wall_sign[facing=east]
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=hotbarLimitOff] run setblock -70 191 78 crimson_wall_sign[facing=east]
...
#Hotbar Limit
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=doHotbarLimit,tag=!hotbarLimitOff] run data modify block -70 191 78 front_text.messages[0] set value {"text":"Hotbar Limit","color":"white","click_event":{"action":"run_command","command":"/tag @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed,scores={refreshsigns=0}] remove doHotbarLimit"}}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=doHotbarLimit,tag=!hotbarLimitOff] run data modify block -70 191 78 front_text.messages[1] set value {"text":"Enabled","color":"green","bold":true,"click_event":{"action":"run_command","command":"/execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed] run playsound ui.button.click master @a[x=0] ~ ~ ~ 1 1"}}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=doHotbarLimit,tag=!hotbarLimitOff] run data modify block -70 191 78 front_text.messages[2] set value {"text":"","click_event":{"action":"run_command","command":"/execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed] run tellraw @s [\"\",{\"text\":\"Hotbar Limit\",\"color\":\"white\",\"bold\":true},{\"text\":\" Disabled:\",\"color\":\"red\",\"bold\":true},{\"text\":\" You can have more than eight items.\",\"color\":\"gray\",\"italic\":true}]"}}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=doHotbarLimit,tag=!hotbarLimitOff] run data modify block -70 191 78 front_text.messages[3] set value {"text":"","click_event":{"action":"run_command","command":"/execute as @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!GamemodeRefreshed] run function arenaclear:refreshoptionssigns"}}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=!doHotbarLimit,tag=!hotbarLimitOff] run data modify block -70 191 78 front_text.messages[0] set value {"text":"Hotbar Limit","color":"white","click_event":{"action":"run_command","command":"/tag @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed,scores={refreshsigns=0}] add doHotbarLimit"}}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=!doHotbarLimit,tag=!hotbarLimitOff] run data modify block -70 191 78 front_text.messages[1] set value {"text":"Disabled","color":"red","bold":true,"click_event":{"action":"run_command","command":"/execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed] run playsound ui.button.click master @a[x=0] ~ ~ ~ 1 1"}}
...
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=!doHotbarLimit,tag=!hotbarLimitOff] run data modify block -70 191 78 front_text.messages[3] set value {"text":"","click_event":{"action":"run_command","command":"/execute as @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!GamemodeRefreshed] run function arenaclear:refreshoptionssigns"}}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=hotbarLimitOff] run data modify block -70 191 78 front_text.messages[0] set value {"text":"Hotbar Limit","color":"white","click_event":{"action":"run_command","command":"/tellraw @s {\"text\":\"Hotbar Limit is incompatible with this gamemode.\",\"color\":\"dark_gray\",\"italic\":true}"}}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=hotbarLimitOff] run data modify block -70 191 78 front_text.messages[1] set value {"text":"Disabled","color":"red","bold":true,"click_event":{"action":"run_command","command":"/execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed] run playsound ui.button.click master @a[x=0] ~ ~ ~ 1 1"}}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=hotbarLimitOff] run data modify block -70 191 78 front_text.messages[2] set value {"text":"Locked","color":"white","bold":true}
execute unless predicate game:gamemode_components/duel_settings_locked if entity @s[tag=hotbarLimitOff] run data modify block -70 191 78 front_text.messages[3] set value {"text":""}
execute if predicate game:gamemode_components/duel_settings_locked run data modify block -70 191 78 front_text.messages[0] set value {"text":"Hotbar Limit","color":"white","click_event":{"action":"run_command","command":"/tellraw @s {\"text\":\"Game Rules are not adjustable in this gamemode.\",\"color\":\"dark_gray\",\"italic\":true}"}}
execute if predicate game:gamemode_components/duel_settings_locked run data modify block -70 191 78 front_text.messages[1] set value {"text":"Locked","color":"white","bold":true,"click_event":{"action":"run_command","command":"/execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!SignsRefreshed] run playsound ui.button.click master @a[x=0] ~ ~ ~ 1 1"}}
execute if predicate game:gamemode_components/duel_settings_locked run data modify block -70 191 78 front_text.messages[2] set value {"text":""}
execute if predicate game:gamemode_components/duel_settings_locked run data modify block -70 191 78 front_text.messages[3] set value {"text":""}
