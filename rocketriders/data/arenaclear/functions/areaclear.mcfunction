...
execute if entity @s[tag=Repeat,tag=firstGameRepeated] unless entity @s[tag=!rngNormal,tag=!rngHeavy,tag=!rngLightning,tag=!rngUtil] as @a at @s run function arenaclear:notifystart
