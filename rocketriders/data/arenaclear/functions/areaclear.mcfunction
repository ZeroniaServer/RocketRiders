...
execute if entity @s[tag=Repeat,tag=firstGameRepeated] unless entity @s[tag=!rngMissile,tag=!rngUtil] as @a[team=Lobby] at @s run function arenaclear:notifystart
