...
tellraw @a[team=!Yellow,team=!Blue,team=!Spectator,tag=daytimeChange] ["",{"text":"Time of Day: ","bold":true,"color":"white"},{"text":"Determines the sky appearance. Click numbers below to change time.","color":"gray","italic":true}]
