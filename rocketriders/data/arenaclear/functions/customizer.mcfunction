...
#bullet
execute as @e[tag=Selection,tag=rngBull] run data merge block -63 193 82 {Text1:"{\"text\":\"Bullet\",\"color\":\"red\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"tag @e[tag=Selection] remove rngBull\"}}",Text2:"{\"text\":\"Enabled\",\"color\":\"green\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"playsound ui.button.click player @a ~ ~ ~ 1 1\"}}",Text3: "{\"text\":\"\"}"}
execute as @e[tag=Selection,tag=!rngBull] run data merge block -63 193 82 {Text1:"{\"text\":\"Bullet\",\"color\":\"red\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"tag @e[tag=Selection] add rngBull\"}}",Text2:"{\"text\":\"Disabled\",\"color\":\"red\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"playsound ui.button.click player @a ~ ~ ~ 1 1\"}}",Text3: "{\"text\":\"\"}"}
