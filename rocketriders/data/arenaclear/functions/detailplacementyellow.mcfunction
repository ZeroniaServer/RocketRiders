...
execute as @s[scores={MiddleDeco=2}] run fill -14 50 29 -14 51 29 air
execute as @s[scores={MiddleDeco=2}] run fill 18 50 29 18 51 29 air
...
execute as @s[scores={BottomDeco=2}] run fill 8 34 30 8 35 30 air

#Layered - Yellow
execute as @s[scores={MiddleDeco=3}] run fill 38 34 49 -14 40 51 minecraft:yellow_stained_glass replace air
execute as @s[scores={MiddleDeco=3}] run fill 38 41 50 -14 48 51 minecraft:yellow_stained_glass replace air
execute as @s[scores={MiddleDeco=3}] run fill -14 49 51 38 56 51 minecraft:yellow_stained_glass replace air
...
execute as @s[scores={MiddleDeco=3}] run fill -14 57 51 38 57 51 minecraft:black_stained_glass replace air
execute as @s[scores={MiddleDeco=3}] run fill 38 49 50 -14 49 50 minecraft:black_stained_glass replace air
