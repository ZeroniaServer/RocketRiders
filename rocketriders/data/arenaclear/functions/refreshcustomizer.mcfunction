...
##Top Decorations
#New Dawn Arch
execute as @s[scores={TopDeco=1},tag=!decosLocked] run setblock -48 197 74 minecraft:structure_block{mode:"LOAD",name:"minecraft:archpreview",showboundingbox:0b}
execute as @s[scores={TopDeco=1},tag=!decosLocked] run setblock -48 198 74 minecraft:redstone_block
execute as @s[scores={TopDeco=1},tag=!decosLocked] run setblock -48 197 74 minecraft:air
#Towers
execute as @s[scores={TopDeco=2},tag=!decosLocked] run setblock -44 197 65 structure_block{mode:"LOAD",name:"minecraft:towerpreview",showboundingbox:0b}
execute as @s[scores={TopDeco=2},tag=!decosLocked] run setblock -44 198 65 redstone_block
execute as @s[scores={TopDeco=2},tag=!decosLocked] run setblock -44 197 65 air
execute as @s[scores={TopDeco=2},tag=!decosLocked] run setblock -44 197 87 structure_block{mode:"LOAD",name:"minecraft:towerpreview",showboundingbox:0b}
execute as @s[scores={TopDeco=2},tag=!decosLocked] run setblock -44 198 87 redstone_block
execute as @s[scores={TopDeco=2},tag=!decosLocked] run setblock -44 197 87 air
#Spikes
execute as @s[scores={TopDeco=3},tag=!decosLocked] run setblock -45 197 71 structure_block{mode:"LOAD",name:"minecraft:spike_top_preview",showboundingbox:0b}
execute as @s[scores={TopDeco=3},tag=!decosLocked] run setblock -45 198 71 redstone_block
execute as @s[scores={TopDeco=3},tag=!decosLocked] run setblock -45 197 71 air

##Top Sides Decorations
#New Dawn Platforms
execute as @s[scores={TopCorner=1},tag=!decosLocked] run setblock -50 194 71 structure_block{mode:"LOAD",name:"minecraft:topplatform_preview",showboundingbox:0b}
execute as @s[scores={TopCorner=1},tag=!decosLocked] run setblock -50 195 71 redstone_block
execute as @s[scores={TopCorner=1},tag=!decosLocked] run setblock -50 194 71 air
...
##Middle Decorations
#New Dawn Slimepads
execute as @s[scores={MiddleDeco=1},tag=!decosLocked] run setblock -49 190 65 structure_block{mode:"LOAD",name:"minecraft:midslimepad_preview",showboundingbox:0b}
execute as @s[scores={MiddleDeco=1},tag=!decosLocked] run setblock -49 191 65 redstone_block
execute as @s[scores={MiddleDeco=1},tag=!decosLocked] run setblock -49 190 65 air
execute as @s[scores={MiddleDeco=1},tag=!decosLocked] run setblock -49 190 85 structure_block{mode:"LOAD",name:"minecraft:midslimepad_preview",showboundingbox:0b}
execute as @s[scores={MiddleDeco=1},tag=!decosLocked] run setblock -49 191 85 redstone_block
execute as @s[scores={MiddleDeco=1},tag=!decosLocked] run setblock -49 190 85 air
#Spikes
...
##Bottom Decorations
#New Dawn Slimepads
execute as @s[scores={BottomDeco=1},tag=!decosLocked] run setblock -49 186 75 structure_block{mode:"LOAD",name:"minecraft:bottomslimepad_preview",showboundingbox:0b}
execute as @s[scores={BottomDeco=1},tag=!decosLocked] run setblock -49 187 75 redstone_block
execute as @s[scores={BottomDeco=1},tag=!decosLocked] run setblock -49 186 75 air
#Spikes
