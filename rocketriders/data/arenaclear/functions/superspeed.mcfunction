...
execute as @e[tag=ArenaClearBlue,type=area_effect_cloud] at @s run fill ~4 ~-4 ~-4 ~-4 ~12 ~4 air replace #custom:missileblocks
execute as @e[tag=ArenaClearYellow,type=area_effect_cloud] at @s run fill ~4 ~-4 ~-4 ~-4 ~12 ~4 air replace #custom:missileblocks
