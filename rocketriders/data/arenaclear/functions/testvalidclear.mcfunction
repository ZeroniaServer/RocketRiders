...
execute if entity @e[type=armor_stand,tag=Selection,tag=!Molerat,tag=WasMolerat] run tag @s add MoleratStop
execute if entity @s[tag=MoleratStop,tag=!moleratConfirm] run scoreboard objectives add moleratConfirm trigger 
...
execute if entity @s[tag=moleratConfirm] run scoreboard objectives remove moleratConfirm
