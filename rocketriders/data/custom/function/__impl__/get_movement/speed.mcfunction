...
# check range
$execute store success score $low var if predicate {type:entity_properties,entity:this,predicate:{movement:{speed:{min:$(min),max:$(mean)}}}}
...
return run function custom:__impl__/get_movement/speed with storage rocketriders:main get_movement
