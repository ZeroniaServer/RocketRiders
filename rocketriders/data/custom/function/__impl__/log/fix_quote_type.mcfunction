...
loot replace block 0 184 -16 container.0 loot {pools:[{rolls:1,entries:[{type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_name",entity:"this",name:{storage:"rocketriders:main",nbt:"log.join_right"}}}]}]}
