loot replace block 0 184 -16 container.0 loot {pools:[{rolls:1,entries:[{type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_name",entity:"this",name:{storage:"rocketriders:main",nbt:"log.message"}}}]}]}
...
execute unless data storage rocketriders:main log.next_component{} run loot replace block 0 184 -16 container.0 loot {pools:[{rolls:1,entries:[{type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_name",entity:"this",name:{storage:"rocketriders:main",nbt:"log.next_component"}}}]}]}
execute if data storage rocketriders:main log.next_component.text run loot replace block 0 184 -16 container.0 loot {pools:[{rolls:1,entries:[{type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_name",entity:"this",name:{storage:"rocketriders:main",nbt:"log.next_component.text"}}}]}]}
execute if data storage rocketriders:main log.next_component.translate run loot replace block 0 184 -16 container.0 loot {pools:[{rolls:1,entries:[{type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_name",entity:"this",name:{storage:"rocketriders:main",nbt:"log.next_component.translate"}}}]}]}
