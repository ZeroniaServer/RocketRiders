...
$fill -160 184 -160 $(fixed_opposite_corner_x) $(fixed_opposite_corner_y) $(fixed_opposite_corner_z) minecraft:air strict
$clone ~ ~ ~ ~$(x_length) ~$(y_length) ~$(z_length) -160 184 -160 filtered minecraft:crying_obsidian
