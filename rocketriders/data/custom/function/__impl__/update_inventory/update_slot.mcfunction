...
execute if items block 0 184 -16 container.0 *[custom_data~{id:"spell_book"}] if data storage rocketriders:main update_inventory.item.components.minecraft:custom_data{spell:"fire"} run item modify block 0 184 -16 container.0 {type:"minecraft:set_custom_data",tag:{spell:"fire"}}
execute if items block 0 184 -16 container.0 *[custom_data~{id:"spell_book"}] if data storage rocketriders:main update_inventory.item.components.minecraft:custom_data{spell:"health"} run item modify block 0 184 -16 container.0 {type:"minecraft:set_custom_data",tag:{spell:"health"}}
execute if items block 0 184 -16 container.0 *[custom_data~{id:"spell_book"}] if data storage rocketriders:main update_inventory.item.components.minecraft:custom_data{spell:"damage"} run item modify block 0 184 -16 container.0 {type:"minecraft:set_custom_data",tag:{spell:"damage"}}
execute if items block 0 184 -16 container.0 *[custom_data~{id:"spell_book"}] if data storage rocketriders:main update_inventory.item.components.minecraft:custom_data{spell:"wind"} run item modify block 0 184 -16 container.0 {type:"minecraft:set_custom_data",tag:{spell:"wind"}}
