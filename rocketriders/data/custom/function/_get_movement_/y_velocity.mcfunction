...
# check range
$execute store success score $low var if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{movement:{y:{min:$(min),max:$(mean)}}}}
...
return run function custom:_get_movement_/y_velocity with storage rocketriders:main get_movement
