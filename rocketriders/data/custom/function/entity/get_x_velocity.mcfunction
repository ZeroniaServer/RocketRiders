execute unless predicate {type:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:movement":{x:{min:0.1}}}} unless predicate {type:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:movement":{x:{max:-0.1}}}} run return 0
