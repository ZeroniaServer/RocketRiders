execute unless predicate {type:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:movement":{z:{min:0.1}}}} unless predicate {type:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:movement":{z:{max:-0.1}}}} run return 0
