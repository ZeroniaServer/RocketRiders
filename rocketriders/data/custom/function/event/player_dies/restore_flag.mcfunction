...
execute if entity @s[tag=carrying_flag.blue_left] run scoreboard players set $flag_state.blue_left match_data 0
...
execute if entity @s[tag=carrying_flag.blue_right] run scoreboard players set $flag_state.blue_right match_data 0
...
execute if entity @s[tag=carrying_flag.yellow_left] run scoreboard players set $flag_state.yellow_left match_data 0
...
execute if entity @s[tag=carrying_flag.yellow_right] run scoreboard players set $flag_state.yellow_right match_data 0
