...
execute if entity @s[tag=CarryFB1] run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if entity @s[tag=CarryFB1] run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"⚠ ","color":"red"},{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if entity @s[tag=CarryFB1] run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]

execute if entity @s[tag=CarryFB2] run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if entity @s[tag=CarryFB2] run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"⚠ ","color":"red"},{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if entity @s[tag=CarryFB2] run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
