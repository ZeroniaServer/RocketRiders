...
execute if score $team var matches 0 on origin if entity @s[predicate=custom:team/blue] run scoreboard players set $award_kill var 0
execute if score $team var matches 1 on origin if entity @s[predicate=custom:team/yellow] run scoreboard players set $award_kill var 0
