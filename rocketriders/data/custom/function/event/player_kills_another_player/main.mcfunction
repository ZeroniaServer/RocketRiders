...
execute if score $can_grant_achievements var matches 1 if function custom:player_is_burning run advancement grant @s only achievements:rr_challenges/fire_within_me
