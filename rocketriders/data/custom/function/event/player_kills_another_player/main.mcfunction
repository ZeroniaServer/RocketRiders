...
execute if predicate game:achievements_can_be_awarded unless predicate custom:player/alive run advancement grant @s only achievements:rr_challenges/revenge_from_grave
