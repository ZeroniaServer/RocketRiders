...
execute if score $do_leave_message var matches 1 if predicate game:phase/match if score $last_arena_team var matches 1 unless entity @e[limit=1,x=0,type=armor_stand,tag=Selection,tag=duelEnabled] run tellraw @a[x=0] [{score:{name:"#blue",objective:"text.accent_color"}},[{score:{name:"#blue",objective:"text.main_color"}},{storage:"rocketriders:main",nbt:"player_left_overworld.name",interpret:true}]," left the match!"]
execute if score $do_leave_message var matches 1 if predicate game:phase/match if score $last_arena_team var matches 2 unless entity @e[limit=1,x=0,type=armor_stand,tag=Selection,tag=duelEnabled] run tellraw @a[x=0] [{score:{name:"#yellow",objective:"text.accent_color"}},[{score:{name:"#yellow",objective:"text.main_color"}},{storage:"rocketriders:main",nbt:"player_left_overworld.name",interpret:true}]," left the match!"]

execute if score $do_leave_message var matches 1 if predicate game:phase/match if score $last_arena_team var matches 1 if entity @e[limit=1,x=0,type=armor_stand,tag=Selection,tag=duelEnabled] run tellraw @a[x=0] [{score:{name:"#blue",objective:"text.accent_color"}},[{score:{name:"#blue",objective:"text.main_color"}},{storage:"rocketriders:main",nbt:"player_left_overworld.name",interpret:true}]," forfeited the match!"]
execute if score $do_leave_message var matches 1 if predicate game:phase/match if score $last_arena_team var matches 2 if entity @e[limit=1,x=0,type=armor_stand,tag=Selection,tag=duelEnabled] run tellraw @a[x=0] [{score:{name:"#yellow",objective:"text.accent_color"}},[{score:{name:"#yellow",objective:"text.main_color"}},{storage:"rocketriders:main",nbt:"player_left_overworld.name",interpret:true}]," forfeited the match!"]

# TODO: This is kind of an ugly hack fix for chase leave messages, but it'll do
execute if score $do_leave_message var matches 1 unless predicate game:phase/match if score $last_arena_team var matches 1 unless entity @e[limit=1,x=0,type=armor_stand,tag=Selection,tag=chaseEnabled] run tellraw @a[x=0] [{score:{name:"#blue",objective:"text.accent_color"}},[{score:{name:"#blue",objective:"text.main_color"}},{storage:"rocketriders:main",nbt:"player_left_overworld.name",interpret:true}]," left the ",{score:{name:"#blue",objective:"text.team_name_lowercase"}}," team!"]
execute if score $do_leave_message var matches 1 unless predicate game:phase/match if score $last_arena_team var matches 1 if entity @e[limit=1,x=0,type=armor_stand,tag=Selection,tag=chaseEnabled] run tellraw @a[x=0] [{score:{name:"#blue",objective:"text.accent_color"}},[{score:{name:"#blue",objective:"text.main_color"}},{storage:"rocketriders:main",nbt:"player_left_overworld.name",interpret:true}]," left the match!"]
execute if score $do_leave_message var matches 1 unless predicate game:phase/match if score $last_arena_team var matches 2 run tellraw @a[x=0] [{score:{name:"#yellow",objective:"text.accent_color"}},[{score:{name:"#yellow",objective:"text.main_color"}},{storage:"rocketriders:main",nbt:"player_left_overworld.name",interpret:true}]," left the ",{score:{name:"#yellow",objective:"text.team_name_lowercase"}}," team!"]

execute if score $do_leave_message var matches 1 if score $last_arena_team var matches 3 run tellraw @a[x=0] [{score:{name:"#spectator",objective:"text.accent_color"}},[{score:{name:"#spectator",objective:"text.main_color"}},{storage:"rocketriders:main",nbt:"player_left_overworld.name",interpret:true}]," is no longer spectating the match!"]
