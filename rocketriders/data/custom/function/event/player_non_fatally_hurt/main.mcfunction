...
execute on attacker run data modify storage rocketriders:main player_non_fatally_hurt.origin set from entity @s[type=creeper,tag=!UtilKilled] data.explosion.origin
