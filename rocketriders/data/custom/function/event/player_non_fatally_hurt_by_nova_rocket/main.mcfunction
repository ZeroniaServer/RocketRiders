...
execute if score $origin_team var matches 0 unless entity @s[predicate=custom:team/blue] run function entities:nova_attach/init
execute if score $origin_team var matches 1 unless entity @s[predicate=custom:team/yellow] run function entities:nova_attach/init
