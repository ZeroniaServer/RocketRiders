...
execute if score $using_nomicon var matches 1 run return run execute in minecraft:overworld if entity @e[x=0,limit=1,type=armor_stand,tag=Selection,tag=sandboxEnabled] at @s run trigger nomicon set 1
