...
execute if data storage rocketriders:main explosion.modifiers.secondary_origin unless data storage rocketriders:main explosion.modifiers{secondary_origin:""} run function custom:__impl__/explosion/get_secondary_origin_uuid with storage rocketriders:main explosion.modifiers
...
execute as @e[distance=..0.01,type=creeper,tag=explosion.this,limit=1] if function custom:__impl__/explosion/remove_tag run function custom:__impl__/explosion/modify with storage rocketriders:main explosion.modifiers
...
# Castle cracks
execute if predicate game:arena_details/castle if predicate game:castle_type/deepslate if predicate custom:tnt_near_castle if data storage rocketriders:main explosion.modifiers{can_crack_deepslate_bricks:true} run function custom:__impl__/explosion/crack_deepslate_bricks
