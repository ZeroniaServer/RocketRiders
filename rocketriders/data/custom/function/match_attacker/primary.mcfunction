...
execute unless score @s primary_damage_origin_uuid.0 matches -2147483648.. run return fail

data modify storage rocketriders:main match_attacker set value {primary:[I;0,0,0,0]}
