...
execute if score $new_team var matches 0 run function custom:player/team/join_blue
execute if score $new_team var matches 1 run function custom:player/team/join_yellow
