...
execute unless items entity @s hotbar.0 *[custom_data~{delete:false}] run item modify entity @s hotbar.0 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s hotbar.1 *[custom_data~{delete:false}] run item modify entity @s hotbar.1 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s hotbar.2 *[custom_data~{delete:false}] run item modify entity @s hotbar.2 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s hotbar.3 *[custom_data~{delete:false}] run item modify entity @s hotbar.3 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s hotbar.4 *[custom_data~{delete:false}] run item modify entity @s hotbar.4 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s hotbar.5 *[custom_data~{delete:false}] run item modify entity @s hotbar.5 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s hotbar.6 *[custom_data~{delete:false}] run item modify entity @s hotbar.6 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s hotbar.7 *[custom_data~{delete:false}] run item modify entity @s hotbar.7 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s hotbar.8 *[custom_data~{delete:false}] run item modify entity @s hotbar.8 {function:"minecraft:set_custom_data",tag:{delete:true}}
execute unless items entity @s weapon.offhand *[custom_data~{delete:false}] run item modify entity @s weapon.offhand {function:"minecraft:set_custom_data",tag:{delete:true}}
...
clear @s *[custom_data~{delete:true}]
