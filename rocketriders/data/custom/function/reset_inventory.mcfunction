...
item modify entity @s hotbar.0 {function:"minecraft:set_custom_data",tag:{delete:true}}
item modify entity @s hotbar.1 {function:"minecraft:set_custom_data",tag:{delete:true}}
item modify entity @s hotbar.2 {function:"minecraft:set_custom_data",tag:{delete:true}}
item modify entity @s hotbar.3 {function:"minecraft:set_custom_data",tag:{delete:true}}
item modify entity @s hotbar.4 {function:"minecraft:set_custom_data",tag:{delete:true}}
item modify entity @s hotbar.5 {function:"minecraft:set_custom_data",tag:{delete:true}}
item modify entity @s hotbar.6 {function:"minecraft:set_custom_data",tag:{delete:true}}
item modify entity @s hotbar.7 {function:"minecraft:set_custom_data",tag:{delete:true}}
item modify entity @s hotbar.8 {function:"minecraft:set_custom_data",tag:{delete:true}}
...
execute if predicate custom:team/lobby if predicate rr:has_parkour if entity @s[tag=inParkour] run item replace entity @s hotbar.5 with clock[custom_name=[{bold:true,color:"yellow",italic:false,text:"Return to Start"}],consumable={consume_seconds:2147483647,has_consume_particles:false,sound:"minecraft:intentionally_empty"},use_effects={can_sprint:true,speed_multiplier:1}]
execute if predicate custom:team/lobby if predicate rr:has_parkour if entity @s[tag=inParkour] run item replace entity @s hotbar.8 with barrier[custom_name=[{bold:true,color:"red",italic:false,text:"Quit Parkour"}],consumable={consume_seconds:2147483647,has_consume_particles:false,sound:"minecraft:intentionally_empty"},use_effects={can_sprint:true,speed_multiplier:1}]
