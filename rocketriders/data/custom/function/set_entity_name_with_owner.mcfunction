...
$loot replace block 0 184 -16 container.0 loot {pools:[{rolls:1,entries:[{type:"item",name:"stone",functions:[{function:"set_name",entity:"this",name: {text:"",extra:[{text:"",insertion:"",hover_event:{action:"show_text",value:""},extra:[$(text_component)]}]} }]}]}]}
