...
execute on attacker if predicate custom:damage_origin run scoreboard players set $attacker_contains_damage_origin var 1
...
$execute as @a[limit=2,x=0,tag=target_attackers.this] if function custom:_target_attackers_/remove_tag run $(run)
