...
# Game Ending
execute if entity @s[tag=Winner] if predicate game:phase/match/over run loot replace block 0 184 -16 container.2 loot items:ending/celebratory_elytra
execute if entity @s[tag=Loser] if predicate game:phase/match/over run loot replace block 0 184 -16 container.3 loot items:ending/loser_banner

# Flag
execute if predicate game:gamemode_components/has_flags if entity @s[tag=CarryFlag,tag=CarryFY1] run item replace block 0 184 -16 container.3 with minecraft:yellow_banner[item_name={bold:true,color:"yellow",text:"Yellow Flag"},enchantments={binding_curse:1},tooltip_display={hidden_components:["enchantments"]}]
execute if predicate game:gamemode_components/has_flags if entity @s[tag=CarryFlag,tag=CarryFY2] run item replace block 0 184 -16 container.3 with minecraft:yellow_banner[item_name={bold:true,color:"yellow",text:"Yellow Flag"},enchantments={binding_curse:1},tooltip_display={hidden_components:["enchantments"]}]
execute if predicate game:gamemode_components/has_flags if entity @s[tag=CarryFlag,tag=CarryFB1] unless predicate game:gamemode_components/red_for_blue run item replace block 0 184 -16 container.3 with minecraft:blue_banner[item_name={bold:true,color:"blue",text:"Blue Flag"},enchantments={binding_curse:1},tooltip_display={hidden_components:["enchantments"]}]
execute if predicate game:gamemode_components/has_flags if entity @s[tag=CarryFlag,tag=CarryFB2] unless predicate game:gamemode_components/red_for_blue run item replace block 0 184 -16 container.3 with minecraft:blue_banner[item_name={bold:true,color:"blue",text:"Blue Flag"},enchantments={binding_curse:1},tooltip_display={hidden_components:["enchantments"]}]
execute if predicate game:gamemode_components/has_flags if entity @s[tag=CarryFlag,tag=CarryFB1] if predicate game:gamemode_components/red_for_blue run item replace block 0 184 -16 container.3 with minecraft:red_banner[item_name={bold:true,color:"blue",text:"Blue Flag"},enchantments={binding_curse:1},tooltip_display={hidden_components:["enchantments"]}]
