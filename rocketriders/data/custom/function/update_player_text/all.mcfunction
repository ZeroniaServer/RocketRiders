...
##Set global storage
execute unless predicate game:match_components/red_for_blue run data modify storage rocketriders:teams blue set value {text:{team_name:"Blue",team_name_lowercase:"blue",main_color:{color:"blue",text:""},accent_color:{color:"dark_aqua",text:""}}}
execute if predicate game:match_components/red_for_blue run data modify storage rocketriders:teams blue set value {text:{team_name:"Red",team_name_lowercase:"red",main_color:{color:"dark_red",text:""},accent_color:{color:"red",text:""}}}
...
scoreboard players display numberformat #spectator text.team_name fixed "Spectator"
...
scoreboard players display numberformat #spectator text.team_name_lowercase fixed "spectator"
...
scoreboard players display numberformat #spectator text.main_color fixed {color:"dark_gray",text:""}
...
scoreboard players display numberformat #spectator text.accent_color fixed {color:"gray",text:""}
