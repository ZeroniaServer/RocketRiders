...
execute unless entity @e[x=0,type=armor_stand,tag=Selection,tag=chaseEnabled] run team modify Blue color blue
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=chaseEnabled] run team modify Blue color dark_red
...
execute unless entity @e[x=0,type=armor_stand,tag=Selection,tag=chaseEnabled] run team modify Blue friendlyFire false
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=chaseEnabled] run team modify Blue friendlyFire true
