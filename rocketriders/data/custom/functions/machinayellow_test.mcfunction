...
execute if score @s Machina matches ..14 at @s if block ~ ~ ~1 air run setblock ~ ~ ~1 red_concrete
...
execute at @s unless entity @s[x=-15,dx=0] unless entity @s[y=33,dy=0] if score @s Machina matches ..14 run function custom:machinayellow_test