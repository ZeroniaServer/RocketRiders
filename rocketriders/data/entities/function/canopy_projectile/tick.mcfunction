...
# Deploy
execute if score @s entity.age matches 10.. on vehicle positioned as @s if predicate entities:canopy_can_be_deployed run function entities:canopy_projectile/actions/deploy
