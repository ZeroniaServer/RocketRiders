...
execute unless entity @s[predicate=entities:icbm/brain] run return run execute positioned as @s on passengers if entity @s[predicate=entities:icbm/brain] run function entities:icbm/actions/explode
