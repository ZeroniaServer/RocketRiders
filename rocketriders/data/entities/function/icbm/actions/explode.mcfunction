...
execute on vehicle positioned as @s positioned ~ ~ ~ summon tnt run data modify entity @s {} merge from storage rocketriders:main icbm
execute on vehicle positioned as @s positioned ~ ~ ~0.1 summon tnt run data modify entity @s {} merge from storage rocketriders:main icbm
execute on vehicle positioned as @s positioned ~ ~ ~-0.1 summon tnt run data modify entity @s {} merge from storage rocketriders:main icbm
execute on vehicle positioned as @s positioned ~0.1 ~ ~ summon tnt run data modify entity @s {} merge from storage rocketriders:main icbm
execute on vehicle positioned as @s positioned ~-0.1 ~ ~ summon tnt run data modify entity @s {} merge from storage rocketriders:main icbm
execute on vehicle positioned as @s positioned ~ ~0.1 ~ summon tnt run data modify entity @s {} merge from storage rocketriders:main icbm
