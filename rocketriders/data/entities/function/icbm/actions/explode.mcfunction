...
execute if predicate game:gamemode_components/explosions_crack_deepslate_bricks if entity @s[predicate=rr_crusade:tnt_near_castle] run function game:explosion_deepslate_cracks/large
