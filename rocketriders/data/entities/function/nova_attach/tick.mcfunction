...
execute if predicate custom:periodic_tick/3 on vehicle on origin at @s run particle firework ~ ~ ~ 0 0 0 0.05 1 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
