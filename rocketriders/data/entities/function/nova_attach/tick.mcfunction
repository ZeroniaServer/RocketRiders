...
execute if predicate rr:has_achievements if predicate game:match_in_play if score @s entity.age matches 8 on vehicle on origin run advancement grant @s only achievements:rr_challenges/uphere
