...
execute unless function entities:canopy/has_passengers run return run function entities:nova_rocket/actions/__explode__/canopy_poof
...
function entities:nova_rocket/actions/__explode__/canopy_poof
