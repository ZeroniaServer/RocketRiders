...
execute unless predicate game:modifiers/explosive/on positioned as @s positioned ~ ~-1 ~ as @e[distance=..8,predicate=entities:type/canopy/brain] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{distance:{y:{max:5},horizontal:{max:6}}}} positioned ~ ~1 ~ run function entities:nova_rocket/actions/__explode__/check_canopy
execute if predicate game:modifiers/explosive/on positioned as @s positioned ~ ~-1 ~ as @e[distance=..14,predicate=entities:type/canopy/brain] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{distance:{y:{max:9},horizontal:{max:10}}}} positioned ~ ~1 ~ run function entities:nova_rocket/actions/__explode__/check_canopy
