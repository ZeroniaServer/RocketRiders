...
execute if predicate custom:periodic_tick/3 if score @s entity.age matches 1.. if predicate entities:origin_team/yellow on vehicle positioned as @s run particle minecraft:falling_dust{block_state:"minecraft:gold_block"} ~ ~0.2 ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if predicate custom:periodic_tick/3 if score @s entity.age matches 1.. if predicate entities:origin_team/none on vehicle positioned as @s run particle minecraft:falling_dust{block_state:"minecraft:white_concrete"} ~ ~0.2 ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
