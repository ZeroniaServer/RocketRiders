...
execute as @e[x=0,type=marker,tag=PlaceYellowShield,scores={shieldplacement=5}] at @s run place template yellowshield3 ~-3 ~-3 ~
execute as @e[x=0,type=marker,tag=PlaceYellowShield,scores={shieldplacement=5}] at @s run playsound block.glass.break master @a[x=0] ~ ~ ~ 2 0
execute as @e[x=0,type=marker,tag=PlaceYellowShield,scores={shieldplacement=5}] at @s run playsound item.shield.block master @a[x=0] ~ ~ ~ 2 0
execute as @e[x=0,type=marker,tag=PlaceYellowShield,scores={shieldplacement=5}] at @s run particle minecraft:block{block_state:"minecraft:yellow_stained_glass"} ~ ~ ~ 1 1 0 0.1 50
kill @e[x=0,type=marker,tag=PlaceYellowShield,scores={shieldplacement=5..}]
...
execute as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=1}] run scoreboard players add @e[x=0,type=armor_stand,tag=Selection] shieldCount 1
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=1}] at @s run function everytick:shield_anim_blue_spawn
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=2}] at @s run function everytick:shield_anim_blue_play
execute as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=1}] at @s run playsound item.shield.break master @a[x=0] ~ ~ ~ 2 0
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=5}] at @s run place template blueshield3 ~-3 ~-3 ~
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=5}] at @s run kill @e[type=block_display]
execute as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=5}] at @s run playsound block.glass.break master @a[x=0] ~ ~ ~ 2 0
execute as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=5}] at @s run playsound item.shield.block master @a[x=0] ~ ~ ~ 2 2
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=5}] at @s run particle minecraft:block{block_state:"minecraft:blue_stained_glass"} ~ ~ ~ 1 1 0 0.1 50
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] run kill @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=5..}]
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] run kill @e[x=0,type=snowball,tag=BlueShield,scores={shieldtest2=20..}]