...
execute if entity @s[type=area_effect_cloud,tag=spell_type.damage] if predicate entities:origin_team/blue positioned ^ ^ ^3 facing entity @p[distance=..30,predicate=custom:team/yellow,tag=!spell.origin] eyes positioned ^ ^ ^0.1 facing entity @s feet run rotate @s facing ^ ^ ^-1
execute if entity @s[type=area_effect_cloud,tag=spell_type.damage] if predicate entities:origin_team/blue positioned ^ ^ ^3 facing entity @p[distance=..15,predicate=custom:team/yellow,tag=!spell.origin,predicate=!custom:has_wither_effect] eyes positioned ^ ^ ^0.1 facing entity @s feet run rotate @s facing ^ ^ ^-1
execute if entity @s[type=area_effect_cloud,tag=spell_type.damage] if predicate entities:origin_team/yellow positioned ^ ^ ^3 facing entity @p[distance=..30,predicate=custom:team/blue,tag=!spell.origin] eyes positioned ^ ^ ^0.1 facing entity @s feet run rotate @s facing ^ ^ ^-1
execute if entity @s[type=area_effect_cloud,tag=spell_type.damage] if predicate entities:origin_team/yellow positioned ^ ^ ^3 facing entity @p[distance=..15,predicate=custom:team/blue,tag=!spell.origin,predicate=!custom:has_wither_effect] eyes positioned ^ ^ ^0.1 facing entity @s feet run rotate @s facing ^ ^ ^-1
...
execute if predicate custom:periodic_tick/3 if score @s entity.age matches 2.. if entity @s[tag=spell_type.fire] positioned as @s run particle minecraft:flame ~ ~ ~ 0.25 0.25 0.25 0 1 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]

execute if score @s entity.age matches 2.. if entity @s[tag=spell_type.health] positioned as @s run particle minecraft:instant_effect{color:0xFF007F} ~ ~ ~ 0.4 0.4 0.4 0 2 force @a[x=0,predicate=custom:belowroof]
execute if score @s entity.age matches 2.. if entity @s[tag=spell_type.health] positioned as @s run particle minecraft:instant_effect{color:0x7F0000} ~ ~ ~ 0.4 0.4 0.4 0 2 force @a[x=0,predicate=custom:belowroof]
execute if predicate custom:periodic_tick/3 if score @s entity.age matches 2.. if entity @s[tag=spell_type.health] positioned as @s run particle minecraft:heart ~ ~ ~ 0.25 0.25 0.25 0 1 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute if predicate custom:periodic_tick/2 if score @s entity.age matches 2.. if entity @s[tag=spell_type.damage] positioned as @s run particle minecraft:raid_omen ~ ~ ~ 0.25 0.25 0.25 0 1 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute if predicate custom:periodic_tick/2 if score @s entity.age matches 2.. if entity @s[tag=spell_type.wind] positioned as @s run particle minecraft:small_gust ~ ~ ~ 0.25 0.25 0.25 0 1 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]

execute unless entity @s[type=area_effect_cloud] unless entity @s[type=breeze_wind_charge] if score @s entity.age matches 2.. if predicate entities:origin_team/blue positioned as @s run particle minecraft:dust{color:[0.75,0.95,1],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute unless entity @s[type=area_effect_cloud] if entity @s[type=breeze_wind_charge] if score @s entity.age matches 2.. if predicate entities:origin_team/blue positioned as @s run particle minecraft:dust{color:[0,0,1],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute unless entity @s[type=area_effect_cloud] if score @s entity.age matches 2.. if predicate entities:origin_team/yellow positioned as @s run particle minecraft:dust{color:[1,1,0],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute unless entity @s[type=area_effect_cloud] if score @s entity.age matches 2.. if predicate entities:origin_team/none positioned as @s run particle minecraft:dust{color:[1,1,1],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if predicate custom:periodic_tick/3 if entity @s[type=area_effect_cloud] if score @s entity.age matches 1.. if predicate entities:origin_team/blue positioned as @s run particle minecraft:dust{color:[0.75,0.95,1],scale:1} ~ ~ ~ 0.3 0.3 0.3 0.1 4 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if predicate custom:periodic_tick/3 if entity @s[type=area_effect_cloud] if score @s entity.age matches 1.. if predicate entities:origin_team/yellow positioned as @s run particle minecraft:dust{color:[1,1,0],scale:1} ~ ~ ~ 0.3 0.3 0.3 0.1 4 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if predicate custom:periodic_tick/3 if entity @s[type=area_effect_cloud] if score @s entity.age matches 1.. if predicate entities:origin_team/none positioned as @s run particle minecraft:dust{color:[1,1,1],scale:1} ~ ~ ~ 0.3 0.3 0.3 0.1 4 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
