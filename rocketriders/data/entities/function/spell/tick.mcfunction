...
execute if entity @s[type=area_effect_cloud,tag=spell_type.health] positioned as @s unless block ~ ~ ~ #custom:nonsolid rotated as @s run execute anchored eyes run particle minecraft:instant_effect{color:0xFF007F,power:1.7} ^ ^ ^-0.3 0.3 0.3 0.3 1 20 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if entity @s[type=area_effect_cloud,tag=spell_type.health] positioned as @s unless block ~ ~ ~ #custom:nonsolid rotated as @s run execute anchored eyes run particle minecraft:instant_effect{color:0x7F0000,power:1.7} ^ ^ ^-0.3 0.3 0.3 0.3 1 20 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if entity @s[type=area_effect_cloud,tag=spell_type.damage] positioned as @s unless block ~ ~ ~ #custom:nonsolid rotated as @s run execute anchored eyes run particle minecraft:instant_effect{color:0x6F6F6F,power:1.7} ^ ^ ^-0.3 0.3 0.3 0.3 1 20 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if entity @s[type=area_effect_cloud,tag=spell_type.damage] positioned as @s unless block ~ ~ ~ #custom:nonsolid rotated as @s run execute anchored eyes run particle minecraft:instant_effect{color:0x2F2F2F,power:1.7} ^ ^ ^-0.3 0.3 0.3 0.3 1 20 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute unless entity @s[type=area_effect_cloud] if entity @s[type=breeze_wind_charge] if score @s entity.age matches 2.. if predicate entities:origin_team/blue positioned as @s run particle minecraft:dust{color:[0,0,1],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
