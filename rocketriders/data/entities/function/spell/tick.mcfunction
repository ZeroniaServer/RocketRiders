...
execute if entity @s[type=area_effect_cloud] if score @s entity.age matches 1.. if predicate entities:origin_team/blue if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:3}} positioned as @s run particle minecraft:dust{color:[0.75,0.95,1],scale:1} ~ ~ ~ 0.3 0.3 0.3 0.1 4 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if entity @s[type=area_effect_cloud] if score @s entity.age matches 1.. if predicate entities:origin_team/yellow if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:3}} positioned as @s run particle minecraft:dust{color:[1,1,0],scale:1} ~ ~ ~ 0.3 0.3 0.3 0.1 4 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if entity @s[type=area_effect_cloud] if score @s entity.age matches 1.. if predicate entities:origin_team/none if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:3}} positioned as @s run particle minecraft:dust{color:[1,1,1],scale:1} ~ ~ ~ 0.3 0.3 0.3 0.1 4 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
