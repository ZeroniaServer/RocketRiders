...
execute if score @s entity.age matches 2.. if entity @s[tag=spell_type.damage] positioned as @s run particle minecraft:instant_effect{color:0x6F6F6F} ~ ~ ~ 0.25 0.25 0.25 0 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if score @s entity.age matches 2.. if entity @s[tag=spell_type.damage] positioned as @s run particle minecraft:instant_effect{color:0x2F2F2F} ~ ~ ~ 0.25 0.25 0.25 0 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute unless entity @s[type=area_effect_cloud] if score @s entity.age matches 2.. if predicate entities:origin_team/blue if score $dust CmdData matches 1 positioned as @s run particle minecraft:dust{color:[0,0,1],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute if entity @s[type=area_effect_cloud] if score @s entity.age matches 2.. if predicate entities:origin_team/blue if score $dust CmdData matches 1 if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:5}} positioned as @s run particle minecraft:dust{color:[0,0,1],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if entity @s[type=area_effect_cloud] if score @s entity.age matches 2.. if predicate entities:origin_team/yellow if score $dust CmdData matches 1 if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:5}} positioned as @s run particle minecraft:dust{color:[1,1,0],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if entity @s[type=area_effect_cloud] if score @s entity.age matches 2.. if predicate entities:origin_team/none if score $dust CmdData matches 1 if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:5}} positioned as @s run particle minecraft:dust{color:[1,1,1],scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
