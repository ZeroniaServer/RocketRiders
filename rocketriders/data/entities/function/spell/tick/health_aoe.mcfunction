...
# Search for player
execute if predicate entities:origin_team/blue run tag @p[distance=..2,predicate=custom:team/blue,tag=!spell.origin,predicate=!custom:has_regeneration_effect] add spell.target
execute if predicate entities:origin_team/yellow run tag @p[distance=..2,predicate=custom:team/yellow,tag=!spell.origin,predicate=!custom:has_regeneration_effect] add spell.target
