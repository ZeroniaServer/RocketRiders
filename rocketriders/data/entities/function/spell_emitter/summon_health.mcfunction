...
execute at @s anchored eyes positioned ^ ^ ^0.5 run return run function custom:summon_persistent_marker_aec {modifiers:{nbt:{Tags:["spell_emitter","spell_type.health"]},run:"function entities:spell_emitter/init/summon"}}
