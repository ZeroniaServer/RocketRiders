...
execute on vehicle if entity @s[predicate=entities:stinging_shield_projectile/body] positioned as @s run return run function entities:stinging_shield_projectile/actions/break
