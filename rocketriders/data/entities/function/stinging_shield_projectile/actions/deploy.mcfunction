...
execute unless entity @s[predicate=entities:type/stinging_shield_projectile/brain] run return run execute on passengers if entity @s[predicate=entities:type/stinging_shield_projectile/brain] run function entities:stinging_shield_projectile/actions/deploy
