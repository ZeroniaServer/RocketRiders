...
execute if entity @s[x=-12,y=36,z=-74,dx=48,dy=25,dz=0] run return run kill @s
execute if entity @s[x=-12,y=36,z=74,dx=48,dy=25,dz=0] run return run kill @s
execute if predicate custom:nearvoid run return run kill @s
execute if entity @s[y=175,dy=100] run return run kill @s
execute unless predicate custom:insideborder run return run kill @s
