...
execute as @e[x=0,type=snowball,predicate=!entities:shield_projectile,predicate=!entities:stinging_shield_projectile,nbt=!{Item:{components:{"minecraft:custom_data":{stinging_shield:1b}}}}] at @s run function entities:shield_projectile/init
...
execute if predicate game:modifier/punchable_tnt as @e[x=0,type=tnt,predicate=!entities:punchable_tnt] at @s run function entities:punchable_tnt/init
...
# Stinging Shield
execute as @e[x=0,predicate=entities:stinging_shield_projectile/brain] at @s run function entities:stinging_shield_projectile/tick
execute as @e[x=0,predicate=entities:stinging_shield] at @s run function entities:stinging_shield/tick
...
# Punchable TNT
execute if predicate game:modifier/punchable_tnt as @e[x=0,predicate=entities:punchable_tnt/brain,scores={entity.age=0..}] run function entities:punchable_tnt/actions/kill
