...
# Punchable TNT
execute if predicate game:modifier/punchable_tnt as @e[x=0,predicate=entities:type/punchable_tnt/brain,scores={entity.age=0..}] run function entities:punchable_tnt/actions/kill
