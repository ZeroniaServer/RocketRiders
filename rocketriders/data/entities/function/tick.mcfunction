...
execute if predicate game:item_pool/shield as @e[x=0,type=snowball,predicate=!entities:type/shield_projectile,predicate=!entities:type/stinging_shield_projectile,predicate=!entities:type/vortex_projectile,nbt={Item:{components:{"minecraft:custom_data":{id:"shield"}}}}] at @s run function entities:shield_projectile/init
execute as @e[x=0,type=snowball,predicate=!entities:type/shield_projectile,predicate=!entities:type/stinging_shield_projectile,predicate=!entities:type/vortex_projectile,nbt={Item:{components:{"minecraft:custom_data":{id:"stinging_shield"}}}}] at @s run function entities:stinging_shield_projectile/init
execute if predicate game:item_pool/vortex as @e[x=0,type=snowball,predicate=!entities:type/shield_projectile,predicate=!entities:type/stinging_shield_projectile,predicate=!entities:type/vortex_projectile,nbt={Item:{components:{"minecraft:custom_data":{id:"vortex"}}}}] at @s run function entities:vortex_projectile/init
