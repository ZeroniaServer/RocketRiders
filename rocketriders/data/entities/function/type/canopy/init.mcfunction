...
execute at @s[tag=canopy.small] if predicate {type:"minecraft:location_check",predicate:{position:{x:{min:186}}}} run tp @s 185.5 ~ ~
execute at @s[tag=canopy.small] unless predicate {type:"minecraft:location_check",predicate:{position:{x:{min:-161.0}}}} run tp @s -160.5 ~ ~
execute at @s[tag=canopy.small] if predicate {type:"minecraft:location_check",predicate:{position:{z:{min:174.0}}}} run tp @s ~ ~ 173.5
execute at @s[tag=canopy.small] unless predicate {type:"minecraft:location_check",predicate:{position:{z:{min:-173.0}}}} run tp @s ~ ~ -172.5
execute at @s[tag=!canopy.small] if predicate {type:"minecraft:location_check",predicate:{position:{x:{min:185}}}} run tp @s 184.5 ~ ~
execute at @s[tag=!canopy.small] unless predicate {type:"minecraft:location_check",predicate:{position:{x:{min:-160.0}}}} run tp @s -159.5 ~ ~
execute at @s[tag=!canopy.small] if predicate {type:"minecraft:location_check",predicate:{position:{z:{min:173.0}}}} run tp @s ~ ~ 172.5
execute at @s[tag=!canopy.small] unless predicate {type:"minecraft:location_check",predicate:{position:{z:{min:-172.0}}}} run tp @s ~ ~ -171.5
