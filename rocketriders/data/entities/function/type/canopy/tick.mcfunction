...
execute if entity @s[tag=!canopy.animated,tag=!canopy.small] run function entities:type/canopy/tick/deployment_animation
execute if entity @s[tag=!canopy.animated,tag=canopy.small] run function entities:type/canopy/tick/deployment_animation_small

#Kill Canopy if marked to be killed
execute if entity @s[tag=canopy.kill] run return run function entities:type/canopy/actions/kill
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 14 run particle minecraft:large_smoke ~ ~ ~ 1 0 1 0 200 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 21 run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1 -1 1 0.01 100 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 28 run particle minecraft:large_smoke ~ ~ ~ 1.5 0 1.5 0 200 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 35 run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1 -1 1 0.01 100 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 42 run particle minecraft:large_smoke ~ ~ ~ 1.5 0 1.5 0.1 200 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 49 run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1.5 -1 1.5 0.01 200 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 56 run particle minecraft:large_smoke ~ ~ ~ 2 0 2 0.1 200 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 63 run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1.5 -1 1.5 0.01 200 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 70 run particle minecraft:large_smoke ~ ~ ~ 2 0 2 0.1 300 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2..299 if score @s canopySmoke matches 77 run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 2 -1 2 0.01 200 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score $in_lava var matches 1 run particle lava ~ ~1 ~ 2 0.1 2 2 50 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if score $in_lava var matches 1 run particle minecraft:falling_lava ~ ~-1 ~ 2 1 2 0.1 50 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if score $in_lava var matches 1 run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1 1 1 0.5 40 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if entity @s[tag=canopy.burn] run particle flame ~ ~ ~ 2 0 2 0.15 250 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if entity @s[tag=canopy.burn] run particle lava ~ ~ ~ 2 0 2 0.1 20 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if entity @s[tag=canopy.burn] run particle explosion_emitter ~ ~ ~ 2 0 2 0.1 1 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if entity @s[tag=canopy.burn] run return run function entities:type/canopy/actions/kill

#Canopy durations
execute if score @s entity.age matches 3.. unless block ~ ~1 ~ oak_wood run return run function entities:type/canopy/actions/kill
execute if score @s entity.age matches 3.. unless block ~ ~ ~ oak_wood run return run function entities:type/canopy/actions/kill
execute if score @s entity.age matches 219.. at @s if predicate custom:periodic_tick/3 run particle minecraft:block{block_state:"minecraft:oak_wood"} ~ ~1 ~ 0.5 0.5 0.5 1 10 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 299 run particle minecraft:block{block_state:"minecraft:oak_wood"} ~ ~1 ~ 0.5 0.5 0.5 1 50 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score $in_water var matches 1 run particle minecraft:falling_water ~ ~1 ~ 2 -1 2 1 50 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if score $in_water var matches 1 run particle minecraft:happy_villager ~ ~1 ~ 2 -1 2 1 50 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
