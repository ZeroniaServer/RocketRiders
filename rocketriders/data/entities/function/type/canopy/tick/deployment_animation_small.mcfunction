...
execute if score @s entity.age matches 9 positioned ~ ~ ~ if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
execute if score @s entity.age matches 9 positioned ~ ~ ~-1 if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
execute if score @s entity.age matches 9 positioned ~ ~ ~1 if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
...
execute if score @s entity.age matches 19 positioned ~-1 ~ ~ if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
execute if score @s entity.age matches 19 positioned ~1 ~ ~ if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
execute if score @s entity.age matches 19 positioned ~ ~ ~-2 if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
execute if score @s entity.age matches 19 positioned ~ ~ ~2 if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
...
execute if score @s entity.age matches 39 positioned ~-2 ~ ~ if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
execute if score @s entity.age matches 39 positioned ~2 ~ ~ if block ~ ~ ~ #minecraft:beehives run function custom:block/release_bees_and_destroy_hive
