...
execute if score @s entity.canopy.movement_cooldown matches ..39 unless predicate game:phase/match/play on origin run tag @s add canopy.player
execute if score @s entity.canopy.movement_cooldown matches ..39 unless predicate game:phase/match/play on passengers on origin run ride @a[limit=1,tag=canopy.player] mount @s[predicate=entities:type/canopy/saddle]
execute if score @s entity.canopy.movement_cooldown matches ..39 unless predicate game:phase/match/play on origin run tag @s remove canopy.player
execute if score @s entity.canopy.movement_cooldown matches ..39 unless predicate game:phase/match/play on origin run tag @s[type=player,predicate=custom:alive] add force_mount
