...
# Search for player
execute if predicate entities:origin_team/blue positioned ~-1.5 ~-1.5 ~-1.5 run tag @e[dx=2,dy=2,dz=2,type=#entities:spell_targets,predicate=custom:team/yellow,tag=!damage_spell.origin,predicate=!custom:has_wither_effect] add damage_spell.target_candidate
execute if predicate entities:origin_team/yellow positioned ~-1.5 ~-1.5 ~-1.5 run tag @e[dx=2,dy=2,dz=2,type=#entities:spell_targets,predicate=custom:team/blue,tag=!damage_spell.origin,predicate=!custom:has_wither_effect] add damage_spell.target_candidate
execute if predicate entities:origin_team/none positioned ~-1.5 ~-1.5 ~-1.5 run tag @e[dx=2,dy=2,dz=2,type=#entities:spell_targets,tag=!damage_spell.origin,predicate=!custom:has_wither_effect] add damage_spell.target_candidate
...
execute if predicate entities:origin_team/blue facing entity @e[limit=1,distance=..20,type=#entities:spell_targets,predicate=custom:team/yellow,tag=!damage_spell.origin,predicate=!custom:has_wither_effect] eyes run rotate @s ~ ~
execute if predicate entities:origin_team/yellow facing entity @e[limit=1,distance=..20,type=#entities:spell_targets,predicate=custom:team/blue,tag=!damage_spell.origin,predicate=!custom:has_wither_effect] eyes run rotate @s ~ ~
execute if predicate entities:origin_team/none facing entity @e[limit=1,distance=..20,type=#entities:spell_targets,tag=!damage_spell.origin,predicate=!custom:has_wither_effect] eyes run rotate @s ~ ~
