...
execute if score $team var matches 0 if predicate custom:near_any_spawn_zone if predicate custom:on_yellow_half run return run function entities:type/fire_spell/actions/break
execute if score $team var matches 1 if predicate custom:near_any_spawn_zone if predicate custom:on_blue_half run return run function entities:type/fire_spell/actions/break
...
execute if score @s entity.age matches 2.. if predicate entities:origin_team/blue on vehicle positioned as @s run particle minecraft:dust{color:0x7FB2FF,scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if score @s entity.age matches 2.. if predicate entities:origin_team/yellow on vehicle positioned as @s run particle minecraft:dust{color:0xFFFF44,scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
