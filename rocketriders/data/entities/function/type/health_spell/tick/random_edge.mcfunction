...
function entities:type/health_spell/tick/random_edge_spawn with storage rocketriders:main health_spell

function entities:type/health_spell/tick/random_edge_spawn_perimeter with storage rocketriders:main health_spell
