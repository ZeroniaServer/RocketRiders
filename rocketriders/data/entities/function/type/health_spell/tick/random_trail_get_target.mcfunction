...
$execute rotated $(yaw) $(pitch) positioned ^ ^ ^$(radius) run function entities:type/health_spell/tick/random_trail_spawn with storage rocketriders:main health_spell
