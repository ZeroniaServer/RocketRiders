...
execute positioned as @s if predicate custom:near_any_spawn_zone_lenient run return run function entities:type/icbm/actions/break_with_reason {message:"ICBM failed to deploy; it was too close a spawnpoint"}
