...
execute positioned as @s if predicate custom:near_any_spawn_zone_lenient run return run function entities:type/icbm/actions/break_with_reason {message:"ICBM failed to explode; it was too close a spawnpoint"}
...
# Castle cracks
execute if predicate game:arena_details/top/castle if entity @s[predicate=custom:tnt/near_castle] run function game:explosion_deepslate_cracks/large
