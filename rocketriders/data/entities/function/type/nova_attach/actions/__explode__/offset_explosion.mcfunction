...
execute if entity @a[limit=1,tag=nova_attach.target,predicate=custom:player/is_carrying_flag] store success score $towards_yellow var if score $towards_yellow var matches 0
