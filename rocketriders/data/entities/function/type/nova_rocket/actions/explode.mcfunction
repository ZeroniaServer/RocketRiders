...
execute if predicate game:match_components/has_chase_crystals positioned as @s positioned ~ ~-0.5 ~ as @e[distance=..5,type=minecraft:end_crystal] run data modify entity @s Invulnerable set value false
execute if predicate game:match_components/has_chase_crystals positioned as @s positioned ~ ~-0.5 ~ on origin at @e[distance=..5,type=minecraft:end_crystal] run damage @n[limit=1,distance=..0.1,type=minecraft:end_crystal] 1 minecraft:player_attack by @s
execute if predicate game:match_components/has_chase_crystals positioned as @s positioned ~ ~-0.5 ~ as @e[distance=..5,type=minecraft:end_crystal] run data modify entity @s Invulnerable set value true
...
execute unless predicate game:modifiers/explosive/on positioned as @s positioned ~ ~-1 ~ as @e[distance=..8,predicate=entities:type/canopy/brain] if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:distance":{y:{max:5},horizontal:{max:6}}}} positioned ~ ~1 ~ run function entities:type/nova_rocket/actions/__explode/check_canopy
execute if predicate game:modifiers/explosive/on positioned as @s positioned ~ ~-1 ~ as @e[distance=..14,predicate=entities:type/canopy/brain] if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:distance":{y:{max:9},horizontal:{max:10}}}} positioned ~ ~1 ~ run function entities:type/nova_rocket/actions/__explode/check_canopy
