...
# Movement trail
execute if predicate custom:periodic_tick/3 if score @s entity.age matches 1.. if predicate entities:origin_team/blue unless predicate game:match_components/red_for_blue on vehicle positioned as @s run particle minecraft:falling_dust{block_state:"minecraft:lapis_block"} ~ ~0.2 ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if predicate custom:periodic_tick/3 if score @s entity.age matches 1.. if predicate entities:origin_team/blue if predicate game:match_components/red_for_blue on vehicle positioned as @s run particle minecraft:falling_dust{block_state:"minecraft:redstone_block"} ~ ~0.2 ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
