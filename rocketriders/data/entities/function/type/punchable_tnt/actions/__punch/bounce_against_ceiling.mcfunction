execute if block ~-0.49 ~0.99 ~-0.49 #custom:nonsolid if block ~-0.49 ~0.99 ~0.49 #custom:nonsolid if block ~0.49 ~0.99 ~-0.49 #custom:nonsolid if block ~0.49 ~0.99 ~0.49 #custom:nonsolid run return 0
