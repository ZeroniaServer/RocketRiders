execute if block ~0.5 ~ ~-0.49 #custom:nonsolid if block ~0.5 ~0.49 ~-0.49 #custom:nonsolid if block ~0.5 ~ ~0.49 #custom:nonsolid if block ~0.5 ~0.49 ~0.49 #custom:nonsolid run return 0
...
execute if score $against_honey var matches 1 run return run execute if score $impulse_x var matches 1.. run scoreboard players set $impulse_x var 0

execute unless score $impulse_x var matches 1.. run return 0
