...
execute if score $against_honey var matches 1 run return run execute if score $impulse_z var matches 1.. run scoreboard players set $impulse_z var 0

execute unless score $impulse_z var matches 1.. run return 0
