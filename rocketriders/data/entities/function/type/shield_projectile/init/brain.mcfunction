## Mount body
ride @s mount @e[distance=..0.01,limit=1,type=snowball,tag=shield_projectile.this]

## Set up data
data modify entity @s data.shield_projectile set value {brain:{}}
scoreboard players set @s entity.age 0

data modify entity @s Owner set from storage rocketriders:main shield_projectile.origin
