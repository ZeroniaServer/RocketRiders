...
execute if predicate custom:near_or_above_roof run return run function entities:type/shield_projectile/actions/break
...
# Deploy
execute if score @s entity.age matches 20.. on vehicle positioned as @s if predicate entities:shield_can_be_deployed run function entities:type/shield_projectile/actions/deploy
