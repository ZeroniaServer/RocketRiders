...
# Deploy
execute if score @s entity.age matches 20.. on vehicle positioned as @s if predicate entities:shield_can_be_deployed unless function custom:location/is_near_flag_base run return run function entities:type/shield_projectile/actions/deploy
