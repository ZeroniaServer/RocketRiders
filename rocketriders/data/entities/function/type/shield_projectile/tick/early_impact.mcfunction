...
execute if predicate entities:shield_blocked_by_portal run return run function entities:type/shield_projectile/actions/break_with_reason {message:"Shield failed to deploy; it was too close to a portal"}
