...
execute if score $too_close var matches 1 run return run function entities:type/shield_projectile/actions/break_with_reason {message:"Shield failed to deploy; it was too close to a Canopy"}
