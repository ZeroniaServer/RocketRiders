execute unless entity @s[type=player] run return run function custom:summon_persistent_marker_aec {modifiers:{nbt:{Tags:["spell_emitter","spell_type.wind"]},run:"function entities:type/spell_emitter/init/summon"}}
