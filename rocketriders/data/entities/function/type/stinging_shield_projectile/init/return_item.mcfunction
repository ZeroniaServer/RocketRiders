...
execute on origin unless items entity @s weapon.mainhand * run return run loot replace entity @s weapon.mainhand loot items:item/stinging_shield
execute on origin run loot give @s loot items:item/stinging_shield
