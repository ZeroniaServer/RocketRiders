...
execute on vehicle positioned as @s if function entities:type/stinging_shield_projectile/tick/check_passive_break run return 0
...
execute if score @s entity.age matches 1.. if predicate custom:periodic_tick/3 run particle minecraft:block{block_state:"minecraft:honey_block"} ~ ~ ~ 0 0 0 1 10
