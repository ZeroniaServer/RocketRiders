...
execute if predicate custom:near_or_above_roof run return run function entities:type/stinging_shield_projectile/actions/break
...
execute if predicate custom:nearvoid run return run function entities:type/stinging_shield_projectile/actions/break
