...
$execute if entity @s[predicate=entities:type/vortex/body] run return run execute on passengers if entity @s[predicate=entities:type/vortex/brain] at @s run function entities:type/vortex/actions/trigger {fuse:$(fuse)}
