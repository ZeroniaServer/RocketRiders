...
# Particles
execute if predicate custom:periodic_tick/3 unless entity @s[tag=vortex.neutral_landmine] if predicate entities:origin_team/blue if predicate game:blue_team_skin/blue on vehicle at @s run function entities:type/vortex/tick/particles/blue
execute if predicate custom:periodic_tick/3 unless entity @s[tag=vortex.neutral_landmine] if predicate entities:origin_team/blue if predicate game:blue_team_skin/any_red_skin on vehicle at @s run function entities:type/vortex/tick/particles/red
execute if predicate custom:periodic_tick/3 unless entity @s[tag=vortex.neutral_landmine] if predicate entities:origin_team/yellow if predicate game:yellow_team_skin/yellow on vehicle at @s run function entities:type/vortex/tick/particles/yellow
execute if predicate custom:periodic_tick/3 unless entity @s[tag=vortex.neutral_landmine] if predicate entities:origin_team/yellow if predicate game:yellow_team_skin/green on vehicle at @s run function entities:type/vortex/tick/particles/green
execute if predicate custom:periodic_tick/3 unless entity @s[tag=vortex.neutral_landmine] if predicate entities:origin_team/none on vehicle at @s run function entities:type/vortex/tick/particles/neutral
