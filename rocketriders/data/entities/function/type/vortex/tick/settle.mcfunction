...
execute align xyz if entity @e[limit=1,dx=0,predicate=entities:type/vortex/body,tag=!vortex.settle_search.this] run function entities:type/vortex/tick/settle_search
