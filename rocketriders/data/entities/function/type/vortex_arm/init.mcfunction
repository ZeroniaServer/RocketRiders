...
execute if score $too_many_arms var matches 1 run return run function entities:type/vortex_arm/actions/break
...
execute at @s summon item_display run function entities:type/vortex_arm/init/body
