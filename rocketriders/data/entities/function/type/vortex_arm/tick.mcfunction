...
execute unless entity @s[tag=vortex_arm.transitioning,scores={entity.age=4}] unless entity @s[tag=vortex_arm.transitioning,scores={entity.age=..2}] run function entities:type/vortex_arm/tick/get_angle
execute unless entity @s[tag=vortex_arm.transitioning,scores={entity.age=4}] unless entity @s[tag=vortex_arm.transitioning,scores={entity.age=..2}] run function entities:type/vortex_arm/tick/set_position with storage rocketriders:main vortex_arm
