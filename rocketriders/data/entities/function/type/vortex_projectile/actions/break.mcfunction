...
execute on vehicle if entity @s[predicate=entities:type/vortex_projectile/body] positioned as @s run return run function entities:type/vortex_projectile/actions/break
