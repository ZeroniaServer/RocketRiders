...
execute unless entity @s[predicate=entities:type/vortex_projectile/brain] run return run execute on passengers if entity @s[predicate=entities:type/vortex_projectile/brain] run function entities:type/vortex_projectile/actions/deploy

# Kill body and correct position
execute on vehicle if entity @s[predicate=entities:type/vortex_projectile/body] run function custom:player/teleport_passengers_to_self_and_die
...
execute at @s run function entities:type/vortex/init
