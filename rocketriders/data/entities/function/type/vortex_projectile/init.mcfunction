...
execute if score $return var matches 1 run return run function entities:type/vortex_projectile/init/return_item
...
execute at @s run function custom:summon_persistent_marker_aec {modifiers:{run:"function entities:type/vortex_projectile/init/brain"}}
