...
# Movement trail
execute if score @s entity.age matches 1.. if predicate custom:periodic_tick/3 run particle dragon_breath ~ ~ ~ 0 0 0 0.02 2 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if score @s entity.age matches 1.. if predicate entities:origin_team/blue if predicate custom:periodic_tick/3 run particle minecraft:dust{color:[0,0,1],scale:1} ~ ~ ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
