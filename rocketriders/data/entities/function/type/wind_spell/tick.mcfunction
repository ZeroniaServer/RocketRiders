...
execute on vehicle positioned as @s if predicate custom:near_or_above_roof run return run function entities:type/wind_spell/actions/break
execute on vehicle positioned as @s if predicate custom:in_void unless predicate custom:entity/is_moving_upwards run return run function entities:type/wind_spell/actions/break
execute on vehicle positioned as @s if predicate custom:location/touching_or_beyond_world_border run return run function entities:type/wind_spell/actions/break
execute on vehicle positioned as @s unless predicate custom:in_arena run return run function entities:type/wind_spell/actions/break
...
execute if score $team var matches 0 if predicate custom:near_any_spawn_zone_lenient if predicate custom:in_yellow_half run return run function entities:type/wind_spell/actions/break
execute if score $team var matches 1 if predicate custom:near_any_spawn_zone_lenient if predicate custom:in_blue_half run return run function entities:type/wind_spell/actions/break
...
# Early impact
execute unless predicate custom:entity/has_vehicle if function custom:projectile_motion_step positioned as @s run return run function entities:type/wind_spell/tick/impact
...
execute if score @s entity.age matches 2.. if predicate entities:origin_team/blue if predicate game:blue_team_skin/blue on vehicle positioned as @s run particle minecraft:dust{color:0x4444FF,scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute if score @s entity.age matches 2.. if predicate entities:origin_team/blue if predicate game:blue_team_skin/classic_red on vehicle positioned as @s run particle minecraft:dust{color:0xDC2828,scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if score @s entity.age matches 2.. if predicate entities:origin_team/yellow if predicate game:yellow_team_skin/yellow on vehicle positioned as @s run particle minecraft:dust{color:0xFFAA00,scale:1} ~ ~ ~ 0.25 0.25 0.25 0.1 2 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
