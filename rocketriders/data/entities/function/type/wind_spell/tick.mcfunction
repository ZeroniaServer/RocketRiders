...
execute on vehicle positioned as @s if predicate custom:location/near_or_beyond_world_border run return run function entities:type/wind_spell/actions/break
