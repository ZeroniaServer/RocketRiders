...
execute if entity @s[tag=!vortex.feathered] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,predicate=!game:modifiers/explosive/on,tag=!ClutterCollector] at @s run function custom:explosion {r:3,modifiers:{copy_name:true}}
execute if entity @s[tag=!vortex.feathered] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,predicate=game:modifiers/explosive/on,tag=!ClutterCollector] at @s run function custom:explosion {r:5,modifiers:{copy_name:true}}
...
execute if entity @s[tag=vortex.feathered] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,predicate=!game:modifiers/explosive/on,tag=!ClutterCollector] at @s run function custom:explosion {r:2,modifiers:{copy_name:true}}
execute if entity @s[tag=vortex.feathered] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,predicate=game:modifiers/explosive/on,tag=!ClutterCollector] at @s run function custom:explosion {r:4,modifiers:{copy_name:true}}
execute if entity @s[tag=vortex.feathered] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=ClutterCollector] at @s run function custom:explosion {r:0,modifiers:{copy_name:true}}
