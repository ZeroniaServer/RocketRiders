...
execute if entity @s[tag=!vortex.feathered] unless predicate game:modifiers/explosive/on unless predicate game:modifiers/clutter_collector/on at @s run function custom:explosion {r:3,modifiers:{copy_name:true}}
execute if entity @s[tag=!vortex.feathered] if predicate game:modifiers/explosive/on unless predicate game:modifiers/clutter_collector/on at @s run function custom:explosion {r:5,modifiers:{copy_name:true}}
execute if entity @s[tag=!vortex.feathered] if predicate game:modifiers/clutter_collector/on at @s run function custom:explosion {r:0,modifiers:{copy_name:true}}

execute if entity @s[tag=vortex.feathered] unless predicate game:modifiers/explosive/on unless predicate game:modifiers/clutter_collector/on at @s run function custom:explosion {r:2,modifiers:{copy_name:true}}
execute if entity @s[tag=vortex.feathered] if predicate game:modifiers/explosive/on unless predicate game:modifiers/clutter_collector/on at @s run function custom:explosion {r:4,modifiers:{copy_name:true}}
execute if entity @s[tag=vortex.feathered] if predicate game:modifiers/clutter_collector/on at @s run function custom:explosion {r:0,modifiers:{copy_name:true}}
