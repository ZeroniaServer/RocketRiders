...
execute if score $dust CmdData matches 1 unless entity @s[tag=vortex.feathered] if predicate entities:origin_team/none unless entity @s[tag=vortex.is_drifting] run particle minecraft:dust{color:0xFFFFFF,scale:1.5} ~ ~-0.2 ~ 0.5 0.5 0 0 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute if score $dust CmdData matches 1 unless entity @s[tag=vortex.feathered] if predicate entities:origin_team/none if entity @s[tag=vortex.is_drifting] on vehicle at @s run particle minecraft:dust{color:0xFFFFFF,scale:1.5} ^ ^ ^-0.5 0.5 0.5 0.5 0 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
