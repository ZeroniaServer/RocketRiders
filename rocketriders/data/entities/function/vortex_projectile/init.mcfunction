...
## Spawn behaviour
# Veteran achievement
execute if predicate rr:has_achievements if predicate game:match_in_playon origin run advancement grant @s[tag=!VortexSpawned] only achievements:rr_challenges/veteran VortexSpawned
