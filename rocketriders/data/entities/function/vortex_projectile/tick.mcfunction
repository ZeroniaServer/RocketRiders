# If the egg hits something, do nothing
execute unless predicate custom:has_vehicle run return run function entities:vortex_projectile/tick/check_for_chicken
