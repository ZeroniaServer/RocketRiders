...
execute unless predicate game:gamemode_components/no_portal if predicate entities:origin_team/blue if entity @s[x=-12,y=36,z=-80,dx=48,dy=28,dz=12] run return run function entities:vortex_projectile/actions/break
execute unless predicate game:gamemode_components/no_portal if predicate entities:origin_team/yellow if entity @s[x=-12,y=36,z=68,dx=48,dy=28,dz=12] run return run function entities:vortex_projectile/actions/break
