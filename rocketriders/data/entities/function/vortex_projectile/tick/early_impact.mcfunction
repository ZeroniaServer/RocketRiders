...
execute if predicate entities:origin_team/blue if entity @s[x=-12,y=36,z=-80,dx=48,dy=28,dz=12] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!customShield,predicate=!game:gamemode_components/no_portal] run return run function entities:vortex_projectile/actions/break
execute if predicate entities:origin_team/yellow if entity @s[x=-12,y=36,z=68,dx=48,dy=28,dz=12] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!customShield,predicate=!game:gamemode_components/no_portal] run return run function entities:vortex_projectile/actions/break
