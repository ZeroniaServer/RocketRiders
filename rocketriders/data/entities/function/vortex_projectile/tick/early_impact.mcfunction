...
execute positioned as @s unless predicate {condition:"minecraft:random_chance",chance:0.0625} run return run function entities:vortex_projectile/actions/break
