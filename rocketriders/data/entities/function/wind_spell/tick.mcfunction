...
execute if score $team var matches 0 if predicate custom:near_any_spawn_zone_lenient if predicate custom:on_yellow_half run return run function entities:wind_spell/actions/break
execute if score $team var matches 1 if predicate custom:near_any_spawn_zone_lenient if predicate custom:on_blue_half run return run function entities:wind_spell/actions/break
execute if score $team var matches -1 if predicate custom:near_any_spawn_zone_lenient run return run function entities:wind_spell/actions/break
