...
execute as @a[x=0,team=!Spectator] at @s as @e[type=arrow,scores={arrowtime=10..},nbt={inGround:1b},tag=!infinity,limit=1,distance=..2,sort=nearest] unless items entity @s contents tipped_arrow run tag @s add pickup
