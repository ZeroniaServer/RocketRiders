...
execute if entity @s[tag=!given] as @p[team=!Spectator,distance=..2,tag=!fullOffhand] if items entity @s container.* arrow[count~{max:63}] run return run tag @s add fullOffhand
