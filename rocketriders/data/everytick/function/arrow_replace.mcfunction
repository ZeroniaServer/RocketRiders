...
execute if entity @s[tag=!given] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=GameStarted] run loot replace entity @p[team=!Spectator,distance=..2,tag=!fullOffhand] weapon.offhand loot items:misc/arrow
execute if entity @s[tag=!given] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!GameStarted] run loot replace entity @p[team=!Spectator,distance=..2,tag=!fullOffhand] weapon.offhand loot items:misc/arrow_lobby
