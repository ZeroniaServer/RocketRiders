...
execute as @e[x=0,type=ender_pearl] at @s run kill @s[predicate=game:above_roof]
execute as @e[x=0,type=snowball] at @s run kill @s[predicate=game:above_roof]
execute as @e[x=0,type=dragon_fireball] at @s run kill @s[predicate=game:above_roof]
execute as @e[x=0,type=egg] at @s run kill @s[predicate=game:above_roof]
execute as @e[x=0,type=fireball] at @s run kill @s[predicate=game:above_roof]
execute as @e[x=0,type=tnt] at @s run kill @s[predicate=game:above_roof]
...
execute unless entity @s[tag=customVoid] as @e[x=0,type=snowball] at @s run kill @s[predicate=game:in_void]
execute unless entity @s[tag=customVoid] as @e[x=0,type=dragon_fireball] at @s run kill @s[predicate=game:in_void]
execute unless entity @s[tag=customVoid] as @e[x=0,type=egg] at @s run kill @s[predicate=game:in_void]
execute unless entity @s[tag=customVoid] as @e[x=0,type=fireball] at @s run kill @s[predicate=game:in_void]
execute unless entity @s[tag=customVoid] as @e[x=0,type=tnt] at @s run kill @s[predicate=game:in_void]
