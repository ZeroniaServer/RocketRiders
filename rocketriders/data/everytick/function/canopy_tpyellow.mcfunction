...
execute if entity @s[scores={PlatTime=1..40}] run attribute @p[team=Yellow,tag=currentTP,tag=canopyTP] minecraft:jump_strength modifier add rocketriders:canopy_penalty -1 add_multiplied_total
execute if entity @s[scores={PlatTime=1..40}] run attribute @p[team=Yellow,tag=currentTP,tag=canopyTP] minecraft:movement_speed modifier add rocketriders:canopy_penalty -1 add_multiplied_total

execute if entity @s[scores={PlatTime=41..}] run attribute @p[team=Yellow,tag=currentTP,tag=canopyTP] minecraft:jump_strength modifier remove rocketriders:canopy_penalty
execute if entity @s[scores={PlatTime=41..}] run attribute @p[team=Yellow,tag=currentTP,tag=canopyTP] minecraft:movement_speed modifier remove rocketriders:canopy_penalty
