...
tag @a[x=0,predicate=custom:team/any_playing_team,gamemode=!spectator,predicate=custom:wearing_elytra,predicate=custom:break_elytra,predicate=!custom:gliding_downwards] add elytra.break
