...
execute if predicate game:phase/match/play unless predicate game:match_components/no_item_timer if score $play_time match matches ..2 as @a[x=0,predicate=custom:team/any_playing_team] as @a[x=0,predicate=custom:team/any_playing_team] run function custom:player/set_xp_bar_empty
execute if predicate game:phase/match/play unless predicate game:match_components/no_item_timer if score $play_time match matches 3.. run data modify storage rocketriders:main item_time_progress set value {level:0}
execute if predicate game:phase/match/play unless predicate game:match_components/no_item_timer if score $play_time match matches 3.. run scoreboard players operation $item_time_progress var = @e[limit=1,x=0,type=armor_stand,tag=Selection] RandomItem
execute if predicate game:phase/match/play unless predicate game:match_components/no_item_timer if score $play_time match matches 3.. run scoreboard players operation $item_time_progress var *= $1000 constant
execute if predicate game:phase/match/play unless predicate game:match_components/no_item_timer if score $play_time match matches 3.. if predicate game:modifiers/minute_mix/on store result storage rocketriders:main item_time_progress.progress float 0.001 run scoreboard players operation $item_time_progress var /= $1200 constant
execute if predicate game:phase/match/play unless predicate game:match_components/no_item_timer if score $play_time match matches 3.. unless predicate game:modifiers/minute_mix/on store result storage rocketriders:main item_time_progress.progress float 0.001 run scoreboard players operation $item_time_progress var /= @e[limit=1,x=0,type=armor_stand,tag=Selection] MaxItemTime
execute if predicate game:phase/match/play unless predicate game:match_components/no_item_timer if score $play_time match matches 3.. as @a[x=0,predicate=custom:team/any_playing_team] run function custom:player/set_xp_bar with storage rocketriders:main item_time_progress
