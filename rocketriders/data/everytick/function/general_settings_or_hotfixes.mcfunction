...
execute unless predicate game:game_running if entity @s[tag=EditedSettings] unless entity @s[tag=crusadeEnabled,predicate=!game:blue_portal_revealed] run function game:place_portal/blue
execute unless predicate game:game_running if entity @s[tag=EditedSettings] unless entity @s[tag=crusadeEnabled,predicate=!game:yellow_portal_revealed] run function game:place_portal/yellow
