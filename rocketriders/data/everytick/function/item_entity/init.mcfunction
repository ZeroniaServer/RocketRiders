...
execute if predicate game:arrow_pickup_rule/crusade_kit_dependent if predicate custom:item_entity/contains_any_arrow run data modify entity @s Owner set value [I;0,0,0,0]
