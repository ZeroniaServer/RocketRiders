...
execute if predicate game:match_components/arrow_pickup/only_crusade_mode_archer_kit if predicate custom:item_entity/contains_any_arrow run data modify entity @s Owner set value [I;0,0,0,0]
