...
execute as @e[x=0,type=area_effect_cloud,tag=lava_splash_alone,tag=!splashMarked] at @s unless block ~1 ~ ~ #custom:nonsolid unless block ~-1 ~ ~ #custom:nonsolid unless block ~ ~ ~1 #custom:nonsolid unless block ~ ~ ~-1 #custom:nonsolid if block ~ ~-1 ~ #custom:air run fill ~ ~ ~ ~ ~-1 ~ lava[level=8] replace #custom:air
