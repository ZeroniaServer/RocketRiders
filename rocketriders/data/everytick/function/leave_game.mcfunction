...
title @a[x=0,scores={LeaveGame=1..,firstJoined=2},tag=!actuallyLeft] times 5 30 5
title @a[x=0,scores={LeaveGame=1..,firstJoined=2},tag=!actuallyLeft] actionbar [""]
title @a[x=0,scores={LeaveGame=1..,firstJoined=2},tag=!actuallyLeft] title [""]
title @a[x=0,scores={LeaveGame=1..,firstJoined=2},tag=!actuallyLeft] subtitle [""]
tag @a[x=0,tag=actuallyLeft] remove actuallyLeft
