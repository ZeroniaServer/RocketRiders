...
execute as @e[x=0,type=marker,tag=bluenovatracker,tag=!NovaLost,tag=!DontExplode] at @s if entity @e[type=marker,tag=YellowPlatform,distance=..7,limit=1] unless entity @e[type=firework_rocket,tag=BlueNova,distance=..5,limit=1] run tag @s add CanopyIsGone
execute as @e[x=0,type=marker,tag=yellownovatracker,tag=!NovaLost,tag=!DontExplode] at @s if entity @e[type=marker,tag=BluePlatform,distance=..7,limit=1] unless entity @e[type=firework_rocket,tag=YellowNova,distance=..5] run tag @s add CanopyIsGone
execute as @e[x=0,type=marker,tag=bluenovatracker,tag=CanopyIsGone,tag=!NovaLost,tag=!DontExplode] at @s run tag @n[type=marker,tag=YellowPlatform,distance=..7] add killCanopy
execute as @e[x=0,type=marker,tag=yellownovatracker,tag=CanopyIsGone,tag=!NovaLost,tag=!DontExplode] at @s run tag @n[type=marker,tag=BluePlatform,distance=..7] add killCanopy
...
execute as @e[x=0,type=marker,tag=CanopyIsGone,tag=yellownovatracker,tag=!NovaLost,tag=!DontExplode] at @s run tag @n[type=marker,tag=BluePlatform,distance=..7] add killCanopy
execute as @e[x=0,type=marker,tag=CanopyIsGone,tag=bluenovatracker,tag=!NovaLost,tag=!DontExplode] at @s run tag @n[type=marker,tag=YellowPlatform,distance=..7] add killCanopy
...
execute if entity @s[tag=!Explosive,tag=!ClutterCollector] as @e[x=0,type=marker,tag=CanopyIsGone,tag=yellownovatracker,tag=!NovaLost,tag=!DontExplode] at @s as @n[type=marker,tag=BluePlatform,distance=..7] at @s positioned ~ ~2 ~ run function custom:explosion {r:5,modifiers:{nbt:{Tags:["UtilKilled","NovaCanopy"],CustomName:"a Nova Rocket"}}}
execute if entity @s[tag=Explosive,tag=!ClutterCollector] as @e[x=0,type=marker,tag=CanopyIsGone,tag=yellownovatracker,tag=!NovaLost,tag=!DontExplode] at @s as @n[type=marker,tag=BluePlatform,distance=..7] at @s positioned ~ ~2 ~ run function custom:explosion {r:7,modifiers:{nbt:{Tags:["UtilKilled","NovaCanopy"],CustomName:"a Nova Rocket"}}}
execute if entity @s[tag=ClutterCollector] as @e[x=0,type=marker,tag=CanopyIsGone,tag=yellownovatracker,tag=!NovaLost,tag=!DontExplode] at @s as @n[type=marker,tag=BluePlatform,distance=..7] at @s positioned ~ ~2 ~ run function custom:explosion {r:0,modifiers:{nbt:{Tags:["UtilKilled","NovaCanopy"],CustomName:"a Nova Rocket"}}}
execute if entity @s[tag=!Explosive,tag=!ClutterCollector] as @e[x=0,type=marker,tag=CanopyIsGone,tag=bluenovatracker,tag=!NovaLost,tag=!DontExplode] at @s as @n[type=marker,tag=YellowPlatform,distance=..7] at @s positioned ~ ~2 ~ run function custom:explosion {r:5,modifiers:{nbt:{Tags:["UtilKilled","NovaCanopy"],CustomName:"a Nova Rocket"}}}
execute if entity @s[tag=Explosive,tag=!ClutterCollector] as @e[x=0,type=marker,tag=CanopyIsGone,tag=bluenovatracker,tag=!NovaLost,tag=!DontExplode] at @s as @n[type=marker,tag=YellowPlatform,distance=..7] at @s positioned ~ ~2 ~ run function custom:explosion {r:7,modifiers:{nbt:{Tags:["UtilKilled","NovaCanopy"],CustomName:"a Nova Rocket"}}}
execute if entity @s[tag=ClutterCollector] as @e[x=0,type=marker,tag=CanopyIsGone,tag=bluenovatracker,tag=!NovaLost,tag=!DontExplode] at @s as @n[type=marker,tag=YellowPlatform,distance=..7] at @s positioned ~ ~2 ~ run function custom:explosion {r:0,modifiers:{nbt:{Tags:["UtilKilled","NovaCanopy"],CustomName:"a Nova Rocket"}}}
...
execute as @a[x=0,tag=YellowNovaAttach,scores={novattach=15..},predicate=custom:is_on_ground] at @s run tag @n[type=marker,tag=BluePlatform,distance=..7] add killCanopy
