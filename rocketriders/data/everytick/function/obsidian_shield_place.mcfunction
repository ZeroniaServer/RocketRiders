...
#Blue panes
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~1 ~2 ~ blue_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-1 ~2 ~ blue_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~1 ~-2 ~ blue_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-1 ~-2 ~ blue_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-2 ~1 ~ cyan_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-2 ~-1 ~ cyan_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~2 ~1 ~ cyan_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~2 ~-1 ~ cyan_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~1 ~2 ~ red_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-1 ~2 ~ red_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~1 ~-2 ~ red_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-1 ~-2 ~ red_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-2 ~1 ~ pink_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-2 ~-1 ~ pink_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~2 ~1 ~ pink_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~2 ~-1 ~ pink_stained_glass_pane[east=true,west=true]
execute if predicate game:match_components/neutral_items if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~1 ~2 ~ white_stained_glass_pane[east=true,west=true]
execute if predicate game:match_components/neutral_items if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-1 ~2 ~ white_stained_glass_pane[east=true,west=true]
execute if predicate game:match_components/neutral_items if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~1 ~-2 ~ white_stained_glass_pane[east=true,west=true]
execute if predicate game:match_components/neutral_items if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-1 ~-2 ~ white_stained_glass_pane[east=true,west=true]
execute if predicate game:match_components/neutral_items if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-2 ~1 ~ white_stained_glass_pane[east=true,west=true]
execute if predicate game:match_components/neutral_items if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-2 ~-1 ~ white_stained_glass_pane[east=true,west=true]
execute if predicate game:match_components/neutral_items if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~2 ~1 ~ white_stained_glass_pane[east=true,west=true]
execute if predicate game:match_components/neutral_items if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~2 ~-1 ~ white_stained_glass_pane[east=true,west=true]
