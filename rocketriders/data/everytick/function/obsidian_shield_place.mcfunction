...
#Yellow panes
execute if entity @s[tag=yellowobalone,scores={shieldplacement=6}] positioned ~1 ~2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ yellow_stained_glass_pane[east=true,west=true]
execute if entity @s[tag=yellowobalone,scores={shieldplacement=6}] positioned ~-1 ~2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ yellow_stained_glass_pane[east=true,west=true]
execute if entity @s[tag=yellowobalone,scores={shieldplacement=6}] positioned ~1 ~-2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ yellow_stained_glass_pane[east=true,west=true]
execute if entity @s[tag=yellowobalone,scores={shieldplacement=6}] positioned ~-1 ~-2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ yellow_stained_glass_pane[east=true,west=true]
execute if entity @s[tag=yellowobalone,scores={shieldplacement=6}] positioned ~-2 ~1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ orange_stained_glass_pane[east=true,west=true]
execute if entity @s[tag=yellowobalone,scores={shieldplacement=6}] positioned ~-2 ~-1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ orange_stained_glass_pane[east=true,west=true]
execute if entity @s[tag=yellowobalone,scores={shieldplacement=6}] positioned ~2 ~1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ orange_stained_glass_pane[east=true,west=true]
execute if entity @s[tag=yellowobalone,scores={shieldplacement=6}] positioned ~2 ~-1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ orange_stained_glass_pane[east=true,west=true]
