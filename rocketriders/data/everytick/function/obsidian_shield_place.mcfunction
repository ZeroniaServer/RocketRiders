...
#Blue panes
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~1 ~2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ blue_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~-1 ~2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ blue_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~1 ~-2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ blue_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~-1 ~-2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ blue_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~-2 ~1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ cyan_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~-2 ~-1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ cyan_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~2 ~1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ cyan_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items unless predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~2 ~-1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ cyan_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~1 ~2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ red_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~-1 ~2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ red_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~1 ~-2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ red_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~-1 ~-2 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ red_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~-2 ~1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ pink_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~-2 ~-1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ pink_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~2 ~1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ pink_stained_glass_pane[east=true,west=true]
execute unless predicate game:match_components/neutral_items if predicate game:match_components/dark_red_for_blue if entity @s[tag=blueobalone,scores={shieldplacement=6}] positioned ~2 ~-1 ~ unless block ~ ~ ~ crying_obsidian unless block ~ ~ ~ #custom:glasspane run setblock ~ ~ ~ pink_stained_glass_pane[east=true,west=true]
