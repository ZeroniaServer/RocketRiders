...
execute as @e[x=0,type=marker,scores={breakobshield=2}] at @s if predicate custom:periodic_tick/3 run particle minecraft:block{block_state:"minecraft:crying_obsidian"} ~ ~ ~ 1 1 0.4 0.1 5 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute as @e[x=0,type=marker,scores={breakobshield=4}] at @s if predicate custom:periodic_tick/3 run particle minecraft:block{block_state:"minecraft:crying_obsidian"} ~ ~ ~ 1 1 0 0.1 25 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
