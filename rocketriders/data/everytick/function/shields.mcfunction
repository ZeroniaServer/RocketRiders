...
execute as @e[x=0,type=snowball,tag=!YellowShield,tag=!BlueShield] store success score @s yellowsCount on origin if entity @s[team=Yellow]
tag @e[x=0,type=snowball,tag=!YellowShield,tag=!BlueShield,scores={yellowsCount=1}] add YellowShield
execute as @e[x=0,type=snowball,tag=!BlueShield] store success score @s bluesCount on origin if entity @s[team=Blue]
tag @e[x=0,type=snowball,tag=!BlueShield,scores={bluesCount=1}] add BlueShield
tag @e[x=0,type=snowball,tag=!NormalShield,nbt=!{Item:{components:{"minecraft:custom_data":{BeeShield:1b}}}}] add NormalShield

##Yellow Shield functionality
execute as @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield] at @s if score $dust CmdData matches 1 run particle minecraft:dust{color:[1,1,0],scale:1} ~ ~ ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
scoreboard players add @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield] shieldtest 1
#Next 2 commands disable Yellow Shields inside of portals
execute unless entity @s[tag=noPortal] as @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield,scores={shieldtest=19..20}] at @s if entity @s[x=-12,y=33,z=-74,dx=48,dy=28] run scoreboard players remove @s shieldtest 1
execute unless entity @s[tag=noPortal] as @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield,scores={shieldtest=19..20}] at @s if entity @s[x=-12,y=33,z=74,dx=48,dy=28] run scoreboard players remove @s shieldtest 1
#Disable Yellow Shields near void
execute as @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield] at @s if predicate custom:nearvoid run scoreboard players remove @s shieldtest 1
#Disable Yellow Shields near spawnpoints
execute as @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield] at @s if entity @e[type=marker,tag=YellowSpawnZone,distance=..3] run scoreboard players remove @s shieldtest 1
execute as @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield] at @s if entity @e[type=marker,tag=BlueSpawnZone,distance=..3] run scoreboard players remove @s shieldtest 1

execute as @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield,scores={shieldtest=20}] at @s run summon marker ~ ~ ~ {Tags:["PlaceYellowShield"]}
...
kill @e[x=0,type=snowball,tag=YellowShield,tag=NormalShield,scores={shieldtest=20..}]

##Blue Shield functionality
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!customShield] as @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield] at @s if score $dust CmdData matches 1 run particle minecraft:dust{color:[0,0,1],scale:1} ~ ~ ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
scoreboard players add @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield] shieldtest2 1
#Next 2 commands disable Blue Shields inside of portals
execute unless entity @s[tag=noPortal] as @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield,scores={shieldtest2=19..20}] at @s if entity @s[x=-12,y=33,z=-74,dx=48,dy=28] run scoreboard players remove @s shieldtest2 1
execute unless entity @s[tag=noPortal] as @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield,scores={shieldtest2=19..20}] at @s if entity @s[x=-12,y=33,z=74,dx=48,dy=28] run scoreboard players remove @s shieldtest2 1
#Disable Blue Shields near void
execute as @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield] at @s if predicate custom:nearvoid run scoreboard players remove @s shieldtest2 1
#Disable Blue Shields near spawnpoints
execute as @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield] at @s if entity @e[type=marker,tag=YellowSpawnZone,distance=..7] run scoreboard players remove @s shieldtest2 1
execute as @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield] at @s if entity @e[type=marker,tag=BlueSpawnZone,distance=..7] run scoreboard players remove @s shieldtest2 1
execute as @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield,scores={shieldtest2=20}] at @s run summon marker ~ ~ ~ {Tags:["PlaceBlueShield"]}
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!customShield] run kill @e[x=0,type=snowball,tag=BlueShield,tag=NormalShield,scores={shieldtest2=20..}]