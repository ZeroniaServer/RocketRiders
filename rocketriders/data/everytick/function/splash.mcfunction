...
execute if entity @s[scores={servermode=-1..0},tag=!realms] as @e[x=0,type=area_effect_cloud,tag=splash_alone,tag=!markedForDeath] at @s unless block ~ ~ ~ water run data merge entity @s {Duration:100}
execute if entity @s[scores={servermode=-1..0},tag=!realms] as @e[x=0,type=area_effect_cloud,tag=splash_alone,tag=!markedForDeath] at @s unless block ~ ~ ~ water run tag @s add markedForDeath
execute unless entity @s[scores={servermode=-1..0},tag=!realms] run kill @e[x=0,type=area_effect_cloud,tag=splash_alone]