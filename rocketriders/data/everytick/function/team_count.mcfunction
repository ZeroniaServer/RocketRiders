...
execute if score $blue_team_count global matches 0 if score $yellow_team_count global matches 0 if score $playing_teams_count global matches 1.. if predicate game:phase/match unless predicate game:phase/match/closing run function lobby:update_nav_book
