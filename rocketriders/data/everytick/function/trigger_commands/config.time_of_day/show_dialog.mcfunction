    ...
    "contents": [\
      ...
      [\
        ...
        {\
          ...
          "click_event": {\
            "action": "run_command",\
            "command": "trigger config.time_of_day set 2"\
          },\
          "hover_event": {\
            "action": "show_text",\
            "value": {\
        ...
        {\
          ...
          "click_event": {\
            "action": "run_command",\
            "command": "trigger config.time_of_day set 3"\
          },\
          "hover_event": {\
            "action": "show_text",\
            "value": {\
        ...
        {\
          ...
          "click_event": {\
            "action": "run_command",\
            "command": "trigger config.time_of_day set 4"\
          },\
          "hover_event": {\
            "action": "show_text",\
            "value": {\
        ...
        {\
          ...
          "click_event": {\
            "action": "run_command",\
            "command": "trigger config.time_of_day set 5"\
          },\
          "hover_event": {\
            "action": "show_text",\
            "value": {\
        ...
        {\
          ...
          "click_event": {\
            "action": "run_command",\
            "command": "trigger config.time_of_day set 6"\
          },\
          "hover_event": {\
            "action": "show_text",\
            "value": {\
  ...
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "template": "trigger config.time_of_day set $(time_of_day)999"\
      }\
    }\
  ]\
}
