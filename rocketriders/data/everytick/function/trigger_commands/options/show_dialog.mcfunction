data modify storage rocketriders:main settings.dialog set value {\
  ...
  "action": {\
    ...
    "action": {\
      ...
      "template": "trigger options set 1000$(starting_crusade_kit)$(default_spell_book)$(auto_fill_hotbar)$(particles)$(show_parkour_instructions)$(show_tips)"\
    }\
  }\
}
...
execute unless predicate rr:has_parkour run data modify storage rocketriders:main settings.dialog.action.action.template set value "trigger options set 1000$(starting_crusade_kit)$(default_spell_book)$(auto_fill_hotbar)$(particles)0$(show_tips)"
...
execute unless entity @e[limit=1,x=0,type=armor_stand,tag=gamemodeAS,tag=rr_crusade] run execute if predicate rr:has_parkour run data modify storage rocketriders:main settings.dialog.action.action.template set value "trigger options set 100000$(auto_fill_hotbar)$(particles)$(show_parkour_instructions)$(show_tips)"
execute unless entity @e[limit=1,x=0,type=armor_stand,tag=gamemodeAS,tag=rr_crusade] run execute unless predicate rr:has_parkour run data modify storage rocketriders:main settings.dialog.action.action.template set value "trigger options set 100000$(auto_fill_hotbar)$(particles)0$(show_tips)"
