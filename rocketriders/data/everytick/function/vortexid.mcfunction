...
execute if entity @s[tag=VortexYellow] align xyz positioned ~.5 ~0.3 ~.5 run summon armor_stand ~ ~-2 ~ {Tags:["VortexItem","VortexItemYellow"],Invisible:1b,Marker:1b,Invulnerable:1b,NoGravity:1b,equipment:{head:{id:"minecraft:ender_pearl"}},DisabledSlots:4144959}
execute if entity @s[tag=VortexBlue] align xyz positioned ~.5 ~0.3 ~.5 run summon armor_stand ~ ~-2 ~ {Tags:["VortexItem","VortexItemBlue"],Invisible:1b,Marker:1b,Invulnerable:1b,NoGravity:1b,equipment:{head:{id:"minecraft:ender_pearl"}},DisabledSlots:4144959}
