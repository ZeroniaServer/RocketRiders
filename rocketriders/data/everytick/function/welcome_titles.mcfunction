...
execute unless predicate rr:is_cubekrowd run tellraw @s[tag=!newPlayer] ["Welcome to ",[{bold:true,color:"blue",text:"Rocket ",shadow_color:[0.05,0.05,0.25,1]},{color:"gold",text:"Riders",shadow_color:[0.35,0.15,0.05,1]}]," ",[{color:"aqua",text:"Version "},{storage:"rocketriders:version",nbt:"name",interpret:true}],{color:"aqua",text:"!"}]
