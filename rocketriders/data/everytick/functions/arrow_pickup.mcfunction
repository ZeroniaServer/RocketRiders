...
execute as @e[type=arrow,tag=pickup,tag=!given,nbt={inGround:1b},tag=!infinity,limit=1] unless data entity @s CustomPotionEffects at @s if entity @p[team=!Spectator,distance=..2,tag=!fullOffhand] run function everytick:arrow_replace
