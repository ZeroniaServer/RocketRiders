...
execute as @e[scores={novattach=1..}] at @s if entity @s[x=-11,y=36,z=73,dx=46,dy=23,dz=2] run kill @s
execute as @e[scores={novattach=1..}] at @s if entity @s[x=-11,y=36,z=-75,dx=46,dy=23,dz=2] run kill @s
...
execute in overworld as @e[scores={novatimer=1..}] at @s run kill @s[y=181,dy=100]
execute in overworld as @e[scores={novattach=1..}] at @s run kill @s[y=181,dy=100]