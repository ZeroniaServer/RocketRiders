...
execute unless entity @s[tag=noPortal] as @e[tag=yellownovatracker,type=marker] at @s if entity @s[x=-11,y=30,z=71,dx=46,dy=32,dz=6] run kill @s
execute unless entity @s[tag=noPortal] as @e[tag=bluenovatracker,type=marker] at @s if entity @s[x=-11,y=30,z=-77,dx=46,dy=32,dz=6] run kill @s
#Kill Nova Rockets near other portals (depends on Fireball Portals option)
execute as @s[tag=!doFireballPortals] unless entity @s[tag=fbPortalsOff] as @e[tag=novatracker,type=marker] at @s if entity @s[x=-11,y=30,z=71,dx=46,dy=32,dz=6] run kill @s
execute as @s[tag=!doFireballPortals] unless entity @s[tag=fbPortalsOff] as @e[tag=novatracker,type=marker] at @s if entity @s[x=-11,y=30,z=-77,dx=46,dy=32,dz=6] run kill @s
...
execute in overworld as @e[tag=novatracker,type=marker] at @s run kill @s[y=175,dy=100]
...
execute as @e[tag=novatracker,type=marker] at @s unless predicate custom:insideborder run kill @s
