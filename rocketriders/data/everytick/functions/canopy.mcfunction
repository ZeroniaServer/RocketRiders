...
execute as @a[team=Yellow] if score @s playerUUIDL = @e[tag=YellowPlatform,scores={PlatTime=1..40},limit=1,sort=nearest] pearlOwnerUUIDL run effect give @s levitation 1 255 true
...
execute as @a[team=Blue] if score @s playerUUIDL = @e[tag=BluePlatform,scores={PlatTime=1..20},limit=1,sort=nearest] pearlOwnerUUIDL run effect give @s levitation 1 255 true
