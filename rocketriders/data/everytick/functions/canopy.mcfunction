...
execute as @a[team=Yellow] if score @s playerUUID = @e[tag=YellowPlatform,scores={PlatTime=1..40},limit=1,sort=arbitrary,type=area_effect_cloud] pearlOwnerUUID at @e[tag=YellowPlatform,scores={PlatTime=1..40},limit=1,sort=arbitrary,type=area_effect_cloud] align xyz positioned ~0.5 ~2.05 ~0.5 run tp @s ~ ~ ~
execute as @a[team=Yellow] at @s if score @s playerUUID = @e[tag=YellowPlatform,scores={PlatTime=1},limit=1,sort=nearest,type=area_effect_cloud] pearlOwnerUUID run effect give @s slow_falling 1 100 true
...
execute as @a[team=Yellow] at @s if score @s playerUUID = @e[tag=YellowPlatform,scores={PlatTime=8..},limit=1,sort=nearest,type=area_effect_cloud] pearlOwnerUUID run effect clear @s slow_falling
...
#The teleport window for players on Canopies is 2 seconds. This is to ensure that falling players arrive on the Canopy safely and to reduce lag-induced oddities with Canopies.
execute as @a[team=Blue] if score @s playerUUID = @e[tag=BluePlatform,scores={PlatTime=1..40},limit=1,sort=arbitrary,type=area_effect_cloud] pearlOwnerUUID at @e[tag=BluePlatform,scores={PlatTime=1..40},limit=1,sort=arbitrary,type=area_effect_cloud] align xyz positioned ~0.5 ~2.05 ~0.5 run tp @s ~ ~ ~
execute as @a[team=Blue] at @s if score @s playerUUID = @e[tag=BluePlatform,scores={PlatTime=1},limit=1,sort=nearest,type=area_effect_cloud] pearlOwnerUUID run effect give @s slow_falling 1 100 true
...
execute as @a[team=Blue] at @s if score @s playerUUID = @e[tag=BluePlatform,scores={PlatTime=8..},limit=1,sort=nearest,type=area_effect_cloud] pearlOwnerUUID run effect clear @s slow_falling
#After 2 seconds the Canopy gives up
