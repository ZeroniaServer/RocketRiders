...
execute as @e[type=marker,scores={PlatTime=1},tag=!animated] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 2
...
execute as @e[type=marker,scores={PlatTime=5..},tag=!animated,tag=!killCanopy] at @s run setblock ~ ~ ~1 spruce_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=5},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 2
...
execute as @e[type=marker,scores={PlatTime=10..},tag=!animated,tag=!killCanopy] at @s run setblock ~ ~ ~2 birch_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=10},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 2
...
execute as @e[type=marker,scores={PlatTime=15..},tag=!animated,tag=!killCanopy] at @s run setblock ~ ~ ~3 jungle_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=15},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
...
execute as @e[type=marker,scores={PlatTime=20..},tag=!animated,tag=!killCanopy] at @s run setblock ~-1 ~ ~1 jungle_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=20..},tag=!animated,tag=!killCanopy] at @s run setblock ~-1 ~ ~2 oak_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=20},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
...
execute as @e[type=marker,scores={PlatTime=25..},tag=!animated,tag=!killCanopy] at @s run setblock ~-1 ~ ~3 oak_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=25},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
...
execute as @e[type=marker,scores={PlatTime=30..},tag=!animated,tag=!killCanopy] at @s run setblock ~-1 ~ ~-1 jungle_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=30..},tag=!animated,tag=!killCanopy] at @s run setblock ~-2 ~ ~-1 oak_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=30},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
...
execute as @e[type=marker,scores={PlatTime=35..},tag=!animated,tag=!killCanopy] at @s run setblock ~1 ~ ~2 oak_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=35},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
...
execute as @e[type=marker,scores={PlatTime=40..},tag=!animated,tag=!killCanopy] at @s run setblock ~-2 ~ ~1 oak_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=40},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
...
execute as @e[type=marker,scores={PlatTime=45..},tag=!animated,tag=!killCanopy] at @s run setblock ~-2 ~ ~2 spruce_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=45},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.6
...
execute as @e[type=marker,scores={PlatTime=50..},tag=!animated,tag=!killCanopy] at @s run setblock ~-3 ~ ~1 oak_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=50},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.6
...
execute as @e[type=marker,scores={PlatTime=55..},tag=!animated,tag=!killCanopy] at @s run setblock ~-3 ~ ~ jungle_leaves[persistent=true] replace
execute as @e[type=marker,scores={PlatTime=55},tag=!animated,tag=!killCanopy] at @s run playsound block.grass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0
...
execute as @e[type=ender_pearl,tag=YellowPlat] at @s if score $dust CmdData matches 1 run particle dust 1 2 0 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=ender_pearl,tag=YellowPlat] at @s if score $dust CmdData matches 1 run particle block spruce_leaves ~ ~ ~ 0 0 0 0.1 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=ender_pearl,scores={testplat=10},predicate=!custom:canopy_nearvoid] at @s run playsound ui.stonecutter.take_result master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=ender_pearl,scores={testplat=10},predicate=!custom:canopy_nearvoid] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
...
execute as @e[type=marker,tag=YellowSpawnZone] at @s run scoreboard players set @a[predicate=custom:indimension,team=Yellow,distance=..6] respawn 0
...
execute if entity @e[type=armor_stand,tag=Selection,tag=!customShield] as @e[type=ender_pearl,tag=BluePlat] at @s if score $dust CmdData matches 1 run particle dust 0 1 1 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @e[type=armor_stand,tag=Selection,tag=!customShield] as @e[type=ender_pearl,tag=BluePlat] at @s if score $dust CmdData matches 1 run particle block spruce_leaves ~ ~ ~ 0 0 0 0.1 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute if entity @e[type=armor_stand,tag=Selection,tag=!customShield] as @e[type=ender_pearl,scores={testplat2=10},predicate=!custom:canopy_nearvoid] at @s run playsound ui.stonecutter.take_result master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute if entity @e[type=armor_stand,tag=Selection,tag=!customShield] as @e[type=ender_pearl,scores={testplat2=10},predicate=!custom:canopy_nearvoid] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute if entity @e[type=armor_stand,tag=Selection,tag=!customShield] as @e[type=ender_pearl,scores={testplat2=10},predicate=!custom:canopy_nearvoid] at @s run playsound block.grass.place master @a[predicate=custom:indimension] ~ ~ ~ 2 0
...
execute if entity @e[type=armor_stand,tag=Selection,tag=!customShield] run tag @a[predicate=custom:indimension,team=Blue] remove checkedTP
execute if entity @e[type=armor_stand,tag=Selection,tag=!customShield] as @e[type=marker,tag=BlueSpawnZone] at @s run scoreboard players set @a[predicate=custom:indimension,team=Blue,distance=..6] respawn 0
...
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=1}] at @s run playsound block.campfire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=1}] at @s run particle minecraft:large_smoke ~ ~ ~ 1 0 1 0 100 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=7}] at @s run playsound block.fire.ambient player @a[predicate=custom:indimension] ~ ~ ~ 2 0.25
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=14}] at @s run playsound block.campfire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=14}] at @s run particle minecraft:large_smoke ~ ~ ~ 1 0 1 0 200 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=21}] at @s run playsound block.fire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 0.5
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=21}] at @s run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1 -1 1 0.01 100 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=28}] at @s run playsound block.campfire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=28}] at @s run particle minecraft:large_smoke ~ ~ ~ 1.5 0 1.5 0 200 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=35}] at @s run playsound block.fire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 0.75
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=35}] at @s run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1 -1 1 0.01 100 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=42}] at @s run playsound block.campfire.ambient player @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=42}] at @s run particle minecraft:large_smoke ~ ~ ~ 1.5 0 1.5 0.1 200 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=49}] at @s run playsound block.fire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=49}] at @s run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1.5 -1 1.5 0.01 200 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=56}] at @s run playsound block.campfire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=56}] at @s run particle minecraft:large_smoke ~ ~ ~ 2 0 2 0.1 200 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=63}] at @s run playsound block.fire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 1.5
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=63}] at @s run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1.5 -1 1.5 0.01 200 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=70}] at @s run playsound block.campfire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=70}] at @s run particle minecraft:large_smoke ~ ~ ~ 2 0 2 0.1 300 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=77}] at @s run playsound block.fire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 2
execute as @e[type=marker,tag=!killCanopy,scores={PlatTime=3..300,canopySmoke=77}] at @s run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 2 -1 2 0.01 200 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=marker,tag=!killCanopy,tag=FirePoof,tag=!LavaPoof] at @s run playsound entity.blaze.shoot master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=marker,tag=!killCanopy,tag=FirePoof] at @s run playsound block.fire.ambient master @a[predicate=custom:indimension] ~ ~ ~ 2 2
...
execute as @e[type=marker,tag=!killCanopy,tag=FirePoof] at @s run particle flame ~ ~ ~ 2 0 2 0.15 250 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,tag=FirePoof] at @s run particle lava ~ ~ ~ 2 0 2 0.1 20 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=!killCanopy,tag=FirePoof] at @s run particle explosion_emitter ~ ~ ~ 2 0 2 0.1 1 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=marker,scores={PlatTime=220..}] at @s if score $dust CmdData matches 1 run particle block oak_wood ~ ~1 ~ 0.5 0.5 0.5 1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,scores={PlatTime=220}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=marker,scores={PlatTime=225}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=marker,scores={PlatTime=230}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=marker,scores={PlatTime=235}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=marker,scores={PlatTime=240}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.4
execute as @e[type=marker,scores={PlatTime=245}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.5
execute as @e[type=marker,scores={PlatTime=250}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.6
execute as @e[type=marker,scores={PlatTime=255}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.7
execute as @e[type=marker,scores={PlatTime=260}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.8
execute as @e[type=marker,scores={PlatTime=265}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.9
execute as @e[type=marker,scores={PlatTime=270}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=marker,scores={PlatTime=275}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1.2
execute as @e[type=marker,scores={PlatTime=280}] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1.5
execute as @e[type=marker,scores={PlatTime=300}] at @s run particle block oak_wood ~ ~1 ~ 0.5 0.5 0.5 1 50 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=marker,tag=wateredInit,tag=!wateredTemp] at @s run playsound minecraft:block.bamboo_sapling.place master @a[predicate=custom:indimension] ~ ~ ~ 1 0.5
execute as @e[type=marker,tag=wateredInit,tag=!wateredTemp] at @s run playsound minecraft:block.chorus_flower.grow master @a[predicate=custom:indimension] ~ ~ ~ 1 1
execute as @e[type=marker,tag=wateredInit,tag=!wateredTemp] at @s run playsound minecraft:entity.player.swim master @a[predicate=custom:indimension] ~ ~ ~ 1 1
execute as @e[type=marker,tag=wateredInit,tag=!wateredTemp] at @s run particle minecraft:falling_water ~ ~1 ~ 2 -1 2 1 50 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=wateredInit,tag=!wateredTemp] at @s run particle minecraft:happy_villager ~ ~1 ~ 2 -1 2 1 50 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=marker,tag=LavaPoof,tag=!FirePoof] at @s run particle lava ~ ~1 ~ 2 0.1 2 2 50 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=LavaPoof,tag=!FirePoof] at @s run particle minecraft:falling_lava ~ ~-1 ~ 2 1 2 0.1 50 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=LavaPoof,tag=!FirePoof] at @s run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 1 1 1 0.5 40 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=LavaPoof,tag=!FirePoof] at @s run playsound minecraft:block.lava.pop master @a[predicate=custom:indimension] ~ ~ ~ 1 0.7
execute as @e[type=marker,tag=LavaPoof,tag=!FirePoof] at @s run playsound minecraft:block.lava.pop master @a[predicate=custom:indimension] ~ ~ ~ 1 0.9
execute as @e[type=marker,tag=LavaPoof,tag=!FirePoof] at @s run playsound minecraft:item.bucket.empty_lava master @a[predicate=custom:indimension] ~ ~ ~ 2 0.8
