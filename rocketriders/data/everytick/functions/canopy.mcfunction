...
execute as @a[team=Yellow] at @s if score @s playerUUIDL = @e[tag=YellowPlatform,scores={PlatTime=8},limit=1,sort=nearest,type=area_effect_cloud] pearlOwnerUUID run effect clear @s slow_falling
...
execute as @a[team=Blue] at @s unless predicate custom:canopy_nearblue if score @s playerUUIDL = @e[tag=BluePlatform,scores={PlatTime=1},limit=1,sort=nearest,type=area_effect_cloud] pearlOwnerUUID run effect give @s jump_boost 2 128 true
execute as @a[team=Blue] at @s unless predicate custom:canopy_nearblue if score @s playerUUIDL = @e[tag=BluePlatform,scores={PlatTime=1},limit=1,sort=nearest,type=area_effect_cloud] pearlOwnerUUID run effect give @s slowness 2 255 true
execute as @a[team=Blue] at @s if score @s playerUUIDL = @e[tag=BluePlatform,scores={PlatTime=8},limit=1,sort=nearest,type=area_effect_cloud] pearlOwnerUUID run effect clear @s slow_falling
#After 2 seconds the Canopy gives up
