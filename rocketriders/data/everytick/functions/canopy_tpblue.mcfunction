...
execute as @p[team=Blue,tag=currentTP,tag=canopyTP] at @s if entity @e[tag=BluePlatform,tag=killCanopy,limit=1,tag=currentTP,sort=nearest,type=area_effect_cloud] run effect clear @s slow_falling
execute as @p[team=Blue,tag=currentTP,tag=canopyTP] at @s if entity @e[tag=BluePlatform,tag=killCanopy,limit=1,tag=currentTP,sort=nearest,type=area_effect_cloud] run effect clear @s slowness
execute as @p[team=Blue,tag=currentTP,tag=canopyTP] at @s if entity @e[tag=BluePlatform,tag=killCanopy,limit=1,tag=currentTP,sort=nearest,type=area_effect_cloud] run effect clear @s jump_boost
execute as @p[team=Blue,tag=currentTP,tag=canopyTP] at @s if entity @e[tag=BluePlatform,tag=killCanopy,limit=1,tag=currentTP,sort=nearest,type=area_effect_cloud] run tag @s remove canopyTP
