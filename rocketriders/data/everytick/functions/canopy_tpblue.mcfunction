...
execute as @p[team=Blue,tag=currentTP,tag=probablyDied] at @s run scoreboard players reset @e[type=marker,tag=BluePlatform,scores={PlatTime=1..40},limit=1,tag=currentTP] pearlOwnerUUID
