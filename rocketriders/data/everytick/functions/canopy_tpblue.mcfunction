...
execute as @p[team=Blue,tag=currentTP,scores={novattach=1..15}] at @s run scoreboard players reset @e[tag=BluePlatform,scores={PlatTime=2..},limit=1,tag=currentTP,type=area_effect_cloud] pearlOwnerUUID
execute as @e[tag=BluePlatform,scores={PlatTime=2..},limit=1,tag=currentTP,type=area_effect_cloud] as @p[team=Blue,tag=currentTP,scores={novattach=1..15}] run tag @s remove canopyTP
#Canopy ends Nova effects if teleporting in first tick
execute as @e[tag=BluePlatform,scores={PlatTime=1},limit=1,tag=currentTP,type=area_effect_cloud] as @p[team=Blue,tag=currentTP,scores={novattach=1..15}] run scoreboard players set @s novattach 16
