...
execute as @p[team=Yellow,tag=currentTP] if entity @e[tag=YellowPlatform,scores={PlatTime=40..41},limit=1,tag=currentTP,type=area_effect_cloud,predicate=!custom:canopy_nearyellow] run tp @s @s
...
execute at @e[tag=YellowPlatform,scores={PlatTime=1..6},limit=1,tag=currentTP,type=area_effect_cloud,predicate=custom:canopy_nearyellow] as @p[team=Yellow,tag=currentTP] align xyz positioned ~0.5 ~2 ~0.5 run tp @s ~ ~ ~
execute at @e[tag=YellowPlatform,scores={PlatTime=1..40},limit=1,tag=currentTP,type=area_effect_cloud,predicate=!custom:canopy_nearyellow] as @p[team=Yellow,tag=currentTP] align xyz positioned ~0.5 ~2 ~0.5 run tp @s ~ ~ ~
...
execute as @p[team=Yellow,tag=currentTP] at @s if entity @e[tag=YellowPlatform,scores={PlatTime=41},limit=1,tag=currentTP,sort=nearest,type=area_effect_cloud,predicate=!custom:canopy_nearyellow] run effect clear @s slow_falling
execute as @p[team=Yellow,tag=currentTP] at @s if entity @e[tag=YellowPlatform,scores={PlatTime=6..},limit=1,tag=currentTP,sort=nearest,type=area_effect_cloud,predicate=custom:canopy_nearyellow] run effect clear @s slow_falling
