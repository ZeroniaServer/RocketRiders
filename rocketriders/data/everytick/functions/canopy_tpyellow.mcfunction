...
execute as @p[team=Yellow,tag=currentTP] if entity @e[type=marker,tag=YellowPlatform,scores={PlatTime=1..5},limit=1,tag=currentTP] run tp @s @s
execute as @p[team=Yellow,tag=currentTP] if entity @e[type=marker,tag=YellowPlatform,scores={PlatTime=36..41},limit=1,tag=currentTP] run tp @s @s
...
execute as @p[team=Yellow,tag=currentTP,scores={novattach=1..15}] at @s run scoreboard players reset @e[type=marker,tag=YellowPlatform,scores={PlatTime=2..},limit=1,tag=currentTP] pearlOwnerUUID
execute as @e[type=marker,tag=YellowPlatform,scores={PlatTime=2..},limit=1,tag=currentTP] as @p[team=Yellow,tag=currentTP,scores={novattach=1..15}] run tag @s remove canopyTP
#Canopy ends Nova effects if teleporting in first tick
execute as @e[type=marker,tag=YellowPlatform,scores={PlatTime=1},limit=1,tag=currentTP] as @p[team=Yellow,tag=currentTP,scores={novattach=1..15}] run scoreboard players set @s novattach 16
...
execute at @e[type=marker,tag=YellowPlatform,scores={PlatTime=1..40},limit=1,tag=currentTP] as @p[team=Yellow,tag=currentTP,tag=canopyTP] align xyz positioned ~0.5 ~2 ~0.5 run tp @s ~ ~ ~
execute as @p[team=Yellow,tag=currentTP,tag=canopyTP] at @s if entity @e[type=marker,tag=YellowPlatform,scores={PlatTime=1..40},limit=1,tag=currentTP,sort=nearest] run effect give @s slow_falling 2 100 true
execute as @p[team=Yellow,tag=currentTP,tag=canopyTP] at @s unless predicate custom:canopy_nearyellow if entity @e[type=marker,tag=YellowPlatform,scores={PlatTime=1..40},limit=1,tag=currentTP,sort=nearest] run effect give @s jump_boost 2 128 true
execute as @p[team=Yellow,tag=currentTP,tag=canopyTP] at @s unless predicate custom:canopy_nearyellow if entity @e[type=marker,tag=YellowPlatform,scores={PlatTime=1..40},limit=1,tag=currentTP,sort=nearest] run effect give @s slowness 2 255 true

#Remove canopy TP tag if teleportation period ends
execute as @p[team=Yellow,tag=currentTP,tag=canopyTP] at @s if entity @e[type=marker,tag=YellowPlatform,scores={PlatTime=41..},limit=1,tag=currentTP,sort=nearest] run tag @s remove canopyTP

#Remove canopy TP tag if Canopy dies prematurely
execute as @p[team=Yellow,tag=currentTP,tag=canopyTP] at @s if entity @e[type=marker,tag=YellowPlatform,tag=killCanopy,limit=1,tag=currentTP,sort=nearest] run tag @s remove canopyTP
...
tag @e[type=marker,tag=YellowPlatform,limit=1,tag=currentTP] add checkedTP
tag @e[type=marker,tag=YellowPlatform,tag=checkedTP] remove currentTP

#Recur until all teleports completed in this tick
execute if entity @e[type=marker,tag=YellowPlatform,tag=!checkedTP] run function everytick:canopy_tpyellow