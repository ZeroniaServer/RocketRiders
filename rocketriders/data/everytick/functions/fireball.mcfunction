...
execute as @e[predicate=custom:indimension,type=marker,tag=BlueFireball,tag=!Cluster] at @s run summon fireball ~ ~1.2 ~ {Tags:["NormalFireball","NoMotion","FireballBlue"],ExplosionPower:1,Motion:[0.0,0.0,0.0]}
execute as @e[predicate=custom:indimension,type=marker,tag=BlueFireball,tag=!Cluster] at @s run summon fireball ~ ~1.2 ~ {Tags:["NormalFireball","NoMotion","FireballBlue","Cluster"],ExplosionPower:1,Motion:[0.0,0.0,0.0]}
...
execute as @e[predicate=custom:indimension,type=marker,tag=YellowFireball,tag=!Cluster] at @s run summon fireball ~ ~1.2 ~ {Tags:["NormalFireball","NoMotion","FireballYellow"],ExplosionPower:1,Motion:[0.0,0.0,0.0]}
execute as @e[predicate=custom:indimension,type=marker,tag=YellowFireball,tag=Cluster] at @s run summon fireball ~ ~1.2 ~ {Tags:["NormalFireball","NoMotion","FireballYellow","Cluster"],ExplosionPower:1,Motion:[0.0,0.0,0.0]}
...
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=chaseEnabled] as @e[predicate=custom:indimension,type=fireball,tag=FireballBlue,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle flame ~ ~0.5 ~ 0 0 0 0.05 2 force @a[predicate=custom:indimension,tag=!hideParticles,predicate=custom:belowroof]
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=chaseEnabled] as @e[predicate=custom:indimension,type=fireball,tag=FireballBlue,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle soul_fire_flame ~ ~0.5 ~ 0 0 0 0.05 2 force @a[predicate=custom:indimension,tag=!hideParticles,predicate=custom:belowroof]
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=chaseEnabled] as @e[predicate=custom:indimension,type=fireball,tag=FireballBlue,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle electric_spark ~ ~0.5 ~ 0 0 0 0.05 3 force @a[predicate=custom:indimension,tag=!hideParticles,predicate=custom:belowroof]
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=!chaseEnabled] as @e[predicate=custom:indimension,type=fireball,tag=FireballBlue,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle soul_fire_flame ~ ~0.5 ~ 0 0 0 0.05 5 force @a[predicate=custom:indimension,tag=!hideParticles,predicate=custom:belowroof]
execute as @e[predicate=custom:indimension,type=fireball,tag=FireballYellow,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle flame ~ ~0.5 ~ 0 0 0 0.05 5 force @a[predicate=custom:indimension,tag=!hideParticles,predicate=custom:belowroof]
