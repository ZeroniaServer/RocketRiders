...
execute as @e[type=marker,tag=YellowFireball] at @s align xyz positioned ~0.5 ~ ~0.5 run summon fireball ~ ~1.2 ~ {Tags:["NormalFireball","NoMotion","FireballYellow"],ExplosionPower:1,Motion:[0.0,0.0,0.0]}
