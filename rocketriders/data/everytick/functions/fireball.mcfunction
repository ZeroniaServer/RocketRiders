...
execute as @e[type=marker,tag=BlueFireball,tag=!UnableSpawn] at @s if predicate custom:nearvoid run tag @s add void
execute as @e[type=marker,tag=BlueFireball,tag=!UnableSpawn] at @s if predicate custom:nearvoid run tag @s add UnableSpawn
execute as @e[type=marker,tag=YellowFireball,tag=!UnableSpawn] at @s if predicate custom:nearvoid run tag @s add void
execute as @e[type=marker,tag=YellowFireball,tag=!UnableSpawn] at @s if predicate custom:nearvoid run tag @s add UnableSpawn

#Roof spawn prevention
execute as @e[type=marker,tag=BlueFireball,tag=!UnableSpawn] at @s if predicate custom:verynearroof run tag @s add roof
execute as @e[type=marker,tag=BlueFireball,tag=!UnableSpawn] at @s if predicate custom:verynearroof run tag @s add UnableSpawn
execute as @e[type=marker,tag=YellowFireball,tag=!UnableSpawn] at @s if predicate custom:verynearroof run tag @s add roof
execute as @e[type=marker,tag=YellowFireball,tag=!UnableSpawn] at @s if predicate custom:verynearroof run tag @s add UnableSpawn
...
execute as @e[type=marker,tag=BlueFireball] at @s as @a[predicate=custom:indimension,distance=..6] run playsound minecraft:item.flintandsteel.use master @s ~ ~ ~ 1 1
execute as @e[type=marker,tag=BlueFireball] at @s as @a[predicate=custom:indimension,distance=..6] run playsound minecraft:entity.blaze.shoot master @s ~ ~ ~ 0.5 1.25
...
execute as @e[type=marker,tag=YellowFireball] at @s as @a[predicate=custom:indimension,distance=..6] run playsound minecraft:item.flintandsteel.use master @s ~ ~ ~ 1 1
execute as @e[type=marker,tag=YellowFireball] at @s as @a[predicate=custom:indimension,distance=..6] run playsound minecraft:entity.blaze.shoot master @s ~ ~ ~ 0.5 1.25
...
execute if score $fireballsound CmdData matches 0 as @e[type=fireball,tag=NormalFireball] at @s as @a[predicate=custom:indimension,distance=..3] run playsound minecraft:block.fire.ambient master @s ~ ~ ~ 0.5 1 0.1

#Custom team particles for moving Fireball
execute if entity @e[type=armor_stand,tag=Selection,tag=chaseEnabled] as @e[type=fireball,tag=FireballBlue,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle flame ~ ~0.5 ~ 0 0 0 0.05 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @e[type=armor_stand,tag=Selection,tag=chaseEnabled] as @e[type=fireball,tag=FireballBlue,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle soul_fire_flame ~ ~0.5 ~ 0 0 0 0.05 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @e[type=armor_stand,tag=Selection,tag=chaseEnabled] as @e[type=fireball,tag=FireballBlue,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle electric_spark ~ ~0.5 ~ 0 0 0 0.05 3 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @e[type=armor_stand,tag=Selection,tag=!chaseEnabled] as @e[type=fireball,tag=FireballBlue,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle soul_fire_flame ~ ~0.5 ~ 0 0 0 0.05 5 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=fireball,tag=FireballYellow,tag=!Still,tag=NormalFireball] at @s if score $dust CmdData matches 1 run particle flame ~ ~0.5 ~ 0 0 0 0.05 5 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=fireball,tag=NormalFireball,tag=FireballBlue,tag=!Still,tag=DontPoof] at @s if entity @a[predicate=custom:indimension,team=Yellow,distance=..7] run tag @s remove DontPoof
execute as @e[type=fireball,tag=NormalFireball,tag=FireballYellow,tag=!Still,tag=DontPoof] at @s if entity @a[predicate=custom:indimension,team=Blue,distance=..7] run tag @s remove DontPoof
...
execute as @e[type=fireball,tag=NormalFireball,tag=!Still,tag=!DontPoof,scores={CmdData=1..}] at @s run playsound entity.blaze.shoot master @a[predicate=custom:indimension] ~ ~ ~ 2 1
