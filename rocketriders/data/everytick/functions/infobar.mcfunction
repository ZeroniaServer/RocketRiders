...
execute as @e[tag=Selection,scores={InfoDisplay=2}] run bossbar set minecraft:infobar name ["",{"text":"You are currently playing on Zeronia.minehut.gg","color":"green","bold":true}]
