...
execute as @e[tag=Selection,scores={InfoDisplay=2}] run bossbar set minecraft:infobar name ["",{"text":"You are currently playing on an early version!","color":"green","bold":true}]
