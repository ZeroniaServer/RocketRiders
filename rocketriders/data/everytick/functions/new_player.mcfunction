...
title @a[scores={firstJoined=0}] subtitle [{"text":"Rocket ","color":"blue","bold":true},{"text":"Riders","color":"gold","bold":true},{"text":" v1.2.0!","color":"green","bold":false}]
...
execute if entity @s[scores={servermode=0},tag=realms] as @a[scores={firstJoined=0}] run advancement grant @s only aaaaaaaatutorial:root
