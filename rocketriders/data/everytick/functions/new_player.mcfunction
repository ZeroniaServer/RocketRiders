...
title @a[scores={firstJoined=0}] subtitle [{"text":"Rocket ","color":"blue","bold":true},{"text":"Riders","color":"gold","bold":true},{"text":" v1.2.14!","color":"green","bold":false}]
...
execute if entity @s[scores={servermode=0},tag=realms] as @a[scores={firstJoined=0}] run advancement grant @s only 2811iaj1:root
