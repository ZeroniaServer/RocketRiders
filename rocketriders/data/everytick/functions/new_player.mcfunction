...
title @a[scores={firstJoined=0}] subtitle [{"text":"Rocket ","color":"blue","bold":true},{"text":"Riders","color":"gold","bold":true},{"text":" v1.0.1!","color":"green","italic":true,"bold":false}]
