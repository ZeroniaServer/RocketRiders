...
execute if entity @a[predicate=custom:indimension,team=!Spectator,predicate=custom:matches_uuid] at @a[predicate=custom:indimension,team=!Spectator,predicate=custom:matches_uuid,limit=1] run tp @s ~ ~ ~
