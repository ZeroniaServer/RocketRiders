...
execute if entity @e[tag=Selection,tag=!customNova] as @e[type=firework_rocket,tag=BlueNova] at @s run particle minecraft:falling_dust lapis_block ~ ~0.2 ~ 0 0 0 1 2 force @a
execute if entity @e[tag=Selection,tag=customNova] as @e[type=firework_rocket,tag=BlueNova] at @s run particle minecraft:dust 3 3 3 1 ~ ~0.2 ~ 0 0 0 1 1 force @a
execute if entity @e[tag=Selection,tag=customNova] as @e[type=firework_rocket,tag=BlueNova] at @s run particle minecraft:dust 3 3 3 1 ^ ^0.2 ^-0.2 0 0 0 1 1 force @a
...
execute as @a[tag=YellowNovaAttach,scores={novattach=15..},nbt={OnGround:1b}] at @s run tag @e[tag=BluePlatform,distance=..7,limit=1,sort=nearest] add killCanopy
...
execute if entity @e[tag=Selection,tag=chaseEnabled] as @a[tag=BlueNovaAttach,scores={novattach=15..},nbt={OnGround:1b}] at @s if entity @e[tag=BluePlatform,tag=killCanopy,distance=..5,limit=1] run scoreboard players set @s novattach 2
