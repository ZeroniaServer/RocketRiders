...
#Blue panes
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~1 ~2 ~ blue_stained_glass_pane[east=true]
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-1 ~2 ~ blue_stained_glass_pane[west=true]
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~1 ~-2 ~ blue_stained_glass_pane[east=true]
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-1 ~-2 ~ blue_stained_glass_pane[west=true]
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-2 ~1 ~ cyan_stained_glass_pane[east=true]
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~-2 ~-1 ~ cyan_stained_glass_pane[east=true]
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~2 ~1 ~ cyan_stained_glass_pane[west=true]
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] if entity @s[tag=blueobalone,scores={shieldplacement=6}] run setblock ~2 ~-1 ~ cyan_stained_glass_pane[west=true]
