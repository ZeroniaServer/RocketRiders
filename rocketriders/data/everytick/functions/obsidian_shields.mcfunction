...
execute as @e[type=enderman,tag=YellowObshield] at @s run summon armor_stand ~ ~1 ~ {NoGravity:1b,Marker:1b,Invulnerable:1b,Invisible:1b,Silent:1b,Tags:["ObFireballAS"],Passengers:[{id:fireball,Tags:["yellowobfireball","obfireball","NoMotionD"],ExplosionPower:0,direction:[0.0,0.0,0.0]}]}
execute as @e[type=enderman,tag=YellowObshield] at @s run summon armor_stand ~ ~1 ~ {NoGravity:1b,Marker:1b,Invulnerable:1b,Invisible:1b,Silent:1b,Tags:["ObFireballAS"],Passengers:[{id:dragon_fireball,Tags:["yellowobfireball","obfireball","NoMotionD"],ExplosionPower:0,direction:[0.0,0.0,0.0]}]}
...
execute as @e[type=armor_stand,tag=yellowobalone,scores={shieldplacement=4}] at @s run setblock ~ ~ ~ structure_block[mode=load]{mode:"LOAD",posX:-1,posY:-1,posZ:0,name:"minecraft:obshield2"}
execute as @e[type=armor_stand,tag=yellowobalone,scores={shieldplacement=4}] at @s run setblock ~ ~-1 ~ observer[facing=down,powered=true]
execute as @e[type=armor_stand,tag=yellowobalone,scores={shieldplacement=4}] at @s run setblock ~ ~-1 ~ observer[facing=down,powered=true]
execute as @e[type=armor_stand,tag=yellowobalone,scores={shieldplacement=4}] at @s run playsound minecraft:block.end_portal_frame.fill player @a ~ ~ ~ 2 0
...
execute as @e[type=armor_stand,tag=yellowobalone,scores={shieldplacement=7}] at @s run scoreboard players set @e[tag=yellowobsidianshield,sort=nearest,limit=1,distance=..3] breakobshield 0
kill @e[type=armor_stand,tag=yellowobalone,scores={shieldplacement=7..}]
