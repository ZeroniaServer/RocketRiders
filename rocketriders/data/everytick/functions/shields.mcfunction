...
execute as @a[predicate=custom:indimension,team=Yellow,scores={ThrowShield=1..}] at @s run tag @e[type=snowball,limit=1,sort=nearest,distance=..5,tag=!YellowShield,tag=!BlueShield,tag=!NullShield] add YellowShield
execute as @a[predicate=custom:indimension,team=Blue,scores={ThrowShield=1..}] at @s run tag @e[type=snowball,limit=1,sort=nearest,distance=..5,tag=!YellowShield,tag=!BlueShield,tag=!NullShield] add BlueShield
scoreboard players reset @a[predicate=custom:indimension] ThrowShield

##Yellow Shield functionality
execute as @e[type=snowball,tag=YellowShield] at @s if score $dust CmdData matches 1 run particle dust 1 1 0 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=marker,tag=PlaceYellowShield,scores={shieldplacement=1}] at @s run playsound block.glass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.6
execute as @e[type=marker,tag=PlaceYellowShield,scores={shieldplacement=1}] at @s run playsound item.shield.break master @a[predicate=custom:indimension] ~ ~ ~ 2 2
execute as @e[type=marker,tag=PlaceYellowShield,scores={shieldplacement=2}] at @s run place template yellowshield2 ~-2 ~-2 ~
execute as @e[type=marker,tag=PlaceYellowShield,scores={shieldplacement=2}] at @s run playsound block.glass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.6
execute as @e[type=marker,tag=PlaceYellowShield,scores={shieldplacement=2}] at @s run playsound item.shield.break master @a[predicate=custom:indimension] ~ ~ ~ 2 2
execute as @e[type=marker,tag=PlaceYellowShield,scores={shieldplacement=3}] at @s run place template yellowshield3 ~-3 ~-3 ~
execute as @e[type=marker,tag=PlaceYellowShield,scores={shieldplacement=3}] at @s run playsound block.glass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=marker,tag=PlaceYellowShield,scores={shieldplacement=3}] at @s run playsound item.shield.block master @a[predicate=custom:indimension] ~ ~ ~ 2 0
...
execute if entity @e[type=armor_stand,tag=Selection,tag=!customShield] as @e[type=snowball,tag=BlueShield] at @s if score $dust CmdData matches 1 run particle dust 0 0 1 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=marker,tag=PlaceBlueShield,scores={shieldplacement=1}] at @s run playsound block.glass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.6
execute as @e[type=marker,tag=PlaceBlueShield,scores={shieldplacement=1}] at @s run playsound item.shield.break master @a[predicate=custom:indimension] ~ ~ ~ 2 2
...
execute as @e[type=marker,tag=PlaceBlueShield,scores={shieldplacement=2}] at @s run playsound block.glass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0.6
execute as @e[type=marker,tag=PlaceBlueShield,scores={shieldplacement=2}] at @s run playsound item.shield.break master @a[predicate=custom:indimension] ~ ~ ~ 2 2
...
execute as @e[type=marker,tag=PlaceBlueShield,scores={shieldplacement=3}] at @s run playsound block.glass.break master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=marker,tag=PlaceBlueShield,scores={shieldplacement=3}] at @s run playsound item.shield.block master @a[predicate=custom:indimension] ~ ~ ~ 2 0
