...
execute as @e[tag=YellowShield,type=snowball] at @s if entity @s[x=-12,y=36,z=-74,dx=48,dy=25] run scoreboard players remove @s shieldtest 1
execute as @e[tag=YellowShield,type=snowball] at @s if entity @s[x=-12,y=36,z=74,dx=48,dy=25] run scoreboard players remove @s shieldtest 1
...
execute as @e[tag=BlueShield,type=snowball] at @s if entity @s[x=-12,y=36,z=-74,dx=48,dy=25] run scoreboard players remove @s shieldtest2 1
execute as @e[tag=BlueShield,type=snowball] at @s if entity @s[x=-12,y=36,z=74,dx=48,dy=25] run scoreboard players remove @s shieldtest2 1
