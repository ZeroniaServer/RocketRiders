...
execute as @e[x=0,type=snowball,tag=YellowShield] at @s if score $dust CmdData matches 1 run particle dust 1 1 0 1 ~ ~ ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute as @e[x=0,type=marker,tag=PlaceYellowShield,scores={shieldplacement=1}] run scoreboard players add @e[x=0,type=armor_stand,tag=Selection] shieldCount 1
...
execute as @e[x=0,type=marker,tag=PlaceYellowShield,scores={shieldplacement=3}] at @s run particle block yellow_stained_glass ~ ~ ~ 1 1 0 0.1 50
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=snowball,tag=BlueShield] at @s if score $dust CmdData matches 1 run particle dust 0 0 1 1 ~ ~ ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=1}] at @s run place template blueshield1 ~-1 ~-1 ~
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=2}] at @s run place template blueshield2 ~-2 ~-2 ~
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=3}] at @s run place template blueshield3 ~-3 ~-3 ~
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] as @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=3}] at @s run particle block blue_stained_glass ~ ~ ~ 1 1 0 0.1 50
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!customShield] run kill @e[x=0,type=marker,tag=PlaceBlueShield,scores={shieldplacement=3..}]
