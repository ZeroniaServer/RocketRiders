...
execute as @e[predicate=custom:indimension,type=egg,tag=YellowVortex] at @s if score $dust CmdData matches 1 run particle dragon_breath ~ ~ ~ 0 0 0 0.02 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[predicate=custom:indimension,type=egg,tag=BlueVortex] at @s if score $dust CmdData matches 1 run particle dragon_breath ~ ~ ~ 0 0 0 0.02 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @s[tag=!custVortParticle] as @e[predicate=custom:indimension,type=egg,tag=YellowVortex] at @s if score $dust CmdData matches 1 run particle dust 1 1 0 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @s[tag=!custVortParticle] as @e[predicate=custom:indimension,type=egg,tag=BlueVortex] at @s if score $dust CmdData matches 1 run particle dust 0 0 1 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute if entity @s[tag=!custVortParticle] as @e[predicate=custom:indimension,type=marker,tag=VortexYellow] at @s if score $dust CmdData matches 1 run particle minecraft:wax_on ~ ~0.3 ~ 0.5 0.5 0 0 3 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[predicate=custom:indimension,type=marker,tag=VortexYellow] at @s if score $dust CmdData matches 1 run particle minecraft:dragon_breath ~ ~0.3 ~ 0.5 0.5 0 0 5 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @s[tag=!custVortParticle] as @e[predicate=custom:indimension,type=marker,tag=VortexYellow] at @s if score $dust CmdData matches 1 run particle dust 1 1 0 1 ~ ~0.3 ~ 0.5 0.5 0 0 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @s[tag=!custVortParticle] as @e[predicate=custom:indimension,type=marker,tag=VortexBlue] at @s if score $dust CmdData matches 1 run particle minecraft:scrape ~ ~0.3 ~ 0.5 0.5 0 0 3 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[predicate=custom:indimension,type=marker,tag=VortexBlue] at @s if score $dust CmdData matches 1 run particle minecraft:dragon_breath ~ ~0.3 ~ 0.5 0.5 0 0 5 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute if entity @s[tag=!custVortParticle] as @e[predicate=custom:indimension,type=marker,tag=VortexBlue] at @s if score $dust CmdData matches 1 run particle dust 0 0 1 1 ~ ~0.3 ~ 0.5 0.5 0 0 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[predicate=custom:indimension,type=marker,tag=VortexFeathered] at @s if score $dust CmdData matches 1 run particle dust 1 1 1 1 ~ ~0.4 ~ 0.5 0.5 0 0 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[predicate=custom:indimension,type=marker,tag=VortexFeathered] at @s if score $dust CmdData matches 1 run particle wax_off ~ ~0.4 ~ 0.5 0.5 0 0 1 force @a[predicate=custom:indimension,predicate=custom:belowroof]
