...
execute as @a[predicate=custom:indimension,team=Yellow,predicate=custom:matches_uuid] at @s run data modify block ~ 174 ~ front_text.messages[0] set value '["",{"selector":"@p[team=Yellow,predicate=custom:matches_uuid]"},{"text":"\'s Vortex"}]'
execute as @a[predicate=custom:indimension,team=Blue,predicate=custom:matches_uuid] at @s run data modify block ~ 174 ~ front_text.messages[0] set value '["",{"selector":"@p[team=Blue,predicate=custom:matches_uuid]"},{"text":"\'s Vortex"}]'
