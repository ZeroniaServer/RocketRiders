...
execute as @a[x=0,team=Yellow,predicate=custom:matches_uuid] at @s run data merge block ~ 174 ~ {Text1:'{"text":""}',Text2:'["",{"selector":"@p[team=Yellow,predicate=custom:matches_uuid]"},{"text":"\'s Vortex"}]'}
execute as @a[x=0,team=Blue,predicate=custom:matches_uuid] at @s run data merge block ~ 174 ~ {Text1:'{"text":""}',Text2:'["",{"selector":"@p[team=Blue,predicate=custom:matches_uuid]"},{"text":"\'s Vortex"}]'}
