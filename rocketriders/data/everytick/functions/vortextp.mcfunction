...
execute as @e[x=0,type=marker,tag=Vortex,tag=teleportPair,limit=1,scores={vortexBoom=1..}] run data merge entity @e[x=0,type=armor_stand,tag=VortexItem,tag=teleportPair,limit=1] {ArmorItems:[{},{},{},{id:"minecraft:ender_eye",Count:1b}],DisabledSlots:4144959}
