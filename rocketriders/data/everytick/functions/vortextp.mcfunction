...
execute as @e[tag=Vortex,type=area_effect_cloud,tag=teleportPair,limit=1] run data merge entity @e[tag=VortexItem,tag=teleportPair,limit=1,type=armor_stand] {ArmorItems:[{},{},{},{id:"minecraft:ender_eye",Count:1b}],DisabledSlots:4144959}
