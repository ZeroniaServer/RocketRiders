...
execute at @e[x=-161,y=183,z=-161,dx=49,dy=49,dz=49,type=block_display,tag=missile_delayed_block] run setblock ~ ~ ~ air strict
execute as @e[x=-161,y=183,z=-161,dx=49,dy=49,dz=49,type=block_display,tag=missile_delayed_block] at @s run function game:missile_delayed_block/place
