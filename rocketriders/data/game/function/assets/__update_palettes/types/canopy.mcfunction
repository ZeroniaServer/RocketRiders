# asset/canopy/blue
execute unless predicate game:match_components/neutral_items run function game:assets/__update_palettes/types/__canopy/template with storage rocketriders:teams blue.team_banner
execute if predicate game:match_components/neutral_items run function game:assets/__update_palettes/types/__canopy/white
...
# asset/canopy/yellow
execute unless predicate game:match_components/neutral_items run function game:assets/__update_palettes/types/__canopy/template with storage rocketriders:teams yellow.team_banner
execute if predicate game:match_components/neutral_items run function game:assets/__update_palettes/types/__canopy/white
...
# asset/canopy/none
function game:assets/__update_palettes/types/__canopy/white
