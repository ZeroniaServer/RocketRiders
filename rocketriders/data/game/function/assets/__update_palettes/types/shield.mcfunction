...
$fill -160 184 -160 -154 190 -160 $(blue_shield_center_stained_glass) replace resin_brick_stairs[facing=north,half=bottom] strict
$fill -160 184 -160 -154 190 -160 $(blue_shield_accent_stained_glass) replace resin_brick_stairs[facing=east,half=bottom] strict
...
fill -160 184 -160 -154 190 -160 resin_brick_stairs[facing=north,half=bottom] replace cyan_stained_glass strict
fill -160 184 -160 -154 190 -160 resin_brick_stairs[facing=east,half=bottom] replace blue_stained_glass strict
$fill -160 184 -160 -154 190 -160 $(yellow_shield_center_stained_glass) replace resin_brick_stairs[facing=north,half=bottom] strict
$fill -160 184 -160 -154 190 -160 $(yellow_shield_accent_stained_glass) replace resin_brick_stairs[facing=east,half=bottom] strict
...
setblock -155 185 -160 structure_void strict
fill -161 184 -161 -161 185 -161 air strict
setblock -161 184 -161 minecraft:structure_block[mode=save]{author:"",ignoreEntities:1b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"SAVE",name:"game:asset/shield/stage_2/white",posX:2,posY:1,posZ:1,powered:0b,rotation:"NONE",seed:0L,showair:0b,showboundingbox:0b,sizeX:5,sizeY:5,sizeZ:1,strict:0b} strict
setblock -161 185 -161 redstone_block
fill -161 184 -161 -161 185 -161 air strict
setblock -161 184 -161 minecraft:structure_block[mode=save]{author:"",ignoreEntities:1b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"SAVE",name:"game:asset/shield/stage_1/white",posX:3,posY:2,posZ:1,powered:0b,rotation:"NONE",seed:0L,showair:0b,showboundingbox:0b,sizeX:3,sizeY:3,sizeZ:1,strict:0b} strict
setblock -161 185 -161 redstone_block
