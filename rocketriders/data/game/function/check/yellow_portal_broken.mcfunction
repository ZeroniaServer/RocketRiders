...
# Normal type
execute if predicate game:portal_type/normal if predicate game:modifiers/double_portal/on in minecraft:overworld unless block -9 38 74 minecraft:nether_portal unless block 13 38 74 minecraft:nether_portal run return run scoreboard players reset $yellow_single_portal match
