...
# Default type
execute if predicate game:portal_type/default if predicate game:modifiers/double_portal/on in minecraft:overworld unless block -9 38 74 minecraft:nether_portal unless block 13 38 74 minecraft:nether_portal run return 1
execute if predicate game:portal_type/default if predicate game:modifiers/double_portal/on run return fail
