...
execute unless predicate game:phase/match run scoreboard players add @s[tag=Countdown] count 1
...
execute unless predicate game:phase/match if score @s count matches 599..600 unless score $chunk_clear_progress global matches 50.. run scoreboard players set @s count 598
scoreboard players set $waiting_for_arena_to_clear var 0
execute unless predicate game:phase/match if score @s count matches 598 unless score $chunk_clear_progress global matches 50.. run scoreboard players set $waiting_for_arena_to_clear var 1
...
execute if predicate game:phase/match run scoreboard objectives add UUIDTracker dummy
execute if predicate game:phase/match run scoreboard objectives add KillerUUID dummy

##Right as game begins
execute if predicate game:phase/match run bossbar set rr:startgame value 30
execute if predicate game:phase/match run bossbar set rr:startgame max 30
execute if predicate game:phase/match run function game:randomsplash
execute if predicate game:phase/match as @a[x=0] at @s run playsound entity.generic.explode master @s ~ ~ ~ 100 1.2
execute if predicate game:phase/match run tp @a[x=0,predicate=custom:team/yellow] 12 64 66 -180 0
execute if predicate game:phase/match run tp @a[x=0,predicate=custom:team/blue] 12 64 -66 0 0
execute if predicate game:phase/match run gamemode spectator @a[x=0,predicate=custom:team/spectator]
execute if predicate game:phase/match if predicate game:modifiers/sonar/on run tellraw @a[x=0,predicate=custom:team/spectator,tag=!JoinSpec] [{color:"gray",text:""},{color:"yellow",text:"⚠"}," The Sonar modifier is enabled! Non-spectating players cannot see the whole arena."]
execute if predicate game:phase/match run tp @a[x=0,predicate=custom:team/spectator] 12 100 0.5 90 90
execute if predicate game:phase/match run tag @a[x=0] remove doing_facade_parkour
execute if predicate game:phase/match run effect clear @a[x=0,predicate=custom:team/any_playing_team] resistance
execute if predicate game:phase/match run effect give @a[x=0,predicate=custom:team/any_playing_team] fire_resistance 10 100 true
execute if predicate game:phase/match run gamemode survival @a[x=0,predicate=custom:team/any_playing_team]
execute if predicate game:phase/match run clear @a[x=0,predicate=custom:team/any_arena_team] *
execute if predicate game:phase/match as @a[x=0,predicate=custom:team/any_playing_team] run function custom:update_armor
execute if predicate game:phase/match as @a[x=0,predicate=custom:team/any_playing_team] run function items:give_main_item
#Hotfix for losing shield upon game starting
execute if predicate game:phase/match if predicate game:gamemode_components/main_item/crusade_kit_dependent as @a[x=0,predicate=custom:team/any_playing_team,predicate=rr_crusade:kit/knight] run loot replace entity @s weapon.offhand loot items:misc/knight_shield
execute if predicate game:phase/match as @a[x=0,predicate=custom:team/any_playing_team] run function game:notify_join
execute if predicate game:phase/match unless predicate game:phase/match/over run tag @a[x=0] remove CalculateWin
execute if predicate game:phase/match unless predicate game:phase/match/over run tag @a[x=0] remove CalculateLoss
#Hotfix for bug where jumping in queue rooms disqualifies you from Ground Bound achievement
execute if predicate game:phase/match run scoreboard players set @a[x=0,predicate=custom:team/any_playing_team] jumps 0
#Enabling damage gamerules
execute if predicate game:phase/match run function custom:game_rules/drowning_damage/on
execute if predicate game:phase/match run function custom:game_rules/fire_damage/on
execute if predicate game:phase/match run scoreboard players operation $initial_blue_team_count global = $blue_team_count global
execute if predicate game:phase/match run scoreboard players operation $initial_yellow_team_count global = $yellow_team_count global
execute if predicate game:phase/match run function lobby:credits/restart
execute if predicate game:phase/match run function custom:game_rules/mob_griefing/on
execute if predicate game:phase/match run kill @e[x=0,type=#arrows]
execute if predicate game:phase/match run scoreboard players set @s count 0
execute if predicate game:phase/match run tag @s remove bossbarOverride
#The forceCountdown tag is used to override conditions that would otherwise cancel a countdown
execute if predicate game:phase/match run tag @s remove forceCountdown
execute if predicate game:phase/match run tag @s remove Countdown
