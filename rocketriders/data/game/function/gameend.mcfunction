...
execute if entity @s[scores={endtimer=570}] if entity @s[scores={servermode=0}] run fill -57 200 84 -70 200 72 air replace #custom:modification_room_pool_blocks strict
