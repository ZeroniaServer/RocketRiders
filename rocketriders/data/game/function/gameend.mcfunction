...
execute if entity @s[scores={endtimer=570}] if entity @s[scores={servermode=0}] run fill -70 200 79 -70 200 77 ladder[facing=east] replace #custom:modification_room_pool_blocks strict
