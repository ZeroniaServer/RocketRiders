...
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=!BothWon,scores={endtimer=1..20}] run title @a[x=0,team=!Lobby] actionbar ["",{"text":"Waiting for potential tie... ","color":"red"},{"text":"5","color":"dark_red","bold":true},{"text":" seconds","color":"red"}]
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=!BothWon,scores={endtimer=21..40}] run title @a[x=0,team=!Lobby] actionbar ["",{"text":"Waiting for potential tie... ","color":"red"},{"text":"4","color":"dark_red","bold":true},{"text":" seconds","color":"red"}]
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=!BothWon,scores={endtimer=41..60}] run title @a[x=0,team=!Lobby] actionbar ["",{"text":"Waiting for potential tie... ","color":"red"},{"text":"3","color":"dark_red","bold":true},{"text":" seconds","color":"red"}]
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=!BothWon,scores={endtimer=61..80}] run title @a[x=0,team=!Lobby] actionbar ["",{"text":"Waiting for potential tie... ","color":"red"},{"text":"2","color":"dark_red","bold":true},{"text":" seconds","color":"red"}]
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=!BothWon,scores={endtimer=81..100}] run title @a[x=0,team=!Lobby] actionbar ["",{"text":"Waiting for potential tie... ","color":"red"},{"text":"1","color":"dark_red","bold":true},{"text":" second","color":"red"}]
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=!BothWon,scores={endtimer=101}] run title @a[x=0,team=!Lobby] actionbar {"text":""}

##System for ties (works with Double Portal modifier)
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=BlueWon,tag=!YellowWon,tag=!SuddenDeath,tag=!DoublePortal,scores={endtimer=1..100}] at @s unless block 11 38 -74 nether_portal run tag @s add SuddenDeath
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=BlueWon,tag=!YellowWon,tag=!SuddenDeath,tag=!DoublePortal,scores={endtimer=1..100}] at @s unless block 13 38 -74 nether_portal run tag @s add SuddenDeath
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=BlueWon,tag=!YellowWon,tag=!SuddenDeath,tag=DoublePortal,scores={endtimer=1..100}] at @s unless block 11 38 -74 nether_portal unless block 13 38 -74 nether_portal run tag @s add SuddenDeath
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=YellowWon,tag=!BlueWon,tag=!SuddenDeath,tag=!DoublePortal,scores={endtimer=1..100}] at @s unless block 13 38 74 nether_portal run tag @s add SuddenDeath
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=YellowWon,tag=!BlueWon,tag=!SuddenDeath,tag=!DoublePortal,scores={endtimer=1..100}] at @s unless block 11 38 74 nether_portal run tag @s add SuddenDeath
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=YellowWon,tag=!BlueWon,tag=!SuddenDeath,tag=DoublePortal,scores={endtimer=1..100}] at @s unless block 11 38 74 nether_portal unless block 13 38 74 nether_portal run tag @s add SuddenDeath
execute if entity @s[tag=doTying,tag=!tyingOff,predicate=!game:gamemode_components/no_portal,tag=YellowWon,tag=BlueWon,tag=!SuddenDeath,scores={endtimer=1..100}] run tag @s add SuddenDeath
...
execute if entity @s[scores={endtimer=570}] if score @s servermode matches 0 run fill -57 201 84 -70 201 72 water[level=7] replace tinted_glass strict
execute if entity @s[scores={endtimer=570}] if score @s servermode matches 0 run fill -57 200 84 -70 200 72 air replace #custom:modification_room_pool_blocks strict
