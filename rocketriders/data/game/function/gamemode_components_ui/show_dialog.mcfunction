data modify storage rocketriders:main gamemode_components.dialog set value {\
  ...
  "title": "Latest Snapshot News",\
  "inputs": [\
    {\
      "type": "minecraft:single_option",\
      "key": "arena__bedrock_frame",\
      "label": "arena/bedrock_frame",\
      "width": 300,\
      "options": [\
        {\
          "id": "0",\
    ...
    {\
      "type": "minecraft:single_option",\
      "key": "arena__no_base_details",\
      "label": "arena/no_base_details",\
      "width": 300,\
      "options": [\
        {\
          "id": "0",\
    ...
    {\
      "type": "minecraft:single_option",\
      "key": "custom_team_colors",\
      "label": "custom_team_colors",\
      "width": 300,\
      "options": [\
        {\
          "id": "0",\
    ...
    {\
      "type": "minecraft:single_option",\
      "key": "decreased_shooting_saber_attack_damage",\
      "label": "decreased_shooting_saber_attack_damage",\
      "width": 300,\
      "options": [\
        {\
          "id": "0",\
...
execute if predicate game:gamemode_components/settings_locked run data modify storage rocketriders:main gamemode_components.dialog.inputs[{key:"settings_locked"}].options[{display:"true"}].initial set value true
