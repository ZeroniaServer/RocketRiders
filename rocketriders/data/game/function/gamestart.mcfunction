...
execute if entity @s[tag=EditedSettings] unless predicate game:phase/match if predicate rr:has_voting if score $players_online global matches ..1 run tag @a[predicate=custom:team/any_arena_team] add LeaveTeams
execute if entity @s[tag=EditedSettings] unless predicate game:phase/match if predicate rr:has_voting if score $players_online global matches ..1 run return run function game:forcestop

##Game Bossbar
execute if predicate game:phase/match/play run bossbar set rr:startgame players @a[x=0,predicate=custom:team/lobby]
execute if entity @s[scores={endtimer=1..}] run bossbar set rr:startgame players @a[x=0,predicate=custom:team/lobby]
execute if predicate game:phase/match/play if entity @s[tag=!bossbarOverride] unless entity @s[tag=YellowFull,tag=BlueFull] unless score @s SDtime matches 1.. run bossbar set rr:startgame name ["",{"text":"A match is currently in progress. Feel free to join in!","color":"dark_green"}]
execute if predicate game:phase/match/play if entity @s[tag=!bossbarOverride,tag=YellowFull,tag=BlueFull] unless score @s SDtime matches 1.. run bossbar set rr:startgame name ["",{"text":"The match is full, but feel free to spectate!","color":"dark_green"}]
execute if predicate game:phase/match/play if entity @s[tag=!bossbarOverride] unless entity @s[tag=YellowFull,tag=BlueFull] if score @s SDtime matches 1.. run bossbar set rr:startgame name ["",{"text":"A tiebreaker is currently progress. Feel free to join in!","color":"dark_red"}]
execute if predicate game:phase/match/play if entity @s[tag=!bossbarOverride,tag=YellowFull,tag=BlueFull] if score @s SDtime matches 1.. run bossbar set rr:startgame name ["",{"text":"The match is full, but feel free to spectate!","color":"dark_red"}]
execute unless predicate game:phase/match/play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] run bossbar set rr:startgame max 30
execute unless predicate game:phase/match/play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] if predicate rr:wait_for_sufficient_players unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Yellow ","color":"gold"},{"text":"players...","color":"white"}]
...
execute unless predicate game:phase/match/play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame value 0
execute unless predicate game:phase/match/play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame color white
execute unless predicate game:phase/match/play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless predicate rr:wait_for_sufficient_players unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting players...","color":"white"}]
...
execute if entity @s[scores={endtimer=1..}] run bossbar set rr:startgame name ["",{"text":"A match is currently ending.","color":"red"}]
execute if entity @s[tag=!EditedSettings] if predicate rr:has_modification_room run bossbar set rr:startgame value 30
execute unless predicate game:phase/match/play unless entity @s[scores={endtimer=1..}] run bossbar set rr:startgame players @a[x=0]
...
execute if predicate game:phase/match/over run tag @a[x=0] remove JoinBlue
...
execute unless predicate game:phase/match/play run tp @a[x=0,tag=JoinBlue] -95 202 60 0 0
execute unless predicate game:phase/match/play unless predicate game:gamemode_components/one_team unless predicate game:gamemode_components/red_for_blue as @a[x=0,tag=JoinBlue] run tellraw @a[x=0] ["",{"selector":"@s","color":"blue"},{"text":" joined the blue team!","color":"dark_aqua"}]
# TODO this is kinda weird, no? why would you say you joined the blue team if it's red
execute unless predicate game:phase/match/play unless predicate game:gamemode_components/one_team if predicate game:gamemode_components/red_for_blue as @a[x=0,tag=JoinBlue] run tellraw @a[x=0] ["",{"selector":"@s","color":"dark_red"},{"text":" joined the blue team!","color":"red"}]
execute unless predicate game:phase/match/play if predicate game:gamemode_components/one_team unless predicate game:gamemode_components/red_for_blue as @a[x=0,tag=JoinBlue] run tellraw @a[x=0] ["",{"selector":"@s","color":"blue"},{"text":" joined the match!","color":"dark_aqua"}]
execute unless predicate game:phase/match/play if predicate game:gamemode_components/one_team if predicate game:gamemode_components/red_for_blue as @a[x=0,tag=JoinBlue] run tellraw @a[x=0] ["",{"selector":"@s","color":"dark_red"},{"text":" joined the match!","color":"red"}]
execute unless predicate game:phase/match/play unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,tag=JoinBlue] {"text":"Fall off the base to return to the Lobby.","color":"blue","italic":true}
execute unless predicate game:phase/match/play if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,tag=JoinBlue] {"text":"Fall off the base to return to the Lobby.","color":"red","italic":true}
execute unless predicate game:phase/match/play run effect give @a[x=0,tag=JoinBlue] resistance infinite 100 true
execute if predicate game:phase/match/play run tp @a[x=0,tag=JoinBlue] 12 64 -66 0 0
execute if predicate game:phase/match/play unless predicate game:gamemode_components/one_team unless predicate game:gamemode_components/red_for_blue as @a[x=0,tag=JoinBlue] run tellraw @a[x=0] ["",{"selector":"@s","color":"blue"},{"text":" joined the blue team! A late arrival, unfortunately.","color":"dark_aqua"}]
execute if predicate game:phase/match/play unless predicate game:gamemode_components/one_team if predicate game:gamemode_components/red_for_blue as @a[x=0,tag=JoinBlue] run tellraw @a[x=0] ["",{"selector":"@s","color":"dark_red"},{"text":" joined the blue team! A late arrival, unfortunately.","color":"red"}]
execute if predicate game:phase/match/play if predicate game:gamemode_components/one_team unless predicate game:gamemode_components/red_for_blue as @a[x=0,tag=JoinBlue] run tellraw @a[x=0] ["",{"selector":"@s","color":"blue"},{"text":" joined the match! A late arrival, unfortunately.","color":"dark_aqua"}]
execute if predicate game:phase/match/play if predicate game:gamemode_components/one_team if predicate game:gamemode_components/red_for_blue as @a[x=0,tag=JoinBlue] run tellraw @a[x=0] ["",{"selector":"@s","color":"dark_red"},{"text":" joined the match! A late arrival, unfortunately.","color":"red"}]
execute if predicate game:phase/match/play as @a[x=0,tag=JoinBlue] run function game:notify_join
execute if predicate game:phase/match/play unless predicate game:phase/match/paused run gamemode survival @a[x=0,predicate=custom:team/blue,gamemode=adventure]
execute unless predicate game:phase/match/play run gamemode adventure @a[x=0,tag=JoinBlue]
execute if predicate game:phase/match/play if predicate game:phase/match/paused run gamemode adventure @a[x=0,tag=JoinBlue]
execute if predicate game:phase/match/play unless predicate game:phase/match/paused run gamemode survival @a[x=0,tag=JoinBlue]
execute if predicate game:phase/match/play run effect clear @a[x=0,tag=JoinBlue] resistance
...
execute if predicate game:phase/match/over run tag @a[x=0] remove JoinYellow
...
execute unless predicate game:phase/match/play run tp @a[x=0,tag=JoinYellow] -95 202 96 180 0
execute unless predicate game:phase/match/play as @a[x=0,tag=JoinYellow] run tellraw @a[x=0] ["",{"selector":"@s","color":"gold"},{"text":" joined the yellow team!","color":"yellow"}]
execute unless predicate game:phase/match/play run tellraw @a[x=0,tag=JoinYellow] {"text":"Fall off the base to return to the Lobby.","color":"gold","italic":true}
execute unless predicate game:phase/match/play run effect give @a[x=0,tag=JoinYellow] resistance infinite 100 true
execute if predicate game:phase/match/play run tp @a[x=0,tag=JoinYellow] 12 64 66 180 0
execute if predicate game:phase/match/play as @a[x=0,tag=JoinYellow] run tellraw @a[x=0] ["",{"selector":"@s","color":"gold"},{"text":" joined the yellow team! A late arrival, unfortunately.","color":"yellow"}]
execute if predicate game:phase/match/play as @a[x=0,tag=JoinYellow] run function game:notify_join
execute if predicate game:phase/match/play unless predicate game:phase/match/paused run gamemode survival @a[x=0,predicate=custom:team/yellow,gamemode=adventure]
execute unless predicate game:phase/match/play run gamemode adventure @a[x=0,tag=JoinYellow]
execute if predicate game:phase/match/play if predicate game:phase/match/paused run gamemode adventure @a[x=0,tag=JoinYellow]
execute if predicate game:phase/match/play unless predicate game:phase/match/paused run gamemode survival @a[x=0,tag=JoinYellow]
execute if predicate game:phase/match/play run effect clear @a[x=0,tag=JoinYellow] resistance
...
execute if predicate game:phase/match/over run tag @a[x=0] remove JoinSpec
...
execute unless predicate game:phase/match run tp @a[x=0,tag=JoinSpec] -95 213 78 90 90
...
execute unless predicate game:phase/match run gamemode adventure @a[x=0,tag=JoinSpec]
...
execute if predicate rr:enable_spectator_leave_cloud if predicate game:phase/match/play if predicate custom:periodic_tick/3 positioned 12.5 95.0 0.5 run particle minecraft:dust{color:[0,1,0],scale:4} ~ ~ ~ 0.7 0.7 0.7 0.3 5 force @a[x=0,predicate=custom:team/spectator,predicate=custom:in_arena]
execute if predicate rr:enable_spectator_leave_cloud if predicate game:phase/match/play if predicate custom:periodic_tick/3 positioned 12.5 95.0 0.5 run particle minecraft:dust{color:[0,1,0],scale:3} ~ ~ ~ 0.8 0.8 0.8 0.3 5 force @a[x=0,predicate=custom:team/spectator,predicate=custom:in_arena]
execute if predicate rr:enable_spectator_leave_cloud if predicate game:phase/match/play if predicate custom:periodic_tick/3 positioned 12.5 95.0 0.5 run particle minecraft:dust{color:[0,1,0],scale:2} ~ ~ ~ 1 1 1 0.3 10 force @a[x=0,predicate=custom:team/spectator,predicate=custom:in_arena]
execute if predicate rr:enable_spectator_leave_cloud if predicate game:phase/match/play positioned 12.5 95.0 0.5 run tag @a[predicate=custom:team/spectator,distance=..4] add LeaveTeams

execute if predicate rr:enable_spectator_leave_cloud unless predicate game:phase/match/play if predicate custom:periodic_tick/3 positioned -89 213.5 78 run particle minecraft:dust{color:[0,1,0],scale:2} ~ ~ ~ 0.35 0.35 0.35 0.3 2 force @a[x=0,predicate=custom:team/spectator,predicate=!custom:in_arena]
execute if predicate rr:enable_spectator_leave_cloud unless predicate game:phase/match/play if predicate custom:periodic_tick/3 positioned -89 213.5 78 run particle minecraft:dust{color:[0,1,0],scale:1.5} ~ ~ ~ 0.4 0.4 0.4 0.3 2 force @a[x=0,predicate=custom:team/spectator,predicate=!custom:in_arena]
execute if predicate rr:enable_spectator_leave_cloud unless predicate game:phase/match/play if predicate custom:periodic_tick/3 positioned -89 213.5 78 run particle minecraft:dust{color:[0,1,0],scale:0.5} ~ ~ ~ 0.5 0.5 0.5 0.3 5 force @a[x=0,predicate=custom:team/spectator,predicate=!custom:in_arena]
execute if predicate rr:enable_spectator_leave_cloud unless predicate game:phase/match/play positioned -89 213.5 78 run tag @a[predicate=custom:team/spectator,distance=..1] add LeaveTeams

execute unless predicate game:phase/match as @a[x=0,predicate=custom:team/spectator] unless entity @s[x=-89,y=213,z=97,dx=-12,dy=10,dz=-38] run tp @s -95 213 78 90 90
...
execute unless predicate game:phase/match as @a[x=0,predicate=custom:team/any_arena_team] run attribute @s minecraft:knockback_resistance modifier add rocketriders:pre_game_queue 10000 add_value
...
##Facade Parkour
execute unless predicate game:phase/match as @a[x=-101,y=197,z=68,dx=12,dy=8,dz=19,gamemode=!spectator,predicate=custom:team/any_playing_team,tag=!doing_facade_parkour,predicate=custom:stepping_on_player_head] run tag @s add doing_facade_parkour
execute unless predicate game:phase/match as @a[x=0,gamemode=!spectator,predicate=custom:team/any_playing_team,tag=doing_facade_parkour] run title @s actionbar {color:"green",text:"Jump off to return to the base"}
execute unless predicate game:phase/match as @a[x=0,gamemode=!spectator,predicate=custom:team/any_playing_team,tag=doing_facade_parkour] at @s if entity @s[x=-84,y=186,z=45,dx=-111,dy=0,dz=110] run function game:end_facade_parkour
execute unless predicate game:phase/match as @a[x=-101,y=202,z=60,dx=12,dy=1,dz=5,gamemode=!spectator,predicate=custom:team/any_playing_team,tag=doing_facade_parkour] run function game:end_facade_parkour
