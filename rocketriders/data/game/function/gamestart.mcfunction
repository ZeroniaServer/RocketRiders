...
execute if predicate game:phase/staging/queue unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown] run bossbar set rr:startgame max 30
execute if predicate game:phase/staging/queue unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown] if predicate rr:wait_for_sufficient_players unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Yellow ","color":"gold"},{"text":"players...","color":"white"}]
...
execute if predicate game:phase/staging/queue unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown] unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame value 0
execute if predicate game:phase/staging/queue unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown] unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame color white
execute if predicate game:phase/staging/queue unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown] unless predicate rr:wait_for_sufficient_players unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting players...","color":"white"}]
