...
execute if score $dust CmdData matches 1 if predicate game:gamemode_components/neutral_utility_colors if entity @s[tag=EditedSettings,scores={largerTeam=-1..0},tag=!BlueFull] as @e[x=0,type=marker,tag=join_pad.blue,tag=!CancelJoin] at @s run particle minecraft:falling_dust{block_state:"minecraft:white_concrete"} ~ ~1 ~ 0.5 1 0.5 0.1 2 force @a[x=0,tag=!hideParticles,predicate=!custom:belowroof]
...
execute if score $dust CmdData matches 1 if predicate game:gamemode_components/neutral_utility_colors if entity @s[tag=EditedSettings,scores={largerTeam=0..1},tag=!YellowFull] as @e[x=0,type=marker,tag=join_pad.yellow,tag=!CancelJoin] at @s run particle minecraft:falling_dust{block_state:"minecraft:white_concrete"} ~ ~1 ~ 0.5 1 0.5 0.1 2 force @a[x=0,tag=!hideParticles,predicate=!custom:belowroof]
...
##Facade Parkour
execute unless predicate game:game_started as @a[x=-101,y=197,z=69,dx=12,dy=8,dz=18,gamemode=!spectator,predicate=custom:on_blue_or_yellow_team,tag=!doing_facade_parkour,predicate=custom:stepping_on_player_head] run tag @s add doing_facade_parkour
