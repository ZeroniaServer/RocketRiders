...
execute if predicate game:phase/staging if entity @s[tag=EditedSettings] if predicate rr:has_voting if score $players_online global matches ..1 run tag @a[predicate=custom:team/any_arena_team] add LeaveTeams
execute if predicate game:phase/staging if entity @s[tag=EditedSettings] if predicate rr:has_voting if score $players_online global matches ..1 run return run function game:forcestop
...
execute if predicate game:phase/match if entity @s[tag=!bossbarOverride] unless entity @s[tag=YellowFull,tag=BlueFull] unless score @s SDtime matches 1.. run bossbar set rr:startgame name ["",{"text":"A match is currently in progress. Feel free to join in!","color":"dark_green"}]
execute if predicate game:phase/match if entity @s[tag=!bossbarOverride,tag=YellowFull,tag=BlueFull] unless score @s SDtime matches 1.. run bossbar set rr:startgame name ["",{"text":"The match is full, but feel free to spectate!","color":"dark_green"}]
execute if predicate game:phase/match if entity @s[tag=!bossbarOverride] unless entity @s[tag=YellowFull,tag=BlueFull] if score @s SDtime matches 1.. run bossbar set rr:startgame name ["",{"text":"A tiebreaker is currently progress. Feel free to join in!","color":"dark_red"}]
execute if predicate game:phase/match if entity @s[tag=!bossbarOverride,tag=YellowFull,tag=BlueFull] if score @s SDtime matches 1.. run bossbar set rr:startgame name ["",{"text":"The match is full, but feel free to spectate!","color":"dark_red"}]
execute if predicate game:phase/staging unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] run bossbar set rr:startgame max 30
execute if predicate game:phase/staging unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] if predicate rr:wait_for_sufficient_players unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Yellow ","color":"gold"},{"text":"players...","color":"white"}]
...
execute if predicate game:phase/staging unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame value 0
execute if predicate game:phase/staging unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame color white
execute if predicate game:phase/staging unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless predicate rr:wait_for_sufficient_players unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting players...","color":"white"}]
