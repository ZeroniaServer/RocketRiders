...
execute unless predicate game:match_in_play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] run bossbar set rr:startgame max 30
execute unless predicate game:match_in_play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] if predicate rr:wait_for_sufficient_players unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Yellow ","color":"gold"},{"text":"players...","color":"white"}]
...
execute unless predicate game:match_in_play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame value 0
execute unless predicate game:match_in_play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame color white
execute unless predicate game:match_in_play unless predicate game:gamemode_components/custom_staging_bossbars if entity @s[tag=!Countdown,tag=EditedSettings] unless predicate rr:wait_for_sufficient_players unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting players...","color":"white"}]
