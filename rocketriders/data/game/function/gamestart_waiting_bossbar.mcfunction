...
execute unless predicate game:gamemode_components/one_team run scoreboard players operation $missing_blue_players var = $min_players_per_team gamemode_components
execute unless predicate game:gamemode_components/one_team run scoreboard players operation $missing_yellow_players var = $min_players_per_team gamemode_components
execute if predicate game:gamemode_components/one_team run scoreboard players operation $missing_blue_players var = $min_players var
execute if predicate game:gamemode_components/one_team run scoreboard players set $missing_yellow_players var 0
...
execute if score $max_players_per_team gamemode_components > $min_players_per_team gamemode_components run scoreboard players display numberformat $at_least var fixed " at least"
execute unless score $max_players_per_team gamemode_components > $min_players_per_team gamemode_components run scoreboard players display numberformat $at_least var fixed ""
...
## One team
execute if predicate game:gamemode_components/one_team run bossbar set rr:startgame name ["Waiting for",{score:{name:"$at_least",objective:"var"}}," ",{bold:true,score:{name:"$missing_blue_players",objective:"var"}},{score:{name:"$blue_more",objective:"var"}}," ",{score:{name:"$blue_missing_plural",objective:"var"}},"..."]
execute if predicate game:gamemode_components/one_team if predicate game:gamemode_components/custom_team_colors run return run bossbar set rr:startgame color white
execute if predicate game:gamemode_components/one_team if predicate game:gamemode_components/red_for_blue run return run bossbar set rr:startgame color red
...
execute unless predicate game:teams/blue_is_sufficient if score $missing_blue_players var matches 1 unless score $max_players_per_team gamemode_components matches 1 run bossbar set rr:startgame name ["Waiting for",{score:{name:"$at_least",objective:"var"}}," ",{bold:true,text:"1"},{score:{name:"$blue_more",objective:"var"}}," ",[{score:{name:"#blue",objective:"text.main_color"}},{score:{name:"#blue",objective:"text.team_name"}}]," player..."]
execute unless predicate game:teams/blue_is_sufficient if score $missing_blue_players var matches 1 if score $max_players_per_team gamemode_components matches 1 run bossbar set rr:startgame name ["Waiting for a ",[{score:{name:"#blue",objective:"text.main_color"}},{score:{name:"#blue",objective:"text.team_name"}}]," player..."]
...
execute unless predicate game:teams/yellow_is_sufficient if score $missing_yellow_players var matches 1 unless score $max_players_per_team gamemode_components matches 1 run bossbar set rr:startgame name ["Waiting for",{score:{name:"$at_least",objective:"var"}}," ",{bold:true,text:"1"},{score:{name:"$yellow_more",objective:"var"}}," ",[{score:{name:"#yellow",objective:"text.main_color"}},{score:{name:"#yellow",objective:"text.team_name"}}]," player..."]
execute unless predicate game:teams/yellow_is_sufficient if score $missing_yellow_players var matches 1 if score $max_players_per_team gamemode_components matches 1 run bossbar set rr:startgame name ["Waiting for a ",[{score:{name:"#yellow",objective:"text.main_color"}},{score:{name:"#yellow",objective:"text.team_name"}}]," player..."]
execute unless predicate game:teams/yellow_is_sufficient if predicate game:gamemode_components/red_for_blue run return run bossbar set rr:startgame color red
