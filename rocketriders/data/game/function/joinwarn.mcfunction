...
execute if entity @s[tag=JoinBlue] unless predicate game:game_rules/disable_team_balancing/on if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=1},tag=!BlueFull] if entity @e[x=0,type=marker,tag=join_pad.blue,tag=!CancelJoin] run tag @s add cannotJoin
execute if entity @s[tag=JoinBlue] unless predicate game:game_rules/disable_team_balancing/on if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=1},tag=!BlueFull] if entity @e[x=0,type=marker,tag=join_pad.blue,tag=!CancelJoin] run title @s[tag=!tryJoinBlue] title {"text":"Team Imbalanced!","color":"red","bold":true}
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin] if entity @e[x=0,type=marker,tag=join_pad.yellow,tag=!CancelJoin] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!YellowFull,scores={largerTeam=0..1}] run title @s[tag=!tryJoinBlue] subtitle [{"text":"Join ","color":"yellow","bold":false},{"text":"Yellow","color":"gold","bold":true},{"text":" instead.","color":"yellow","bold":false}]
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=-1..0}] unless entity @e[x=0,type=marker,tag=join_pad.spectator,tag=CancelJoin] run title @s[tag=!tryJoinBlue] subtitle {"text":"Feel free to spectate instead.","color":"gray","bold":false}
...
#Joining while team is imbalanced and joinpad is enabled
execute if entity @s[tag=JoinYellow] unless predicate game:game_rules/disable_team_balancing/on if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=-1},tag=!YellowFull] if entity @e[x=0,type=marker,tag=join_pad.yellow,tag=!CancelJoin] run tag @s add cannotJoin
execute if entity @s[tag=JoinYellow] unless predicate game:game_rules/disable_team_balancing/on if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=-1},tag=!YellowFull] if entity @e[x=0,type=marker,tag=join_pad.yellow,tag=!CancelJoin] run title @s[tag=!tryJoinYellow] title {"text":"Team Imbalanced!","color":"red","bold":true}
...
#Resolution message: yellow is available, so join yellow
execute if entity @s[tag=JoinYellow,tag=cannotJoin] if entity @e[x=0,type=marker,tag=join_pad.blue,tag=!CancelJoin] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!BlueFull,scores={largerTeam=-1..0}] run title @s[tag=!tryJoinYellow] subtitle [{"text":"Join ","color":"dark_aqua","bold":false},{"text":"Blue","color":"blue","bold":true},{"text":" instead.","color":"dark_aqua","bold":false}]
...
#Resolution message: yellow is imbalanced, so spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=0..1}] unless entity @e[x=0,type=marker,tag=join_pad.spectator,tag=CancelJoin] run title @s[tag=!tryJoinYellow] subtitle {"text":"Feel free to spectate instead.","color":"gray","bold":false}
