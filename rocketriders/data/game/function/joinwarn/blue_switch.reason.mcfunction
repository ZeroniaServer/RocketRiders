...
execute if predicate game:gamemode_components/one_team run return run data modify storage rocketriders:joinwarn title set value {bold:true,color:"red",text:"Cannot Switch Team!"}
