...
execute if predicate game:phase/match/over run return run data modify storage rocketriders:joinwarn subtitle set value {color:"gray",text:"Wait until a new game has started."}
execute if predicate game:phase/match if predicate game:gamemode_components/lock_playing_teams_during_match if predicate game:teams/spectator_is_joinable run return run data modify storage rocketriders:joinwarn subtitle set value {color:"gray",text:"Feel free to spectate instead."}
