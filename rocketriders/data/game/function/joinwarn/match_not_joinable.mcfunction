...
execute if predicate game:phase/match/closing/outcome run return run data modify storage rocketriders:joinwarn subtitle set value {color:"gray",text:"Wait until a new match has started."}
