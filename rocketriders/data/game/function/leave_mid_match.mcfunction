...
execute if predicate game:match_components/one_team run return run tellraw @a[x=0] [{score:{name:"#blue",objective:"text.accent_color"}},{selector:"@s"}," left the match!"]
