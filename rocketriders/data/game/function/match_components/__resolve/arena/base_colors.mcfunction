## Not specified
execute unless data storage rocketriders:match components."arena/base_colors" run return run data modify storage rocketriders:match components."arena/base_colors" set value {blue:{front:"main",middle:"accent",back:"white"},yellow:{front:"main",middle:"accent",back:"white"}}
...
# Teams match
execute if score $matching var matches 1 run data modify storage rocketriders:main match_components.value set value {blue:{front:"main",middle:"accent",back:"white"}}
