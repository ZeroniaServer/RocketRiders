## Not specified
execute unless data storage rocketriders:match components."arena/base_colors" run return run data modify storage rocketriders:match components."arena/base_colors" set value {blue:{front:"main",middle:"accent",back:"white",detail:"black",flag:"flag"},yellow:{front:"main",middle:"accent",back:"white",detail:"black",flag:"flag"}}
...
# Teams match
execute if score $matching var matches 1 run data modify storage rocketriders:main match_components.value set value {blue:{front:"main",middle:"accent",back:"white",detail:"black",flag:"flag"}}
...
execute if score $matching var matches 1 run data modify storage rocketriders:main match_components.value.blue.flag set from storage rocketriders:match components."arena/base_colors".flag
...
# Teams do not match
data modify storage rocketriders:main match_components.value set value {blue:{front:"main",middle:"accent",back:"white",flag:"flag"},yellow:{front:"main",middle:"accent",back:"white",flag:"flag"}}
...
data modify storage rocketriders:main match_components.value.blue.flag set from storage rocketriders:match components."arena/base_colors".blue.flag
...
data modify storage rocketriders:main match_components.value.yellow.flag set from storage rocketriders:match components."arena/base_colors".yellow.flag
