## Not specified
execute unless data storage rocketriders:match components."arena/base_materials" run return run data modify storage rocketriders:match components."arena/base_materials" set value {blue:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass",flag:"wool"},yellow:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass",flag:"wool"}}
...
# Teams match
execute if score $matching var matches 1 run data modify storage rocketriders:main match_components.value set value {blue:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass",flag:"wool"}}
...
execute if score $matching var matches 1 run data modify storage rocketriders:main match_components.value.blue.detail set from storage rocketriders:match components."arena/base_materials".detail
execute if score $matching var matches 1 run data modify storage rocketriders:main match_components.value.blue.flag set from storage rocketriders:match components."arena/base_materials".flag
...
# Teams do not match
data modify storage rocketriders:main match_components.value set value {blue:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass",flag:"wool"},yellow:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass",flag:"wool"}}
...
data modify storage rocketriders:main match_components.value.blue.detail set from storage rocketriders:match components."arena/base_materials".blue.detail
data modify storage rocketriders:main match_components.value.blue.flag set from storage rocketriders:match components."arena/base_materials".blue.flag
...
data modify storage rocketriders:main match_components.value.yellow.detail set from storage rocketriders:match components."arena/base_materials".yellow.detail
data modify storage rocketriders:main match_components.value.yellow.flag set from storage rocketriders:match components."arena/base_materials".yellow.flag
