## Not specified
execute unless data storage rocketriders:match components."arena/base_materials" run return run data modify storage rocketriders:match components."arena/base_materials" set value {blue:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass"},yellow:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass"}}
...
# Teams match
execute if score $matching var matches 1 run data modify storage rocketriders:main match_components.value set value {blue:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass"}}
...
# Teams do not match
data modify storage rocketriders:main match_components.value set value {blue:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass"},yellow:{front:"stained_glass",middle:"stained_glass",back:"stained_glass",detail:"stained_glass"}}
