...
$execute store success score $arena/bedrock_base_frames match_components if predicate {type:"int_value_check",value:$(arena__bedrock_base_frames),test:1}
...
$execute store success score $checkered_yellow_base match_components if predicate {type:"int_value_check",value:$(checkered_yellow_base),test:1}
...
# custom_team_colors
$execute store success score $custom_team_colors match_components if predicate {type:"int_value_check",value:$(custom_team_colors),test:1}
...
$execute store success score $decreased_shooting_saber_attack_damage match_components if predicate {type:"int_value_check",value:$(decreased_shooting_saber_attack_damage),test:1}
...
# friendly_fire
$execute store success score $friendly_fire match_components if predicate {type:"int_value_check",value:$(friendly_fire),test:1}
execute if score $friendly_fire match_components matches 0 run scoreboard players reset $friendly_fire match_components

# lower_void
$execute store success score $lower_void match_components if predicate {type:"int_value_check",value:$(lower_void),test:1}
execute if score $lower_void match_components matches 0 run scoreboard players reset $lower_void match_components

# no_achievements
$execute store success score $no_achievements match_components if predicate {type:"int_value_check",value:$(no_achievements),test:1}
...
# neutral_items
$execute store success score $neutral_items match_components if predicate {type:"int_value_check",value:$(neutral_items),test:1}
...
$execute store success score $no_feathered_vortices match_components if predicate {type:"int_value_check",value:$(no_feathered_vortices),test:1}
...
# no_item_timer
$execute store success score $no_item_timer match_components if predicate {type:"int_value_check",value:$(no_item_timer),test:1}
...
# one_team
$execute store success score $one_team match_components if predicate {type:"int_value_check",value:$(one_team),test:1}
...
# crusade_banners
$execute store success score $crusade_banners match_components if predicate {type:"int_value_check",value:$(crusade_banners),test:1}
...
$execute store success score $arena/classic_base_frames match_components if predicate {type:"int_value_check",value:$(arena__classic_base_frames),test:1}
...
# winner_pegasus
$execute store success score $winner_pegasus match_components if predicate {type:"int_value_check",value:$(winner_pegasus),test:1}
