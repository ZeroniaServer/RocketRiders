...
execute if predicate game:feature_flags/1_4_0_update if score $config_override.rotting match_components matches 1 run data modify storage rocketriders:main match_components.dialog.inputs append value {type:"minecraft:single_option",key:"",label:{color:"gray",text:"🔒 config_override.rotting"},width:300,options:[{id:"1",display:"on"}]}
execute if predicate game:feature_flags/1_4_0_update if score $config_override.rotting match_components matches -1 run data modify storage rocketriders:main match_components.dialog.inputs append value {type:"minecraft:single_option",key:"",label:{color:"gray",text:"🔒 config_override.rotting"},width:300,options:[{id:"-1",display:"off"}]}
