...
data modify storage rocketriders:main match_components.dialog.inputs append value {type:"minecraft:single_option",key:"classic_shooting_saber_name",label:"classic_shooting_saber_name",width:300,options:[{id:"0",display:{color:"white",text:"false"}},{id:"1",display:{color:"white",text:"true"}}]}
...
execute if score $config_override.tie_window_length match_components matches 1.. run data modify storage rocketriders:main match_components.dialog.inputs append value {type:"minecraft:single_option",key:"",label:{color:"gray",text:"🔒 config_override.tie_window_length"},width:300,options:[{id:"5",display:"5"}]}
execute if score $config_override.tie_window_length match_components matches 1.. store result storage rocketriders:main match_components.dialog.inputs[-1].options[0].id int 1 run scoreboard players get $config_override.tie_window_length match_components
execute if score $config_override.tie_window_length match_components matches 1.. run data modify storage rocketriders:main match_components.dialog.inputs[-1].options[0].id set string storage rocketriders:main match_components.dialog.inputs[-1].options[0].id
execute if score $config_override.tie_window_length match_components matches 1.. run data modify storage rocketriders:main match_components.dialog.inputs[-1].options[0].display set string storage rocketriders:main match_components.dialog.inputs[-1].options[0].id
execute if score $config_override.tie_window_length match_components matches ..-1 run data modify storage rocketriders:main match_components.dialog.inputs append value {type:"minecraft:single_option",key:"",label:{color:"gray",text:"🔒 config_override.tie_window_length"},width:300,options:[{id:"-1",display:"0"}]}
...
execute if score $config_override.instant_tnt match_components matches 1 run data modify storage rocketriders:main match_components.dialog.inputs append value {type:"minecraft:single_option",key:"",label:{color:"gray",text:"🔒 config_override.instant_tnt"},width:300,options:[{id:"1",display:"on"}]}
execute if score $config_override.instant_tnt match_components matches -1 run data modify storage rocketriders:main match_components.dialog.inputs append value {type:"minecraft:single_option",key:"",label:{color:"gray",text:"🔒 config_override.instant_tnt"},width:300,options:[{id:"-1",display:"off"}]}
