...
## Leave Mid-Match
execute if predicate rr:drop_main_item_to_leave_match if predicate game:phase/match/play as @a[scores={LeaveMidgame=1},predicate=custom:team/any_playing_team] run function game:leave_mid_match
