...
execute if entity @s[tag=normalEnabled] run function rr_normal:game/on_phase_start/staging/configuration
execute if entity @s[tag=powerupsEnabled] run function rr_powerups:game/on_phase_start/staging/configuration
execute if entity @s[tag=pveEnabled] run function rr_pve:game/on_phase_start/staging/configuration
execute if entity @s[tag=sandboxEnabled] run function rr_sandbox:game/on_phase_start/staging/configuration
execute if entity @s[tag=swapEnabled] run function rr_swap:game/on_phase_start/staging/configuration
