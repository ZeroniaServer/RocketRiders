...
#Set Blue Base
execute unless predicate game:match_components/red_for_blue run fill -14 34 -52 38 63 -56 blue_stained_glass replace #custom:basereplace
execute if predicate game:match_components/red_for_blue run fill -14 34 -52 38 63 -56 red_stained_glass replace #custom:basereplace
execute unless predicate game:match_components/red_for_blue run fill 38 63 -61 -14 34 -57 minecraft:cyan_stained_glass replace #custom:basereplace
execute if predicate game:match_components/red_for_blue run fill 38 63 -61 -14 34 -57 minecraft:pink_stained_glass replace #custom:basereplace
...
execute if predicate game:modifiers/hardcore/on run fill 38 63 -63 -14 34 -52 air
execute if predicate game:modifiers/hardcore/on run fill -14 63 -66 38 34 -66 white_stained_glass
execute if predicate game:modifiers/hardcore/on unless predicate game:match_components/red_for_blue run fill -14 63 -65 38 34 -65 cyan_stained_glass
execute if predicate game:modifiers/hardcore/on if predicate game:match_components/red_for_blue run fill -14 63 -65 38 34 -65 pink_stained_glass
execute if predicate game:modifiers/hardcore/on unless predicate game:match_components/red_for_blue run fill -14 63 -64 38 34 -64 blue_stained_glass
execute if predicate game:modifiers/hardcore/on if predicate game:match_components/red_for_blue run fill -14 63 -64 38 34 -64 red_stained_glass
...
## Details
execute unless predicate game:match_components/arena/no_base_details unless predicate game:arena_details/castle run function arenaclear:detailplacement
