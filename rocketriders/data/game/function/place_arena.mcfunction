...
## Details
execute unless predicate game:gamemode_components/arena/no_base_details unless predicate game:arena_details/castle run function arenaclear:detailplacement
