...
execute if score $x_offset var matches 49..51 if score $z_offset var matches 1..3 if predicate game:arena_details/top/castle run scoreboard players set $fill_column var 0
execute if score $x_offset var matches 1..3 if score $z_offset var matches 1..3 if predicate game:arena_details/top/castle run scoreboard players set $fill_column var 0
...
# Flag support pads
execute if score $z_offset var matches 0 if predicate game:match_components/has_flags run function game:regenerate_back_layer/flag_support_pads/search with storage rocketriders:main regenerate_back_layer
