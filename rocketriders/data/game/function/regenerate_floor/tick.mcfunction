execute unless predicate game:modifiers/hardcore/on unless predicate game:arena_details/top/castle run scoreboard players set $depth var 15
execute unless predicate game:modifiers/hardcore/on if predicate game:arena_details/top/castle run scoreboard players set $depth var 10
...
execute if predicate game:arena_details/top/castle positioned -8.5 63.5 ~ run function game:regenerate_floor/offset with storage rocketriders:main regenerate_floor
