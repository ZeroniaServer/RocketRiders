...
execute if entity @e[limit=1,x=0,type=armor_stand,tag=Selection,tag=forceCountdown] run return run tellraw @s {color:"red",text:"Cannot restart a forced countdown."}
