...
return run execute if function game:set_phase/__set/match.paused if function game:set_phase/__enter/match if function game:set_phase/__finish_transition run function game:on_phase_start/match/paused
