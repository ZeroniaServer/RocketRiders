...
execute if predicate game:phase/match run return run execute if function game:set_phase/__set/match.paused if function game:set_phase/__enter/match/paused run scoreboard players reset $transitioning_phase global
return run execute if function game:set_phase/__set/match.queue.waiting if function game:set_phase/__enter/match if function game:set_phase/__enter/match/paused run scoreboard players reset $transitioning_phase global
