...
execute if entity @s[scores={SDtime=1},tag=YellowWonFirst] run item replace entity @a[x=0,team=Yellow] armor.chest with leather_chestplate[unbreakable={show_in_tooltip:0b},enchantments={levels:{binding_curse:1,projectile_protection:1},show_in_tooltip:0b},enchantment_glint_override=false,attribute_modifiers={modifiers:[],show_in_tooltip:0b},custom_name='[{"text":"Yellow Chestplate","color":"yellow","bold":true,"italic":false}]',dyed_color={rgb:16768000,show_in_tooltip:0b},trim={material:"minecraft:netherite",pattern:"minecraft:spire"},hide_additional_tooltip={}]
