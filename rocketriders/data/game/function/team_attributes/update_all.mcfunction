...
# Yellow
execute if predicate game:yellow_team_skin/yellow unless predicate game:match_components/checkered_yellow_base run data modify storage rocketriders:teams yellow set value \
{\
    text: {\
        team_name: "Yellow",\
...
execute if predicate game:yellow_team_skin/green unless predicate game:match_components/checkered_yellow_base run data modify storage rocketriders:teams yellow set value \
{\
    text: {\
        team_name: "Green",\
...
scoreboard players display numberformat #blue text.flag fixed {storage:"rocketriders:teams",nbt:"blue.text.flag",interpret:true}
...
scoreboard players display numberformat #yellow text.flag fixed {storage:"rocketriders:teams",nbt:"yellow.text.flag",interpret:true}
