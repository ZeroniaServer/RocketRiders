...
# Crack deepslate
execute unless predicate game:game_rules/friendly_tnt_damage/on if predicate game:gamemode_components/explosions_crack_deepslate_bricks if predicate rr_crusade:tnt_near_castle run function game:explosion_deepslate_cracks/medium
