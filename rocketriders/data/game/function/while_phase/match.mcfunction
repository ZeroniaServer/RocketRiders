...
execute unless predicate game:phase/match/paused unless predicate game:phase/match/over as @a[x=0,predicate=custom:team/any_playing_team,gamemode=!spectator,tag=!JoinBlue,tag=!JoinYellow] at @s in overworld if entity @s[predicate=custom:breaching_lobby] run function game:punishbreach
execute unless predicate game:phase/match/paused if predicate game:phase/match/over as @a[x=0,predicate=custom:team/blue] at @s in overworld if entity @s[predicate=custom:breaching_lobby] run tp @s 12 64 -66 0 0
execute unless predicate game:phase/match/paused if predicate game:phase/match/over as @a[x=0,predicate=custom:team/yellow] at @s in overworld if entity @s[predicate=custom:breaching_lobby] run tp @s 12 64 66 180 0
execute unless predicate game:phase/match/paused if predicate game:phase/match/over as @a[x=0,predicate=custom:team/spectator] at @s in overworld if entity @s[predicate=custom:breaching_lobby] run tp @s 12 100 0.5 90 90
