...
##Game time
scoreboard players add $time match_data 1
...
## Castle
# Pathways
execute if predicate game:arena_details/top/castle if predicate game:castle_type/deepslate run function game:place_castle_pathways
# Hanging ladders
