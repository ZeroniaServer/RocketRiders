...
execute if score $closing_timer global matches 1 run gamemode adventure @a[x=0,predicate=custom:team/blue]
execute if score $closing_timer global matches 1 run gamemode adventure @a[x=0,predicate=custom:team/yellow]
...
execute if score $closing_timer global matches 250 run gamemode spectator @a[x=0,predicate=custom:team/any_playing_team]
