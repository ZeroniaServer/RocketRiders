...
scoreboard players operation $tie_window_countdown_seconds var = $closing_sequence.max_tie_window_time match_data
scoreboard players operation $tie_window_countdown_seconds var -= $closing_sequence.time match_data
...
execute if score $closing_sequence.time match_data >= $closing_sequence.max_tie_window_time match_data run title @a[x=0,predicate=!custom:team/lobby] actionbar ""
execute if score $closing_sequence.time match_data >= $closing_sequence.max_tie_window_time match_data run return run function game:set_phase/match.closing.outcome.celebration
