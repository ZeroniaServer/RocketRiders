...
execute if score $closing_timer global matches 21..40 run title @a[x=0,predicate=!custom:team/lobby] actionbar [{color:"red",text:"Waiting for potential tie... "},{bold:true,color:"dark_red",text:"4"}," seconds"]
execute if score $closing_timer global matches 41..60 run title @a[x=0,predicate=!custom:team/lobby] actionbar [{color:"red",text:"Waiting for potential tie... "},{bold:true,color:"dark_red",text:"3"}," seconds"]
