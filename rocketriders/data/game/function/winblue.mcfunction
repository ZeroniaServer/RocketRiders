...
execute unless predicate game:game_rules/disable_titles/on unless predicate game:gamemode_components/red_for_blue run title @a[x=0,predicate=!custom:team/lobby] title ["",{"text":"Team Blue Won!","color":"blue","bold":false}]
execute unless predicate game:game_rules/disable_titles/on if predicate game:gamemode_components/red_for_blue run title @a[x=0,predicate=!custom:team/lobby] title ["",{"text":"Team Red Won!","color":"dark_red","bold":false}]
