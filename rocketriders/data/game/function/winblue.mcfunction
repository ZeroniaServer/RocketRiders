...
item replace entity @a[x=0,team=Yellow] armor.head with yellow_banner[enchantments={levels:{binding_curse:1},show_in_tooltip:0b},custom_name='{"text":"Flag of Shameful Loss","color":"gold","bold":true,"italic":false}',attribute_modifiers={show_in_tooltip:0b},unbreakable={show_in_tooltip:0b},stored_enchantments={show_in_tooltip:0b},hide_additional_tooltip={},banner_patterns=[{color:"white",pattern:"half_horizontal"},{color:"white",pattern:"half_horizontal_bottom"},{color:"red",pattern:"stripe_left"},{color:"red",pattern:"stripe_bottom"},{color:"white",pattern:"stripe_left"},{color:"white",pattern:"stripe_bottom"},{color:"white",pattern:"stripe_right"},{color:"white",pattern:"square_top_left"}]] 1
