...
item replace entity @a[x=0,team=Blue,scores={HasFirework=0}] hotbar.1 with firework_rocket[custom_name='{"text":"Celebratory Fireworks","color":"blue","bold":true,"italic":false}',can_place_on={predicates:[{blocks:["#custom:missileblocks","#custom:basereplace"]}],show_in_tooltip:0b},attribute_modifiers={show_in_tooltip:0b},stored_enchantments={show_in_tooltip:0b},hide_additional_tooltip={},fireworks={explosions:[{shape:"large_ball",colors:[I;2437522,2651799],has_trail:1,has_twinkle:1}],flight_duration:3}] 5
execute if entity @s[scores={servermode=0},tag=!SMCustom] run item replace entity @a[x=0,team=Blue] armor.chest with elytra[unbreakable={show_in_tooltip:0b},enchantments={levels:{binding_curse:1},show_in_tooltip:0b},enchantment_glint_override=true,custom_name='[{"text":"Elytra","color":"blue","bold":true,"italic":false}]',attribute_modifiers={show_in_tooltip:0b},can_break={show_in_tooltip:0b},can_place_on={show_in_tooltip:0b},stored_enchantments={show_in_tooltip:0b},hide_additional_tooltip={},dyed_color={show_in_tooltip:0b}] 1
execute unless entity @s[scores={servermode=0},tag=!SMCustom] run item replace entity @a[x=0,team=Blue] armor.chest with elytra[unbreakable={show_in_tooltip:0b},custom_name='[{"text":"Elytra","color":"blue","bold":true,"italic":false}]',enchantments={show_in_tooltip:0b},attribute_modifiers={show_in_tooltip:0b},can_break={show_in_tooltip:0b},can_place_on={show_in_tooltip:0b},stored_enchantments={show_in_tooltip:0b},hide_additional_tooltip={},dyed_color={show_in_tooltip:0b}] 1
item replace entity @a[x=0,team=Yellow,scores={HasFirework=0}] hotbar.1 with firework_rocket[custom_name='{"text":"Celebratory Fireworks","color":"gold","bold":true,"italic":false}',can_place_on={predicates:[{blocks:["#custom:missileblocks","#custom:basereplace"]}],show_in_tooltip:0b},attribute_modifiers={show_in_tooltip:0b},stored_enchantments={show_in_tooltip:0b},hide_additional_tooltip={},fireworks={explosions:[{shape:"large_ball",colors:[I;14602026,15435844],has_trail:1,has_twinkle:1}],flight_duration:3}] 5
execute if entity @s[scores={servermode=0},tag=!SMCustom] run item replace entity @a[x=0,team=Yellow] armor.chest with elytra[unbreakable={show_in_tooltip:0b},enchantments={levels:{binding_curse:1},show_in_tooltip:0b},enchantment_glint_override=true,custom_name='[{"text":"Elytra","color":"gold","bold":true,"italic":false}]',attribute_modifiers={show_in_tooltip:0b},can_break={show_in_tooltip:0b},can_place_on={show_in_tooltip:0b},stored_enchantments={show_in_tooltip:0b},hide_additional_tooltip={},dyed_color={show_in_tooltip:0b}] 1
execute unless entity @s[scores={servermode=0},tag=!SMCustom] run item replace entity @a[x=0,team=Yellow] armor.chest with elytra[unbreakable={show_in_tooltip:0b},custom_name='[{"text":"Elytra","color":"gold","bold":true,"italic":false}]',enchantments={show_in_tooltip:0b},attribute_modifiers={show_in_tooltip:0b},can_break={show_in_tooltip:0b},can_place_on={show_in_tooltip:0b},stored_enchantments={show_in_tooltip:0b},hide_additional_tooltip={},dyed_color={show_in_tooltip:0b}] 1
