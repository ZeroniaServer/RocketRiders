...
item replace entity @a[x=0,team=Blue] armor.chest with elytra[unbreakable={show_in_tooltip:0b},enchantments={levels:{binding_curse:1,projectile_protection:1},show_in_tooltip:0b},enchantment_glint_override=false,attribute_modifiers={modifiers:[],show_in_tooltip:0b},custom_name='[{"text":"Elytra","color":"blue","bold":true,"italic":false}]'] 1
...
item replace entity @a[x=0,team=Yellow] armor.chest with elytra[unbreakable={show_in_tooltip:0b},enchantments={levels:{binding_curse:1,projectile_protection:1},show_in_tooltip:0b},enchantment_glint_override=false,attribute_modifiers={modifiers:[],show_in_tooltip:0b},custom_name='[{"text":"Elytra","color":"gold","bold":true,"italic":false}]'] 1
