...
execute if score $winsplash CmdData matches 66 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"What is that I hear? Sounds like skill issue."}
execute if score $winsplash CmdData matches 67 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"Hey wait, did they grief themselves?"}
execute if score $winsplash CmdData matches 68 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"Well done, medal is at -224 77 29 (pranked)"}
execute if score $winsplash CmdData matches 69 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"Now, was that so hard?"}
execute if score $winsplash CmdData matches 70 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"Yes Rico, kaboom."}
execute if score $winsplash CmdData matches 71 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"Hasta la vista, baby!"}
execute if score $winsplash CmdData matches 72 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"W"}
execute if score $winsplash CmdData matches 73 run title @a[x=0,tag=Winner] subtitle [{color:"green",text:"The "},{bold:true,text:"Rock"}," really came through!"]
execute if score $winsplash CmdData matches 74 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"Who trained you?"}
execute if score $winsplash CmdData matches 75 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"Hey, Queen! Girl, you have done it again."}
execute if score $winsplash CmdData matches 76 run title @a[x=0,tag=Winner] subtitle {color:"green",text:"Constantly raising the bar for us all, and doing it flawlessly."}
