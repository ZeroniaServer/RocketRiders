...
execute unless predicate game:game_rules/disable_titles/on run title @a[x=0,predicate=!custom:team/lobby] title [{bold:true,score:{name:"#yellow",objective:"text.main_color"}},"Team ",{score:{name:"#blue",objective:"text.team_name"}}," Won!"]
