...
execute if entity @s[scores={servermode=0},tag=!SMCustom] run item replace entity @a[x=0,team=Yellow] armor.chest with elytra[unbreakable={show_in_tooltip:0b},enchantments={levels:{binding_curse:1},show_in_tooltip:0b},enchantment_glint_override=true,custom_name='[{"text":"Elytra","color":"gold","bold":true,"italic":false}]'] 1
execute unless entity @s[scores={servermode=0},tag=!SMCustom] run item replace entity @a[x=0,team=Yellow] armor.chest with elytra[unbreakable={show_in_tooltip:0b},custom_name='[{"text":"Elytra","color":"gold","bold":true,"italic":false}]',enchantments={show_in_tooltip:0b},enchantment_glint_override=true] 1
item replace entity @a[x=0,team=Blue] armor.head with blue_banner[enchantments={levels:{binding_curse:1},show_in_tooltip:0b},custom_name='{"text":"Flag of Shameful Loss","color":"blue","bold":true,"italic":false}',enchantment_glint_override=true,hide_additional_tooltip={},banner_patterns=[{color:"white",pattern:"half_horizontal"},{color:"white",pattern:"half_horizontal_bottom"},{color:"blue",pattern:"stripe_left"},{color:"blue",pattern:"stripe_bottom"},{color:"white",pattern:"stripe_left"},{color:"white",pattern:"stripe_bottom"},{color:"white",pattern:"stripe_right"},{color:"white",pattern:"square_top_left"}]] 1
