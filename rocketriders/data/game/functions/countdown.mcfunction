...
execute as @s[scores={count=20}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"29","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=20}] run bossbar set rr:startgame value 29
execute as @s[scores={count=40}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"28","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=40}] run bossbar set rr:startgame value 28
execute as @s[scores={count=60}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"27","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=60}] run bossbar set rr:startgame value 27
execute as @s[scores={count=80}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"26","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=80}] run bossbar set rr:startgame value 26
execute as @s[scores={count=100}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"25","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=100}] run bossbar set rr:startgame value 25
execute as @s[scores={count=120}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"24","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=120}] run bossbar set rr:startgame value 24
execute as @s[scores={count=140}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"23","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=140}] run bossbar set rr:startgame value 23
execute as @s[scores={count=160}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"22","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=160}] run bossbar set rr:startgame value 22
execute as @s[scores={count=180}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"21","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=180}] run bossbar set rr:startgame value 21
execute as @s[scores={count=200}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"20","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=200}] run bossbar set rr:startgame value 20
execute as @s[scores={count=220}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"19","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=220}] run bossbar set rr:startgame value 19
execute as @s[scores={count=240}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"18","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=240}] run bossbar set rr:startgame value 18
execute as @s[scores={count=260}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"17","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=260}] run bossbar set rr:startgame value 17
execute as @s[scores={count=280}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"16","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=280}] run bossbar set rr:startgame value 16
execute as @s[scores={count=300}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"15","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=300}] run bossbar set rr:startgame value 15
execute as @s[scores={count=320}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"14","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=320}] run bossbar set rr:startgame value 14
execute as @s[scores={count=340}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"13","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=340}] run bossbar set rr:startgame value 13
execute as @s[scores={count=360}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"12","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
execute as @s[scores={count=360}] run bossbar set rr:startgame value 12
execute as @s[scores={count=380}] run bossbar set rr:startgame name ["",{"text":"The game will begin in ","color":"green"},{"text":"11","bold":true,"color":"dark_green"},{"text":" seconds.","color":"green"}]
...
execute as @s[tag=GameStarted,tag=!customSaberMsg,tag=SMActive] run tellraw @a[team=Blue] [{"text":"Use ","color":"aqua","italic":"true"},{"text":"/leave ","color":"blue","bold":"true","italic":"false"},{"text":"to leave the match.","color":"aqua","italic":"true"}]
execute as @s[tag=GameStarted,tag=!customSaberMsg,tag=SMActive] run tellraw @a[team=Yellow] [{"text":"Use ","color":"yellow","italic":"true"},{"text":"/leave ","color":"gold","bold":"true","italic":"false"},{"text":"to leave the match.","color":"yellow","italic":"true"}]
