...
execute if entity @s[scores={count=1..399}] unless entity @a[predicate=custom:indimension,team=Lobby,tag=!inParkour,tag=!vanished] run bossbar set rr:startgame max 10
execute if entity @s[scores={count=1..399}] unless entity @a[predicate=custom:indimension,team=Lobby,tag=!inParkour,tag=!vanished] run scoreboard players set @s count 400
execute if entity @s[scores={count=1..600}] run scoreboard players set @a[predicate=custom:indimension] dropBow 0
...
execute if entity @s[scores={count=400}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.5
...
execute if entity @s[scores={count=420}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.5
...
execute if entity @s[scores={count=440}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.5
...
execute if entity @s[scores={count=460}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.5
...
execute if entity @s[scores={count=480}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.5
...
execute if entity @s[scores={count=500}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.5
...
execute if entity @s[scores={count=520}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.6
...
execute if entity @s[scores={count=540}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.7
...
execute if entity @s[scores={count=560}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.8
...
execute if entity @s[scores={count=580}] as @a[predicate=custom:indimension] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.9
...
execute if entity @s[tag=GameStarted] as @a[predicate=custom:indimension] at @s run playsound entity.generic.explode master @s ~ ~ ~ 100 1.2
execute if entity @s[tag=GameStarted,tag=!customSpawns] run tp @a[predicate=custom:indimension,team=Yellow] 12 64 66 -180 0
execute if entity @s[tag=GameStarted,tag=!customSpawns] run tp @a[predicate=custom:indimension,team=Blue] 12 64 -66 0 0
execute if entity @s[tag=GameStarted] run effect clear @a[predicate=custom:indimension,team=Blue] resistance
execute if entity @s[tag=GameStarted] run effect clear @a[predicate=custom:indimension,team=Yellow] resistance
execute if entity @s[tag=GameStarted] run effect give @a[predicate=custom:indimension,team=Blue] fire_resistance 10 100 true
execute if entity @s[tag=GameStarted] run effect give @a[predicate=custom:indimension,team=Yellow] fire_resistance 10 100 true
execute if entity @s[tag=GameStarted] run gamemode survival @a[predicate=custom:indimension,team=Yellow]
execute if entity @s[tag=GameStarted] run gamemode survival @a[predicate=custom:indimension,team=Blue]
...
execute if entity @s[tag=GameStarted,tag=!customSaberMsg,tag=SMActive] run tellraw @a[predicate=custom:indimension,team=Blue] [{"text":"Use ","color":"aqua","italic":true},{"text":"/leave ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"aqua","italic":true}]
execute if entity @s[tag=GameStarted,tag=!customSaberMsg,tag=SMActive] run tellraw @a[predicate=custom:indimension,team=Yellow] [{"text":"Use ","color":"yellow","italic":true},{"text":"/leave ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
execute if entity @s[tag=GameStarted,tag=!GameEnd] run tag @a[predicate=custom:indimension] remove CalculateWin
execute if entity @s[tag=GameStarted,tag=!GameEnd] run tag @a[predicate=custom:indimension] remove CalculateLoss
#Hotfix for bug where jumping in queue rooms disqualifies you from Ground Bound achievement
execute if entity @s[tag=GameStarted] run scoreboard players set @a[predicate=custom:indimension,team=Yellow] jumps 0
execute if entity @s[tag=GameStarted] run scoreboard players set @a[predicate=custom:indimension,team=Blue] jumps 0
