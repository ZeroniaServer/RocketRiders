...
execute if entity @s[scores={endtimer=1},tag=!noSabers] run kill @e[x=0,type=item,nbt={Item:{id:"minecraft:bow"}}]
...
execute if entity @s[tag=!fireballOverride,scores={endtimer=1}] as @e[x=0,type=fireball,scores={endFireball=1}] at @s run summon area_effect_cloud ~ ~-.375 ~ {Duration:2000000,Radius:0,NoGravity:1b,Tags:["endFireballAEC","endFireball"],Passengers:[{id:"minecraft:fireball",Tags:["endFireball"],ExplosionPower:0,Motion:[0.0d,0.0d,0.0d],power:[0.0d,0.0d,0.0d]}]}
execute if entity @s[tag=!fireballOverride,scores={endtimer=1}] as @e[x=0,type=fireball,tag=endFireball] at @s run data modify entity @s Item set from entity @e[type=fireball,scores={endFireball=1},limit=1,sort=nearest,distance=..1] Item
execute if entity @s[tag=!fireballOverride,scores={endtimer=1}] as @e[x=0,type=fireball,tag=endFireball] at @s run data modify entity @s Tags set from entity @e[type=fireball,scores={endFireball=1},limit=1,sort=nearest,distance=..1] Tags
execute if entity @s[tag=!fireballOverride,scores={endtimer=1}] as @e[x=0,type=area_effect_cloud,tag=endFireballAEC] at @s run kill @e[type=fireball,scores={endFireball=1},limit=1,sort=nearest,distance=..1]
execute if entity @s[tag=!fireballOverride,scores={endtimer=1}] as @e[x=0,type=area_effect_cloud,tag=endFireballAEC] at @s run tag @e[type=fireball,limit=1,sort=nearest,distance=..1] add endFireball
execute if entity @s[tag=!fireballOverride,scores={endtimer=1..}] as @e[x=0,type=fireball,tag=endFireball] run data merge entity @s {ExplosionPower:0,Motion:[0.0d,0.0d,0.0d],power:[0.0d,0.0d,0.0d]}
