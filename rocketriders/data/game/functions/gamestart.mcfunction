...
##Game Bossbar
execute if entity @s[tag=GameStarted] run bossbar set rr:startgame players @a[predicate=custom:indimension,team=Lobby]
execute if entity @s[scores={endtimer=1..}] run bossbar set rr:startgame players @a[predicate=custom:indimension,team=Lobby]
...
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar,tag=!SMCustom] unless entity @s[scores={endtimer=1..}] if entity @a[predicate=custom:indimension,team=Blue] unless entity @a[predicate=custom:indimension,team=Yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Yellow ","color":"gold"},{"text":"players...","color":"white"}]
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar,tag=!SMCustom] unless entity @s[scores={endtimer=1..}] if entity @a[predicate=custom:indimension,team=Blue] unless entity @a[predicate=custom:indimension,team=Yellow] run bossbar set rr:startgame color blue
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar,tag=!SMCustom] unless entity @s[scores={endtimer=1..}] if entity @a[predicate=custom:indimension,team=Blue] unless entity @a[predicate=custom:indimension,team=Yellow] run bossbar set rr:startgame value 15
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar,tag=!SMCustom] unless entity @s[scores={endtimer=1..}] if entity @a[predicate=custom:indimension,team=Yellow] unless entity @a[predicate=custom:indimension,team=Blue] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Blue ","color":"blue"},{"text":"players...","color":"white"}]
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar,tag=!SMCustom] unless entity @s[scores={endtimer=1..}] if entity @a[predicate=custom:indimension,team=Yellow] unless entity @a[predicate=custom:indimension,team=Blue] run bossbar set rr:startgame color yellow
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar,tag=!SMCustom] unless entity @s[scores={endtimer=1..}] if entity @a[predicate=custom:indimension,team=Yellow] unless entity @a[predicate=custom:indimension,team=Blue] run bossbar set rr:startgame value 15
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar,tag=!SMCustom] unless entity @s[scores={endtimer=1..}] unless entity @a[predicate=custom:indimension,team=Blue] unless entity @a[predicate=custom:indimension,team=Yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Yellow ","color":"gold"},{"text":"and ","color":"white"},{"text":"Blue ","color":"blue"},{"text":"players...","color":"white"}]
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar] unless entity @s[scores={endtimer=1..}] unless entity @a[predicate=custom:indimension,team=Blue] unless entity @a[predicate=custom:indimension,team=Yellow] run bossbar set rr:startgame value 0
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar] unless entity @s[scores={endtimer=1..}] unless entity @a[predicate=custom:indimension,team=Blue] unless entity @a[predicate=custom:indimension,team=Yellow] run bossbar set rr:startgame color white
execute if entity @s[tag=!GameStarted,tag=!Countdown,tag=EditedSettings,tag=!customBossbar,tag=SMCustom] unless entity @s[scores={endtimer=1..}] unless entity @a[predicate=custom:indimension,team=Blue] unless entity @a[predicate=custom:indimension,team=Yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting players...","color":"white"}]
...
execute if entity @s[tag=!GameStarted] unless entity @s[scores={endtimer=1..}] run bossbar set rr:startgame players @a[predicate=custom:indimension]

##Blue Join Pad
execute unless entity @s[scores={largerTeam=-1..0},tag=!BlueFull,tag=EditedSettings] as @a[predicate=custom:indimension,tag=JoinBlue] run function game:joinwarn
execute if entity @s[tag=JustCleared] run tag @a[predicate=custom:indimension] remove JoinBlue
...
execute if entity @s[tag=!GameStarted,tag=chaseEnabled] as @a[predicate=custom:indimension,tag=JoinBlue] run tellraw @a[predicate=custom:indimension] ["",{"selector":"@s","color":"dark_red"},{"text":" joined the game!","color":"red"}]
execute if entity @s[tag=!GameStarted,tag=!chaseEnabled] run tellraw @a[predicate=custom:indimension,tag=JoinBlue] {"text":"Fall off the base to return to the Lobby.","color":"blue","italic":true}
execute if entity @s[tag=!GameStarted,tag=chaseEnabled] run tellraw @a[predicate=custom:indimension,tag=JoinBlue] {"text":"Fall off the base to return to the Lobby.","color":"red","italic":true}
execute if entity @s[tag=!GameStarted] run effect give @a[predicate=custom:indimension,tag=JoinBlue] resistance infinite 255 true
execute if entity @s[tag=GameStarted,tag=!customSpawns] run tp @a[predicate=custom:indimension,tag=JoinBlue] 12 64 -66 0 0
execute if entity @s[tag=GameStarted,tag=!chaseEnabled] as @a[predicate=custom:indimension,tag=JoinBlue] run tellraw @a[predicate=custom:indimension] ["",{"selector":"@s","color":"blue"},{"text":" joined the blue team! A late arrival, unfortunately.","color":"aqua"}]
execute if entity @s[tag=GameStarted,tag=chaseEnabled] as @a[predicate=custom:indimension,tag=JoinBlue] run tellraw @a[predicate=custom:indimension] ["",{"selector":"@s","color":"dark_red"},{"text":" joined the game! A late arrival, unfortunately.","color":"red"}]
execute if entity @s[tag=GameStarted,tag=!customSaberMsg,tag=!SMActive] run tellraw @a[predicate=custom:indimension,tag=JoinBlue] [{"text":"Drop your ","color":"aqua","italic":true},{"text":"Shooting Saber ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"aqua","italic":true}]
execute if entity @s[tag=GameStarted,tag=!customSaberMsg,tag=SMActive] run tellraw @a[predicate=custom:indimension,tag=JoinBlue] [{"text":"Use ","color":"aqua","italic":true},{"text":"/leave ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"aqua","italic":true}]
execute if entity @s[tag=GameStarted] run gamemode survival @a[predicate=custom:indimension,team=Blue,gamemode=adventure]
execute if entity @s[tag=GameStarted] run effect clear @a[predicate=custom:indimension,tag=JoinBlue] resistance
execute if entity @s[tag=!customSpawns] as @a[predicate=custom:indimension,tag=JoinBlue] at @s run playsound entity.enderman.teleport master @s ~ ~ ~
...
execute if entity @s[tag=JustCleared] run tag @a[predicate=custom:indimension] remove JoinYellow
...
execute if entity @s[tag=!noSabers] as @a[predicate=custom:indimension,tag=JoinYellow] run function game:saberyellow
execute if entity @s[tag=!GameStarted,tag=Hardcore] as @a[predicate=custom:indimension,tag=JoinYellow] run function modifiers:hardcoreset
execute if entity @s[tag=!GameStarted,tag=!customSpawns] run tp @a[predicate=custom:indimension,tag=JoinYellow] -95 202 96 180 0
execute if entity @s[tag=!GameStarted] as @a[predicate=custom:indimension,tag=JoinYellow] run tellraw @a[predicate=custom:indimension] ["",{"selector":"@s","color":"gold"},{"text":" joined the yellow team!","color":"yellow"}]
execute if entity @s[tag=!GameStarted] run tellraw @a[predicate=custom:indimension,tag=JoinYellow] {"text":"Fall off the base to return to the Lobby.","color":"gold","italic":true}
execute if entity @s[tag=!GameStarted] run effect give @a[predicate=custom:indimension,tag=JoinYellow] resistance infinite 255 true
execute if entity @s[tag=GameStarted,tag=!customSpawns] run tp @a[predicate=custom:indimension,tag=JoinYellow] 12 64 66 180 0
execute if entity @s[tag=GameStarted] as @a[predicate=custom:indimension,tag=JoinYellow] run tellraw @a[predicate=custom:indimension] ["",{"selector":"@s","color":"gold"},{"text":" joined the yellow team! A late arrival, unfortunately.","color":"yellow"}]
execute if entity @s[tag=GameStarted,tag=!customSaberMsg,tag=!SMActive] run tellraw @a[predicate=custom:indimension,tag=JoinYellow] [{"text":"Drop your ","color":"yellow","italic":true},{"text":"Shooting Saber ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
execute if entity @s[tag=GameStarted,tag=!customSaberMsg,tag=SMActive] run tellraw @a[predicate=custom:indimension,tag=JoinYellow] [{"text":"Use ","color":"yellow","italic":true},{"text":"/leave ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
execute if entity @s[tag=GameStarted] run gamemode survival @a[predicate=custom:indimension,team=Yellow,gamemode=adventure]
execute if entity @s[tag=GameStarted] run effect clear @a[predicate=custom:indimension,tag=JoinYellow] resistance
execute if entity @s[tag=!customSpawns] as @a[predicate=custom:indimension,tag=JoinYellow] at @s run playsound entity.enderman.teleport master @s ~ ~ ~
#Achievement keybind tutorial
...
execute if score $dust CmdData matches 1 as @e[predicate=custom:indimension,type=marker,tag=specjoinpad,tag=!CancelJoin] at @s run particle falling_dust minecraft:gray_concrete ~ ~1 ~ 0.5 1 0.5 0.1 5 force @a[predicate=custom:indimension,tag=!hideParticles,predicate=!custom:belowroof]
...
gamemode spectator @a[predicate=custom:indimension,tag=JoinSpec]
tag @a[predicate=custom:indimension] remove JoinSpec
...
tp @a[predicate=custom:indimension,team=Spectator,tag=leftBorder] 12 100 0.5 90 90
tellraw @a[predicate=custom:indimension,team=Spectator,tag=leftBorder] {"text":"Cannot leave world border!","color":"red"}
tag @a[predicate=custom:indimension] remove leftBorder

##Leave Pad
execute as @a[predicate=custom:indimension,gamemode=!spectator] at @s if entity @s[x=-84,y=186,z=45,dx=-111,dy=0,dz=110] unless entity @s[team=!Yellow,team=!Blue] in overworld run tag @s add LeaveTeams
...
execute if score $barriers CmdData matches 1 as @e[predicate=custom:indimension,type=marker,tag=CancelJoin] at @s run particle block_marker barrier ~ ~1 ~ 0 0 0 0 1 force @a[predicate=custom:indimension,tag=!hideParticles,team=Lobby,predicate=!custom:belowroof]