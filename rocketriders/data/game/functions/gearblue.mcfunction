...
replaceitem entity @a[tag=JoinBlue,scores={XP=101..400}] armor.feet leather_boots{display:{Name:'[{"text":"Bronze Boots","color":"#CD7F32","bold":true,"italic":false}]',color:13467442},HideFlags:39,Unbreakable:1,Enchantments:[{id:binding_curse,lvl:1}]}
