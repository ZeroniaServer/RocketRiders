...
replaceitem entity @s[team=Blue] armor.legs leather_leggings{display:{Name:'[{"text":"Blue Leggings","color":"blue","bold":true,"italic":false}]',color:3949738},HideFlags:39,Unbreakable:1,Enchantments:[{id:binding_curse,lvl:1}]}
execute if entity @e[tag=Selection,type=armor_stand,tag=noYZELO] run replaceitem entity @s[team=Blue] armor.feet leather_boots{display:{Name:'[{"text":"Blue Boots","color":"blue","bold":true,"italic":false}]',color:3949738},HideFlags:39,Unbreakable:1,Enchantments:[{id:binding_curse,lvl:1}]}
execute unless entity @e[tag=rr_duel,type=armor_stand] run replaceitem entity @s[team=Blue] armor.feet leather_boots{display:{Name:'[{"text":"Blue Boots","color":"blue","bold":true,"italic":false}]',color:3949738},HideFlags:39,Unbreakable:1,Enchantments:[{id:binding_curse,lvl:1}]}
