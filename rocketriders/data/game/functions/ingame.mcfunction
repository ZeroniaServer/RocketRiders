...
execute if entity @a[predicate=custom:indimension,tag=DelayActionbar] run scoreboard players add @a[predicate=custom:indimension,tag=DelayActionbar] actionbardelay 1
execute if entity @a[predicate=custom:indimension,scores={actionbardelay=50..}] run tag @a[predicate=custom:indimension,tag=DelayActionbar,scores={actionbardelay=50..}] remove DelayActionbar
execute if entity @a[predicate=custom:indimension,scores={actionbardelay=50..}] run scoreboard players reset @a[predicate=custom:indimension,scores={actionbardelay=50..}] actionbardelay

##Hotfix so Ground Bound achievement isn't broken
scoreboard players add @a[predicate=custom:indimension,team=Yellow] jumps 0
scoreboard players add @a[predicate=custom:indimension,team=Blue] jumps 0

##Hotfix so Pacifist achievement isn't broken
scoreboard players add @a[predicate=custom:indimension,team=Yellow] kills 0
scoreboard players add @a[predicate=custom:indimension,team=Blue] kills 0

##Prevent players from going above the arena
execute as @a[predicate=custom:indimension,gamemode=!spectator,tag=!JoinBlue,tag=!JoinYellow] unless entity @s[team=!Yellow,team=!Blue] at @s in overworld if entity @s[y=181,dy=100] run function game:punishbreach
...
execute if entity @s[tag=GameStarted,scores={gametime=1..2}] as @a[predicate=custom:indimension] unless entity @s[team=!Yellow,team=!Blue] if entity @s[predicate=custom:is_on_fire] at @s run function game:putoutfire
...
##Clear lobby arrows
execute if entity @s[tag=GameStarted,tag=!NoFall,scores={gametime=..4}] as @a[predicate=custom:indimension] unless entity @s[team=!Blue,team=!Yellow] run clear @s arrow{Lobby:1b}

##Remove kills
execute if entity @s[tag=GameStarted,tag=!NoFall,scores={gametime=..4}] as @a[predicate=custom:indimension] unless entity @s[team=!Blue,team=!Yellow] run scoreboard players reset @s kills
...
scoreboard players reset @a[predicate=custom:indimension] LaunchCrossbow