...
scoreboard players set @e[tag=RandomLossSplash,type=area_effect_cloud] RNGmax 41
...
execute as @e[tag=RandomLossSplash,scores={RNGscore=29},type=area_effect_cloud] run title @a[tag=Loser] subtitle ["",{"text":"Did you forget to open the client?","color":"red"}]
...
execute as @e[tag=RandomLossSplash,scores={RNGscore=38},type=area_effect_cloud] run title @a[tag=Loser] subtitle ["",{"text":"Congrats, you won at losing!","color":"red"}]
execute as @e[tag=RandomLossSplash,scores={RNGscore=39},type=area_effect_cloud] run title @a[tag=Loser] subtitle ["",{"text":"Task failed successfully.","color":"red"}]
execute as @e[tag=RandomLossSplash,scores={RNGscore=40},type=area_effect_cloud] run title @a[tag=Loser] subtitle ["",{"text":"You must have been playing against Chronos.","color":"red"}]
