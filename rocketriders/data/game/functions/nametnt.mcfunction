...
execute as @e[predicate=custom:indimension,type=tnt,tag=UtilKilled,distance=..6] run data modify entity @s CustomName set from storage rocketriders:utilkill CustomName
