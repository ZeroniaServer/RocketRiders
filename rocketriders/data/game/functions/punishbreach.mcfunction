...
execute unless entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=customSpawns] run tp @s[team=Blue] 12 64 -66 0 0
execute unless entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=customSpawns] run tp @s[team=Yellow] 12 64 66 -180 0
