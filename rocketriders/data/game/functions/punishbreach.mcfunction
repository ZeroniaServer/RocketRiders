...
execute if entity @s[team=Blue,nbt={SpawnX:12,SpawnY:64,SpawnZ:-66}] run tellraw @a ["",{"selector":"@s"},{"text":" tried to breach the Lobby"}]
execute if entity @s[team=Yellow,nbt={SpawnX:12,SpawnY:64,SpawnZ:66}] run tellraw @a ["",{"selector":"@s"},{"text":" tried to breach the Lobby"}]
