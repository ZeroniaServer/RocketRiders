...
scoreboard players set @e[tag=RandomSplash] RNGmax 60
...
execute as @e[tag=RandomSplash,scores={RNGscore=59}] run title @a subtitle ["",{"text":"An on-time arrival, fortunately.","color":"green"}]
