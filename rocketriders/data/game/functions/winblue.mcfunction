...
replaceitem entity @a[team=Blue] armor.chest elytra{HideFlags:4,Enchantments:[{id:binding_curse,lvl:1}],Unbreakable:1b,display:{Name:'[{"text":"Elytra","color":"blue","bold":"true"}]'}} 1
