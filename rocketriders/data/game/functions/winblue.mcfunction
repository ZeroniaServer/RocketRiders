...
give @a[team=Yellow,scores={HasFlag=0}] yellow_banner{display:{Name:'{"text":"Flag of Shameful Loss","color":"yellow","bold":"true","italic":"false"}'},BlockEntityTag:{Base:11,Patterns:[{Pattern:hh,Color:0},{Pattern:hhb,Color:0},{Pattern:ls,Color:4},{Pattern:bs,Color:4},{Pattern:ls,Color:0},{Pattern:bs,Color:0},{Pattern:rs,Color:0},{Pattern:tl,Color:0}]}} 1
