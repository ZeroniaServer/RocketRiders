...
execute as Evtema3 if entity @s[team=Blue] run replaceitem entity @s armor.head green_banner{display:{Name:'{"text":"Flag of Many Warcrimes","color":"red","bold":"true","italic":"false"}'},BlockEntityTag:{Base:2,Patterns:[{Pattern:mc,Color:14}]},Enchantments:[{id:binding_curse,lvl:1}],HideFlags:39} 1
