...
execute unless predicate game:phase/match/over if score @e[limit=1,x=0,type=armor_stand,tag=Selection] endtimer matches 1.. run function game:set_phase/match.over.tie_window
