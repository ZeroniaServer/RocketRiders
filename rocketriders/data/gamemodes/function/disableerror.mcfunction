...
execute unless predicate game:phase/match/closing if score $closing_sequence.time match_data matches 1.. run function game:set_phase/match.closing.tie_window
