...
execute store result score @s HasNova run clear @s crossbow[custom_data~{nova:1b}] 0
...
clear @s[scores={HasVortex=2..}] egg[custom_data~{icbm:0b}] 1
clear @s[scores={HasSplash=2..}] lingering_potion[custom_data~{splash:1b}] 1
clear @s[scores={HasICBM=2..}] egg[custom_data~{icbm:1b}] 1