execute if predicate items:effects/infinity_saber/on run title @s actionbar [{"text":"Infinity Saber timer reset to ","color":"light_purple"},{"text":"30 seconds.","color":"red"}]
