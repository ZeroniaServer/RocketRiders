...
#Hypersonic
execute if entity @s[tag=BlueHyper] run place template items:hypersonic_yellow ~2 ~ ~7 180
execute if entity @s[tag=YellowHyper] run place template items:hypersonic_blue ~2 ~ ~7 180
