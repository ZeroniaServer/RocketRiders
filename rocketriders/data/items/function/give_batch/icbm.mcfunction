...
execute if score $increase_item_limit.icbm match_components matches 1.. run scoreboard players operation $item_limit var += $increase_item_limit.icbm match_components
