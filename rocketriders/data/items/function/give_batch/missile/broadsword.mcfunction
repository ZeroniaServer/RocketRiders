...
execute if score $base_item_limit.missile/broadsword match_components matches 1.. run scoreboard players operation $item_limit var = $base_item_limit.missile/broadsword match_components
