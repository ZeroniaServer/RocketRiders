...
execute store result score $inventory_count var run clear @s *[custom_data~{id:"missile/hypersonic"}] 0
...
# limit reached
execute if score $give_item var matches 1 if score $final_batch_size var matches 0 if score $item_limit var matches 1 run title @s actionbar {color:"aqua",text:"Hypersonic already obtained"}
execute if score $give_item var matches 1 if score $final_batch_size var matches 0 if score $item_limit var matches 2.. run title @s actionbar {color:"aqua",text:"Maximum Hypersonics already obtained"}
