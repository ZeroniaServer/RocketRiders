...
execute if score $increase_item_limit.spell_book match_components matches 1.. run scoreboard players operation $item_limit var += $increase_item_limit.spell_book match_components
...
execute store result score $inventory_count var run clear @s *[custom_data~{id:"spell_book"}] 0
