...
execute if score $increase_item_limit.surprise_egg match_components matches 1.. run scoreboard players operation $item_limit var += $increase_item_limit.surprise_egg match_components
...
execute if entity @s[tag=BackSurprise] run scoreboard players add $inventory_count var 1
