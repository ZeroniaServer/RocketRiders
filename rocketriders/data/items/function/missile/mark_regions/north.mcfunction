execute summon marker run function items:missile/mark_regions/get_position
...
execute store result storage rocketriders:main mark_missile_regions.z int 4 run data get storage rocketriders:main mark_missile_regions.positive_corner[2] 0.25
function items:missile/mark_regions/store_towards_north with storage rocketriders:main mark_missile_regions
