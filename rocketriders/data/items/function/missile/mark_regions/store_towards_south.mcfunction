...
$execute if data storage rocketriders:arena_clear missile_regions[{x:$(x1),y:$(y1)}].min_z store result score $previous_z var run data get storage rocketriders:arena_clear missile_regions[{x:$(x1),y:$(y1)}].min_z
...
scoreboard players reset $previous_z var
$execute if data storage rocketriders:arena_clear missile_regions[{x:$(x1),y:$(y2)}].min_z store result score $previous_z var run data get storage rocketriders:arena_clear missile_regions[{x:$(x1),y:$(y2)}].min_z
...
scoreboard players reset $previous_z var
$execute if data storage rocketriders:arena_clear missile_regions[{x:$(x2),y:$(y1)}].min_z store result score $previous_z var run data get storage rocketriders:arena_clear missile_regions[{x:$(x2),y:$(y1)}].min_z
...
scoreboard players reset $previous_z var
$execute if data storage rocketriders:arena_clear missile_regions[{x:$(x2),y:$(y2)}].min_z store result score $previous_z var run data get storage rocketriders:arena_clear missile_regions[{x:$(x2),y:$(y2)}].min_z
