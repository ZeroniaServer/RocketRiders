...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] run scoreboard players operation @s HasBlade %=  constant
...
loot give @s[scores={HasBlade=0},tag=!fullHotbar] loot items:missile/normal/blade
