...
#Antidupe check
execute store result score @s HasNull run clear @s #custom:missile[custom_data~{spawn_egg:{type:"missile",missile:"chronullifier"}}] 0
...
loot give @s[scores={HasNull=0},tag=!fullHotbar] loot items:missile/normal/chronullifier
