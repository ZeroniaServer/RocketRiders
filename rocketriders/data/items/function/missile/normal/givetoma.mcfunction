...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] run scoreboard players operation @s HasToma %= 64 CmdData
...
loot give @s[scores={HasToma=0},tag=!fullHotbar] loot items:missile/normal/tomatwo
