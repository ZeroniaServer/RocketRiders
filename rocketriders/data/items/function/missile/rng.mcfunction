...
execute unless predicate game:item_pool_meta/all_heavy_missiles_disabled if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!givenAllHeavy] run summon marker 0 0 0 {Tags:["rngHeavy","rng2"],CustomName:"rngHeavy (Heavy Missiles)"}
execute unless predicate game:item_pool_meta/all_normal_missiles_disabled if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!givenAllNormal] run summon marker 0 0 0 {Tags:["rngNormal","rng2"],CustomName:"rngNormal (Normal Missiles)"}
execute unless predicate game:item_pool_meta/all_lightning_missiles_disabled if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!givenAllLightning] run summon marker 0 0 0 {Tags:["rngLightning","rng2"],CustomName:"rngLightning (Lightning Missiles)"}
