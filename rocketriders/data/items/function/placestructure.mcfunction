...
execute if predicate game:gamemode_components/neutral_utility_colors at @s positioned ~ ~2 ~ run function items:whitemissile
execute unless predicate game:gamemode_components/neutral_utility_colors if predicate game:gamemode_components/red_for_blue at @s positioned ~ ~2 ~ run function items:redmissile
