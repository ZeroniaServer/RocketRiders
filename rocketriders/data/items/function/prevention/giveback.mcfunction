...
execute if score $play_time match_data matches 200.. unless predicate game:match_components/disable_antigrief_system run title @a[limit=1,x=0,tag=antigriefMSG] actionbar {color:"red",text:"You cannot spawn missiles inside your own base"}
execute if score $play_time match_data matches ..199 unless predicate game:match_components/disable_antigrief_system run title @a[limit=1,x=0,tag=antigriefMSG] actionbar {color:"red",text:"You cannot collide missiles for the first 10 seconds of a match"}
