...
#Hypersonic
execute at @s[tag=BlueHyper,tag=!UnableMissile] positioned ~-1 ~-6 ~5 store result score @s Unable run clone ~ ~ ~ ~2 ~2 ~9 ~ ~ ~ filtered light[level=0] force
execute at @s[tag=YellowHyper,tag=!UnableMissile] positioned ~-1 ~-6 ~-14 store result score @s Unable run clone ~ ~ ~ ~2 ~2 ~9 ~ ~ ~ filtered light[level=0] force
