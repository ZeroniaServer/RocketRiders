...
execute if entity @e[x=0,type=marker,tag=surpriseYellowHeavy,tag=rngSelected] run function items:rng/surprise_yellow/rngheavy
execute if entity @e[x=0,type=marker,tag=surpriseYellowNormal,tag=rngSelected] run function items:rng/surprise_yellow/rngnormal
execute if entity @e[x=0,type=marker,tag=surpriseYellowLightning,tag=rngSelected] run function items:rng/surprise_yellow/rnglightning
execute if entity @e[x=0,type=marker,tag=surpriseYellowSpecial,tag=rngSelected] run function items:rng/surprise_yellow/rngspecial
