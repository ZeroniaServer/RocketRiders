...
execute if predicate game:item_pool/missile/hurricane run summon marker ~ ~ ~ {Tags:["surpriseYellowHur","surpriseYellow2"]}
execute if predicate game:item_pool/missile/thunderbolt run summon marker ~ ~ ~ {Tags:["surpriseYellowBolt","surpriseYellow2"]}
