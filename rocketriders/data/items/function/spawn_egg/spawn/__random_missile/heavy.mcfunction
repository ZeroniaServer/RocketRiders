...
loot replace block 0 184 -16 container.0 loot {pools:[{rolls:1,entries:[\
    {type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_components",components:{"minecraft:custom_data":{missile:"auxiliary"}}},condition:"game:item_pool/missile/auxiliary"},\
    {type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_components",components:{"minecraft:custom_data":{missile:"juggerbuster"}}},condition:"game:item_pool/missile/juggerbuster"},\
    {type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_components",components:{"minecraft:custom_data":{missile:"rifter"}}},condition:"game:item_pool/missile/rifter"},\
    {type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_components",components:{"minecraft:custom_data":{missile:"warhead"}}},condition:"game:item_pool/missile/warhead"},\
]}]}
