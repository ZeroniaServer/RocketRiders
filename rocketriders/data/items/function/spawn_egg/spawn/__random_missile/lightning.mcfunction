...
loot replace block 0 184 -16 container.0 loot {pools:[{rolls:1,entries:[\
    {type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_components",components:{"minecraft:custom_data":{missile:"hurricane"}}},condition:"game:item_pool/missile/hurricane"},\
    {type:"minecraft:item",name:"minecraft:stone",modifier:{type:"minecraft:set_components",components:{"minecraft:custom_data":{missile:"thunderbolt"}}},condition:"game:item_pool/missile/thunderbolt"},\
]}]}
