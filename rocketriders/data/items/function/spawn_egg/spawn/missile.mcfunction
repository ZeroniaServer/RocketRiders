...
execute if score $play_time match_data matches 200.. if score $missile_origin_team var matches 0 if score $intersecting_blue var matches 1 unless predicate game:match_components/allow_team_griefing store success score $antigrief_flagged var run function items:missile/check_antigrief_blue with storage rocketriders:main missile.properties
execute if score $play_time match_data matches 200.. if score $missile_origin_team var matches 1 if score $intersecting_yellow var matches 1 unless predicate game:match_components/allow_team_griefing store success score $antigrief_flagged var run function items:missile/check_antigrief_yellow with storage rocketriders:main missile.properties
...
execute if score $play_time match_data matches ..199 unless predicate game:match_components/allow_team_griefing if score $missile_origin_team var matches 0 if predicate custom:in_blue_half run scoreboard players set $strong_antigrief var 1
execute if score $play_time match_data matches ..199 unless predicate game:match_components/allow_team_griefing if score $missile_origin_team var matches 1 if predicate custom:in_yellow_half run scoreboard players set $strong_antigrief var 1
