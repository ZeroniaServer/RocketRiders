...
execute at @s[tag=BlueFireball,tag=Cluster] run summon fireball ~ ~1.2 ~ {Tags:["NormalFireball","NoMotion","FireballBlue","Cluster"],ExplosionPower:1,Motion:[0.0d,0.0d,0.0d],Item:{id:"minecraft:blaze_powder"}}
...
execute at @s[tag=YellowFireball,tag=Cluster] run summon fireball ~ ~1.2 ~ {Tags:["NormalFireball","NoMotion","FireballYellow","Cluster"],ExplosionPower:1,Motion:[0.0d,0.0d,0.0d],Item:{id:"minecraft:blaze_powder"}}
