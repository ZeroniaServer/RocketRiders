...
##Flipping Capability
execute if entity @s[tag=yellowmissile] if entity @a[x=0,predicate=custom:team/yellow,tag=FlipMissile,tag=placer,limit=1] run tag @s add missileflip
execute if entity @s[tag=bluemissile] if entity @a[x=0,predicate=custom:team/blue,tag=FlipMissile,tag=placer,limit=1] run tag @s add missileflip
...
execute if score $match_play_time global matches 200.. unless predicate game:gamemode_components/disable_antigrief_system if entity @s[tag=bluemissile,tag=!missileflip,x=-15,dx=54,y=33,dy=40,z=-86,dz=40] run function items:prevention/antigrief
execute if score $match_play_time global matches 200.. unless predicate game:gamemode_components/disable_antigrief_system if entity @s[tag=yellowmissile,tag=!missileflip,x=-15,dx=54,y=33,dy=40,z=46,dz=40] run function items:prevention/antigrief
execute if score $match_play_time global matches 200.. unless predicate game:gamemode_components/disable_antigrief_system if entity @s[tag=yellowmissile,tag=missileflip,x=-15,dx=54,y=33,dy=40,z=-86,dz=40] run function items:flip/antigrief
execute if score $match_play_time global matches 200.. unless predicate game:gamemode_components/disable_antigrief_system if entity @s[tag=bluemissile,tag=missileflip,x=-15,dx=54,y=33,dy=40,z=46,dz=40] run function items:flip/antigrief

#Stronger antigrief - starts before 10 seconds
execute if score $match_play_time global matches ..199 unless predicate game:gamemode_components/disable_antigrief_system if entity @s[tag=bluemissile,tag=!missileflip,x=-15,dx=54,y=33,dy=40,z=-86,dz=40] run function items:prevention/antigrief_10sec
execute if score $match_play_time global matches ..199 unless predicate game:gamemode_components/disable_antigrief_system if entity @s[tag=yellowmissile,tag=!missileflip,x=-15,dx=54,y=33,dy=40,z=46,dz=40] run function items:prevention/antigrief_10sec
execute if score $match_play_time global matches ..199 unless predicate game:gamemode_components/disable_antigrief_system if entity @s[tag=yellowmissile,tag=missileflip,x=-15,dx=54,y=33,dy=40,z=-86,dz=40] run function items:prevention/antigrief_10sec
execute if score $match_play_time global matches ..199 unless predicate game:gamemode_components/disable_antigrief_system if entity @s[tag=bluemissile,tag=missileflip,x=-15,dx=54,y=33,dy=40,z=46,dz=40] run function items:prevention/antigrief_10sec
