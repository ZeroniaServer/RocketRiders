## Repositioning
execute at @s[tag=BlueObshield] unless block ~ ~ ~ #custom:nonsolid if block ~ ~1 ~ #custom:nonsolid run tp @s ~ ~1 ~
execute at @s[tag=BlueObshield] unless block ~ ~ ~ #custom:nonsolid if block ~ ~-1 ~ #custom:nonsolid run tp @s ~ ~-1 ~
execute at @s[tag=BlueObshield] if block ~ ~ ~ #custom:nonsolid unless block ~ ~1 ~ #custom:nonsolid run tp @s ~ ~-1 ~
execute at @s[tag=YellowObshield] unless block ~ ~ ~ #custom:nonsolid if block ~ ~1 ~ #custom:nonsolid run tp @s ~ ~1 ~
execute at @s[tag=YellowObshield] unless block ~ ~ ~ #custom:nonsolid if block ~ ~-1 ~ #custom:nonsolid run tp @s ~ ~-1 ~
execute at @s[tag=YellowObshield] if block ~ ~ ~ #custom:nonsolid unless block ~ ~1 ~ #custom:nonsolid run tp @s ~ ~-1 ~
...
execute at @s[tag=BlueObshield,tag=!UnableSpawn] if predicate custom:near_or_above_roof run tag @s add UnableSpawn
execute at @s[tag=YellowObshield,tag=!UnableSpawn] if predicate custom:near_or_above_roof run tag @s add roof
execute at @s[tag=YellowObshield,tag=!UnableSpawn] if predicate custom:near_or_above_roof run tag @s add UnableSpawn
...
execute at @s[tag=BlueObshield] run summon dragon_fireball ~ ~1.2 ~ {Tags:["blueobfireball","obfireball"],Motion:[0.0d,0.0d,0.0d],HasVisualFire:true,Passengers:[{id:"minecraft:marker",Tags:["blueobtracker"]}],acceleration_power:0}
...
execute at @s[tag=YellowObshield] run summon dragon_fireball ~ ~1.2 ~ {Tags:["yellowobfireball","obfireball"],Motion:[0.0d,0.0d,0.0d],HasVisualFire:true,Passengers:[{id:"minecraft:marker",Tags:["yellowobtracker"]}],acceleration_power:0}
