...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=rngHeavy,tag=!heavyOff] run summon marker ~ ~ ~ {Tags:["surpriseBlueHeavy","surpriseBlue1"]}
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=rngNormal,tag=!normalOff] run summon marker ~ ~ ~ {Tags:["surpriseBlueNormal","surpriseBlue1"]}
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=rngLightning,tag=!lightningOff] run summon marker ~ ~ ~ {Tags:["surpriseBlueLightning","surpriseBlue1"]}
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=Chaos] run summon marker ~ ~ ~ {Tags:["surpriseBlueSpecial","surpriseBlue1"]}
