...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=rngHeavy,tag=!heavyOff] run summon marker ~ ~ ~ {Tags:["surpriseBlueHeavy","surpriseBlue1"]}
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=rngNormal,tag=!normalOff] run summon marker ~ ~ ~ {Tags:["surpriseBlueNormal","surpriseBlue1"]}
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=rngLightning,tag=!lightningOff] run summon marker ~ ~ ~ {Tags:["surpriseBlueLightning","surpriseBlue1"]}
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=Chaos] run summon marker ~ ~ ~ {Tags:["surpriseBlueSpecial","surpriseBlue1"]}
