...
execute if predicate game:item_pool/missile/hurricane run summon marker ~ ~ ~ {Tags:["surpriseBlueHur","surpriseBlue2"]}
execute if predicate game:item_pool/missile/thunderbolt run summon marker ~ ~ ~ {Tags:["surpriseBlueBolt","surpriseBlue2"]}
