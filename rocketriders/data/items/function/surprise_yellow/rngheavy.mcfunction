...
execute if predicate game:item_pool/missile/auxiliary run summon marker ~ ~ ~ {Tags:["surpriseYellowAux","surpriseYellow2"]}
execute if predicate game:item_pool/missile/rifter run summon marker ~ ~ ~ {Tags:["surpriseYellowRift","surpriseYellow2"]}
execute if predicate game:item_pool/missile/juggerbuster run summon marker ~ ~ ~ {Tags:["surpriseYellowJbuster","surpriseYellow2"]}
execute if predicate game:item_pool/missile/warhead run summon marker ~ ~ ~ {Tags:["surpriseYellowWar","surpriseYellow2"]}
