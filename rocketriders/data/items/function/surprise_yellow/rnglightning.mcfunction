...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=rngHur] run summon marker ~ ~ ~ {Tags:["surpriseYellowHur","surpriseYellow2"]}
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=rngThun] run summon marker ~ ~ ~ {Tags:["surpriseYellowBolt","surpriseYellow2"]}
