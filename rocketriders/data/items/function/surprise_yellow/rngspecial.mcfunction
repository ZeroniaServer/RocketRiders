...
execute if entity @e[x=0,type=marker,tag=rngSelected,tag=surpriseYellowBroad] run summon marker ~ ~ ~ {Tags:["missile","yellowmissile","YellowBroad","surp"]}
execute if entity @e[x=0,type=marker,tag=rngSelected,tag=surpriseYellowBull] run summon marker ~ ~ ~ {Tags:["missile","yellowmissile","YellowBull","surp"]}
execute if entity @e[x=0,type=marker,tag=rngSelected,tag=surpriseYellowDuplex] run summon marker ~ ~ ~ {Tags:["missile","yellowmissile","YellowDuplex","surp"]}
execute if entity @e[x=0,type=marker,tag=rngSelected,tag=surpriseYellowHyper] run summon marker ~ ~ ~ {Tags:["missile","yellowmissile","YellowHyper","surp"]}
