...
#Special
execute unless predicate game:modifiers/special_treatment/__forced_off run tag @s remove givenBroad
execute unless predicate game:modifiers/special_treatment/__forced_off run tag @s remove givenBull
execute unless predicate game:modifiers/special_treatment/__forced_off run tag @s remove givenDuplex
execute unless predicate game:modifiers/special_treatment/__forced_off run tag @s remove givenHyper
execute unless predicate game:modifiers/special_treatment/__forced_off run tag @s remove givenAllSpecial
