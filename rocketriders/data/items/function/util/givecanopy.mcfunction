...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!canopyStack] run give @s[team=Yellow,scores={HasPlat=0},tag=!fullHotbar] ender_pearl{CustomModelData:2,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"gold","bold":true}]',Lore:['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don\'t play with fire on it!","color":"gray"}']}} 1
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!canopyStack] run give @s[team=Blue,scores={HasPlat=0},tag=!fullHotbar] ender_pearl{CustomModelData:1,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"blue","bold":true}]',Lore:['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don\'t play with fire on it!","color":"gray"}']}} 1
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run give @s[team=Yellow,scores={HasPlat=..1},tag=!fullHotbar] ender_pearl{CustomModelData:2,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"gold","bold":true}]',Lore:['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don\'t play with fire on it!","color":"gray"}']}} 1
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run give @s[team=Blue,scores={HasPlat=..1},tag=!fullHotbar] ender_pearl{CustomModelData:1,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"blue","bold":true}]',Lore:['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don\'t play with fire on it!","color":"gray"}']}} 1
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run give @s[team=Yellow,scores={HasPlat=..2},tag=!fullHotbar] ender_pearl{CustomModelData:2,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"gold","bold":true}]',Lore:['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don\'t play with fire on it!","color":"gray"}']}} 1
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run give @s[team=Blue,scores={HasPlat=..2},tag=!fullHotbar] ender_pearl{CustomModelData:1,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"blue","bold":true}]',Lore:['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don\'t play with fire on it!","color":"gray"}']}} 1
