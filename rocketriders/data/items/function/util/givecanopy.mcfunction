...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run give @s[team=Yellow,scores={HasPlat=..1},tag=!fullHotbar] ender_pearl[custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"gold","bold":true}]',lore=['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don't play with fire on it!","color":"gray"}'],custom_model_data=2] 1
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run give @s[team=Blue,scores={HasPlat=..1},tag=!fullHotbar] ender_pearl[custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"blue","bold":true}]',lore=['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don't play with fire on it!","color":"gray"}'],custom_model_data=1] 1
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run give @s[team=Yellow,scores={HasPlat=..2},tag=!fullHotbar] ender_pearl[custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"gold","bold":true}]',lore=['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don't play with fire on it!","color":"gray"}'],custom_model_data=2] 1
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run give @s[team=Blue,scores={HasPlat=..2},tag=!fullHotbar] ender_pearl[custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"blue","bold":true}]',lore=['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don't play with fire on it!","color":"gray"}'],custom_model_data=1] 1
