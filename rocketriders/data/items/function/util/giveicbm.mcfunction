...
give @s[team=Yellow,scores={HasICBM=0},tag=!fullHotbar] egg[max_stack_size=64,enchantment_glint_override=true,custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"ICBM","color":"gold","bold":true}]',lore=['{"text":"Short for \\"intercontinental ballistic missile\\".","color":"gray"}','{"text":"Blows up upon impact or after short flight.","color":"gray"}'],custom_data={icbm:1b}] 1
give @s[team=Blue,scores={HasICBM=0},tag=!fullHotbar] egg[max_stack_size=64,enchantment_glint_override=true,custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"ICBM","color":"blue","bold":true}]',lore=['{"text":"Short for \\"intercontinental ballistic missile\\".","color":"gray"}','{"text":"Blows up upon impact or after short flight.","color":"gray"}'],custom_data={icbm:1b}] 1
