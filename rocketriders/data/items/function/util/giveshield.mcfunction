...
give @s[team=Yellow,scores={HasShield=0},tag=!fullHotbar] snowball[custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Shield","color":"gold","bold":true}]',lore=['{"text":"Throw to spawn a glass Shield.","color":"gray"}','{"text":"This is able to stop most missiles.","color":"gray"}'],custom_model_data=2] 1
give @s[team=Blue,scores={HasShield=0},tag=!fullHotbar] snowball[custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Shield","color":"blue","bold":true}]',lore=['{"text":"Throw to spawn a glass Shield.","color":"gray"}','{"text":"This is able to stop most missiles.","color":"gray"}'],custom_model_data=1] 1
