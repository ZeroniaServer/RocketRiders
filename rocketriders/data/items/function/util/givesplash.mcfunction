...
give @s[team=Yellow,scores={HasSplash=0},tag=!fullHotbar] lingering_potion[custom_data={splash:1b},custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Splash","color":"gold","bold":true}]',lore=['{"text":"Spawns a brief water source where it","color":"gray"}','{"text":"lands. Used to restart missiles, reduce","color":"gray"}','{"text":"explosions, or break your fall.","color":"gray"}'],potion_contents={potion:"minecraft:water"},hide_additional_tooltip={}] 1
give @s[team=Blue,scores={HasSplash=0},tag=!fullHotbar] lingering_potion[custom_data={splash:1b},custom_name='[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Splash","color":"blue","bold":true}]',lore=['{"text":"Spawns a brief water source where it","color":"gray"}','{"text":"lands. Used to restart missiles, reduce","color":"gray"}','{"text":"explosions, or break your fall.","color":"gray"}'],potion_contents={potion:"minecraft:water"},hide_additional_tooltip={}] 1
