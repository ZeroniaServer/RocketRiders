...
execute unless entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=canopyStack] run clear @s[scores={HasPlat=2..}] ender_pearl 1
execute unless entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=canopyStack] run scoreboard players remove @s[scores={HasPlat=2..}] HasPlat 1
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run clear @s[scores={HasPlat=3..}] ender_pearl 1
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run scoreboard players remove @s[scores={HasPlat=3..}] HasPlat 1
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run clear @s[scores={HasPlat=4..}] ender_pearl 1
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run scoreboard players remove @s[scores={HasPlat=4..}] HasPlat 1
