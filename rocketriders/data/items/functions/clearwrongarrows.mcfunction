...
clear @s[scores={wrongWitherArrow=1..}] tipped_arrow{CustomPotionEffects:[{Id:20b,Amplifier:0b,Duration:100,ShowParticles:1b}],CustomPotionColor:8421504}
function items:replacewrongarrows
