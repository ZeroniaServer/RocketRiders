...
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] if entity @s[nbt={Item:{id:"minecraft:ender_pearl"}}] as @a[predicate=custom:matches_uuid] store result score @s HasPlat run clear @s ender_pearl 0
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] if entity @s[nbt={Item:{id:"minecraft:ender_pearl"}}] run scoreboard players operation $toomany CmdData = @s CmdData
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] if entity @s[nbt={Item:{id:"minecraft:ender_pearl"}}] as @a[predicate=custom:matches_uuid] run scoreboard players operation $toomany CmdData += @s HasPlat
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] if entity @s[nbt={Item:{id:"minecraft:ender_pearl"}}] if score $toomany CmdData matches 2.. run tag @a[predicate=custom:matches_uuid] add hadTooMany
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] if entity @s[nbt={Item:{id:"minecraft:ender_pearl"}}] if score $toomany CmdData matches 3.. run tag @a[predicate=custom:matches_uuid] add hadTooMany
...
execute if entity @s[nbt={Item:{id:"minecraft:squid_spawn_egg"}}] run scoreboard players operation $toomany CmdData = @s CmdData
execute if entity @s[nbt={Item:{id:"minecraft:cod_spawn_egg"}}] run scoreboard players operation $toomany CmdData = @s CmdData
tellraw @a [{"text":"Player has: "},{"score":{"name":"@p[predicate=custom:matches_uuid]","objective":"HasSurprise"}}]
...
execute unless entity @s[nbt={Item:{id:"minecraft:arrow"}}] unless entity @s[nbt={Item:{id:"minecraft:tipped_arrow"}}] unless entity @s[nbt={Item:{id:"minecraft:cod_spawn_egg"}}] unless entity @s[nbt={Item:{id:"minecraft:squid_spawn_egg"}}] run scoreboard players remove @s CmdData 1
...
tellraw @a [{"selector":"@s"},{"text":" "},{"score":{"name":"@s","objective":"CmdData"}},{"text":" "},{"score":{"name":"$toomany","objective":"CmdData"}}]
