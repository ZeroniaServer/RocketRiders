...
#Hypersonic
execute if entity @s[tag=BlueHyper] run place template hypersonic_yellow ~2 ~ ~8 180
execute if entity @s[tag=YellowHyper] run place template hypersonic_blue ~2 ~ ~8 180
