...
scoreboard players operation $minifyyellow yMissileCount = @e[tag=Selection,type=armor_stand,limit=1] yMissileCount
...
execute as @s[tag=minify] run data remove storage rocketriders:ymissilepos x[0]
execute as @s[tag=minify] run data remove storage rocketriders:ymissilepos y[0]
execute as @s[tag=minify] run data remove storage rocketriders:ymissilepos z[0]
execute as @s[tag=minify] run scoreboard players remove @e[tag=Selection,type=armor_stand,limit=1] yMissileCount 1
tag @s remove minify
