...
scoreboard players operation $minifyyellow yMissileCount = @e[type=armor_stand,tag=Selection,limit=1] yMissileCount
...
execute as @s[tag=minify] run scoreboard players remove @e[type=armor_stand,tag=Selection,limit=1] yMissileCount 1
tag @s remove minify
