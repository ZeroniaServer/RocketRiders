...
give @s[team=Yellow,scores={HasJug=0},tag=!fullHotbar] zombie_horse_spawn_egg{CustomModelData:2,display:{Name:'[{"text":"[Heavy] ","color":"dark_red","bold":true},{"text":"Juggerbuster","color":"gold","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"32","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"1.7m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"Chronos22","color":"red"}]','{"text":" ","color":"gray"}','{"text":"This is a Juggernaut-ShieldBuster hybrid.","color":"gray"}','{"text":"This missile has the power of a Juggernaut","color":"gray"}','{"text":"plus the ability to bust through a shield.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","yellowmissile","YellowJug"]}} 1
give @s[team=Blue,scores={HasJug=0},tag=!fullHotbar] zombie_horse_spawn_egg{CustomModelData:1,display:{Name:'[{"text":"[Heavy] ","color":"dark_red","bold":true},{"text":"Juggerbuster","color":"blue","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"32","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"1.7m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"Chronos22","color":"red"}]','{"text":" ","color":"gray"}','{"text":"This is a Juggernaut-ShieldBuster hybrid.","color":"gray"}','{"text":"This missile has the power of a Juggernaut","color":"gray"}','{"text":"plus the ability to bust through a shield.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","bluemissile","BlueJug"]}} 1
