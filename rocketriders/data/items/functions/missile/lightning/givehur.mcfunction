...
give @s[team=Yellow,scores={HasHur=0},tag=!fullHotbar] drowned_spawn_egg{display:{Name:'[{"text":"[Lightning] ","color":"yellow","bold":"true"},{"text":"Hurricane","color":"gold","bold":"true"}]',Lore:['{"text":"Amount of TNT: ","color":"gray"}','{"text":"18","color":"red"}','{"text":" "}','{"text":"Made by:","color":"gray"}','{"text":"HolyToiletPaper","color":"gray"}','{"text":" ","color":"gray"}','{"text":"The Hurricane is a lightning-speed missile.","color":"gray"}','{"text":"Fittingly, it flies faster than most missiles.","color":"gray"}','{"text":"It might be harder to get on this one.","color":"gray"}']},EntityTag:{id:"minecraft:area_effect_cloud",Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:['missile','yellowmissile','YellowHur']}} 1
