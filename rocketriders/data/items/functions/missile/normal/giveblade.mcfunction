...
execute as @s[scores={HasBlade=1..},tag=!fullHotbar,tag=!BackBlade] at @s run playsound minecraft:block.note_block.bass player @s ~ ~ ~ 1 1
title @s[scores={HasBlade=0},tag=!fullHotbar,tag=!BackBlade] actionbar {"text":"Blade obtained.","color":"aqua"}
give @s[team=Yellow,scores={HasBlade=0},tag=!fullHotbar] husk_spawn_egg{display:{Name:'[{"text":"[Normal] ","color":"green","bold":"true"},{"text":"Blade","color":"gold","bold":"true"}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"15","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"1.7m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"HolyToiletPaper","color":"red"}]','{"text":" ","color":"gray"}','{"text":"The Blade is a sword-shaped missile.","color":"gray"}','{"text":"Breaking the slime block on the side","color":"gray"}','{"text":"will drop down 3 bomber TNT below it.","color":"gray"}']},EntityTag:{id:"minecraft:area_effect_cloud",Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:['missile','yellowmissile','YellowBlade']}} 1
