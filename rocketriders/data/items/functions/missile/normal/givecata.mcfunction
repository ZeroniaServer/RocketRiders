...
#Game tracking
execute unless entity @s[tag=BackCata] run tag @e[type=armor_stand,tag=Selection,tag=tetrisTime] add givenCata
execute unless entity @s[tag=BackCata] run tag @e[type=armor_stand,tag=Bot] add HasCata