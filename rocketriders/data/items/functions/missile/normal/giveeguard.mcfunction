...
give @s[team=Yellow,scores={HasGuard=0},tag=!fullHotbar] elder_guardian_spawn_egg{CustomModelData:2,display:{Name:'[{"text":"[Normal] ","color":"green","bold":true},{"text":"Elder Guardian","color":"gold","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"9","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"1.7m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"Rubix_One","color":"red"}]','{"text":" ","color":"gray"}','{"text":"An upgrade from the original Guardian","color":"gray"}','{"text":"in Missile Wars, the Elder Guardian is","color":"gray"}','{"text":"bigger and covers the TNT better.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","yellowmissile","YellowGuard"]}} 1
give @s[team=Blue,scores={HasGuard=0},tag=!fullHotbar] elder_guardian_spawn_egg{CustomModelData:1,display:{Name:'[{"text":"[Normal] ","color":"green","bold":true},{"text":"Elder Guardian","color":"blue","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"9","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"1.7m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"Rubix_One","color":"red"}]','{"text":" ","color":"gray"}','{"text":"An upgrade from the original Guardian","color":"gray"}','{"text":"in Missile Wars, the Elder Guardian is","color":"gray"}','{"text":"bigger and covers the TNT better.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","bluemissile","BlueGuard"]}} 1
