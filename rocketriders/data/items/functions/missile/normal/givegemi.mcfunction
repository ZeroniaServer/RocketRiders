...
#Game tracking
execute unless entity @s[tag=BackGemi] run tag @e[type=armor_stand,tag=Selection,tag=tetrisTime] add givenGemi
execute unless entity @s[tag=BackGemi] run tag @e[type=armor_stand,tag=Bot] add HasGemi