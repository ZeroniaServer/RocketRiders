...
give @s[team=Yellow,scores={HasLift=0},tag=!fullHotbar] dolphin_spawn_egg{display:{Name:'[{"text":"[Normal] ","color":"green","bold":"true"},{"text":"Lifter","color":"gold","bold":"true"}]',Lore:['{"text":"Amount of TNT: ","color":"gray"}','{"text":"8","color":"red"}','{"text":" "}','{"text":"Made by:","color":"gray"}','{"text":"Chronos22","color":"gray"}','{"text":" ","color":"gray"}','{"text":"The Lifter lifts its warhead","color":"gray"}','{"text":"up by 3 blocks when it hits","color":"gray"}','{"text":"an obstacle.","color":"gray"}']},EntityTag:{id:"minecraft:area_effect_cloud",Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:['missile','yellowmissile','YellowLift']}} 1
...
#Game tracking
tag @e[tag=Selection,type=armor_stand] add givenLift
tag @e[tag=Bot,type=armor_stand] add BotHasLift