...
give @s[team=Yellow,scores={HasLift=0},tag=!fullHotbar] dolphin_spawn_egg{CustomModelData:2,display:{Name:'[{"text":"[Normal] ","color":"green","bold":true},{"text":"Lifter","color":"gold","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"8","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"2.0m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"Chronos22","color":"red"}]','{"text":" ","color":"gray"}','{"text":"The Lifter lifts its warhead","color":"gray"}','{"text":"up by 3 blocks when it hits","color":"gray"}','{"text":"an obstacle.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","yellowmissile","YellowLift"]}} 1
give @s[team=Blue,scores={HasLift=0},tag=!fullHotbar] dolphin_spawn_egg{CustomModelData:1,display:{Name:'[{"text":"[Normal] ","color":"green","bold":true},{"text":"Lifter","color":"blue","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"8","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"2.0m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"Chronos22","color":"red"}]','{"text":" ","color":"gray"}','{"text":"The Lifter lifts its warhead","color":"gray"}','{"text":"up by 3 blocks when it hits","color":"gray"}','{"text":"an obstacle.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","bluemissile","BlueLift"]}} 1
