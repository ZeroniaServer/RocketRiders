...
give @s[team=Yellow,scores={HasNull=0},tag=!fullHotbar] phantom_spawn_egg{CustomModelData:2,display:{Name:'[{"text":"[Normal] ","color":"green","bold":true},{"text":"Chronullifier","color":"gold","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"14","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"2.2m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"Chronos22 & YZEROgame","color":"red"}]','{"text":" ","color":"gray"}','{"text":"The Chronullifier uses a unique","color":"gray"}','{"text":"observer engine with the same","color":"gray"}','{"text":"speed as non-observer engines.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","yellowmissile","YellowNull"]}} 1
give @s[team=Blue,scores={HasNull=0},tag=!fullHotbar] phantom_spawn_egg{CustomModelData:1,display:{Name:'[{"text":"[Normal] ","color":"green","bold":true},{"text":"Chronullifier","color":"blue","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"14","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"2.2m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"Chronos22 & YZEROgame","color":"red"}]','{"text":" ","color":"gray"}','{"text":"The Chronullifier uses a unique","color":"gray"}','{"text":"observer engine with the same","color":"gray"}','{"text":"speed as non-observer engines.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","bluemissile","BlueNull"]}} 1
