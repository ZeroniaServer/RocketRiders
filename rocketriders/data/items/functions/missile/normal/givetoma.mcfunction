...
give @s[team=Yellow,scores={HasToma=0},tag=!fullHotbar] creeper_spawn_egg{CustomModelData:2,display:{Name:'[{"text":"[Normal] ","color":"green","bold":true},{"text":"TomaTwo","color":"gold","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"16","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"2.0m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"YZEROgame & Chronos22","color":"red"}]','{"text":" ","color":"gray"}','{"text":"The TomaTwo is a missile inspired by","color":"gray"}','{"text":"the Tomahawk from Missile Wars. This","color":"gray"}','{"text":"missile uses an observer engine.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","yellowmissile","YellowToma"]}} 1
give @s[team=Blue,scores={HasToma=0},tag=!fullHotbar] creeper_spawn_egg{CustomModelData:1,display:{Name:'[{"text":"[Normal] ","color":"green","bold":true},{"text":"TomaTwo","color":"blue","bold":true}]',Lore:['[{"text":"Amount of TNT: ","color":"gray"},{"text":"16","color":"red"}]','[{"text":"Speed: ","color":"gray"},{"text":"2.0m/s","color":"red"}]','[{"text":"Made by: ","color":"gray"},{"text":"YZEROgame & Chronos22","color":"red"}]','{"text":" ","color":"gray"}','{"text":"The TomaTwo is a missile inspired by","color":"gray"}','{"text":"the Tomahawk from Missile Wars. This","color":"gray"}','{"text":"missile uses an observer engine.","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["missile","bluemissile","BlueToma"]}} 1
