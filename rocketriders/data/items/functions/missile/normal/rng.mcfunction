...
execute as @e[type=marker,tag=rngSelected,tag=rngCata] as @a unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/givecata
execute as @e[type=marker,tag=rngSelected,tag=rngEguard] as @a unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/giveeguard
execute as @e[type=marker,tag=rngSelected,tag=rngNull] as @a unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/givenull
execute as @e[type=marker,tag=rngSelected,tag=rngSlash] as @a unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/giveslash
execute as @e[type=marker,tag=rngSelected,tag=rngToma] as @a unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/givetoma
execute as @e[type=marker,tag=rngSelected,tag=rngCitadel] as @a unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/givecitadel
execute as @e[type=marker,tag=rngSelected,tag=rngGemi] as @a unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/givegemi
