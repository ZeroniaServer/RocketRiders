...
execute if entity @e[type=armor_stand,tag=Selection,tag=Chaos,tag=!givenAllSpecial] run summon marker 0 0 0 {Tags:["rngSpecial","rng2"]}
...
execute as @e[type=marker,tag=rngSelected,tag=rngSpecial] run function items:missile/special/rng
