...
#Thunderbolt
execute if entity @s[tag=BlueBolt,tag=!UnableMissile] at @s positioned ~-1 175 ~5 store result score @s Volume run fill ~-1 ~ ~ ~3 ~1 ~9 void_air
execute if entity @s[tag=BlueBolt,tag=!UnableMissile] at @s positioned ~-1 ~-5 ~5 store result score @s Unable run clone ~-1 ~ ~ ~3 ~1 ~9 ~ 175 ~ filtered #custom:missileblocks force
execute if entity @s[tag=YellowBolt,tag=!UnableMissile] at @s positioned ~-1 175 ~-14 store result score @s Volume run fill ~-1 ~ ~ ~3 ~1 ~9 void_air
execute if entity @s[tag=YellowBolt,tag=!UnableMissile] at @s positioned ~-1 ~-5 ~-14 store result score @s Unable run clone ~-1 ~ ~ ~3 ~1 ~9 ~ 175 ~ filtered #custom:missileblocks force
...
#Catapult
execute if entity @s[tag=BlueCata,tag=!UnableMissile] at @s positioned ~-1 175 ~4 store result score @s Volume run fill ~-1 ~ ~ ~3 ~2 ~9 void_air
execute if entity @s[tag=BlueCata,tag=!UnableMissile] at @s positioned ~-1 ~-6 ~4 store result score @s Unable run clone ~-1 ~ ~ ~3 ~2 ~9 ~ 175 ~ filtered #custom:missileblocks force
