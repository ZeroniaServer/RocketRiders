...
execute as @s[tag=YellowAux] at @s if score @s AuxSpawned = @a[team=Blue,sort=nearest,limit=1,distance=..12] TomaSpawned run tag @a[team=Blue,sort=nearest,limit=1,distance=..12] add BackAux
execute as @s[tag=YellowAux] at @s if score @s AuxSpawned = @a[team=Blue,sort=nearest,limit=1,distance=..12] TomaSpawned run tag @a[team=Blue,sort=nearest,limit=1,distance=..12] add MissiMSG
...
execute as @s[tag=YellowJug] at @s store result score @s JugSpawned run scoreboard players get @p[team=Blue,sort=nearest,limit=1,distance=..12] JugSpawned
