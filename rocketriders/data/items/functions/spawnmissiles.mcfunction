...
#Fireball
execute as @e[tag=BlueFireball] at @s run summon minecraft:fireball ~ ~1 ~ {Tags:["NormalFireball"],ExplosionPower:1,direction:[0.0,0.0,0.0]}
tp @e[tag=BlueFireball] ~ ~-200 ~
kill @e[tag=BlueFireball]
execute as @e[tag=YellowFireball] at @s run summon minecraft:fireball ~ ~1 ~ {Tags:["NormalFireball"],ExplosionPower:1,direction:[0.0,0.0,0.0]}
