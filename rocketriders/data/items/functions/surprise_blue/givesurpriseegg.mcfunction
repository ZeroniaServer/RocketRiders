...
give @s[team=Blue,scores={HasSurprise=..2},tag=!fullHotbar] squid_spawn_egg{CustomModelData:1,display:{Name:'[{"text":"[???] ","color":"light_purple","bold":true},{"text":"Surprise Egg","color":"blue","bold":true}]',Lore:['{"text":"Wonder what it spawns?","color":"gray"}']},EntityTag:{id:"minecraft:marker",Tags:["BlueSurprise","surprising"]}} 1