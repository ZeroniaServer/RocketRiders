...
execute if entity @e[type=armor_stand,tag=Selection,tag=Chaos] run summon marker ~ ~ ~ {Tags:["surpriseBlueSpecial","surpriseBlue1"]}
...
execute if entity @e[type=marker,tag=surpriseBlueSpecial,tag=rngSelected] run function items:surprise_blue/rngspecial