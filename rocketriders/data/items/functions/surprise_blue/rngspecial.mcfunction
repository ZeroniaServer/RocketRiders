...
execute if entity @e[predicate=custom:indimension,type=marker,tag=rngSelected,tag=surpriseBlueBroad] run summon marker ~ ~ ~ {Tags:["missile","bluemissile","BlueBroad","surp"]}
execute if entity @e[predicate=custom:indimension,type=marker,tag=rngSelected,tag=surpriseBlueBull] run summon marker ~ ~ ~ {Tags:["missile","bluemissile","BlueBull","surp"]}
execute if entity @e[predicate=custom:indimension,type=marker,tag=rngSelected,tag=surpriseBlueDuplex] run summon marker ~ ~ ~ {Tags:["missile","bluemissile","BlueDuplex","surp"]}
execute if entity @e[predicate=custom:indimension,type=marker,tag=rngSelected,tag=surpriseBlueHyper] run summon marker ~ ~ ~ {Tags:["missile","bluemissile","BlueHyper","surp"]}
