...
#Title/giving
title @s[scores={HasSurprise=3..},tag=!fullHotbar,tag=!BackSurprise,tag=!hadTooMany] actionbar {"text":"Surprise Egg already obtained.","color":"aqua"}
execute if entity @s[scores={HasSurprise=3..},tag=!fullHotbar,tag=!BackSurprise,tag=!hadTooMany] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
title @s[tag=!fullHotbar,tag=!BackSurprise,tag=hadTooMany] actionbar {"text":"Surprise Egg already obtained.","color":"aqua"}
execute if entity @s[tag=!fullHotbar,tag=!BackSurprise,tag=hadTooMany] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
title @s[scores={HasSurprise=..2},tag=!fullHotbar,tag=!BackSurprise,tag=!hadTooMany] actionbar {"text":"Surprise Egg obtained.","color":"aqua"}
