...
execute if entity @e[type=armor_stand,tag=Selection,tag=Chaos] run summon marker ~ ~ ~ {Tags:["surpriseYellowSpecial","surpriseYellow1"]}
...
execute if entity @e[type=marker,tag=surpriseYellowHeavy,tag=rngSelected] run function items:surprise_yellow/rngheavy
execute if entity @e[type=marker,tag=surpriseYellowNormal,tag=rngSelected] run function items:surprise_yellow/rngnormal
execute if entity @e[type=marker,tag=surpriseYellowLightning,tag=rngSelected] run function items:surprise_yellow/rnglightning
execute if entity @e[type=marker,tag=surpriseYellowSpecial,tag=rngSelected] run function items:surprise_yellow/rngspecial