...
give @s[scores={HasArrows=0},tag=fullOffhand,tag=Infinity,tag=!hadTooMany] arrow{display:{Name:'{"text":"Arrow","color":"light_purple","italic":true,"bold":true}'}} 1
...
item replace entity @s[scores={HasArrows=0},tag=!fullOffhand,tag=Infinity,tag=!hadTooMany] weapon.offhand with arrow{display:{Name:'{"text":"Arrow","color":"light_purple","italic":true,"bold":true}'}} 1
...
execute if entity @s[scores={HasArrows=0},tag=!fullOffhand,tag=Infinity,tag=!hadTooMany] at @s run playsound minecraft:entity.item.pickup player @s ~ ~ ~ 0.25 2
