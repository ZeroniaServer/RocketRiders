...
execute if entity @e[tag=Selection,type=armor_stand,tag=!canopyStack] as @s[scores={HasPlat=1..},tag=!fullHotbar] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
...
execute if entity @e[tag=Selection,type=armor_stand,tag=canopyStack] as @s[scores={HasPlat=2..},tag=!fullHotbar] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
