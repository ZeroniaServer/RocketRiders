...
execute if entity @e[type=armor_stand,tag=Selection,tag=doStacking,tag=!canopyStack] as @s[scores={HasPlat=1..15},tag=fullHotbar] run tag @s remove fullHotbar
...
execute if entity @e[type=armor_stand,tag=Selection,tag=!canopyStack] as @s[scores={HasPlat=1..},tag=!fullHotbar] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
execute if entity @e[type=armor_stand,tag=Selection,tag=!canopyStack] run title @s[scores={HasPlat=0},tag=!fullHotbar] actionbar {"text":"Canopy obtained.","color":"aqua"}
...
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] as @s[scores={HasPlat=1},tag=fullHotbar] run tag @s remove fullHotbar
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] run title @s[scores={HasPlat=2..},tag=!fullHotbar] actionbar {"text":"Canopy already obtained.","color":"aqua"}
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] as @s[scores={HasPlat=2..},tag=!fullHotbar] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] run title @s[scores={HasPlat=..1},tag=!fullHotbar] actionbar {"text":"Canopy obtained.","color":"aqua"}
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] run give @s[team=Yellow,scores={HasPlat=..1},tag=!fullHotbar] ender_pearl{CustomModelData:2,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"gold","bold":true}]',Lore:['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don\'t play with fire on it!","color":"gray"}']}} 1
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] run give @s[team=Blue,scores={HasPlat=..1},tag=!fullHotbar] ender_pearl{CustomModelData:1,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Canopy","color":"blue","bold":true}]',Lore:['{"text":"The Canopy creates a leaf platform.","color":"gray"}','{"text":"Use it to quickly reposition yourself,","color":"gray"}','{"text":"but don\'t play with fire on it!","color":"gray"}']}} 1
