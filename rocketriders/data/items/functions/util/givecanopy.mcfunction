...
execute if entity @e[type=armor_stand,tag=Selection,tag=!canopyStack] run title @s[tag=!fullHotbar,tag=itemDeducted] actionbar {"text":"Canopy already obtained.","color":"aqua"}
execute if entity @e[type=armor_stand,tag=Selection,tag=!canopyStack] if entity @s[tag=!fullHotbar,tag=itemDeducted] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
...
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run title @s[scores={HasPlat=2..},tag=!fullHotbar,tag=!hadTooMany] actionbar {"text":"Canopy already obtained.","color":"aqua"}
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] if entity @s[scores={HasPlat=2..},tag=!fullHotbar,tag=!hadTooMany] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run title @s[tag=!fullHotbar,tag=hadTooMany] actionbar {"text":"Canopy already obtained.","color":"aqua"}
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] if entity @s[tag=!fullHotbar,tag=hadTooMany] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=!CTF3stack] run title @s[scores={HasPlat=..1},tag=!fullHotbar,tag=!itemDeducted] actionbar {"text":"Canopy obtained.","color":"aqua"}
...
#CTF mode overtime
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] if entity @s[scores={HasPlat=1},tag=fullHotbar] run tag @s remove fullHotbar
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run title @s[scores={HasPlat=3..},tag=!fullHotbar,tag=!hadTooMany] actionbar {"text":"Canopy already obtained.","color":"aqua"}
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] if entity @s[scores={HasPlat=3..},tag=!fullHotbar,tag=!hadTooMany] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run title @s[tag=!fullHotbar,tag=hadTooMany] actionbar {"text":"Canopy already obtained.","color":"aqua"}
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] if entity @s[tag=!fullHotbar,tag=hadTooMany] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack,tag=CTF3stack] run title @s[scores={HasPlat=..2},tag=!fullHotbar,tag=!itemDeducted] actionbar {"text":"Canopy obtained.","color":"aqua"}
