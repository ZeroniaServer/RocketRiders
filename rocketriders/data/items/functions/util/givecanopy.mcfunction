...
execute if entity @e[type=armor_stand,tag=Selection,tag=!canopyStack] if entity @s[scores={HasPlat=1..},tag=!fullHotbar] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
...
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] if entity @s[scores={HasPlat=1},tag=fullHotbar] run tag @s remove fullHotbar
...
execute if entity @e[type=armor_stand,tag=Selection,tag=canopyStack] if entity @s[scores={HasPlat=2..},tag=!fullHotbar] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
