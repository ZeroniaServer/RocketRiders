...
#Title/giving
title @s[scores={HasFireball=1..},tag=!fullHotbar,tag=!itemDeducted] actionbar {"text":"Fireball already obtained.","color":"aqua"}
...
title @s[tag=!fullHotbar,tag=itemDeducted] actionbar {"text":"Fireball already obtained.","color":"aqua"}
execute if entity @s[tag=!fullHotbar,tag=itemDeducted] at @s run playsound minecraft:block.note_block.bass master @s ~ ~ ~ 1 1
title @s[scores={HasFireball=0},tag=!fullHotbar,tag=!itemDeducted] actionbar {"text":"Fireball obtained.","color":"aqua"}
