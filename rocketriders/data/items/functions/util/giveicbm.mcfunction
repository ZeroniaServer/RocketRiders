#Antidupe check
execute store result score @s HasVortex run clear @s egg{icbm:1b} 0
...
#Title/giving
title @s[scores={HasVortex=1..},tag=!fullHotbar,tag=!itemDeducted] actionbar {"text":"ICBM already obtained.","color":"aqua"}
...
title @s[scores={HasVortex=0},tag=!fullHotbar,tag=!itemDeducted] actionbar {"text":"ICBM obtained.","color":"aqua"}
give @s[team=Yellow,scores={HasVortex=0},tag=!fullHotbar] egg{icbm:1b,CustomModelData:3,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"ICBM","color":"gold","bold":true}]',Lore:['{"text":"Short for \\"intercontinental ballistic missile\\".","color":"gray"}','{"text":"Blows up upon impact or after short flight.","color":"gray"}']},Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:7} 1
give @s[team=Blue,scores={HasVortex=0},tag=!fullHotbar] egg{icbm:1b,CustomModelData:3,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"ICBM","color":"blue","bold":true}]',Lore:['{"text":"Short for \\"intercontinental ballistic missile\\".","color":"gray"}','{"text":"Blows up upon impact or after short flight.","color":"gray"}']},Enchantments:[{id:"minecraft:unbreaking",lvl:1}],HideFlags:7} 1
