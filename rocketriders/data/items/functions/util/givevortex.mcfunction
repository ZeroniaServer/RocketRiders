...
give @s[team=Yellow,scores={HasVortex=0},tag=!fullHotbar] egg{CustomModelData:2,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Vortex","color":"gold","bold":true}]',Lore:['{"text":"A sky-mine. Blows up when enemies get","color":"gray"}','{"text":"close, missiles pass through it, or it","color":"gray"}','{"text":"gets shot by projectiles. Can chain react!","color":"gray"}']}} 1
give @s[team=Blue,scores={HasVortex=0},tag=!fullHotbar] egg{CustomModelData:1,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":true},{"text":"Vortex","color":"blue","bold":true}]',Lore:['{"text":"A sky-mine. Blows up when enemies get","color":"gray"}','{"text":"close, missiles pass through it, or it","color":"gray"}','{"text":"gets shot by projectiles. Can chain react!","color":"gray"}']}} 1
