...
execute if entity @e[tag=Selection,tag=!GameStarted,type=armor_stand] store result score @s HasArrows run clear @s arrow{display:{Name:"{\"text\":\"Arrow\",\"color\":\"light_purple\",\"italic\":\"true\",\"bold\":\"true\"}"},Lobby:1b} 0
execute if entity @e[tag=Selection,tag=GameStarted,type=armor_stand] store result score @s HasArrows run clear @s arrow{display:{Name:"{\"text\":\"Arrow\",\"color\":\"light_purple\",\"italic\":\"true\",\"bold\":\"true\"}"}} 0
