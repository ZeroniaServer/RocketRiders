...
execute unless predicate game:match_cancellable_phase if predicate game:phase/match/over run return run tellraw @s {color:"red",text:"You cannot edit game settings right now. A match is ending."}
