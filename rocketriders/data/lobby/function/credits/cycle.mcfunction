...
execute if predicate custom:periodic_tick/3 as @e[x=0,type=armor_stand,tag=SelectedCredit] at @s run particle minecraft:dust{color:[0.0,1.0,0.0],scale:1} ~ ~1 ~ 0.5 0.5 0.5 0 1 force @a[x=0,tag=!hideParticles,predicate=!custom:belowroof]
