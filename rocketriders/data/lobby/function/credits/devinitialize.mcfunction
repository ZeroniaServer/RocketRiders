...
data merge entity @e[x=0,type=armor_stand,tag=BlockyCredits,limit=1] {equipment:{mainhand:{id:"minecraft:player_head",components:{"minecraft:profile":{name:"BlockyCam",id:[I;-1162922729,1472808821,-1732059875,-2002025870],properties:[{name:"textures",value:""}]}}}}}
