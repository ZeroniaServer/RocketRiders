...
tellraw @s[scores={displayinfo=2}] {"text":"A sky-mine. Blows up when enemies get close, missiles pass through it, or it gets shot by projectiles. It also follows enemies!","color":"gray","italic":true}
