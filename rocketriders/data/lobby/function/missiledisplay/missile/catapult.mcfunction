...
loot replace entity @e[limit=1,x=0,type=item_display,tag=missile_display_text.icon] contents loot items:missile/normal/catapult
...
place template game:missile/south/white/catapult 18 203 72 none none 1 0 strict
