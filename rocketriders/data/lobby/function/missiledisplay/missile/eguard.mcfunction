...
data merge entity @e[x=0,type=area_effect_cloud,tag=NameDisp,limit=1] {CustomName:{"text":"Elder Guardian","color":"green","bold":true}}
data merge entity @e[x=0,type=area_effect_cloud,tag=TNTDisp,limit=1] {CustomName:["",{"text":"TNT Count: ","color":"dark_green","bold":true},{"text":"9","color":"white"}]}
...
loot replace entity @e[x=0,type=item_frame,tag=MisDispIF,limit=1] contents loot items:missile/normal/elder_guardian
...
place template game:elderguard_blue 18 203 73
