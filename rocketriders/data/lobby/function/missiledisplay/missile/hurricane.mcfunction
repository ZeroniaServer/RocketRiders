...
data modify entity @e[limit=1,x=0,type=text_display,tag=missile_display_text.body] text set value ["",{bold:true,color:"dark_green",text:"TNT Count: "},"18","\n\n",{bold:true,color:"dark_green",text:"Speed: "},"3.3m/s"]
data modify entity @e[limit=1,x=0,type=text_display,tag=missile_display_text.title] text set value {bold:true,color:"yellow",text:"Hurricane"}
loot replace entity @e[limit=1,x=0,type=item_display,tag=missile_display_text.icon] contents loot items:item/missile/hurricane
...
place template game:asset/missile/hurricane/display 18 203 74 none none 1 0 strict
