...
loot replace entity @e[x=0,type=item_frame,tag=MisDispIF,limit=1] contents loot items:missile/special/hypersonic
...
place template game:hypersonic_blue 18 203 74
