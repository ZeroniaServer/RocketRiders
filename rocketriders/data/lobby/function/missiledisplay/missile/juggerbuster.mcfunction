...
loot replace entity @e[limit=1,x=0,type=item_display,tag=missile_display_text.icon] contents loot items:item/missile/juggerbuster
...
place template game:asset/missile/juggerbuster/display 18 203 70 none none 1 0 strict
