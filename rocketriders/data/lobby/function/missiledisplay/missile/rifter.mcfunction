...
data merge entity @e[x=0,type=area_effect_cloud,tag=NameDisp,limit=1] {CustomName:{"text":"Rifter","color":"red","bold":true}}
data merge entity @e[x=0,type=area_effect_cloud,tag=TNTDisp,limit=1] {CustomName:["",{"text":"TNT Count: ","color":"dark_green","bold":true},{"text":"34","color":"white"}]}
...
loot replace entity @e[x=0,type=item_frame,tag=MisDispIF,limit=1] contents loot items:missile/heavy/rifter
