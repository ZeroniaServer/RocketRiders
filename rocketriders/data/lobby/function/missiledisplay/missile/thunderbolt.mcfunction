...
data merge entity @e[x=0,type=area_effect_cloud,tag=NameDisp,limit=1] {CustomName:{"text":"Thunderbolt","color":"yellow","bold":true}}
...
loot replace entity @e[x=0,type=item_frame,tag=MisDispIF,limit=1] contents loot items:missile/lightning/thunderbolt
