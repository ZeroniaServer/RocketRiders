...
loot replace entity @e[limit=1,x=0,type=item_display,tag=missile_display_text.icon] contents loot items:item/missile/tomatwo
...
place template game:asset/missile/tomatwo/display 18 203 74 none none 1 0 strict
