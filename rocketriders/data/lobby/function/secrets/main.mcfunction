...
execute positioned -36 214 16 if block ~ ~ ~ stone_button[powered=false] run tag @a[x=0] remove btn1
...
execute positioned -37 214 140 if block ~ ~ ~ stone_button[powered=false] run tag @a[x=0] remove btn2
