...
#Cancel parkour
execute as @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=!SMActive] as @a[predicate=custom:indimension,scores={LobbyWarp=1..},tag=inParkour] run tellraw @s [{"text":"You used a Lobby Warp, so your Parkour run was canceled.","color":"red"}]
...
execute as @e[predicate=custom:indimension,type=armor_stand,tag=Selection,scores={servermode=0}] as @a[predicate=custom:indimension,scores={LobbyWarp=2}] at @s run tp @s -64 202 78 90 0
...
#Sound and effects
execute as @a[predicate=custom:indimension,scores={LobbyWarp=1..,hideParticles=0}] at @s run playsound minecraft:entity.zombie_villager.converted master @s ~ ~ ~ 1 2
...
execute as @e[predicate=custom:indimension,type=armor_stand,tag=Selection,scores={servermode=1..}] as @a[predicate=custom:indimension,scores={LobbyWarp=2}] run tellraw @s [{"text":"You cannot access this area.","color":"red"}]
