...
#Initial stuff
kill @e[type=armor_stand,tag=devcycle]
...
item replace entity @e[type=armor_stand,tag=EvtemaCredits] armor.head with player_head{SkullOwner:{Id:[I;-943590382,1320568700,-1377308582,-375799538],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMWRjNDJlYTk4ZTExNjRlNWQ4MmI5ZGM3N2M5NGNjMjJmYmY1NmRlNzg3MDNjMDQ3ZmYxNWU4NzA2N2NmNWNiYSJ9fX0="}]}}}
item replace entity @e[type=armor_stand,tag=EvtemaCredits] weapon.mainhand with slime_ball
item replace entity @e[type=armor_stand,tag=EvtemaCredits] armor.chest with leather_chestplate{display:{color:14548992}}
...
item replace entity @e[type=armor_stand,tag=ChronosCredits] weapon.mainhand with bow
item replace entity @e[type=armor_stand,tag=ChronosCredits] armor.chest with iron_chestplate
item replace entity @e[type=armor_stand,tag=ChronosCredits] armor.legs with iron_leggings
item replace entity @e[type=armor_stand,tag=ChronosCredits] armor.feet with diamond_boots
...
item replace entity @e[type=armor_stand,tag=BuilderCreditsAS] weapon.mainhand with netherite_pickaxe
...
item replace entity @e[type=armor_stand,tag=ToulCredits] weapon.mainhand with writable_book
data merge entity @e[type=armor_stand,tag=BlockyCredits,limit=1] {HandItems:[{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:BlockyCam}}]}

#Pose and armor
item replace entity @e[type=armor_stand,tag=BuilderCreditsAS] armor.chest with leather_chestplate{display:{color:16770835}}
item replace entity @e[type=armor_stand,tag=BuilderCreditsAS] armor.legs with leather_leggings{display:{color:16770835}}
item replace entity @e[type=armor_stand,tag=BuilderCreditsAS] armor.feet with leather_boots{display:{color:10813439}}

item replace entity @e[type=armor_stand,tag=BlockyCredits] armor.chest with leather_chestplate{display:{color:14061821}}
item replace entity @e[type=armor_stand,tag=BlockyCredits] armor.legs with leather_leggings{display:{color:14061821}}
item replace entity @e[type=armor_stand,tag=BlockyCredits] armor.feet with leather_boots{display:{color:13784063}}

item replace entity @e[type=armor_stand,tag=ToulCredits] armor.chest with leather_chestplate{display:{color:16383998}}
item replace entity @e[type=armor_stand,tag=ToulCredits] armor.legs with leather_leggings{display:{color:1908001}}
item replace entity @e[type=armor_stand,tag=ToulCredits] armor.feet with leather_boots{display:{color:16351261}}

#Skulls
item replace entity @e[type=armor_stand,tag=BardCredits] armor.head with player_head{SkullOwner:{Id:[I;203251676,1795967249,-2032645852,-553887958],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYzZhMDA4NjkxNDM1NDllYWEyNmEyM2ViNTQ2OTNjZTUyYzI3YTIxYTA1MTJmZTg3ZmRiNGZmNzBiY2ViYmU3ZiJ9fX0="}]}}}
item replace entity @e[type=armor_stand,tag=HugoCredits] armor.head with player_head{SkullOwner:{Id:[I;59284743,-1969601549,-1756957932,-1612509311],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTJjMmYwMmRhZDI1ZGNiMzk5MDdiZjA0ODY3MzdjZTAxOTc5ZDljMDQ3OTBkYWVlNTBjNzM2ZTI0YTQ2ZjdkMCJ9fX0="}]}}}
item replace entity @e[type=armor_stand,tag=TrekCredits] armor.head with player_head{SkullOwner:{Id:[I;87557875,-969129795,-1389005621,845682813],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTQwZGE1OGNlOGE1ZTA0MDc5MTJlM2M3MmU2NzIyZmExNGMzNTI3ZDMxMjg4MWMwNWRiYzg2MWNiYTg0NzQyNCJ9fX0="}]}}}
item replace entity @e[type=armor_stand,tag=TypCredits] armor.head with player_head{SkullOwner:{Id:[I;-1356426805,730483112,-1391175837,-1416409699],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjhkNGJjYzQxM2ZjZGZiMWZmOTc5YWQzMzg3MDZhNWE2NDBjOTk2YWE0YmU5OWUwNzZiODE5ZjFkMzQ3ZTk0OSJ9fX0="}]}}}
item replace entity @e[type=armor_stand,tag=BlockyCredits] armor.head with player_head{SkullOwner:{Id:[I;421022523,1072909005,-1990128211,621962662],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTE2NDA2YjAwMjY2OTgyZjBiYTU4ZjViMjIxOWI4MGViNGEyMGRmODQ1MTE2NTk1NzE4NzZhYjE2YTM4MTI1MiJ9fX0="}]}}}
item replace entity @e[type=armor_stand,tag=ToulCredits] armor.head with player_head{SkullOwner:{Id:[I;306683579,646400271,-1510886369,1816201274],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmVlM2VmOWVlMzQ5ZjA2MzgyNTc5NmIwY2Q4ZWZmNmFkNThiNzgzYjEyY2E4YjY4MDM3MWZiZTQyZmZmMjIwMiJ9fX0="}]}}}
