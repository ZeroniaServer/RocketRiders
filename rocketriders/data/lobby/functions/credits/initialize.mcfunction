...
replaceitem entity @e[tag=CarsCredits] armor.head player_head{SkullOwner:ConvenientStore}
...
replaceitem entity @e[tag=AusCredits] armor.head player_head{SkullOwner:Ausxh}
replaceitem entity @e[tag=DrakanCredits] armor.head player_head{SkullOwner:Drakan1}
...
replaceitem entity @e[tag=SeraCredits] armor.head player_head{SkullOwner:MaelstromMonarch}
