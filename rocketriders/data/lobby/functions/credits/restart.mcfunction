...
tp @e[tag=FuriousCredits,type=armor_stand] -51 211 90 90 0
tp @e[tag=PinguCredits,type=armor_stand] -51 211 91 90 0
tp @e[tag=TopazCredits,type=armor_stand] -51 211 92 90 0
