...
tellraw @s[scores={displayinfo=2}] {"text":"A sky-mine. Blows up when enemies get close, missiles pass through it, or it gets shot by arrows. Can chain react!","color":"gray","italic":"true"}
...
tellraw @s[scores={displayinfo=8}] {"text":"(Made by: Rubix_One)","color":"gray","italic":"true"}
