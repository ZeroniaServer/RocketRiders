data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"A.N.T.","color":"light_purple"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT count: ","color":"green"},{"text":"2","color":"light_purple"}]'}
