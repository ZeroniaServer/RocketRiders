data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Auxiliary","color":"light_purple"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT count: ","color":"green"},{"text":"25","color":"light_purple"}]'}
