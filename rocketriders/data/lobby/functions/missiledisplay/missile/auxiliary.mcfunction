...
data merge entity @e[tag=NameDisp,limit=1,type=area_effect_cloud] {CustomName:'{"text":"Auxiliary","color":"red","bold":true}'}
...
data merge entity @e[tag=MisDispIF,limit=1,type=item_frame] {Item:{id:"minecraft:mooshroom_spawn_egg",Count:1b}}
