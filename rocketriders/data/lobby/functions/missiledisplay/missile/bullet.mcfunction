data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Bullet","color":"light_purple"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT count: ","color":"green"},{"text":"45","color":"light_purple"}]'}
