...
data merge entity @e[tag=NameDisp,limit=1,type=area_effect_cloud] {CustomName:'{"text":"Bullet","color":"dark_purple","bold":"true"}'}
data merge entity @e[tag=TNTDisp,limit=1,type=area_effect_cloud] {CustomName:'["",{"text":"TNT Count: ","color":"dark_green","bold":"true"},{"text":"45","color":"white"}]'}
...
data merge entity @e[tag=MisDispIF,limit=1,type=item_frame] {Item:{id:"minecraft:skeleton_horse_spawn_egg",tag:{Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:7},Count:1b}}
...
execute positioned 12 203 78 run tellraw @a[distance=..5] {"text":"The Bullet makes all missiles look like an A.N.T. With 45 TNT, 12 of which being triggers, you have to be very careful defusing this one!","color":"gray","italic":"true"}
