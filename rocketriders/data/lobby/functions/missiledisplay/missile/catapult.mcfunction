...
data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Catapult","color":"green","bold":"true"}'}
...
data merge entity @e[tag=MisDispIF,limit=1] {Item:{id:"minecraft:cave_spider_spawn_egg",Count:1b}}
...
execute positioned 12 203 78 run tellraw @a[distance=..5] {"text":"The Catapult does as its name suggests. Once it contacts a wall, it launches 2 TNT blocks upwards. Watch out!","color":"gray","italic":"true"}
