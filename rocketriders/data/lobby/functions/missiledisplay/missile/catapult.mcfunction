...
data merge entity @e[x=0,type=area_effect_cloud,tag=NameDisp,limit=1] {CustomName:'{"text":"Catapult","color":"green","bold":true}'}
...
data merge entity @e[x=0,type=item_frame,tag=MisDispIF,limit=1] {Item:{id:"minecraft:cave_spider_spawn_egg",Count:1b}}
