data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Citadel","color":"green"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT Count: ","color":"dark_green"},{"text":"16","color":"light_purple"}]'}
