...
data merge entity @e[tag=MisDispIF,limit=1] {Item:{id:"minecraft:parrot_spawn_egg",tag:{Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:7,Count:1b},Count:1b}}
