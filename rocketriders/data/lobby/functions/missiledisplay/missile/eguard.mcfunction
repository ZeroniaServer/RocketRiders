data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Elder Guardian","color":"green"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT Count: ","color":"dark_green"},{"text":"9","color":"light_purple"}]'}
