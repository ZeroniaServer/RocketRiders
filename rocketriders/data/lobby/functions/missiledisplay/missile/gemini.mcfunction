data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Gemini","color":"green","bold":"true"}'}
...
data merge entity @e[tag=MisDispIF,limit=1] {Item:{id:"minecraft:fox_spawn_egg",Count:1b}}
