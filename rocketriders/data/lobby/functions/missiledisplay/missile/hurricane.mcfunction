data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Hurricane","color":"gold"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT Count: ","color":"dark_green"},{"text":"18","color":"light_purple"}]'}
data merge entity @e[tag=SpeedDisp,limit=1] {CustomName:'[{"text":"Speed: ","color":"dark_green"},{"text":"3.3m/s","color":"light_purple"}]'}
data merge entity @e[tag=MisDispIF,limit=1] {Item:{id:"minecraft:drowned_spawn_egg",Count:1b}}
