data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Hurricane","color":"light_purple"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT count: ","color":"green"},{"text":"18","color":"light_purple"}]'}
