data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Hypersonic","color":"light_purple"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT count: ","color":"green"},{"text":"4","color":"light_purple"}]'}
data merge entity @e[tag=SpeedDisp,limit=1] {CustomName:'[{"text":"Speed: ","color":"green"},{"text":"4.4m/s","color":"light_purple"}]'}
