...
data merge entity @e[type=area_effect_cloud,tag=NameDisp,limit=1] {CustomName:'{"text":"Lifter","color":"green","bold":true}'}
data merge entity @e[type=area_effect_cloud,tag=TNTDisp,limit=1] {CustomName:'["",{"text":"TNT Count: ","color":"dark_green","bold":true},{"text":"8","color":"white"}]'}
...
data merge entity @e[type=item_frame,tag=MisDispIF,limit=1] {Item:{id:"minecraft:dolphin_spawn_egg",Count:1b}}
