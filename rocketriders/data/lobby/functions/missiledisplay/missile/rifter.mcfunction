data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Rifter","color":"red"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT Count: ","color":"dark_green"},{"text":"34","color":"light_purple"}]'}
