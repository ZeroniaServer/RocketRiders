data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Slasher","color":"light_purple"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT count: ","color":"green"},{"text":"6","color":"light_purple"}]'}
