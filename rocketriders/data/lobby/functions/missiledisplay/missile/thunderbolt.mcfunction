data merge entity @e[tag=NameDisp,limit=1] {CustomName:'{"text":"Thunderbolt","color":"light_purple"}'}
data merge entity @e[tag=TNTDisp,limit=1] {CustomName:'[{"text":"TNT count: ","color":"green"},{"text":"15","color":"light_purple"}]'}
data merge entity @e[tag=SpeedDisp,limit=1] {CustomName:'[{"text":"Speed: ","color":"green"},{"text":"3.3m/s","color":"light_purple"}]'}
