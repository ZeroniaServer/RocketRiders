...
data merge entity @e[type=area_effect_cloud,tag=NameDisp,limit=1] {CustomName:'{"text":"Warhead","color":"red","bold":true}'}
...
data merge entity @e[type=item_frame,tag=MisDispIF,limit=1] {Item:{id:"minecraft:silverfish_spawn_egg",Count:1b}}
