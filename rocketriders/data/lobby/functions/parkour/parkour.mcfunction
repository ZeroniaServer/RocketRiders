...
execute as @a[predicate=custom:indimension,team=Lobby,tag=earnCheckpoint,tag=!hideParticles] at @s run particle firework ~ ~1 ~ 0 0 0 0.1 100 force @s
...
execute as @a[predicate=custom:indimension,team=Lobby,tag=finishedParkour,tag=!cheatedParkour,tag=!hideParticles] at @s run particle firework ~ ~1 ~ 0 0 0 0.1 100 force @s
