...
##Boots (non-duel mode)
execute unless entity @e[x=0,type=armor_stand,tag=rr_duel,limit=1] run item replace entity @a[x=0,team=Lobby,tag=inParkour,nbt=!{Inventory:[{id:"minecraft:iron_boots",Slot:100b}]}] armor.feet with iron_boots{display:{Name:'{"text":"Parkour Boots","color":"dark_green","bold":true,"italic":false}'},HideFlags:7}
execute if entity @s[tag=noYZELO] run item replace entity @a[x=0,team=Lobby,tag=inParkour,nbt=!{Inventory:[{id:"minecraft:iron_boots",Slot:100b}]}] armor.feet with iron_boots{display:{Name:'{"text":"Parkour Boots","color":"dark_green","bold":true,"italic":false}'},HideFlags:7}
