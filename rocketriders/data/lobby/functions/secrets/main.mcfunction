...
execute positioned -36 213 15 if block ~ ~ ~ warped_pressure_plate[powered=true] as @e[predicate=custom:indimension,type=painting,limit=1,sort=nearest,tag=!changed,distance=..2] run function lobby:secrets/randompainting
execute positioned -36 213 15 if block ~ ~ ~ warped_pressure_plate[powered=false] run tag @e[predicate=custom:indimension,type=painting,limit=1,sort=nearest,distance=..2] remove changed

execute positioned -37 213 141 if block ~ ~ ~ light_weighted_pressure_plate[power=1] as @e[predicate=custom:indimension,type=painting,limit=1,sort=nearest,tag=!changed,distance=..2] run function lobby:secrets/randompainting
execute positioned -37 213 141 if block ~ ~ ~ light_weighted_pressure_plate[power=0] run tag @e[predicate=custom:indimension,type=painting,limit=1,sort=nearest,distance=..2] remove changed
