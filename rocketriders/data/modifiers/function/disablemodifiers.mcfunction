...
execute if predicate game:feature_flags/1_4_0_update/on run scoreboard players reset $yes_fall config
...
execute if predicate game:feature_flags/1_4_0_update/on run scoreboard players reset $zero_gravity_tnt config
