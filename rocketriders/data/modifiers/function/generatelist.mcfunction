...
execute if predicate game:modifier/explosive run data modify storage rocketriders:modifiers list append value {"text":"Explosive","color":"aqua","hover_event":{"action":"show_text","value":["",{"text":"TNT, Fireballs, Nova Rockets, and the Vortex all do more explosion damage.","color":"white"}]}}
execute if entity @s[tag=Residers] run data modify storage rocketriders:modifiers list append value {"text":"Rocket Residers","color":"aqua","hover_event":{"action":"show_text","value":["",{"text":"Players cannot leave their bases.","color":"white"}]}}
...
execute if entity @s[tag=Molerat] run data modify storage rocketriders:modifiers list append value {"text":"Molerat","color":"aqua","hover_event":{"action":"show_text","value":["",{"text":"A big block of glass spawns in the center of the map, which players must break through to damage the other base.","color":"white"}]}}
...
execute if entity @s[tag=Hardcore] run data modify storage rocketriders:modifiers list append value {"text":"Hardcore","color":"aqua","hover_event":{"action":"show_text","value":["",{"text":"Players have three hearts of health and bases are one block thick.","color":"white"}]}}
...
execute if predicate game:modifier/punchable_tnt run data modify storage rocketriders:modifiers list append value {"text":"Punchable TNT","color":"aqua","hover_event":{"action":"show_text","value":["",{"text":"Primed TNT can be punched forward.","color":"white"}]}}
execute if predicate game:modifier/unstable_tnt run data modify storage rocketriders:modifiers list append value {"text":"Unstable TNT","color":"aqua","hover_event":{"action":"show_text","value":["",{"text":"Breaking TNT blocks immediately ignites them.","color":"white"}]}}
execute if predicate game:modifier/hobbits run data modify storage rocketriders:modifiers list append value {"text":"Hobbits","color":"aqua","hover_event":{"action":"show_text","value":["",{"text":"Players are 2/3 their normal size, and can sneak under 1-block-tall gaps.","color":"white"}]}}
...
execute if predicate game:modifier/explosive run data modify storage rocketriders:modifiers length append value 9
...
execute if predicate game:modifier/punchable_tnt run data modify storage rocketriders:modifiers length append value 13
execute if predicate game:modifier/unstable_tnt run data modify storage rocketriders:modifiers length append value 12
execute if predicate game:modifier/hobbits run data modify storage rocketriders:modifiers length append value 7
