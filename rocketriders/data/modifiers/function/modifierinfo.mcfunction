...
#Rotting
execute if predicate game:feature_flags/1_4_0_update if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=22}] if predicate game:modifiers/rotting/on run tellraw @s ["",{"text":"Rotting","color":"aqua","bold":true},{"text":" Enabled:","color":"green","bold":true},{"text":" Blocks left between the bases will slowly be consumed by rot.","color":"gray","italic":true}]
execute if predicate game:feature_flags/1_4_0_update if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=22}] unless predicate game:modifiers/rotting/on run tellraw @s ["",{"text":"Rotting","color":"aqua","bold":true},{"text":" Disabled!","color":"red","bold":true}]
