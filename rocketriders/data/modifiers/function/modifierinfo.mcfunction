...
#No Fall
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=1}] if predicate game:modifiers/no_fall/on run tellraw @s ["",{"text":"No Fall","color":"aqua","bold":true},{"text":" Enabled:","color":"green","bold":true},{"text":" Players are immune to fall damage.","color":"gray","italic":true}]
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=1}] unless predicate game:modifiers/no_fall/on run tellraw @s ["",{"text":"No Fall","color":"aqua","bold":true},{"text":" Disabled!","color":"red","bold":true}]
...
#Hardcore
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=12}] if predicate game:modifiers/hardcore/on run tellraw @s ["",{"text":"Hardcore","color":"aqua","bold":true},{"text":" Enabled:","color":"green","bold":true},{"text":" Players have three hearts of health and bases are only three blocks thick.","color":"gray","italic":true}]
...
#Double Portal
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=13}] if predicate game:modifiers/double_portal/on run tellraw @s ["",{"text":"Double Portal","color":"aqua","bold":true},{"text":" Enabled:","color":"green","bold":true},{"text":" Both portals must be broken to win the match.","color":"gray","italic":true}]
...
#Instant TNT
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=19}] if predicate game:modifiers/instant_tnt/on run tellraw @s ["",{"text":"Instant TNT","color":"aqua","bold":true},{"text":" Enabled:","color":"green","bold":true},{"text":" Primed TNT instantly explodes.","color":"gray","italic":true}]
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=19}] unless predicate game:modifiers/instant_tnt/on run tellraw @s ["",{"text":"Instant TNT","color":"aqua","bold":true},{"text":" Disabled!","color":"red","bold":true}]
...
#Rotting
execute if predicate game:feature_flags/1_4_0_update/on if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=22}] if predicate game:modifiers/rotting/on run tellraw @s ["",{"text":"Rotting","color":"aqua","bold":true},{"text":" Enabled:","color":"green","bold":true},{"text":" Blocks left between the bases will slowly be consumed by rot.","color":"gray","italic":true}]
execute if predicate game:feature_flags/1_4_0_update/on if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={modifierID=22}] unless predicate game:modifiers/rotting/on run tellraw @s ["",{"text":"Rotting","color":"aqua","bold":true},{"text":" Disabled!","color":"red","bold":true}]
