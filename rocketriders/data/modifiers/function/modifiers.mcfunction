...
execute unless predicate game:phase/match/pause if predicate game:modifiers/sonar/on as @e[x=0,type=ender_pearl,tag=!is_glowing] run function game:glowing/on
execute unless predicate game:phase/match/pause if predicate game:modifiers/sonar/on as @e[x=0,type=firework_rocket,tag=!is_glowing] run function game:glowing/on
execute unless predicate game:phase/match/pause if predicate game:modifiers/sonar/on as @e[x=0,type=fireball,tag=!is_glowing] run function game:glowing/on
execute unless predicate game:phase/match/pause if predicate game:modifiers/sonar/on as @e[x=0,type=dragon_fireball,tag=!is_glowing] run function game:glowing/on
execute unless predicate game:phase/match/pause if predicate game:modifiers/sonar/on as @e[x=0,type=#custom:potion,tag=!is_glowing] run function game:glowing/on
execute unless predicate game:phase/match/pause if predicate game:modifiers/sonar/on as @e[x=0,type=tnt_minecart,tag=!is_glowing] run function game:glowing/on
