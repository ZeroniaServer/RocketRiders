...
execute unless entity @s[tag=Sonar,predicate=!game:game_paused] run effect give @a[x=0,predicate=custom:on_blue_or_yellow_or_spectator_team] night_vision infinite 100 true
...
execute if entity @s[tag=SpamClick] as @a[x=0,team=Lobby] run attribute @s minecraft:attack_speed base reset
execute if entity @s[tag=!SpamClick] as @a[x=0,predicate=custom:on_blue_or_yellow_team] run attribute @s minecraft:attack_speed base reset
