...
execute unless predicate game:gamemode_components/lower_void store result storage rocketriders:main rotting.y int 1 run random value 0..180
execute if predicate game:gamemode_components/lower_void store result storage rocketriders:main rotting.y int 1 run random value -20..180
