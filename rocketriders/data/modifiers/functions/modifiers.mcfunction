...
##Instamine
execute if entity @s[tag=Instamine] as @a[x=0] unless entity @s[team=!Yellow,team=!Blue] run effect give @s haste infinite 255 true
execute if entity @s[tag=Instamine] run effect clear @a[x=0,team=!Yellow,team=!Blue] haste

##Explosive
execute if entity @s[tag=Explosive,tag=!ClutterCollector] as @e[x=0,type=tnt,nbt={Fuse:1s}] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:5,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"]}
execute if entity @s[tag=Explosive,tag=!ClutterCollector] as @e[x=0,type=tnt,nbt={Fuse:1s},tag=UtilKilled] at @s run data modify entity @e[type=creeper,tag=ExplosiveTNT,limit=1,sort=nearest,distance=..1] CustomName set from entity @s CustomName

execute if entity @s[tag=Explosive,tag=!ClutterCollector] run kill @e[x=0,type=tnt,nbt={Fuse:1s}]
...
#Clutter Collector
execute if entity @s[tag=ClutterCollector,tag=Explosive,tag=!Hardcore] as @e[x=0,type=tnt,nbt={Fuse:1s},z=-50,dz=100,x=-160,dx=320,y=-20,dy=200] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:0,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"]}
execute if entity @s[tag=ClutterCollector,tag=Explosive,tag=!Hardcore] as @e[x=0,type=tnt,nbt={Fuse:1s}] unless entity @s[z=-50,dz=100,x=-160,dx=320,y=-20,dy=200] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:5,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"]}
execute if entity @s[tag=ClutterCollector,tag=!Explosive,tag=!Hardcore] as @e[x=0,type=tnt,nbt={Fuse:1s},z=-50,dz=100,x=-160,dx=320,y=-20,dy=200] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:0,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"]}
execute if entity @s[tag=ClutterCollector,tag=Explosive,tag=Hardcore] as @e[x=0,type=tnt,nbt={Fuse:1s},z=-62,dz=124,x=-160,dx=320,y=-20,dy=200] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:0,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"]}
execute if entity @s[tag=ClutterCollector,tag=Explosive,tag=Hardcore] as @e[x=0,type=tnt,nbt={Fuse:1s}] unless entity @s[z=-62,dz=124,x=-160,dx=320,y=-20,dy=200] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:5,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"]}
execute if entity @s[tag=ClutterCollector,tag=!Explosive,tag=Hardcore] as @e[x=0,type=tnt,nbt={Fuse:1s},z=-62,dz=124,x=-160,dx=320,y=-20,dy=200] at @s run summon creeper ~ ~ ~ {NoGravity:1b,CustomName:'{"text":"TNT"}',ExplosionRadius:0,Fuse:0,Silent:1b,CustomNameVisible:0b,NoAI:1b,CanPickUpLoot:0b,DeathTime:19s,Tags:["ExplosiveTNT"]}
execute if entity @s[tag=ClutterCollector] as @e[x=0,type=tnt,nbt={Fuse:1s},tag=UtilKilled] at @s run data modify entity @e[type=creeper,tag=ExplosiveTNT,limit=1,sort=nearest,distance=..1] CustomName set from entity @s CustomName
execute if entity @s[tag=ClutterCollector,tag=Explosive] run kill @e[x=0,type=tnt,nbt={Fuse:1s}]
execute if entity @s[tag=ClutterCollector,tag=!Explosive,tag=!Hardcore] run kill @e[x=0,type=tnt,nbt={Fuse:1s},z=-50,dz=100,x=-160,dx=320,y=-20,dy=200]
execute if entity @s[tag=ClutterCollector,tag=!Explosive,tag=Hardcore] run kill @e[x=0,type=tnt,nbt={Fuse:1s},z=-61,dz=122,x=-160,dx=320,y=-20,dy=200]
