...
##Instamine
execute if entity @s[tag=Instamine] as @a[predicate=custom:indimension] unless entity @s[team=!Yellow,team=!Blue] run effect give @s haste infinite 255 true
...
execute if entity @s[tag=Residers,tag=!GameEnd] as @a[predicate=custom:indimension,team=Yellow,predicate=custom:residers] run tag @s add crosser
#Hackfix: void works for crossers too
execute as @a[predicate=custom:indimension,tag=crosser] run function game:void
tag @a[predicate=custom:indimension] remove crosser

##Spam Click
execute if entity @s[tag=SpamClick] as @a[predicate=custom:indimension] unless entity @s[team=!Blue,team=!Yellow] run attribute @s minecraft:generic.attack_speed base set 1000
execute if entity @s[tag=SpamClick] as @a[predicate=custom:indimension,team=Lobby] run attribute @s minecraft:generic.attack_speed base set 4
execute if entity @s[tag=!SpamClick] as @a[predicate=custom:indimension] unless entity @s[team=!Blue,team=!Yellow] run attribute @s minecraft:generic.attack_speed base set 4

##Ninja Jump
execute if entity @s[tag=NinjaJump] as @a[predicate=custom:indimension] unless entity @s[team=!Blue,team=!Yellow] run effect give @s speed infinite 2 true
execute if entity @s[tag=NinjaJump] as @a[predicate=custom:indimension] unless entity @s[team=!Blue,team=!Yellow] run effect give @s jump_boost infinite 2 true

##Hardcore
execute if entity @s[tag=Hardcore] as @a[predicate=custom:indimension] unless entity @s[team=!Blue,team=!Yellow] if entity @s[scores={nnhealth_max=20}] run function modifiers:hardcoreset
