...
# Make sure new game mode components system is set correctly for the currently enabled game mode
...
execute at @e[x=0,type=marker,tag=join_pad.left] run summon text_display ~ ~1 ~ {Tags:["join_pad_display","join_pad_display.left"],text:{atlas:"minecraft:items",sprite:"minecraft:item/barrier",color:"#EFEFEF"},width:1,height:1,transformation:{left_rotation:[0,0,0,1],translation:[-0.1875,-1.125,0],right_rotation:[0,0,0,1],scale:[7.5,7.5,0]},billboard:"center",background:0}
execute at @e[x=0,type=marker,tag=join_pad.middle] run summon text_display ~ ~1 ~ {Tags:["join_pad_display","join_pad_display.middle"],text:{atlas:"minecraft:items",sprite:"minecraft:item/barrier",color:"#EFEFEF"},width:1,height:1,transformation:{left_rotation:[0,0,0,1],translation:[-0.1875,-1.125,0],right_rotation:[0,0,0,1],scale:[7.5,7.5,0]},billboard:"center",background:0}
...
execute unless score $dark_red_for_blue gamemode_components matches 1 run setblock -80 211 62 minecraft:sea_lantern
execute if score $dark_red_for_blue gamemode_components matches 1 run setblock -80 211 62 minecraft:shroomlight
execute unless score $one_team gamemode_components matches 1 run setblock -80 211 94 minecraft:ochre_froglight[axis=y]
execute if score $one_team gamemode_components matches 1 unless score $dark_red_for_blue gamemode_components matches 1 run setblock -80 211 94 minecraft:sea_lantern
execute if score $one_team gamemode_components matches 1 if score $dark_red_for_blue gamemode_components matches 1 run setblock -80 211 94 minecraft:shroomlight
