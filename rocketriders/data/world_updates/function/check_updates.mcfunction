...
execute unless score $WorldVersion CmdData matches 1318.. run function world_updates:do_update {version_id: 1318, function: "world_updates:1_3_2/update", version_display_name: "1.3.2", is_indev: false}
