...
execute unless score $WorldVersion CmdData matches 1310.. run function world_updates:do_update {version_id: 1310, function: "world_updates:1_3_0-pre13/update", version_display_name: "1.3.0-pre14", is_indev: true}
