...
execute unless score $WorldVersion CmdData matches 1404.. run function world_updates:do_update {version_id: 1404, function: "world_updates:1_3_4/_", version_display_name: "1.3.4", is_indev: false}
