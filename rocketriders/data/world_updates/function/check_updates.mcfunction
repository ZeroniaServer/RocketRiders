...
execute unless score $WorldVersion CmdData matches 1316.. run function world_updates:do_update {version_id: 1316, function: "world_updates:1_3_1-rc1/update", version_display_name: "1.3.1-rc1", is_indev: false}
