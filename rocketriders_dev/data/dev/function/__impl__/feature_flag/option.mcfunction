...
$execute if score @s dev matches 2$(index)1 if predicate game:feature_flags/$(config_id)/on run data modify storage rocketriders:main dev.dialog.body.contents append value [{color:"gray",text:"\nWhen you opened this dialog, this feature was "},{color:"green",translate:"options.on"}]
$execute if score @s dev matches 2$(index)1 unless predicate game:feature_flags/$(config_id)/on run data modify storage rocketriders:main dev.dialog.body.contents append value [{color:"gray",text:"\nWhen you opened this dialog, this feature was "},{color:"red",translate:"options.off"}]
