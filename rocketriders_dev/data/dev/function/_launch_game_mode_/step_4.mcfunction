...
execute in minecraft:overworld run tp @a[limit=1,x=0,scores={dev_action=1}] -79.5 205.0 62.5
execute in minecraft:overworld run tp @a[limit=1,x=0,scores={dev_action=0}] -79.5 205.0 94.5
