execute if predicate custom:team/yellow run return run tellraw @s [{color:"red",text:"You are already on the "},{score:{name:"@s",objective:"text.team_name_lowercase"}}," team"]
...
execute if predicate game:match_components/one_team run return run tellraw @s {color:"red",text:"There is no yellow team in this game mode."}

execute if predicate custom:team/blue unless predicate game:phase/match/closing/outcome run tellraw @a[x=0] [{score:{name:"@s",objective:"text.accent_color"}},{selector:"@s"}," left the ",{score:{name:"@s",objective:"text.team_name_lowercase"}}," team!"]
...
execute if predicate game:phase/staging run return run execute positioned -79.5 205.0 94.5 run function custom:player/teleport_with_sound
...
execute if predicate game:phase/match run function custom:player/team/join_yellow
...
execute if predicate game:phase/match run return run execute unless predicate custom:in_arena positioned 12.5 64.0 66.5 rotated 180 0 run function custom:player/teleport_with_sound
