...
execute if entity @s[tag=BlueBot,scores={botriding=1..2}] at @s run data merge entity @s {Motion:[0.0d,0.55d,1.0d]}
execute if entity @s[tag=YellowBot,scores={botriding=1..2}] at @s run data merge entity @s {Motion:[0.0d,0.55d,-1.0d]}
