...
execute as @e[x=0,type=armor_stand,tag=FreshBlueBot] run item replace entity @s armor.chest with leather_chestplate{display:{color:2359551}}
execute as @e[x=0,type=armor_stand,tag=FreshBlueBot] run item replace entity @s armor.legs with leather_leggings{display:{color:2359551}}
execute as @e[x=0,type=armor_stand,tag=FreshBlueBot] run item replace entity @s armor.feet with leather_boots{display:{color:2359551}}
