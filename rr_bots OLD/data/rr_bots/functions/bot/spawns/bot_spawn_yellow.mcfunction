...
execute as @e[x=0,type=armor_stand,tag=FreshYellowBot] run item replace entity @s armor.chest with leather_chestplate{display:{color:16449280}}
execute as @e[x=0,type=armor_stand,tag=FreshYellowBot] run item replace entity @s armor.legs with leather_leggings{display:{color:16449280}}
execute as @e[x=0,type=armor_stand,tag=FreshYellowBot] run item replace entity @s armor.feet with leather_boots{display:{color:16449280}}
