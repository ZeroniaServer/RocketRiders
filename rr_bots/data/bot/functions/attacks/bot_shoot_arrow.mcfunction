...
execute as @s[tag=BlueBot,scores={botarrow=1}] at @s run tp @s ~ ~ ~ facing entity @a[team=Yellow,sort=nearest,limit=1]
execute as @s[tag=YellowBot,scores={botarrow=1}] at @s run tp @s ~ ~ ~ facing entity @a[team=Blue,sort=nearest,limit=1]
