...
execute as @s[tag=LOSTrackerBlue,tag=!Returned,tag=!DeniedLOS] at @s unless block ^ ^ ^0.1 air run tag @s add DeniedLOS
...
execute as @s[tag=LOSTrackerYellow,tag=!Returned,tag=!DeniedLOS] at @s unless block ^ ^ ^0.1 air run tag @s add DeniedLOS
...
execute as @s[tag=!DeniedLOS] at @s run function bot:attacks/lostrack