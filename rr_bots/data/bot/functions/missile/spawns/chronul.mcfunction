...
execute as @s[tag=BlueBot,tag=!DoneSpawning,tag=BotNullSpawn,tag=BotRider] at @s if block ~ ~-3 ~4 air unless entity @e[tag=RecentBotspawn,distance=..7] run tag @s add Speed22
...
execute as @s[tag=YellowBot,tag=!DoneSpawning,tag=BotNullSpawn,tag=BotRider] at @s if block ~ ~-3 ~-4 air unless entity @e[tag=RecentBotspawn,distance=..7] run tag @s add Speed22
