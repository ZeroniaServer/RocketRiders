...
execute as @s[tag=BotRider] if entity @s[tag=!Speed20,tag=!Speed22,tag=!Speed17,tag=!Speed33,scores={botriding=20..}] unless entity @s[scores={botmisspawn=1..40}] run tag @s remove BotRider


execute as @s[tag=!BotRider,tag=Speed20] unless entity @s[scores={botriding=1..}] run tag @s remove BotRider
execute as @s[tag=!BotRider,tag=Speed22] unless entity @s[scores={botriding=1..}] run tag @s remove BotRider
execute as @s[tag=!BotRider,tag=Speed17] unless entity @s[scores={botriding=1..}] run tag @s remove BotRider
execute as @s[tag=!BotRider,tag=Speed33] unless entity @s[scores={botriding=1..}] run tag @s remove BotRider
