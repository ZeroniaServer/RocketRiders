execute as @s[tag=!Returned] at @s if entity @e[type=armor_stand,tag=BotArrows,distance=..4,limit=1,sort=nearest] run tag @e[type=armor_stand,tag=BotArrows,distance=..4,limit=1,sort=nearest] add BotFireArrow
execute as @s[tag=BotSpotted] at @s if entity @e[type=armor_stand,tag=BotArrows,distance=..4,limit=1,sort=nearest] run tag @s add Returned
execute as @s[tag=BotSpotted] at @s if entity @e[type=armor_stand,tag=BotArrows,distance=..4,limit=1,sort=nearest] run kill @s
