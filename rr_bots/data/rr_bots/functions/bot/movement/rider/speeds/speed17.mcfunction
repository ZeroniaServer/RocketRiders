...
execute if entity @s[tag=BlueBot,scores={botriding=1..2}] at @s run data merge entity @s {Motion:[0.0,0.6,0.8]}
execute if entity @s[tag=YellowBot,scores={botriding=1..2}] at @s run data merge entity @s {Motion:[0.0,0.6,-0.8]}
