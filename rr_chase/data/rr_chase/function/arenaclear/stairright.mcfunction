...
execute positioned ~1 ~-1 ~ if entity @e[limit=1,x=0,type=marker,tag=chaseStairs,predicate=rr_chase:stairs_base_width] run function rr_chase:arenaclear/stairright