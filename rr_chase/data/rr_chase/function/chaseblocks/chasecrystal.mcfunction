...
execute if predicate rr:has_achievements as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if score @s ChaseCrystalID = @a[tag=InLead,distance=..3,sort=nearest,limit=1] playerUUID run advancement grant @a[tag=InLead,distance=..3,sort=nearest,limit=1] only achievements:rr_challenges/boomerang
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~ ~2 run function custom:explosion {power:4,modifiers:{nbt:{CustomName:"a crystal"}}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~1 ~2 run function custom:explosion {power:4,modifiers:{nbt:{CustomName:"a crystal"}}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~-1 ~2 run function custom:explosion {power:4,modifiers:{nbt:{CustomName:"a crystal"}}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~ ~2.2 run function custom:explosion {power:4,modifiers:{nbt:{CustomName:"a crystal"}}}
...
execute as @e[x=0,type=armor_stand,tag=ChaseCrystal,scores={CmdData=300..}] at @s run particle explosion ~ ~ ~ 0 0 0 0.1 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
