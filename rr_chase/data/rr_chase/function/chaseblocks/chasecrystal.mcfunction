...
execute as @e[x=0,type=armor_stand,tag=ChaseCrystal] at @s if predicate custom:periodic_tick/3 run particle minecraft:dust{color:[1,0,3],scale:1} ^0.3 ^0.4 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute as @e[x=0,type=armor_stand,tag=ChaseCrystal] at @s if predicate custom:periodic_tick/3 run particle minecraft:dust{color:[1,0,3],scale:1} ^-0.3 ^0.4 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute as @e[x=0,type=armor_stand,tag=ChaseCrystal] at @s run tp @s ~ ~ ~ facing entity @a[x=0,tag=InLead,limit=1,sort=nearest]
...
execute as @e[x=0,type=armor_stand,tag=ChaseCrystal] at @s unless entity @a[tag=InLead,distance=..20] if predicate custom:periodic_tick/3 run particle minecraft:dust{color:[1,0,3],scale:1} ^0.3 ^0.4 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute as @e[x=0,type=armor_stand,tag=ChaseCrystal] at @s unless entity @a[tag=InLead,distance=..20] if predicate custom:periodic_tick/3 run particle minecraft:dust{color:[1,0,3],scale:1} ^-0.3 ^0.4 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
