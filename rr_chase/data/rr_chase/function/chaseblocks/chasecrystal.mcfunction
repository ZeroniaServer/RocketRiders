...
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~ ~2 run function custom:explosion {power:4,modifiers:{name:"a crystal"}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~1 ~2 run function custom:explosion {power:4,modifiers:{name:"a crystal"}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~-1 ~2 run function custom:explosion {power:4,modifiers:{name:"a crystal"}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~ ~2.2 run function custom:explosion {power:4,modifiers:{name:"a crystal"}}
