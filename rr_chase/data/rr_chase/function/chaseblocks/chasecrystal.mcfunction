...
execute if entity @e[x=0,type=armor_stand,tag=ChaseCrystal] as @a[x=0,tag=InLead] at @s if entity @e[type=armor_stand,tag=ChaseCrystal,distance=10..] unless entity @e[type=armor_stand,tag=ChaseCrystal,distance=..7] run title @a[x=0,tag=InLead,scores={ChaseAlarm=1}] subtitle ["",{color:"red",text:"⚠"},{bold:true,color:"dark_blue",text:"Chase Crystal Incoming!"},{color:"red",text:"⚠"}]
execute if entity @e[x=0,type=armor_stand,tag=ChaseCrystal] as @a[x=0,tag=InLead] at @s if entity @e[type=armor_stand,tag=ChaseCrystal,distance=10..] unless entity @e[type=armor_stand,tag=ChaseCrystal,distance=..7] run title @a[x=0,tag=InLead,scores={ChaseAlarm=5}] subtitle ["",{color:"red",text:"⚠"},{bold:true,color:"blue",text:"Chase Crystal Incoming!"},{color:"red",text:"⚠"}]
execute if entity @e[x=0,type=armor_stand,tag=ChaseCrystal] as @a[x=0,tag=InLead] at @s if entity @e[type=armor_stand,tag=ChaseCrystal,distance=..9] run title @a[x=0,tag=InLead,scores={ChaseAlarm=5}] subtitle ["",{color:"dark_red",text:"☠"},{bold:true,color:"red",text:"Chase Crystal Incoming!"},{color:"dark_red",text:"☠"}]
...
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~ ~2 run function custom:explosion {power:4,modifiers:{name:"Chase Crystal"}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~1 ~2 run function custom:explosion {power:4,modifiers:{name:"Chase Crystal"}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~-1 ~2 run function custom:explosion {power:4,modifiers:{name:"Chase Crystal"}}
execute as @e[x=0,type=armor_stand,tag=CrystalComplete] at @s if entity @a[tag=InLead,distance=..2] as @a[tag=InLead,distance=..3,sort=nearest,limit=1] at @s positioned ~ ~ ~2.2 run function custom:explosion {power:4,modifiers:{name:"Chase Crystal"}}
