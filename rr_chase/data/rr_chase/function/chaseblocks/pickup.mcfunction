...
execute as @e[x=0,type=marker,tag=MissileBlock,tag=!KillChaseblock] at @s unless block ~ ~ ~ red_stained_glass run fill ~-1 ~ ~-1 ~1 ~ ~3 air replace moving_piston{blockState:"minecraft:red_stained_glass"}
...
execute as @e[x=0,type=marker,tag=MissileBlock,tag=!KillChaseblock] at @s unless block ~ ~ ~ red_stained_glass run tag @a[predicate=custom:team/blue,sort=nearest,limit=1,distance=..12,scores={BreakCBRed=1..}] add getItem
execute as @e[x=0,type=marker,tag=MissileBlock,tag=!KillChaseblock] at @s unless block ~ ~ ~ red_stained_glass as @a[predicate=custom:team/blue,tag=getItem,sort=nearest,limit=1,distance=..12,scores={BreakCBRed=1..}] run function rr_chase:chaseblocks/givemissile
execute as @e[x=0,type=marker,tag=MissileBlock,tag=!KillChaseblock] at @s unless block ~ ~ ~ red_stained_glass run tag @a[predicate=custom:team/blue,sort=nearest,limit=1,distance=..12,scores={BreakCBRed=1..}] remove getItem
...
execute as @e[x=0,type=marker,tag=UtilBlock,tag=!KillChaseblock2] at @s unless block ~ ~ ~ purple_stained_glass run fill ~-1 ~ ~-1 ~1 ~ ~3 air replace moving_piston{blockState:"minecraft:purple_stained_glass"}
...
execute as @e[x=0,type=marker,tag=UtilBlock,tag=!KillChaseblock2] at @s unless block ~ ~ ~ purple_stained_glass run tag @a[predicate=custom:team/blue,sort=nearest,limit=1,distance=..12,scores={BreakCBPurple=1..}] add getItem
execute as @e[x=0,type=marker,tag=UtilBlock,tag=!KillChaseblock2] at @s unless block ~ ~ ~ purple_stained_glass as @a[predicate=custom:team/blue,tag=getItem,sort=nearest,limit=1,distance=..12,scores={BreakCBPurple=1..}] run function rr_chase:chaseblocks/giveutil
execute as @e[x=0,type=marker,tag=UtilBlock,tag=!KillChaseblock2] at @s unless block ~ ~ ~ purple_stained_glass run tag @a[predicate=custom:team/blue,sort=nearest,limit=1,distance=..12,scores={BreakCBPurple=1..}] remove getItem
...
execute as @e[x=0,type=marker,tag=ArrowBlock,tag=!KillChaseblock3] at @s unless block ~ ~ ~ cyan_stained_glass run fill ~-1 ~ ~-1 ~1 ~ ~3 air replace moving_piston{blockState:"minecraft:cyan_stained_glass"}
...
execute as @e[x=0,type=marker,tag=ArrowBlock,tag=!KillChaseblock3] at @s unless block ~ ~ ~ cyan_stained_glass run tag @a[predicate=custom:team/blue,sort=nearest,limit=1,distance=..12,scores={BreakCBCyan=1..}] add getItem
execute as @e[x=0,type=marker,tag=ArrowBlock,tag=!KillChaseblock3] at @s unless block ~ ~ ~ cyan_stained_glass as @a[predicate=custom:team/blue,tag=getItem,sort=nearest,limit=1,distance=..12,scores={BreakCBCyan=1..}] run function rr_chase:chaseblocks/givearrows
execute as @e[x=0,type=marker,tag=ArrowBlock,tag=!KillChaseblock3] at @s unless block ~ ~ ~ cyan_stained_glass run tag @a[predicate=custom:team/blue,sort=nearest,limit=1,distance=..12,scores={BreakCBCyan=1..}] remove getItem
...
execute as @e[x=0,type=marker,tag=CrystalBlock,tag=!KillChaseblock4] at @s unless block ~ ~ ~ tinted_glass run fill ~-1 ~ ~-1 ~1 ~ ~3 air replace moving_piston{blockState:"minecraft:tinted_glass"}
...
execute as @e[x=0,type=marker,tag=CrystalBlock,tag=!KillChaseblock4] at @s unless block ~ ~ ~ tinted_glass if entity @a[predicate=custom:team/blue,distance=..12,scores={BreakCBTint=1..}] run playsound minecraft:entity.shulker.shoot master @a[x=0] ~ ~ ~ 1 1.3
