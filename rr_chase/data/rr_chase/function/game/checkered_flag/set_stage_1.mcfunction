...
tp @e[limit=1,x=0,type=block_display,tag=checkered_flag.flag_1] ~-1 ~6 ~
tp @e[limit=1,x=0,type=block_display,tag=checkered_flag.flag_2] ~-1 ~7 ~
tp @e[limit=1,x=0,type=block_display,tag=checkered_flag.flag_3] ~-2 ~6 ~-1
tp @e[limit=1,x=0,type=block_display,tag=checkered_flag.flag_4] ~-2 ~7 ~-1
tp @e[limit=1,x=0,type=block_display,tag=checkered_flag.flag_5] ~-3 ~6 ~-1
tp @e[limit=1,x=0,type=block_display,tag=checkered_flag.flag_6] ~-3 ~7 ~-1
tp @e[limit=1,x=0,type=block_display,tag=checkered_flag.flag_7] ~-4 ~6 ~-1
