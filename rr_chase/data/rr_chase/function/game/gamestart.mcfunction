...
#Bossbar
execute if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if score $blue_team_count global matches 0 run bossbar set rr:startgame name ["",{"text":"Awaiting players...","color":"white"}]
...
execute if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if score $blue_team_count global matches 1 run bossbar set rr:startgame name ["",{"text":"Awaiting more players...","color":"white"}]
execute if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if score $blue_team_count global matches 1 run bossbar set rr:startgame value 15
execute if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if score $blue_team_count global matches 1 run bossbar set rr:startgame color green
...
execute if predicate rr:wait_for_sufficient_players if predicate game:phase/staging/queue/countdown if score $blue_team_count global matches 0..1 run function game:restartcountdown

execute unless predicate rr:wait_for_sufficient_players if predicate game:phase/staging/queue/waiting if score $blue_team_count global matches 1.. run function game:set_phase/staging.queue.countdown
execute unless predicate rr:wait_for_sufficient_players if predicate game:phase/staging/queue/countdown if score $blue_team_count global matches 0 run function game:restartcountdown
