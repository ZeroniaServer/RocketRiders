...
execute if score $$flag_wave var matches 20..39 run place template game:asset/flag/stage_1/yellow 8 70 63 none none 1 0 strict
execute if score $$flag_wave var matches 0..19 run place template game:asset/flag/stage_2/yellow 8 70 63 none none 1 0 strict
