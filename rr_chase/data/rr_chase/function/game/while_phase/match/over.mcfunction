...
execute if score $match_over_timer global matches 1.. run bossbar set rr_chase:lead players none
execute if score $match_over_timer global matches 1.. run bossbar set rr_chase:lead name ["",{"text":"No one is in the lead!","color":"red"}]
execute if score $match_over_timer global matches 1.. run bossbar set rr_chase:lead value 0
