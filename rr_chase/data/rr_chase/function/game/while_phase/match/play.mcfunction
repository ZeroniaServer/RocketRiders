...
execute positioned 12 64 65 run tag @p[gamemode=!spectator,predicate=custom:team/blue,predicate=custom:in_arena,tag=!onBlue,predicate=custom:player/alive] add InLead
