##Achievements
execute if entity @s[scores={servermode=-1..0},predicate=!rr:realms] run function rr_chase:achievements/aftergame
...
execute if entity @s[scores={servermode=-1..0},predicate=!rr:realms] run advancement grant @a[x=0,team=Blue,tag=Winner,limit=1] only achievements:rr_challenges/speed
