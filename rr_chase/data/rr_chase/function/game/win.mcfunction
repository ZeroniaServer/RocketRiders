...
item replace entity @a[x=0,team=Blue,tag=Winner,limit=1] armor.chest with minecraft:elytra[enchantments={levels:{binding_curse:1,projectile_protection:1},show_in_tooltip:0b},enchantment_glint_override=false,unbreakable={show_in_tooltip:0b},custom_name='[{"text":"Elytra","color":"blue","bold":true,"italic":false}]',hide_additional_tooltip={}] 1
execute as @a[x=0] store result score @s HasFlag run clear @s #banners 0
item replace entity @a[x=0,team=Blue,tag=Loser,scores={HasFlag=0}] armor.head with minecraft:blue_banner[custom_name='{"text":"Flag of Shameful Loss","color":"blue","bold":true,"italic":false}',banner_patterns=[{pattern:"half_horizontal",color:"white"},{pattern:"half_horizontal_bottom",color:"white"},{pattern:"stripe_left",color:"blue"},{pattern:"stripe_bottom",color:"blue"},{pattern:"stripe_left",color:"white"},{pattern:"stripe_bottom",color:"white"},{pattern:"stripe_right",color:"white"},{pattern:"square_top_left",color:"white"}],enchantments={levels:{binding_curse:1,projectile_protection:1},show_in_tooltip:0b},enchantment_glint_override=false,attribute_modifiers={modifiers:[],show_in_tooltip:0b},hide_additional_tooltip={}] 1
