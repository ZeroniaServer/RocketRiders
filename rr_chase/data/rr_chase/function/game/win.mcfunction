...
item replace entity @a[x=0,team=Blue,tag=Winner,limit=1] armor.chest with minecraft:elytra[equippable={slot:"chest",damage_on_hurt:false,equip_sound:"minecraft:intentionally_empty",asset_id:"elytra"},enchantments={levels:{binding_curse:1},show_in_tooltip:0b},enchantment_glint_override=false,unbreakable={show_in_tooltip:0b},custom_name='[{"text":"Elytra","color":"blue","bold":true,"italic":false}]',hide_additional_tooltip={}] 1
