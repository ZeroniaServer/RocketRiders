...
execute as @e[predicate=custom:indimension,type=end_crystal,tag=KillCrystal] at @s run particle explosion ~ ~ ~ 0.2 0.2 0.2 0.1 4 force @a[predicate=custom:indimension,scores={hideParticles=0},predicate=custom:belowroof]
