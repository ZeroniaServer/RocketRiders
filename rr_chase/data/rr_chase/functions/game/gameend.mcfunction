...
execute if entity @s[scores={endtimer=1}] as @a[team=Blue,tag=Loser] run function rr_chase:chasegear/losesaber
execute if entity @s[scores={endtimer=1}] run effect give @a[team=Blue,tag=Loser] weakness infinite 255 true
