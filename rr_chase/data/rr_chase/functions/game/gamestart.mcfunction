...
execute if score $dust CmdData matches 1 if entity @s[tag=!BlueFull] as @e[predicate=custom:indimension,type=marker,tag=bluejoinpad,tag=!CancelJoin] at @s run particle dust 3 3 3 1 ~ ~1 ~ 0.5 1 0.5 0.1 5 force @a[predicate=custom:indimension,tag=!hideParticles,predicate=!custom:belowroof]
