...
execute as @a[predicate=custom:indimension,team=Blue] at @s run tag @e[type=egg,sort=nearest,limit=1,distance=..5,tag=BlueVortex] add YellowVortex
execute as @a[predicate=custom:indimension,team=Blue] at @s run tag @e[type=egg,sort=nearest,limit=1,distance=..5,tag=BlueVortex] remove BlueVortex

#Overwrite vortex particles
execute as @e[type=egg,tag=YellowVortex] at @s if score $dust CmdData matches 1 run particle dust 3 3 3 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=VortexYellow] at @s if score $dust CmdData matches 1 run particle dust 3 3 3 1.5 ~ ~0.3 ~ 0.5 0.5 0 0 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=marker,tag=VortexYellow] at @s if score $dust CmdData matches 1 run particle minecraft:electric_spark ~ ~0.3 ~ 0.5 0.5 0 0 3 force @a[predicate=custom:indimension,predicate=custom:belowroof]

#Nova tracking
execute as @a[predicate=custom:indimension,team=Blue] at @s if entity @e[type=firework_rocket,distance=..4,limit=1,tag=BlueNova] run tag @s add BlueNovaNear
execute as @a[predicate=custom:indimension,team=Blue] at @s if entity @e[type=marker,distance=..4,limit=1,tag=bluenovatracker] run tag @s add BlueNovaNear
execute as @a[predicate=custom:indimension,team=Blue,tag=BlueNovaNear,scores={NovaNear=4..}] at @s unless entity @e[type=firework_rocket,distance=..4,limit=1,tag=BlueNova] run tag @s remove BlueNovaNear
...
#Shield
execute as @e[type=snowball,tag=BlueShield] at @s if score $dust CmdData matches 1 run particle dust 3 3 3 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
#Canopy
execute as @e[type=ender_pearl,tag=BluePlat] at @s if score $dust CmdData matches 1 run particle dust 3 3 3 1 ~ ~ ~ 0 0 0 0.1 10 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[type=ender_pearl,tag=BluePlat] at @s if score $dust CmdData matches 1 run particle block spruce_leaves ~ ~ ~ 0 0 0 0.1 2 force @a[predicate=custom:indimension,predicate=custom:belowroof]
...
execute as @e[type=ender_pearl,scores={testplat2=10},predicate=!custom:canopy_nearvoid] at @s run place template rr_chase:whitecanopy1 ~-1 ~ ~-1
execute as @e[type=ender_pearl,scores={testplat2=10},predicate=!custom:canopy_nearvoid] at @s run playsound ui.stonecutter.take_result master @a[predicate=custom:indimension] ~ ~ ~ 2 0
execute as @e[type=ender_pearl,scores={testplat2=10},predicate=!custom:canopy_nearvoid] at @s run playsound block.wood.break master @a[predicate=custom:indimension] ~ ~ ~ 2 1
execute as @e[type=ender_pearl,scores={testplat2=10},predicate=!custom:canopy_nearvoid] at @s run playsound block.grass.place master @a[predicate=custom:indimension] ~ ~ ~ 2 0
...
execute as @e[type=marker,tag=BlueSpawnZone] at @s run scoreboard players set @a[predicate=custom:indimension,team=Blue,distance=..6] respawn 0
