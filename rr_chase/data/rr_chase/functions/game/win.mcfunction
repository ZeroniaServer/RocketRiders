...
title @a[team=!Lobby] title ["",{"selector":"@a[team=Blue,tag=Winner,limit=1]","color":"blue"},{"text":" Won!","color":"blue","bold":false}]
tellraw @a ["",{"selector":"@a[team=Blue,tag=Winner,limit=1]","color":"blue"},{"text":" Won!","color":"blue","bold":false}]
