...
execute as @e[tag=RandomWinSplash,scores={RNGscore=26},type=area_effect_cloud] run title @a[tag=Winner] subtitle ["",{"text":"Winner winner chicken dinner!","color":"green"}]
execute as @e[tag=RandomWinSplash,scores={RNGscore=27},type=area_effect_cloud] run title @a[tag=Winner] subtitle ["",{"text":"Drink the salty tears of your enemies!","color":"green"}]
