execute unless entity @e[type=armor_stand,tag=rr_chase,limit=1] run summon armor_stand 23 216 -18 {Tags:["rr_chase","gamemodeAS"],Marker:1b,Invisible:1b,Invulnerable:1b,CustomNameVisible:0b,CustomName:'{"text":"Chase Mode"}'}
