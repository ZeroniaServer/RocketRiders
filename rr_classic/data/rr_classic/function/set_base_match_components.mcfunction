...
scoreboard players set $item_pool.missile/broadsword match_components -1
scoreboard players set $item_pool.missile/bullet match_components -1
...
scoreboard players set $item_pool.missile/duplex match_components -1
...
scoreboard players set $item_pool.missile/hypersonic match_components -1
