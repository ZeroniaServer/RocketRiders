...
execute as @a[team=!Spectator,scores={crusadekit=2}] at @s as @e[type=arrow,scores={arrowtime=10..},nbt={inGround:1b},tag=!infinity,limit=1,distance=..2,sort=nearest] unless data entity @s custom_potion_effects run tag @s add pickup
...
#Give arrow
execute as @a[team=!Spectator,tag=!fullOffhand,scores={crusadekit=2}] at @s as @e[type=arrow,tag=pickup,tag=!given,nbt={inGround:1b},tag=!infinity,limit=1,distance=..2,sort=nearest] unless data entity @s custom_potion_effects at @s run function everytick:arrow_replace
execute if entity @s[tag=!GameStarted] as @e[type=arrow,tag=pickup,tag=!given,nbt={inGround:1b},tag=!infinity] unless data entity @s custom_potion_effects at @s run give @p[team=!Spectator,distance=..2,tag=fullOffhand,scores={crusadekit=2}] arrow{display:{Name:'{"text":"Arrow","color":"light_purple","italic":true,"bold":true}'},Lobby:1b}
execute if entity @s[tag=GameStarted] as @e[type=arrow,tag=pickup,tag=!given,nbt={inGround:1b},tag=!infinity] unless data entity @s custom_potion_effects at @s run give @p[team=!Spectator,distance=..2,tag=fullOffhand,scores={crusadekit=2}] arrow{display:{Name:'{"text":"Arrow","color":"light_purple","italic":true,"bold":true}'}}
