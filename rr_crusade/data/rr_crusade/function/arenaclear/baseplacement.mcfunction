...
#blue
summon armor_stand -94 202 64 {Rotation:[-180.0f,0.0f],Tags:["CrusadeEntity","KitSelect","KnightStand","BlueKit"],Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:1b,CustomName:{"text":"Knight","color":"dark_green","bold":true},CustomNameVisible:1b,Pose:{RightArm:[321.0f,0.0f,0.0f]}}
...
#yellow
summon armor_stand -96 202 92 {Rotation:[0.0f,0.0f],Tags:["CrusadeEntity","KitSelect","KnightStand","YellowKit"],Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:1b,CustomName:{"text":"Knight","color":"dark_green","bold":true},CustomNameVisible:1b,Pose:{RightArm:[321.0f,0.0f,0.0f]}}
...
#Text
execute positioned -95 204 64 run function custom:summon_persistent_marker_aec {modifiers:{nbt:{Tags:["CrusadeEntity","KitMessage"],CustomName:{text:"Click a sign to select a kit!"},CustomNameVisible:true}}}
execute positioned -95 204 92 run function custom:summon_persistent_marker_aec {modifiers:{nbt:{Tags:["CrusadeEntity","KitMessage"],CustomName:{text:"Click a sign to select a kit!"},CustomNameVisible:true}}}
