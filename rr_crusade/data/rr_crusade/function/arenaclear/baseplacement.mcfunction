...
#kit stand items
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=BlueKit] run item replace entity @s armor.head with minecraft:netherite_helmet[equippable={slot:"head",equip_sound:"minecraft:intentionally_empty",asset_id:"netherite"},trim={material:"minecraft:lapis",pattern:"minecraft:tide"}]
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=YellowKit] run item replace entity @s armor.head with minecraft:netherite_helmet[equippable={slot:"head",equip_sound:"minecraft:intentionally_empty",asset_id:"netherite"},trim={material:"minecraft:gold",pattern:"minecraft:raiser"}]
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=BlueKit] run item replace entity @s armor.chest with minecraft:leather_chestplate[equippable={slot:"chest",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:quartz",pattern:"minecraft:vex"},dyed_color=3949738]
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=YellowKit] run item replace entity @s armor.chest with minecraft:leather_chestplate[equippable={slot:"chest",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:netherite",pattern:"minecraft:spire"},dyed_color=16768000]
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=BlueKit] run item replace entity @s armor.legs with minecraft:iron_leggings[equippable={slot:"legs",equip_sound:"minecraft:intentionally_empty",asset_id:"iron"},trim={material:"minecraft:lapis",pattern:"minecraft:vex"}]
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=YellowKit] run item replace entity @s armor.legs with minecraft:iron_leggings[equippable={slot:"legs",equip_sound:"minecraft:intentionally_empty",asset_id:"iron"},trim={material:"minecraft:netherite",pattern:"minecraft:spire"}]
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=BlueKit] run item replace entity @s armor.feet with minecraft:leather_boots[equippable={slot:"feet",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:quartz",pattern:"minecraft:vex"},dyed_color=3949738]
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=YellowKit] run item replace entity @s armor.feet with minecraft:leather_boots[equippable={slot:"feet",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:netherite",pattern:"minecraft:spire"},dyed_color=16768000]
...
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=BlueKit] run item replace entity @s armor.legs with minecraft:leather_leggings[equippable={slot:"legs",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:quartz",pattern:"minecraft:vex"},dyed_color=3949738]
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=YellowKit] run item replace entity @s armor.legs with minecraft:leather_leggings[equippable={slot:"legs",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:netherite",pattern:"minecraft:spire"},dyed_color=16768000]
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=BlueKit] run item replace entity @s armor.feet with minecraft:leather_boots[equippable={slot:"feet",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:quartz",pattern:"minecraft:vex"},dyed_color=3949738]
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=YellowKit] run item replace entity @s armor.feet with minecraft:leather_boots[equippable={slot:"feet",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:netherite",pattern:"minecraft:spire"},dyed_color=16768000]
...
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=BlueKit] run item replace entity @s armor.chest with minecraft:leather_chestplate[equippable={slot:"chest",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:quartz",pattern:"minecraft:vex"},dyed_color=3949738]
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=YellowKit] run item replace entity @s armor.chest with minecraft:leather_chestplate[equippable={slot:"chest",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:netherite",pattern:"minecraft:spire"},dyed_color=16768000]
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=BlueKit] run item replace entity @s armor.legs with minecraft:leather_leggings[equippable={slot:"legs",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:quartz",pattern:"minecraft:vex"},dyed_color=3949738]
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=YellowKit] run item replace entity @s armor.legs with minecraft:leather_leggings[equippable={slot:"legs",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:netherite",pattern:"minecraft:spire"},dyed_color=16768000]
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=BlueKit] run item replace entity @s armor.feet with minecraft:leather_boots[equippable={slot:"feet",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:quartz",pattern:"minecraft:vex"},dyed_color=3949738]
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=YellowKit] run item replace entity @s armor.feet with minecraft:leather_boots[equippable={slot:"feet",equip_sound:"minecraft:intentionally_empty",asset_id:"leather"},trim={material:"minecraft:netherite",pattern:"minecraft:spire"},dyed_color=16768000]
