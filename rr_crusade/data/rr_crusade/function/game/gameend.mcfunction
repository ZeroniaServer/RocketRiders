...
execute if entity @s[tag=BothWon,scores={endtimer=1}] run give @a[x=0,team=Yellow,scores={crusadekit=2}] minecraft:bow[custom_name={"translate":"Shooting Saber","color":"gold","bold":true,"italic":false},lore=[{"translate":"A weapon used for both"},{"translate":"ranged and melee attacks."}],unbreakable={},enchantments={flame:1},attribute_modifiers=[{id:"rocketriders:saber",type:"attack_damage",amount:2.5,operation:"add_value",slot:"mainhand"}]]
...
execute if entity @s[tag=YellowWon,scores={endtimer=1}] run give @a[x=0,team=Blue,scores={crusadekit=2}] minecraft:bow[custom_name={"translate":"Shooting Saber","color":"blue","bold":true,"italic":false},lore=[{"translate":"A weapon used for both"},{"translate":"ranged and melee attacks"}],unbreakable={},enchantments={flame:1}]
execute if entity @s[tag=BlueWon,scores={endtimer=1}] run give @a[x=0,team=Blue,scores={crusadekit=2}] minecraft:bow[custom_name={"translate":"Shooting Saber","color":"blue","bold":true,"italic":false},lore=[{"translate":"A weapon used for both"},{"translate":"ranged and melee attacks."}],unbreakable={},enchantments={flame:1},attribute_modifiers=[{id:"rocketriders:saber",type:"attack_damage",amount:2.5,operation:"add_value",slot:"mainhand"}]]
execute if entity @s[tag=BlueWon,scores={endtimer=1}] run give @a[x=0,team=Yellow,scores={crusadekit=2}] minecraft:bow[custom_name={"translate":"Shooting Saber","color":"gold","bold":true,"italic":false},lore=[{"translate":"A weapon used for both"},{"translate":"ranged and melee attacks"}],unbreakable={},enchantments={flame:1}]
...
execute if entity @s[tag=YellowWon,scores={endtimer=1}] run give @a[x=0,team=Blue,scores={crusadekit=3}] minecraft:breeze_rod[custom_model_data={floats:[1]},unbreakable={},custom_name=[{"text":"Spell Wand","italic":false,"bold":true,"color":"blue"}],lore=[[{"translate":"A special wand, made to"}],[{"translate":"set enemies on fire!"}]],enchantments={fire_aspect:2}]
execute if entity @s[tag=BlueWon,scores={endtimer=1}] run clear @a[x=0,team=Yellow,scores={crusadekit=3}] blaze_rod
execute if entity @s[tag=BlueWon,scores={endtimer=1}] run give @a[x=0,team=Yellow,scores={crusadekit=3}] minecraft:blaze_rod[custom_model_data={floats:[1]},unbreakable={},custom_name=[{"text":"Spell Wand","italic":false,"bold":true,"color":"gold"}],lore=[[{"translate":"A special wand, made to"}],[{"translate":"set enemies on fire!"}]],enchantments={fire_aspect:2}]
