...
execute if entity @s[tag=BothWon,scores={endtimer=1}] run give @a[x=0,team=Yellow,scores={crusadekit=2}] minecraft:bow[custom_name='{"translate":"Shooting Saber","color":"gold","bold":true,"italic":false}',lore=['{"translate":"A weapon used for both"}','{"translate":"ranged and melee attacks."}'],unbreakable={show_in_tooltip:0b},enchantments={flame:1},attribute_modifiers=[{id:"rocketriders:saber",type:"generic.attack_damage",amount:2.5,operation:"add_value",slot:"mainhand"}]]
execute if entity @s[tag=BothWon,scores={endtimer=1}] run give @a[x=0,team=Blue,scores={crusadekit=2}] minecraft:bow[custom_name='{"translate":"Shooting Saber","color":"blue","bold":true,"italic":false}',lore=['{"translate":"A weapon used for both"}','{"translate":"ranged and melee attacks."}'],unbreakable={show_in_tooltip:0b},enchantments={flame:1},attribute_modifiers=[{id:"rocketriders:saber",type:"generic.attack_damage",amount:2.5,operation:"add_value",slot:"mainhand"}]]
