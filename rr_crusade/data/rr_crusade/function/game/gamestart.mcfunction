...
#Notify Join
execute if entity @s[tag=GameStarted,tag=!SMActive] run tellraw @a[x=0,tag=JoinBlue,scores={crusadekit=1}] [{"text":"Drop your ","color":"dark_aqua","italic":true},{"text":"Knight Sword ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"dark_aqua","italic":true}]
execute if entity @s[tag=GameStarted,tag=!SMActive] run tellraw @a[x=0,tag=JoinBlue,scores={crusadekit=2}] [{"text":"Drop your ","color":"dark_aqua","italic":true},{"text":"Shooting Saber ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"dark_aqua","italic":true}]
execute if entity @s[tag=GameStarted,tag=!SMActive] run tellraw @a[x=0,tag=JoinBlue,scores={crusadekit=3}] [{"text":"Drop your ","color":"dark_aqua","italic":true},{"text":"Spell Wand ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"dark_aqua","italic":true}]
...
execute if entity @s[tag=GameStarted,tag=!SMActive] run tellraw @a[x=0,tag=JoinYellow,scores={crusadekit=1}] [{"text":"Drop your ","color":"yellow","italic":true},{"text":"Knight Sword ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
execute if entity @s[tag=GameStarted,tag=!SMActive] run tellraw @a[x=0,tag=JoinYellow,scores={crusadekit=2}] [{"text":"Drop your ","color":"yellow","italic":true},{"text":"Shooting Saber ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
execute if entity @s[tag=GameStarted,tag=!SMActive] run tellraw @a[x=0,tag=JoinYellow,scores={crusadekit=3}] [{"text":"Drop your ","color":"yellow","italic":true},{"text":"Spell Wand ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
...
execute if entity @s[scores={count=600}] as @a[x=0,team=Blue,scores={crusadekit=2}] run item replace entity @s hotbar.0 with minecraft:bow[custom_name='{"translate":"Shooting Saber","color":"blue","bold":true,"italic":false}',lore=['{"translate":"A weapon used for both"}','{"translate":"ranged and melee attacks."}'],unbreakable={show_in_tooltip:0b},enchantments={flame:1},attribute_modifiers=[{id:"rocketriders:saber",type:"attack_damage",amount:2.5,operation:"add_value",slot:"mainhand"}]]
execute if entity @s[scores={count=600}] as @a[x=0,team=Yellow,scores={crusadekit=2}] run item replace entity @s hotbar.0 with minecraft:bow[custom_name='{"translate":"Shooting Saber","color":"gold","bold":true,"italic":false}',lore=['{"translate":"A weapon used for both"}','{"translate":"ranged and melee attacks."}'],unbreakable={show_in_tooltip:0b},enchantments={flame:1},attribute_modifiers=[{id:"rocketriders:saber",type:"attack_damage",amount:2.5,operation:"add_value",slot:"mainhand"}]]
#Hotfix for being able to cast spells in queue
execute if entity @s[scores={count=600}] run clear @a[x=0,team=Blue,scores={crusadekit=3}] breeze_rod
execute if entity @s[scores={count=600}] run clear @a[x=0,team=Yellow,scores={crusadekit=3}] blaze_rod
execute if entity @s[scores={count=600}] as @a[x=0,team=Blue,scores={crusadekit=3}] run item replace entity @s hotbar.0 with minecraft:breeze_rod[custom_model_data={floats:[1]},unbreakable={},custom_name='[{"text":"Spell Wand","italic":false,"bold":true,"color":"blue"}]',lore=['[{"translate":"A special wand, made"}]','[{"translate":"to cast spells!"}]'],enchantments={fire_aspect:2,sharpness:2},consumable={animation:"block",consume_seconds:2147483647,has_consume_particles:false,sound:"intentionally_empty"}]
execute if entity @s[scores={count=600}] as @a[x=0,team=Yellow,scores={crusadekit=3}] run item replace entity @s hotbar.0 with minecraft:blaze_rod[custom_model_data={floats:[1]},unbreakable={},custom_name='[{"text":"Spell Wand","italic":false,"bold":true,"color":"gold"}]',lore=['[{"translate":"A special wand, made"}]','[{"translate":"to cast spells!"}]'],enchantments={fire_aspect:2,sharpness:2},consumable={animation:"block",consume_seconds:2147483647,has_consume_particles:false,sound:"intentionally_empty"}]
