...
execute if score $CBA crusadehp matches 1.. unless score $CBAcd crusadehp matches 1.. positioned 36 47 -39 run function rr_crusade:game/glass_dynamic_fill with storage rocketriders:teams blue.color_palette
...
execute if predicate game:blue_portal_revealed positioned 36 47 -39 run function rr_crusade:game/glass_dynamic_fill with storage rocketriders:teams blue.color_palette
