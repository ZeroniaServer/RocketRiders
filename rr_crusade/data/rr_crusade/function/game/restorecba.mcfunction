...
execute unless score $CBA crusadehp matches 1.. as @a[x=0,team=Yellow] at @s run playsound minecraft:entity.experience_orb.pickup master @s ~ ~ ~ 1 0
execute unless score $CBA crusadehp matches 1.. as @a[x=0,team=Yellow] at @s run playsound minecraft:block.glass.break master @s ~ ~ ~ 1 2
execute unless score $CBA crusadehp matches 1.. as @a[x=0,team=Blue] at @s run playsound minecraft:entity.wither.death master @s ~ ~ ~ 1 1
