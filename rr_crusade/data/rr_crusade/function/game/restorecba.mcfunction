...
execute if score $CBA crusadehp matches 1.. unless predicate game:game_rules/disable_death_messages/on run gamerule minecraft:show_death_messages false
execute if score $CBA crusadehp matches 1.. unless predicate game:game_rules/disable_death_messages/on positioned 38 49 -37 as @e[type=player,gamemode=!creative,gamemode=!spectator,predicate=custom:team/any_playing_team,distance=..5] run tellraw @a[x=0] ["",{"selector":"@s"},{"text":" got too close to a Nexus","color":"white"}]
...
execute if score $CBA crusadehp matches 1.. unless predicate game:game_rules/disable_death_messages/on run gamerule minecraft:show_death_messages true
...
execute if score $CBA crusadehp matches 1.. unless score $CBAcd crusadehp matches 1.. positioned 36 47 -39 run function rr_crusade:game/nexus_glass_dynamic_fill with storage rocketriders:teams blue.color_palette
execute if score $CBA crusadehp matches 1.. run function rr_crusade:game/place_nexus/blue_a
...
execute if score $CBA crusadehp matches 1.. if score $CBAcd crusadehp matches 1.. run data modify entity @e[limit=1,x=0,type=end_crystal,tag=nexus.blue_a] Invulnerable set value true
...
execute unless score $CBA crusadehp matches 1.. positioned 38.5 49.6 -36.5 run function rr_crusade:game/nexus_destroyed_particles
