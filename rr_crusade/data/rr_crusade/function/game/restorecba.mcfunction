...
execute unless score $CBA crusadehp matches 1.. unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/yellow] ["\n",{"text":"✔ ","color":"green"},{"text":"Blue Crystal ","color":"blue"},{"text":"A","bold":true,"color":"dark_aqua"},{"text":" has been destroyed!","color":"blue"}]
execute unless score $CBA crusadehp matches 1.. unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/blue] ["\n",{"text":"⚠ ","color":"red"},{"text":"Blue Crystal ","color":"blue"},{"text":"A","bold":true,"color":"dark_aqua"},{"text":" has been destroyed!","color":"blue"}]
execute unless score $CBA crusadehp matches 1.. unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["\n",{"text":"Blue Crystal ","color":"blue"},{"text":"A","bold":true,"color":"dark_aqua"},{"text":" has been destroyed!","color":"blue"}]
execute unless score $CBA crusadehp matches 1.. if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/yellow] ["\n",{"text":"✔ ","color":"green"},{"text":"Red Crystal ","color":"dark_red"},{"text":"A","bold":true,"color":"red"},{"text":" has been destroyed!","color":"dark_red"}]
execute unless score $CBA crusadehp matches 1.. if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/blue] ["\n",{"text":"⚠ ","color":"red"},{"text":"Red Crystal ","color":"dark_red"},{"text":"A","bold":true,"color":"red"},{"text":" has been destroyed!","color":"dark_red"}]
execute unless score $CBA crusadehp matches 1.. if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["\n",{"text":"Red Crystal ","color":"dark_red"},{"text":"A","bold":true,"color":"red"},{"text":" has been destroyed!","color":"dark_red"}]
