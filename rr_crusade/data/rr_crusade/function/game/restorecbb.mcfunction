...
execute if score $CBB crusadehp matches 1.. unless score $CBBcd crusadehp matches 1.. unless predicate game:match_components/red_for_blue run fill -16 47 -35 -12 51 -39 minecraft:blue_stained_glass
execute if score $CBB crusadehp matches 1.. unless score $CBBcd crusadehp matches 1.. if predicate game:match_components/red_for_blue run fill -16 47 -35 -12 51 -39 minecraft:red_stained_glass
...
execute unless score $CBB crusadehp matches 1.. positioned -13.5 49.5 -36.5 run function rr_crusade:game/crystal_destroyed_particles
