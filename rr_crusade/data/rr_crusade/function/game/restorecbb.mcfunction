...
execute if score $CBB crusadehp matches 1.. unless score $CBBcd crusadehp matches 1.. positioned -16 47 -39 run function rr_crusade:game/nexus_glass_dynamic_fill with storage rocketriders:teams blue.color_palette
execute if score $CBB crusadehp matches 1.. run function rr_crusade:game/place_nexus/blue_b
...
execute if score $CBB crusadehp matches 1.. if score $CBBcd crusadehp matches 1.. run data modify entity @e[limit=1,x=0,type=end_crystal,tag=nexus.blue_b] Invulnerable set value true
...
execute unless score $CBB crusadehp matches 1.. run fill -16 47 -40 -12 51 -35 air
execute unless score $CBB crusadehp matches 1.. run fill -17 52 -40 -11 52 -37 air
execute unless score $CBB crusadehp matches 1.. positioned -13.5 49.5 -36.5 run function rr_crusade:game/nexus_destroyed_particles
