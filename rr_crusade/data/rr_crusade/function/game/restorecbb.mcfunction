...
execute if score $CBB crusadehp matches 1.. unless score $CBBcd crusadehp matches 1.. positioned -16 47 -39 run function rr_crusade:game/glass_dynamic_fill with storage rocketriders:teams blue.color_palette
...
execute if predicate game:blue_portal_revealed positioned -16 47 -39 run function rr_crusade:game/glass_dynamic_fill with storage rocketriders:teams blue.color_palette
