...
execute unless score $CBB crusadehp matches 1.. unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/yellow] ["\n",{"text":"✔ ","color":"green"},{"text":"Blue Crystal ","color":"blue"},{"text":"B","bold":true,"color":"dark_aqua"},{"text":" has been destroyed!","color":"blue"}]
execute unless score $CBB crusadehp matches 1.. unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/blue] ["\n",{"text":"⚠ ","color":"red"},{"text":"Blue Crystal ","color":"blue"},{"text":"B","bold":true,"color":"dark_aqua"},{"text":" has been destroyed!","color":"blue"}]
execute unless score $CBB crusadehp matches 1.. unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["\n",{"text":"Blue Crystal ","color":"blue"},{"text":"B","bold":true,"color":"dark_aqua"},{"text":" has been destroyed!","color":"blue"}]
execute unless score $CBB crusadehp matches 1.. if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/yellow] ["\n",{"text":"✔ ","color":"green"},{"text":"Red Crystal ","color":"dark_red"},{"text":"B","bold":true,"color":"red"},{"text":" has been destroyed!","color":"dark_red"}]
execute unless score $CBB crusadehp matches 1.. if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/blue] ["\n",{"text":"⚠ ","color":"red"},{"text":"Red Crystal ","color":"dark_red"},{"text":"B","bold":true,"color":"red"},{"text":" has been destroyed!","color":"dark_red"}]
execute unless score $CBB crusadehp matches 1.. if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["\n",{"text":"Red Crystal ","color":"dark_red"},{"text":"B","bold":true,"color":"red"},{"text":" has been destroyed!","color":"dark_red"}]
...
#> Expose Portals
execute if predicate game:blue_portal_revealed unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/yellow] ["\n",{"text":"Both Blue Crystals have been destroyed!","color":"blue"},{"text":"\nA portal has been exposed; destroy it to win!","color":"dark_aqua","italic":true}]
execute if predicate game:blue_portal_revealed unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/blue] ["\n",{"text":"Both of your Crystals have been destroyed!","color":"blue"},{"text":"\nYour portal is no longer protected; don't let it get destroyed!","color":"dark_aqua","italic":true}]
execute if predicate game:blue_portal_revealed unless predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["\n",{"text":"Both Blue Crystals have been destroyed!","color":"blue"}]
execute if predicate game:blue_portal_revealed if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/yellow] ["\n",{"text":"Both Red Crystals have been destroyed!","color":"dark_red"},{"text":"\nA portal has been exposed; destroy it to win!","color":"red","italic":true}]
execute if predicate game:blue_portal_revealed if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=custom:team/blue] ["\n",{"text":"Both of your Crystals have been destroyed!","color":"dark_red"},{"text":"\nYour portal is no longer protected; don't let it get destroyed!","color":"red","italic":true}]
execute if predicate game:blue_portal_revealed if predicate game:gamemode_components/red_for_blue run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["\n",{"text":"Both Red Crystals have been destroyed!","color":"dark_red"}]
