...
execute if score $CYA crusadehp matches 1.. unless score $nodeathmessages CmdData matches 1 positioned -14 49 37 as @e[type=player,gamemode=!creative,gamemode=!spectator,team=!Spectator,team=!Developer,team=!Lobby,distance=..5] run tellraw @a[x=0] ["",{"selector":"@s"},{"text":" got too close to an End Crystal","color":"white"}]
