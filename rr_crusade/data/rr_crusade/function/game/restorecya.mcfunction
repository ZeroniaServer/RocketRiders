...
execute if score $CYA crusadehp matches 1.. unless score $CYAcd crusadehp matches 1.. positioned -16 47 35 run function rr_crusade:game/glass_dynamic_fill with storage rocketriders:teams yellow.color_palette
...
execute if predicate game:yellow_portal_revealed positioned -16 47 35 run function rr_crusade:game/glass_dynamic_fill with storage rocketriders:teams yellow.color_palette
