...
execute if score $CYA crusadehp matches 1.. unless predicate game:game_rules/disable_death_messages/on run gamerule minecraft:show_death_messages false
...
execute if score $CYA crusadehp matches 1.. unless predicate game:game_rules/disable_death_messages/on run gamerule minecraft:show_death_messages true
...
execute if score $CYA crusadehp matches 1.. unless score $CYAcd crusadehp matches 1.. positioned -16 47 35 run function rr_crusade:game/nexus_glass_dynamic_fill with storage rocketriders:teams yellow.color_palette
execute if score $CYA crusadehp matches 1.. run function rr_crusade:game/place_nexus/yellow_a
...
execute if score $CYA crusadehp matches 1.. if score $CYAcd crusadehp matches 1.. run data modify entity @e[limit=1,x=0,type=end_crystal,tag=nexus.yellow_a] Invulnerable set value true
...
execute unless score $CYA crusadehp matches 1.. positioned -13.5 49.5 37.5 run function rr_crusade:game/nexus_destroyed_particles
