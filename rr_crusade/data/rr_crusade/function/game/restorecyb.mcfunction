...
execute if score $CYB crusadehp matches 1.. unless predicate game:game_rules/disable_death_messages/on run gamerule minecraft:show_death_messages false
...
execute if score $CYB crusadehp matches 1.. unless predicate game:game_rules/disable_death_messages/on run gamerule minecraft:show_death_messages true
...
execute if score $CYB crusadehp matches 1.. unless score $CYBcd crusadehp matches 1.. positioned 36 47 35 run function rr_crusade:game/nexus_glass_dynamic_fill with storage rocketriders:teams yellow.color_palette
execute if score $CYB crusadehp matches 1.. run function rr_crusade:game/place_nexus/yellow_b
...
execute if score $CYB crusadehp matches 1.. if score $CYBcd crusadehp matches 1.. run data modify entity @e[limit=1,x=0,type=end_crystal,tag=nexus.yellow_b] Invulnerable set value true
...
execute unless score $CYB crusadehp matches 1.. run fill 36 47 35 40 51 40 air
execute unless score $CYB crusadehp matches 1.. run fill 35 52 37 41 52 40 air
execute unless score $CYB crusadehp matches 1.. positioned 38.5 49.5 37.5 run function rr_crusade:game/nexus_destroyed_particles
