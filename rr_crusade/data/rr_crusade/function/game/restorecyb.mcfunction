...
execute if score $CYB crusadehp matches 1.. unless score $CYBcd crusadehp matches 1.. positioned 36 47 35 run function rr_crusade:game/crystal_glass_dynamic_fill with storage rocketriders:teams yellow.color_palette
...
execute unless score $CYB crusadehp matches 1.. positioned 38.5 49.5 37.5 run function rr_crusade:game/crystal_destroyed_particles
...
execute if predicate game:yellow_portal_revealed run bossbar set rr_crusade:yellow name [{score:{name:"#yellow",objective:"text.accent_color"}},"",[{score:{name:"#yellow",objective:"text.main_color"}},{bold:true,score:{name:"#yellow",objective:"text.team_name"}}]," Crystals are Destroyed"]
