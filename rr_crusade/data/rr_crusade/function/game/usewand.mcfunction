...
execute unless predicate game:match_components/has_spells run playsound block.note_block.didgeridoo master @s ~ ~ ~ 1 1
execute unless predicate game:match_components/has_spells run return run title @s actionbar [{"text":"Spells are not enabled in this game mode!","color":"red"}]
