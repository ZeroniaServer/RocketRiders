...
execute unless predicate game:match_in_play as @a[x=0,scores={crusadechange=2}] run function rr_crusade:items/kit/give/archer
execute unless predicate game:match_in_play as @a[x=0,scores={crusadechange=3}] run function rr_crusade:items/kit/give/mage

execute if predicate game:match_in_play as @a[x=0,tag=!CrusadeNoteKnight,scores={crusadechange=1}] run function rr_crusade:items/kit/notify/knight
execute if predicate game:match_in_play as @a[x=0,tag=!CrusadeNoteArcher,scores={crusadechange=2}] run function rr_crusade:items/kit/notify/archer
execute if predicate game:match_in_play as @a[x=0,tag=!CrusadeNoteMage,scores={crusadechange=3}] run function rr_crusade:items/kit/notify/mage

execute unless predicate game:match_in_play run tag @a[x=0] remove CrusadeNoteKnight
execute unless predicate game:match_in_play run tag @a[x=0] remove CrusadeNoteArcher
execute unless predicate game:match_in_play run tag @a[x=0] remove CrusadeNoteMage

execute unless predicate game:match_in_play run scoreboard players reset @a[x=0,scores={crusadechange=1..}] crusadechange
...
execute if entity @e[x=0,type=marker,tag=PlacerClear,tag=Cleared] unless predicate game:match_in_play run tag @s add crusadeLast
...
execute if entity @s[tag=EditedSettings] if score $extra_match_repetitions config matches 1.. if entity @a[x=0,tag=informMe] run function gamemodes:informrepeat
