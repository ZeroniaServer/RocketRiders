...
execute if entity @s[tag=rngGemi,tag=givenGemi] as @a[x=0,tag=Late,scores={crusadekit=1}] run function items:missile/normal/givegemi
...
execute if entity @s[tag=rngCitadel,tag=givenCita] as @a[x=0,tag=Late,scores={crusadekit=2}] run function items:missile/normal/givecitadel
