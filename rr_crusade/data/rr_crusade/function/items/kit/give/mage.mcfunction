...
execute unless entity @s[scores={crusadekit=3}] unless entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=GameStarted] run loot replace entity @s hotbar.0 loot items:misc/spell_wand_end
