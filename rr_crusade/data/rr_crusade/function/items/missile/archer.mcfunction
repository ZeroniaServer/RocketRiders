...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngBroad] as @a[x=0,scores={crusadekit=2},tag=getItem,predicate=custom:on_blue_or_yellow_team] run function items:missile/special/givebroad
