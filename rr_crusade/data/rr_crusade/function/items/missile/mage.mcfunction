...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngAnt] as @a[x=0,predicate=rr_crusade:kit/mage,tag=getItem,predicate=custom:team/any_playing_team] run function items:give_batch/missile/ant
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngToma] as @a[x=0,predicate=rr_crusade:kit/mage,tag=getItem,predicate=custom:team/any_playing_team] run function items:give_batch/missile/tomatwo
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngCata] as @a[x=0,predicate=rr_crusade:kit/mage,tag=getItem,predicate=custom:team/any_playing_team] run function items:give_batch/missile/catapult
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngLift] as @a[x=0,predicate=rr_crusade:kit/mage,tag=getItem,predicate=custom:team/any_playing_team] run function items:give_batch/missile/lifter
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngNull] as @a[x=0,predicate=rr_crusade:kit/mage,tag=getItem,predicate=custom:team/any_playing_team] run function items:give_batch/missile/chronullifier
