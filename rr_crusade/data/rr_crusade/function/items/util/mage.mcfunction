...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngSpellBook] as @a[x=0,scores={crusadekit=3},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function rr_crusade:items/util/givespellbook
