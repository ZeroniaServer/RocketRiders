...
execute as @e[x=0,type=marker,tag=SelectedTip,tag=Tip19] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"In Crusade Mode, both the Vortex and the ICBM can be obtained! The ICBM (short for \"intercontinental ballistic missile\") can be used to deal instant explosive damage upon contact.","color":"gray"}]
