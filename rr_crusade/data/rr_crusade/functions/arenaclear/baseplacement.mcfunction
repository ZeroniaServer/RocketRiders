...
execute as @e[predicate=custom:indimension,type=armor_stand,tag=ArcherStand,tag=BlueKit] run item replace entity @s armor.head with chainmail_helmet{Trim:{material:"minecraft:lapis",pattern:"minecraft:tide"}}
