...
#kit stand items
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=BlueKit] run item replace entity @s armor.head with netherite_helmet{Trim:{material:"minecraft:lapis",pattern:"minecraft:tide"}}
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=YellowKit] run item replace entity @s armor.head with netherite_helmet{Trim:{material:"minecraft:gold",pattern:"minecraft:raiser"}}
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=BlueKit] run item replace entity @s armor.chest with leather_chestplate{Trim:{material:"minecraft:quartz",pattern:"minecraft:vex"},display:{color:3949738}}
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=YellowKit] run item replace entity @s armor.chest with leather_chestplate{Trim:{material:"minecraft:netherite",pattern:"minecraft:spire"},display:{color:16768000}}
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=BlueKit] run item replace entity @s armor.legs with iron_leggings{Trim:{material:"minecraft:lapis",pattern:"minecraft:vex"}}
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=YellowKit] run item replace entity @s armor.legs with iron_leggings{Trim:{material:"minecraft:netherite",pattern:"minecraft:spire"}}
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=BlueKit] run item replace entity @s armor.feet with leather_boots{Trim:{material:"minecraft:quartz",pattern:"minecraft:vex"},display:{color:3949738}}
execute as @e[x=0,type=armor_stand,tag=KnightStand,tag=YellowKit] run item replace entity @s armor.feet with leather_boots{Trim:{material:"minecraft:netherite",pattern:"minecraft:spire"},display:{color:16768000}}
...
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=BlueKit] run item replace entity @s armor.head with chainmail_helmet{Trim:{material:"minecraft:lapis",pattern:"minecraft:tide"}}
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=YellowKit] run item replace entity @s armor.head with chainmail_helmet{Trim:{material:"minecraft:gold",pattern:"minecraft:raiser"}}
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=BlueKit] run item replace entity @s armor.chest with chainmail_chestplate{Trim:{material:"minecraft:lapis",pattern:"minecraft:vex"},display:{color:3949738}}
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=YellowKit] run item replace entity @s armor.chest with chainmail_chestplate{Trim:{material:"minecraft:gold",pattern:"minecraft:spire"},display:{color:16768000}}
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=BlueKit] run item replace entity @s armor.legs with leather_leggings{Trim:{material:"minecraft:quartz",pattern:"minecraft:vex"},display:{color:3949738}}
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=YellowKit] run item replace entity @s armor.legs with leather_leggings{Trim:{material:"minecraft:netherite",pattern:"minecraft:spire"},display:{color:16768000}}
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=BlueKit] run item replace entity @s armor.feet with leather_boots{Trim:{material:"minecraft:quartz",pattern:"minecraft:vex"},display:{color:3949738}}
execute as @e[x=0,type=armor_stand,tag=ArcherStand,tag=YellowKit] run item replace entity @s armor.feet with leather_boots{Trim:{material:"minecraft:netherite",pattern:"minecraft:spire"},display:{color:16768000}}
...
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=BlueKit] run item replace entity @s armor.chest with leather_chestplate{Trim:{material:"minecraft:quartz",pattern:"minecraft:vex"},display:{color:3949738}}
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=YellowKit] run item replace entity @s armor.chest with leather_chestplate{Trim:{material:"minecraft:netherite",pattern:"minecraft:spire"},display:{color:16768000}}
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=BlueKit] run item replace entity @s armor.legs with leather_leggings{Trim:{material:"minecraft:quartz",pattern:"minecraft:vex"},display:{color:3949738}}
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=YellowKit] run item replace entity @s armor.legs with leather_leggings{Trim:{material:"minecraft:netherite",pattern:"minecraft:spire"},display:{color:16768000}}
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=BlueKit] run item replace entity @s armor.feet with leather_boots{Trim:{material:"minecraft:quartz",pattern:"minecraft:vex"},display:{color:3949738}}
execute as @e[x=0,type=armor_stand,tag=MageStand,tag=YellowKit] run item replace entity @s armor.feet with leather_boots{Trim:{material:"minecraft:netherite",pattern:"minecraft:spire"},display:{color:16768000}}
