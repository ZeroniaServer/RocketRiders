...
execute if score @e[tag=Selection,tag=!crusadeEnabled,tag=switchGamemodes,limit=1] SetGamemode = @e[tag=rr_crusade,limit=1] gamemodeID run function rr_crusade:enable
