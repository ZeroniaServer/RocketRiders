...
execute unless entity @s[tag=noPortal] as @e[type=marker,tag=yellownovatracker] at @s if entity @s[x=2,y=37,z=64,dx=20,dy=26,dz=6] run kill @s
execute unless entity @s[tag=noPortal] as @e[type=marker,tag=bluenovatracker] at @s if entity @s[x=2,y=37,z=-70,dx=20,dy=26,dz=6] run kill @s
