...
execute if entity @s[tag=GameStarted,tag=!SMActive] run tellraw @a[predicate=custom:indimension,tag=JoinYellow] [{"text":"Drop your ","color":"yellow","italic":true},{"text":"Knight Sword ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
...
execute if entity @s[scores={count=600},tag=!SMActive] run tellraw @a[predicate=custom:indimension,team=Blue,scores={crusadekit=1}] [{"text":"Drop your ","color":"aqua","italic":true},{"text":"Knight Sword ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"aqua","italic":true}]
execute if entity @s[scores={count=600},tag=!SMActive] run tellraw @a[predicate=custom:indimension,team=Blue,scores={crusadekit=2}] [{"text":"Drop your ","color":"aqua","italic":true},{"text":"Shooting Saber ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"aqua","italic":true}]
execute if entity @s[scores={count=600},tag=!SMActive] run tellraw @a[predicate=custom:indimension,team=Blue,scores={crusadekit=3}] [{"text":"Drop your ","color":"aqua","italic":true},{"text":"Fire Wand ","color":"blue","bold":true,"italic":false},{"text":"to leave the match.","color":"aqua","italic":true}]
...
execute if entity @s[scores={count=600},tag=!SMActive] run tellraw @a[predicate=custom:indimension,team=Yellow,scores={crusadekit=1}] [{"text":"Drop your ","color":"yellow","italic":true},{"text":"Knight Sword ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
execute if entity @s[scores={count=600},tag=!SMActive] run tellraw @a[predicate=custom:indimension,team=Yellow,scores={crusadekit=2}] [{"text":"Drop your ","color":"yellow","italic":true},{"text":"Shooting Saber ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
execute if entity @s[scores={count=600},tag=!SMActive] run tellraw @a[predicate=custom:indimension,team=Yellow,scores={crusadekit=3}] [{"text":"Drop your ","color":"yellow","italic":true},{"text":"Fire Wand ","color":"gold","bold":true,"italic":false},{"text":"to leave the match.","color":"yellow","italic":true}]
...
execute if entity @s[scores={count=600}] run clear @a[predicate=custom:indimension,team=Blue,scores={crusadekit=2}] bow
execute if entity @s[scores={count=600}] run clear @a[predicate=custom:indimension,team=Yellow,scores={crusadekit=2}] bow
execute if entity @s[scores={count=600}] as @a[predicate=custom:indimension,team=Blue,scores={crusadekit=2}] run item replace entity @s hotbar.0 with bow{display:{Name:'{"translate":"Shooting Saber","color":"blue","bold":true,"italic":false}',Lore:['{"translate":"A weapon used for both"}','{"translate":"ranged and melee attacks."}']},HideFlags:4,Unbreakable:1b,Enchantments:[{id:"flame",lvl:1},{id:"sharpness",lvl:4}]}
execute if entity @s[scores={count=600}] as @a[predicate=custom:indimension,team=Yellow,scores={crusadekit=2}] run item replace entity @s hotbar.0 with bow{display:{Name:'{"translate":"Shooting Saber","color":"gold","bold":true,"italic":false}',Lore:['{"translate":"A weapon used for both"}','{"translate":"ranged and melee attacks."}']},HideFlags:4,Unbreakable:1b,Enchantments:[{id:"flame",lvl:1},{id:"sharpness",lvl:4}]}
execute if entity @s[scores={count=600}] as @a[predicate=custom:indimension,team=Blue,scores={crusadekit=2}] run tag @s remove fullOffhand
execute if entity @s[scores={count=600}] as @a[predicate=custom:indimension,team=Yellow,scores={crusadekit=2}] run tag @s remove fullOffhand
#Hotfix for losing shield in queue
execute if entity @s[scores={count=600}] run clear @a[predicate=custom:indimension,team=Blue,scores={crusadekit=1}] shield
execute if entity @s[scores={count=600}] run clear @a[predicate=custom:indimension,team=Yellow,scores={crusadekit=1}] shield
execute if entity @s[scores={count=600}] as @a[predicate=custom:indimension,team=Blue,scores={crusadekit=1}] run item replace entity @s weapon.offhand with shield{Damage:326,display:{Name:'[{"text":"Knight Shield","italic":false,"bold":true,"color":"blue"}]',Lore:['[{"translate":"A not-so-sturdy shield."}]']},BlockEntityTag:{Base:11,Patterns:[{Pattern:"flo",Color:3},{Pattern:"bo",Color:3}]}}
execute if entity @s[scores={count=600}] as @a[predicate=custom:indimension,team=Yellow,scores={crusadekit=1}] run item replace entity @s[team=Yellow] weapon.offhand with shield{Damage:326,display:{Name:'[{"text":"Knight Shield","italic":false,"bold":true,"color":"gold"}]',Lore:['[{"translate":"A not-so-sturdy shield."}]']},BlockEntityTag:{Base:4,Patterns:[{Pattern:"flo",Color:1},{Pattern:"bo",Color:1}]}}
