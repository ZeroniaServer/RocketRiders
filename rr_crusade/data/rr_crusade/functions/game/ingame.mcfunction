...
#> Kit signs + obsidian
execute unless block 14 64 -64 oak_wall_sign run setblock 14 64 -64 minecraft:oak_wall_sign[facing=north]{front_text:{messages:['{"text":"Select Kit:","clickEvent":{"action":"run_command","value":"trigger crusadechange set 1"},"color":"#09FF00"}', '{"text":"Knight","bold":true,"color":"#008805"}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}}
execute unless block 12 64 -63 oak_wall_sign run setblock 12 64 -63 minecraft:oak_wall_sign[facing=north]{front_text:{messages:['{"text":"Select Kit:","clickEvent":{"action":"run_command","value":"trigger crusadechange set 2"},"color":"#09FF00"}', '{"text":"Archer","bold":true,"color":"#008805"}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}}
execute unless block 10 64 -64 oak_wall_sign run setblock 10 64 -64 minecraft:oak_wall_sign[facing=north]{front_text:{messages:['{"text":"Select Kit:","clickEvent":{"action":"run_command","value":"trigger crusadechange set 3"},"color":"#09FF00"}', '{"text":"Mage","bold":true,"color":"#008805"}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}}
execute unless block 10 64 64 oak_wall_sign run setblock 10 64 64 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['{"text":"Select Kit:","clickEvent":{"action":"run_command","value":"trigger crusadechange set 1"},"color":"#09FF00"}', '{"text":"Knight","bold":true,"color":"#008805"}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}}
execute unless block 12 64 63 oak_wall_sign run setblock 12 64 63 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['{"text":"Select Kit:","clickEvent":{"action":"run_command","value":"trigger crusadechange set 2"},"color":"#09FF00"}', '{"text":"Archer","bold":true,"color":"#008805"}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}}
execute unless block 14 64 64 oak_wall_sign run setblock 14 64 64 minecraft:oak_wall_sign[facing=south]{front_text:{messages:['{"text":"Select Kit:","clickEvent":{"action":"run_command","value":"trigger crusadechange set 3"},"color":"#09FF00"}', '{"text":"Mage","bold":true,"color":"#008805"}', '{"text":""}', '{"text":""}'], has_glowing_text: false, color: "black"}}
