scoreboard players remove $CYA crusadehp 2
...
execute if score $CYA crusadehp matches 1.. run fill 2 58 32 -2 62 36 minecraft:yellow_stained_glass
execute if score $CYA crusadehp matches 1.. run summon end_crystal 0 60 34 {Tags:["CrusadeEntity","CrusadeYellowA"],BeamTarget:{X:12,Y:54,Z:52},ShowBottom:0b}
execute if score $CYA crusadehp matches 1.. positioned 0 60 34 run playsound minecraft:block.glass.break master @a ~ ~ ~ 1 0.8
execute if score $CYA crusadehp matches 1.. positioned 0 60 34 run playsound minecraft:block.respawn_anchor.set_spawn master @a ~ ~ ~ 2 2
