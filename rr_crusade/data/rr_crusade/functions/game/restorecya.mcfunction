...
execute unless score $CYA crusadehp matches 1.. run tellraw @a[predicate=custom:indimension,team=Blue] ["\n",{"text":"✔ ","color":"green"},{"text":"Yellow Crystal ","color":"gold"},{"text":"A","bold":true,"color":"yellow"},{"text":" has been destroyed!","color":"gold"}]
execute unless score $CYA crusadehp matches 1.. run tellraw @a[predicate=custom:indimension,team=Yellow] ["\n",{"text":"⚠ ","color":"red"},{"text":"Yellow Crystal ","color":"gold"},{"text":"A","bold":true,"color":"yellow"},{"text":" has been destroyed!","color":"gold"}]
execute unless score $CYA crusadehp matches 1.. run tellraw @a[predicate=custom:indimension,team=!Yellow,team=!Blue] ["\n",{"text":"Yellow Crystal ","color":"gold"},{"text":"A","bold":true,"color":"yellow"},{"text":" has been destroyed!","color":"gold"}]
execute unless score $CYA crusadehp matches 1.. as @a[predicate=custom:indimension,team=Blue] at @s run playsound minecraft:entity.experience_orb.pickup master @s ~ ~ ~ 1 0
execute unless score $CYA crusadehp matches 1.. as @a[predicate=custom:indimension,team=Blue] at @s run playsound minecraft:block.glass.break master @s ~ ~ ~ 1 2
execute unless score $CYA crusadehp matches 1.. as @a[predicate=custom:indimension,team=Yellow] at @s run playsound minecraft:entity.wither.death master @s ~ ~ ~ 1 1
execute unless score $CYA crusadehp matches 1.. as @a[predicate=custom:indimension,team=Yellow] at @s run playsound minecraft:block.glass.break master @s ~ ~ ~ 1 0

execute if score $CYA crusadehp matches 1.. run gamerule showDeathMessages false
execute if score $CYA crusadehp matches 1.. positioned -14 49 37 as @e[predicate=custom:indimension,type=player,team=!Spectator,team=!Developer,team=!Lobby,distance=..5] run tellraw @a[predicate=custom:indimension] ["",{"selector":"@s"},{"text":" went too close to an End Crystal","color":"white"}]
execute if score $CYA crusadehp matches 1.. positioned -14 49 37 run kill @a[predicate=custom:indimension,team=!Spectator,team=!Developer,team=!Lobby,distance=..5]
...
execute if score $CYA crusadehp matches 1.. positioned -14 49 37 run playsound minecraft:block.glass.break master @a[predicate=custom:indimension] ~ ~ ~ 1 0.8
execute if score $CYA crusadehp matches 1.. positioned -14 49 37 run playsound minecraft:block.respawn_anchor.set_spawn master @a[predicate=custom:indimension] ~ ~ ~ 2 2
...
execute unless score $CYA crusadehp matches 1.. run tellraw @a[predicate=custom:indimension] [""]