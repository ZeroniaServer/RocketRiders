execute unless entity @e[tag=rr_crusade,limit=1,type=armor_stand] run summon armor_stand 23 216 -18 {Tags:["rr_crusade"],Marker:1b,Invisible:1b,Invulnerable:1b,CustomNameVisible:0b}
