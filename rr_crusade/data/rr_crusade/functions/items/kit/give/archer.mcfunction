...
execute unless entity @s[scores={crusadekit=2}] run item replace entity @s[team=Blue] hotbar.0 with bow{display:{Name:'{"translate":"Shooting Saber","color":"blue","bold":true,"italic":false}',Lore:['{"translate":"A weapon used for"}','{"translate":"ranged attacks."}']},HideFlags:4,Unbreakable:1b,Enchantments:[{id:"flame",lvl:1}]}
...
execute unless entity @s[scores={crusadekit=2}] run item replace entity @s[team=Yellow] hotbar.0 with bow{display:{Name:'{"translate":"Shooting Saber","color":"gold","bold":true,"italic":false}',Lore:['{"translate":"A weapon used for"}','{"translate":"ranged attacks."}']},HideFlags:4,Unbreakable:1b,Enchantments:[{id:"flame",lvl:1}]}
...
execute if entity @e[type=armor_stand,tag=Selection,tag=!GameStarted,tag=!GameEnd,scores={count=..599}] unless entity @s[scores={crusadekit=2}] run item replace entity @s weapon.offhand with arrow{display:{Name:'{"text":"Arrow","color":"light_purple","italic":true,"bold":true}'},Lobby:1b} 20
