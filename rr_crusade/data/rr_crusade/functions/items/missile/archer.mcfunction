...
execute as @e[type=marker,tag=rngSelected,tag=rngGemi] as @a[predicate=custom:indimension,scores={crusadekit=2},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/givegemi
execute as @e[type=marker,tag=rngSelected,tag=rngSlash] as @a[predicate=custom:indimension,scores={crusadekit=2},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/giveslash
execute as @e[type=marker,tag=rngSelected,tag=rngThun] as @a[predicate=custom:indimension,scores={crusadekit=2},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/lightning/givethun
execute as @e[type=marker,tag=rngSelected,tag=rngHur] as @a[predicate=custom:indimension,scores={crusadekit=2},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/lightning/givehur
execute as @e[type=marker,tag=rngSelected,tag=rngBroad] as @a[predicate=custom:indimension,scores={crusadekit=2},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/special/givebroad
