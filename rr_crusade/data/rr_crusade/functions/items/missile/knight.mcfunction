...
execute as @e[type=marker,tag=rngSelected,tag=rngCitadel] as @a[predicate=custom:indimension,scores={crusadekit=1},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/givecitadel
execute as @e[type=marker,tag=rngSelected,tag=rngJbuster] as @a[predicate=custom:indimension,scores={crusadekit=1},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/heavy/givejbuster
execute as @e[type=marker,tag=rngSelected,tag=rngWar] as @a[predicate=custom:indimension,scores={crusadekit=1},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/heavy/givewar
execute as @e[type=marker,tag=rngSelected,tag=rngAux] as @a[predicate=custom:indimension,scores={crusadekit=1},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/heavy/giveaux
execute as @e[type=marker,tag=rngSelected,tag=rngBlade] as @a[predicate=custom:indimension,scores={crusadekit=1},tag=getItem] unless entity @s[team=!Yellow,team=!Blue] run function items:missile/normal/giveblade
