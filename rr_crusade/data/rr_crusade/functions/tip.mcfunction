...
execute as @e[type=marker,tag=SelectedTip,tag=Tip7] as @a unless entity @s[scores={GamesPlayed=10..}] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"In Crusade Mode, both enemy crystals A and B must be destroyed to unlock the portal behind the enemy base.","color":"gray"}]
...
execute as @e[type=marker,tag=SelectedTip,tag=Tip9] as @a unless entity @s[scores={GamesPlayed=10..}] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"In Crusade Mode, the glass beneath the middle platform regenerates over time.","color":"gray"}]
...
execute as @e[type=marker,tag=SelectedTip,tag=Tip17] as @a unless entity @s[scores={GamesPlayed=10..}] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"In Crusade Mode, you can easily destroy enemy crystals by sending missles at the glass.","color":"gray"}]
