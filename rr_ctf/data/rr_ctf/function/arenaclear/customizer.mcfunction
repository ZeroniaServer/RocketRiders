...
execute if entity @s[scores={refreshsigns=1..}] run data modify block -69 192 74 front_text.messages[0] set value {"text":"Game Mode:","color":"#6b006b"}
data modify block -69 191 74 front_text.messages[0] set value {"text":""}
data modify block -69 191 74 front_text.messages[1] set value {"color":"light_purple","click_event":{"action":"run_command","command":"function rr_ctf:info"},"text":"Game Mode Info"}
