scoreboard players set $flags_captured_by_blue match_data 0
scoreboard players set $flags_captured_by_yellow match_data 0
...
scoreboard players set $flag_state.yellow_right match_data 30
scoreboard players set $flag_state.yellow_left match_data 30
scoreboard players set $flag_state.blue_right match_data 30
scoreboard players set $flag_state.blue_left match_data 30
