scoreboard players set $flags_captured_by_blue match 0
scoreboard players set $flags_captured_by_yellow match 0
...
scoreboard players set $flag_state.yellow_right match 30
scoreboard players set $flag_state.yellow_left match 30
scoreboard players set $flag_state.blue_right match 30
scoreboard players set $flag_state.blue_left match 30
