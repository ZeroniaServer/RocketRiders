...
scoreboard players display numberformat Blue: FlagDisp fixed ["",{text:"0",color:red,bold:true},{text:"/2 ",color:white},[{score:{name:"#yellow",objective:"text.accent_color"}},"🏴"]]
...
scoreboard players display numberformat Yellow: FlagDisp fixed ["",{text:"0",color:red,bold:true},{text:"/2 ",color:white},[{score:{name:"#blue",objective:"text.accent_color"}},"🏴"]]
