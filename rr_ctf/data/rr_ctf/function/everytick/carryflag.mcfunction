...
execute as @a[x=0,tag=CarryFY1,scores={FlagScore=1}] run item replace entity @s armor.head with minecraft:yellow_banner[enchantments={binding_curse:1}]
execute as @a[x=0,tag=CarryFY1,scores={FlagScore=1}] run fill 34 65 63 30 72 64 air replace yellow_wool
execute as @a[x=0,tag=CarryFY2,scores={FlagScore=1}] run item replace entity @s armor.head with minecraft:yellow_banner[enchantments={binding_curse:1}]
execute as @a[x=0,tag=CarryFY2,scores={FlagScore=1}] run fill -10 66 64 -14 65 63 air replace yellow_wool
execute as @a[x=0,tag=CarryFB1,scores={FlagScore=1}] run item replace entity @s armor.head with minecraft:blue_banner[enchantments={binding_curse:1}]
execute as @a[x=0,tag=CarryFB1,scores={FlagScore=1}] run fill -14 65 -64 -10 66 -65 air replace blue_wool
execute as @a[x=0,tag=CarryFB2,scores={FlagScore=1}] run item replace entity @s armor.head with minecraft:blue_banner[enchantments={binding_curse:1}]
