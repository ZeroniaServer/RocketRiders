...
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] unless score $flags_captured_by_blue global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},[{color:"white",text:" has captured "},{score:{name:"$flags_captured_by_blue",objective:"global"}}]]
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_blue global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},{color:"white",text:" has captured 1"}]
...
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" successfully captured a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" successfully captured your flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"blue"},{"text":" successfully captured a","color":"yellow"},{"text":" Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
...
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] unless score $flags_captured_by_blue global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},[{color:"white",text:" has captured "},{score:{name:"$flags_captured_by_blue",objective:"global"}}]]
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_blue global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},{color:"white",text:" has captured 1"}]
...
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" successfully captured a ","color":"green"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" successfully captured your flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"blue"},{"text":" successfully captured a","color":"dark_aqua"},{"text":" Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
...
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] unless score $flags_captured_by_yellow global matches 1 run scoreboard players display name Yellow: FlagDisp [{color:"gold",text:"Yellow"},[{color:"white",text:" has captured "},{score:{name:"$flags_captured_by_yellow",objective:"global"}}]]
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_yellow global matches 1 run scoreboard players display name Yellow: FlagDisp [{color:"gold",text:"Yellow"},{color:"white",text:" has captured 1"}]
...
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" successfully captured a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" successfully captured your flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"gold"},{"text":" successfully captured a","color":"dark_aqua"},{"text":" Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
...
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB2,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_yellow global matches 1 run scoreboard players display name Yellow: FlagDisp [{color:"gold",text:"Yellow"},{color:"white",text:" has captured 1"}]
...
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB2,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" successfully captured a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB2,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" successfully captured your flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB2,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"gold"},{"text":" successfully captured a","color":"dark_aqua"},{"text":" Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
...
execute as @a[x=0,tag=CarryFlag,predicate=custom:team/blue,scores={FlagScore=1}] at @s run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"blue"},{"text":" stole a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute as @a[x=0,tag=CarryFlag,predicate=custom:team/blue,scores={FlagScore=1}] at @s run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" stole a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute as @a[x=0,tag=CarryFlag,predicate=custom:team/blue,scores={FlagScore=1}] at @s run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" stole your flag!","color":"yellow"},"\n"]


execute as @a[x=0,tag=CarryFlag,predicate=custom:team/yellow,scores={FlagScore=1}] at @s run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"gold"},{"text":" stole a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute as @a[x=0,tag=CarryFlag,predicate=custom:team/yellow,scores={FlagScore=1}] at @s run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" stole a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute as @a[x=0,tag=CarryFlag,predicate=custom:team/yellow,scores={FlagScore=1}] at @s run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" stole your flag!","color":"dark_aqua"},"\n"]
effect give @a[x=0,tag=CarryFlag,scores={FlagScore=1}] glowing infinite 0 true
effect give @a[x=0,tag=CarryFlag,scores={FlagScore=1}] resistance 15 0 true
effect give @a[x=0,tag=CarryFlag,scores={FlagScore=1}] strength 15 0 true
