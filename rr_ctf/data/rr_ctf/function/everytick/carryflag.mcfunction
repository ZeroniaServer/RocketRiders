...
execute as @e[x=0,type=player,team=Blue,tag=CarryFY1,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] unless score $flags_captured_by_yellow global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},[{color:"white",text:" has captured "},{score:{name:"$flags_captured_by_blue",objective:"global"}}]]
execute as @e[x=0,type=player,team=Blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_yellow global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},{color:"white",text:" has captured 1 flag"}]
...
execute as @e[x=0,type=player,team=Yellow,tag=CarryFB1,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_yellow global matches 1 run scoreboard players display name Yellow: FlagDisp [{color:"gold",text:"Yellow"},{color:"white",text:" has captured 1 flag"}]
...
execute as @e[x=0,type=player,team=Yellow,tag=CarryFB2,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_yellow global matches 1 run scoreboard players display name Yellow: FlagDisp [{color:"gold",text:"Yellow"},{color:"white",text:" has captured 1 flag"}]
