...
execute as @e[x=0,type=player,team=Blue,tag=CarryFY1,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] unless score $flags_captured_by_blue global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},[{color:"white",text:" has captured "},{score:{name:"$flags_captured_by_blue",objective:"global"}}]]
execute as @e[x=0,type=player,team=Blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_blue global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},{color:"white",text:" has captured 1"}]
...
execute as @e[x=0,type=player,team=Blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] unless score $flags_captured_by_blue global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},[{color:"white",text:" has captured "},{score:{name:"$flags_captured_by_blue",objective:"global"}}]]
execute as @e[x=0,type=player,team=Blue,tag=CarryFY2,tag=onBlue,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_blue global matches 1 run scoreboard players display name Blue: FlagDisp [{color:"blue",text:"Blue"},{color:"white",text:" has captured 1"}]
...
execute as @e[x=0,type=player,team=Yellow,tag=CarryFB1,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_yellow global matches 1 run scoreboard players display name Yellow: FlagDisp [{color:"gold",text:"Yellow"},{color:"white",text:" has captured 1"}]
...
execute as @e[x=0,type=player,team=Yellow,tag=CarryFB2,tag=onYellow,predicate=custom:alive,scores={FlagDeliver=3..}] if score $flags_captured_by_yellow global matches 1 run scoreboard players display name Yellow: FlagDisp [{color:"gold",text:"Yellow"},{color:"white",text:" has captured 1"}]
...
execute if entity @a[limit=1,x=0,tag=CarryFB1,scores={FlagScore=1}] run fill -14 65 -64 -10 66 -65 air replace blue_wool
execute if entity @a[limit=1,x=0,tag=CarryFB2,scores={FlagScore=1}] run fill 30 65 -64 34 66 -65 air replace blue_wool
execute if entity @a[limit=1,x=0,tag=CarryFlag,scores={FlagScore=1}] as @a[x=0,team=!Lobby] at @s run playsound entity.ender_dragon.flap master @s ~ ~ ~ 1 2
