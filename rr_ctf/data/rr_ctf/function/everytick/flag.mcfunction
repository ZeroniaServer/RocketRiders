...
execute if predicate game:match_in_play as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run tellraw @a[x=0,team=!Yellow,team=!Blue] ["","\n",{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run tellraw @a[x=0,team=Blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run tellraw @a[x=0,team=Yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" lowered your flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:match_in_play positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run scoreboard players set FY1: FlagScore 29
execute if predicate game:match_in_play positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:match_in_play as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,team=!Yellow,team=!Blue] ["","\n",{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,team=Blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,team=Yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" lowered your flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:match_in_play positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run scoreboard players set FY2: FlagScore 29
execute if predicate game:match_in_play positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:match_in_play as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,team=!Yellow,team=!Blue] ["","\n",{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,team=Yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,team=Blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" lowered your flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:match_in_play positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run scoreboard players set FB1: FlagScore 29
execute if predicate game:match_in_play positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:match_in_play as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,team=!Yellow,team=!Blue] ["","\n",{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,team=Yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,team=Blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" lowered your flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:match_in_play positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run scoreboard players set FB2: FlagScore 29
execute if predicate game:match_in_play positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:match_in_play run tag @e[x=0,type=player,team=Blue,tag=CarryFY1] add CarryFlag
execute if predicate game:match_in_play run tag @e[x=0,type=player,team=Blue,tag=CarryFY2] add CarryFlag
execute if predicate game:match_in_play run tag @e[x=0,type=player,team=Yellow,tag=CarryFB1] add CarryFlag
execute if predicate game:match_in_play run tag @e[x=0,type=player,team=Yellow,tag=CarryFB2] add CarryFlag
...
execute if predicate game:match_in_play run scoreboard players add @a[x=0,team=Blue] FlagsCaptured 0
execute if predicate game:match_in_play run scoreboard players add @a[x=0,team=Yellow] FlagsCaptured 0
execute if predicate game:match_in_play run scoreboard players reset @a[x=0,team=!Blue,team=!Yellow] FlagsCaptured
...
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFB1] if score FB1: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFB2] if score FB2: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFY1] if score FY1: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFY2] if score FY2: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
...
execute if predicate game:match_in_play as @a[x=0,tag=CarryFB1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB1,team=!Lobby,team=!Spectator] if score FB1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @a[x=0,tag=CarryFB2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB2,team=!Lobby,team=!Spectator] if score FB2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY1,team=!Lobby,team=!Spectator] if score FY1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"selector":"@s","color":"blue"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY2,team=!Lobby,team=!Spectator] if score FY2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"selector":"@s","color":"blue"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]

execute if predicate game:match_in_play as @a[x=0,tag=CarryFB1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB1,team=!Lobby,team=!Spectator] if score FB1: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play as @a[x=0,tag=CarryFB2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB2,team=!Lobby,team=!Spectator] if score FB2: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY1,team=!Lobby,team=!Spectator] if score FY1: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY2,team=!Lobby,team=!Spectator] if score FY2: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7

execute if predicate game:match_in_play as @a[x=0,tag=CarryFB1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB1,team=!Lobby,team=!Spectator] if score FB1: FlagScore matches -1 run scoreboard players set FB1: FlagScore 0
execute if predicate game:match_in_play as @a[x=0,tag=CarryFB2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB2,team=!Lobby,team=!Spectator] if score FB2: FlagScore matches -1 run scoreboard players set FB2: FlagScore 0
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY1,team=!Lobby,team=!Spectator] if score FY1: FlagScore matches -1 run scoreboard players set FY1: FlagScore 0
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY2,team=!Lobby,team=!Spectator] if score FY2: FlagScore matches -1 run scoreboard players set FY2: FlagScore 0
...
execute if predicate game:match_in_play unless entity @e[x=0,type=player,team=Blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 value 0
execute if predicate game:match_in_play unless entity @e[x=0,type=player,team=Blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 players none
execute if predicate game:match_in_play unless entity @e[x=0,type=player,team=Blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 value 0
execute if predicate game:match_in_play unless entity @e[x=0,type=player,team=Blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 players none
execute if predicate game:match_in_play unless entity @e[x=0,type=player,team=Yellow,tag=CarryFB1] run bossbar set rr_ctf:fb1 value 0
