...
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
...
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:phase/match/play positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run scoreboard players set FY1: FlagScore 29
execute if predicate game:phase/match/play positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" lowered your flag!","color":"yellow"},"\n"]
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:phase/match/play positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run scoreboard players set FY2: FlagScore 29
execute if predicate game:phase/match/play positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:phase/match/play unless predicate game:gamemode_components/red_for_blue as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:phase/match/play if predicate game:gamemode_components/red_for_blue as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s"},{"text":" lowered a ","color":"red"},{"text":"Red","color":"dark_red"},{"text":" flag!","color":"red"},"\n"]
...
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:phase/match/play positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run scoreboard players set FB1: FlagScore 29
execute if predicate game:phase/match/play positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:phase/match/play unless predicate game:gamemode_components/red_for_blue as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:phase/match/play if predicate game:gamemode_components/red_for_blue as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s"},{"text":" lowered a ","color":"red"},{"text":"Red","color":"dark_red"},{"text":" flag!","color":"red"},"\n"]
execute if predicate game:phase/match/play unless predicate game:gamemode_components/red_for_blue as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:phase/match/play if predicate game:gamemode_components/red_for_blue as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s"},{"text":" lowered a ","color":"red"},{"text":"Red","color":"dark_red"},{"text":" flag!","color":"red"},"\n"]
execute if predicate game:phase/match/play unless predicate game:gamemode_components/red_for_blue as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s"},{"text":" lowered your flag!","color":"dark_aqua"},"\n"]
execute if predicate game:phase/match/play if predicate game:gamemode_components/red_for_blue as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s"},{"text":" lowered your flag!","color":"red"},"\n"]
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:phase/match/play positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run scoreboard players set FB2: FlagScore 29
execute if predicate game:phase/match/play positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
