...
execute if predicate game:match_in_play as @a[x=0,tag=CarryFlag,tag=!DelayActionbar] run title @s actionbar [{"text":"You stole a flag! Return to your base to capture it!","color":"white","bold":true}]
...
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
...
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:match_in_play positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run scoreboard players set FY1: FlagScore 29
execute if predicate game:match_in_play positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
execute unless predicate game:match_in_play positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if score FY1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:match_in_play if score FY1: FlagScore matches 0 positioned 34 65 64 if entity @e[type=player,predicate=custom:team/blue,distance=..3] unless entity @a[x=0,tag=CarryFY1] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,predicate=custom:team/blue,distance=..2,predicate=custom:alive] add CarryFY1
execute if predicate game:match_in_play if score FY1: FlagScore matches 0 positioned 34 65 64 if entity @e[type=player,predicate=custom:team/blue,distance=..7,scores={MineWhiteGlass=1..}] unless entity @a[x=0,tag=CarryFY1] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,predicate=custom:team/blue,distance=..7,scores={MineWhiteGlass=1..},predicate=custom:alive] add CarryFY1
execute if predicate game:match_in_play if entity @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1] run scoreboard players set FY1: FlagScore -1
...
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" lowered your flag!","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:match_in_play positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run scoreboard players set FY2: FlagScore 29
execute if predicate game:match_in_play positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,predicate=custom:team/blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
execute unless predicate game:match_in_play positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if score FY2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:match_in_play if score FY2: FlagScore matches 0 positioned -10 65 64 if entity @e[type=player,predicate=custom:team/blue,distance=..3] unless entity @a[x=0,tag=CarryFY2] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,predicate=custom:team/blue,distance=..2,predicate=custom:alive] add CarryFY2
execute if predicate game:match_in_play if score FY2: FlagScore matches 0 positioned -10 65 64 if entity @e[type=player,predicate=custom:team/blue,distance=..7,scores={MineWhiteGlass=1..}] unless entity @a[x=0,tag=CarryFY2] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,predicate=custom:team/blue,distance=..7,scores={MineWhiteGlass=1..},predicate=custom:alive] add CarryFY2
execute if predicate game:match_in_play if entity @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2] run scoreboard players set FY2: FlagScore -1
...
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" lowered your flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:match_in_play positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run scoreboard players set FB1: FlagScore 29
execute if predicate game:match_in_play positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
execute unless predicate game:match_in_play positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if score FB1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:match_in_play if score FB1: FlagScore matches 0 positioned -10 65 -64 if entity @e[type=player,predicate=custom:team/yellow,distance=..3] unless entity @a[x=0,tag=CarryFB1] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,predicate=custom:team/yellow,distance=..2,predicate=custom:alive] add CarryFB1
execute if predicate game:match_in_play if score FB1: FlagScore matches 0 positioned -10 65 -64 if entity @e[type=player,predicate=custom:team/yellow,distance=..7,scores={MineWhiteGlass=1..}] unless entity @a[x=0,tag=CarryFB1] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,predicate=custom:team/yellow,distance=..7,scores={MineWhiteGlass=1..},predicate=custom:alive] add CarryFB1
execute if predicate game:match_in_play if entity @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1] run scoreboard players set FB1: FlagScore -1
...
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" lowered your flag!","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute if predicate game:match_in_play positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run scoreboard players set FB2: FlagScore 29
execute if predicate game:match_in_play positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
execute unless predicate game:match_in_play positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if score FB2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if predicate game:match_in_play if score FB2: FlagScore matches 0 positioned 34 65 -64 if entity @e[type=player,predicate=custom:team/yellow,distance=..3] unless entity @a[x=0,tag=CarryFB2] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,predicate=custom:team/yellow,distance=..2,predicate=custom:alive] add CarryFB2
execute if predicate game:match_in_play if score FB2: FlagScore matches 0 positioned 34 65 -64 if entity @e[type=player,predicate=custom:team/yellow,distance=..7,scores={MineWhiteGlass=1..}] unless entity @a[x=0,tag=CarryFB2] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,predicate=custom:team/yellow,distance=..7,scores={MineWhiteGlass=1..},predicate=custom:alive] add CarryFB2
execute if predicate game:match_in_play if entity @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB2] run scoreboard players set FB2: FlagScore -1
...
execute if predicate game:match_in_play run tag @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1] add CarryFlag
execute if predicate game:match_in_play run tag @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2] add CarryFlag
execute if predicate game:match_in_play run tag @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1] add CarryFlag
execute if predicate game:match_in_play run tag @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB2] add CarryFlag

# Show flag carriers in tablist
#scoreboard players set @a[x=0,tag=CarryFlag] flag_tablist_display 1
execute if predicate game:match_in_play run scoreboard players reset @a[x=0,tag=!CarryFlag] flag_tablist_display
execute if predicate game:match_in_play run scoreboard players display numberformat @a[x=0,tag=CarryFlag,tag=CarryFY1] flag_tablist_display fixed {color:"yellow",text:"🏴"}
execute if predicate game:match_in_play run scoreboard players display numberformat @a[x=0,tag=CarryFlag,tag=CarryFY2] flag_tablist_display fixed {color:"yellow",text:"🏴"}
execute if predicate game:match_in_play run scoreboard players display numberformat @a[x=0,tag=CarryFlag,tag=CarryFB1] flag_tablist_display fixed {color:"blue",text:"🏴"}
execute if predicate game:match_in_play run scoreboard players display numberformat @a[x=0,tag=CarryFlag,tag=CarryFB2] flag_tablist_display fixed {color:"blue",text:"🏴"}

#Add scores for flag carriers
execute if predicate game:match_in_play run scoreboard players add @a[x=0,predicate=custom:team/blue] FlagsCaptured 0
execute if predicate game:match_in_play run scoreboard players add @a[x=0,predicate=custom:team/yellow] FlagsCaptured 0
execute if predicate game:match_in_play run scoreboard players reset @a[x=0,predicate=!custom:team/any_playing_team] FlagsCaptured
execute if predicate game:match_in_play run scoreboard players set @a[x=0,scores={FlagsCaptured=3..}] FlagsCaptured 2

#If flag carrier disconnects completely
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFB1] if score FB1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"text":"A player left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFB2] if score FB2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"text":"A player left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFY1] if score FY1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"text":"A player left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFY2] if score FY2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"text":"A player left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]

execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFB1] if score FB1: FlagScore matches -1 as @a[x=0,predicate=!custom:team/lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFB2] if score FB2: FlagScore matches -1 as @a[x=0,predicate=!custom:team/lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFY1] if score FY1: FlagScore matches -1 as @a[x=0,predicate=!custom:team/lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFY2] if score FY2: FlagScore matches -1 as @a[x=0,predicate=!custom:team/lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7

execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFB1] if score FB1: FlagScore matches -1 run scoreboard players set FB1: FlagScore 0
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFB2] if score FB2: FlagScore matches -1 run scoreboard players set FB2: FlagScore 0
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFY1] if score FY1: FlagScore matches -1 run scoreboard players set FY1: FlagScore 0
execute if predicate game:match_in_play unless entity @a[x=0,tag=CarryFY2] if score FY2: FlagScore matches -1 run scoreboard players set FY2: FlagScore 0

#Handle non-players (leaving midgame)
#Does not apply if there's already another flag carrier (in case of relog)
execute if predicate game:match_in_play as @a[x=0,tag=CarryFB1,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFB1,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FB1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @a[x=0,tag=CarryFB2,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFB2,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FB2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY1,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFY1,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FY1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"selector":"@s","color":"blue"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY2,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFY2,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FY2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"selector":"@s","color":"blue"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]

execute if predicate game:match_in_play as @a[x=0,tag=CarryFB1,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFB1,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FB1: FlagScore matches -1 as @a[x=0,predicate=!custom:team/lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play as @a[x=0,tag=CarryFB2,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFB2,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FB2: FlagScore matches -1 as @a[x=0,predicate=!custom:team/lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY1,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFY1,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FY1: FlagScore matches -1 as @a[x=0,predicate=!custom:team/lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY2,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFY2,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FY2: FlagScore matches -1 as @a[x=0,predicate=!custom:team/lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7

execute if predicate game:match_in_play as @a[x=0,tag=CarryFB1,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFB1,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FB1: FlagScore matches -1 run scoreboard players set FB1: FlagScore 0
execute if predicate game:match_in_play as @a[x=0,tag=CarryFB2,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFB2,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FB2: FlagScore matches -1 run scoreboard players set FB2: FlagScore 0
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY1,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFY1,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FY1: FlagScore matches -1 run scoreboard players set FY1: FlagScore 0
execute if predicate game:match_in_play as @a[x=0,tag=CarryFY2,predicate=!custom:team/any_playing_team] unless entity @a[x=0,tag=CarryFY2,predicate=!custom:team/lobby,predicate=!custom:team/spectator] if score FY2: FlagScore matches -1 run scoreboard players set FY2: FlagScore 0

execute if predicate game:match_in_play run function rr_ctf:everytick/clearflagtags

execute if predicate game:match_in_play run scoreboard players reset @a[x=0] MinePurpleGlass
execute if predicate game:match_in_play run scoreboard players reset @a[x=0] MineWhiteGlass
...
execute if predicate game:match_in_play run effect clear @a[x=0,tag=!CarryFlag,predicate=custom:team/any_playing_team] resistance
execute if predicate game:match_in_play run effect clear @a[x=0,tag=!CarryFlag,predicate=custom:team/any_playing_team] strength
execute if predicate game:match_in_play run effect clear @a[x=0,tag=!CarryFlag,predicate=custom:team/any_playing_team] absorption
execute if predicate game:match_in_play unless entity @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 value 0
execute if predicate game:match_in_play unless entity @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 players none
execute if predicate game:match_in_play unless entity @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 value 0
execute if predicate game:match_in_play unless entity @e[x=0,type=player,predicate=custom:team/blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 players none
execute if predicate game:match_in_play unless entity @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1] run bossbar set rr_ctf:fb1 value 0
execute if predicate game:match_in_play unless entity @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB1] run bossbar set rr_ctf:fb1 players none
execute if predicate game:match_in_play unless entity @e[x=0,type=player,predicate=custom:team/yellow,tag=CarryFB2] run bossbar set rr_ctf:fb2 value 0
