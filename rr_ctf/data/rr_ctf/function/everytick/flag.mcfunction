...
execute if score FlagWave FlagScore matches 20 if score FB1: FlagScore matches 30.. unless predicate game:gamemode_components/red_for_blue run place template game:blue_flag1 -14 71 -65
execute if score FlagWave FlagScore matches 20 if score FB1: FlagScore matches 30.. if predicate game:gamemode_components/red_for_blue run place template game:red_flag1 -14 71 -65
execute if score FlagWave FlagScore matches 40.. if score FB1: FlagScore matches 30.. unless predicate game:gamemode_components/red_for_blue run place template game:blue_flag2 -14 71 -65
execute if score FlagWave FlagScore matches 40.. if score FB1: FlagScore matches 30.. if predicate game:gamemode_components/red_for_blue run place template game:red_flag2 -14 71 -65

execute if score FlagWave FlagScore matches 20 if score FB2: FlagScore matches 30.. unless predicate game:gamemode_components/red_for_blue run place template game:blue_flag1 30 71 -65
execute if score FlagWave FlagScore matches 20 if score FB2: FlagScore matches 30.. if predicate game:gamemode_components/red_for_blue run place template game:red_flag1 30 71 -65
execute if score FlagWave FlagScore matches 40.. if score FB2: FlagScore matches 30.. unless predicate game:gamemode_components/red_for_blue run place template game:blue_flag2 30 71 -65
execute if score FlagWave FlagScore matches 40.. if score FB2: FlagScore matches 30.. if predicate game:gamemode_components/red_for_blue run place template game:red_flag2 30 71 -65
...
execute as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run tellraw @a[x=0,team=!Yellow,team=!Blue] ["","\n",{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run tellraw @a[x=0,team=Blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run tellraw @a[x=0,team=Yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" lowered your flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run scoreboard players set FY1: FlagScore 29
execute positioned 34 65 64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if score FY1: FlagScore matches 0 positioned 34 65 64 if entity @e[type=player,team=Blue,distance=..3] unless entity @a[x=0,tag=CarryFY1] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,team=Blue,distance=..2,scores={respawn=0},predicate=custom:alive] add CarryFY1
execute if score FY1: FlagScore matches 0 positioned 34 65 64 if entity @e[type=player,team=Blue,distance=..7,scores={MineWhiteGlass=1..}] unless entity @a[x=0,tag=CarryFY1] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,team=Blue,distance=..7,scores={MineWhiteGlass=1..,respawn=0},predicate=custom:alive] add CarryFY1
...
execute as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,team=!Yellow,team=!Blue] ["","\n",{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,team=Blue] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"blue"},{"text":" lowered a ","color":"yellow"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run tellraw @a[x=0,team=Yellow] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"blue"},{"text":" lowered your flag!","color":"yellow"},"\n"]
execute as @e[x=0,type=player,team=Blue,scores={MinePurpleGlass=1..}] positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run scoreboard players set FY2: FlagScore 29
execute positioned -10 65 64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,team=Blue,scores={MinePurpleGlass=1..},distance=..7] if score FY2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if score FY2: FlagScore matches 0 positioned -10 65 64 if entity @e[type=player,team=Blue,distance=..3] unless entity @a[x=0,tag=CarryFY2] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,team=Blue,distance=..2,scores={respawn=0},predicate=custom:alive] add CarryFY2
execute if score FY2: FlagScore matches 0 positioned -10 65 64 if entity @e[type=player,team=Blue,distance=..7,scores={MineWhiteGlass=1..}] unless entity @a[x=0,tag=CarryFY2] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,team=Blue,distance=..7,scores={MineWhiteGlass=1..,respawn=0},predicate=custom:alive] add CarryFY2
...
execute as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,team=!Yellow,team=!Blue] ["","\n",{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,team=Yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,team=Blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" lowered your flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run scoreboard players set FB1: FlagScore 29
execute positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if score FB1: FlagScore matches 0 positioned -10 65 -64 if entity @e[type=player,team=Yellow,distance=..3] unless entity @a[x=0,tag=CarryFB1] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,team=Yellow,distance=..2,scores={respawn=0},predicate=custom:alive] add CarryFB1
...
execute as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,team=!Yellow,team=!Blue] ["","\n",{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,team=Yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,team=Blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" lowered your flag!","color":"dark_aqua"},"\n"]
execute as @e[x=0,type=player,team=Yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run function rr_ctf:everytick/lowerflagtitle

execute positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run scoreboard players set FB2: FlagScore 29
execute positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass unless entity @e[type=player,team=Yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run setblock ~ ~ ~ purple_stained_glass
...
execute if score FB2: FlagScore matches 0 positioned 34 65 -64 if entity @e[type=player,team=Yellow,distance=..3] unless entity @a[x=0,tag=CarryFB2] run tag @e[type=player,limit=1,sort=nearest,tag=!CarryFlag,team=Yellow,distance=..2,scores={respawn=0},predicate=custom:alive] add CarryFB2
...
tag @e[x=0,type=player,team=Blue,tag=CarryFY1] add CarryFlag
tag @e[x=0,type=player,team=Blue,tag=CarryFY2] add CarryFlag
...
scoreboard players reset @a[x=0,team=!Blue,team=!Yellow] FlagsCaptured
scoreboard players set @a[x=0,scores={FlagsCaptured=3..}] FlagsCaptured 2

#If flag carrier disconnects completely
execute unless entity @a[x=0,tag=CarryFB1] if score FB1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"text":"A player left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute unless entity @a[x=0,tag=CarryFB2] if score FB2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"text":"A player left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute unless entity @a[x=0,tag=CarryFY1] if score FY1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"text":"A player left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]
execute unless entity @a[x=0,tag=CarryFY2] if score FY2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"text":"A player left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]

execute unless entity @a[x=0,tag=CarryFB1] if score FB1: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute unless entity @a[x=0,tag=CarryFB2] if score FB2: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute unless entity @a[x=0,tag=CarryFY1] if score FY1: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute unless entity @a[x=0,tag=CarryFY2] if score FY2: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7

execute unless entity @a[x=0,tag=CarryFB1] if score FB1: FlagScore matches -1 run scoreboard players set FB1: FlagScore 0
execute unless entity @a[x=0,tag=CarryFB2] if score FB2: FlagScore matches -1 run scoreboard players set FB2: FlagScore 0
execute unless entity @a[x=0,tag=CarryFY1] if score FY1: FlagScore matches -1 run scoreboard players set FY1: FlagScore 0
execute unless entity @a[x=0,tag=CarryFY2] if score FY2: FlagScore matches -1 run scoreboard players set FY2: FlagScore 0

#Handle non-players (leaving midgame)
#Does not apply if there's already another flag carrier (in case of relog)
execute as @a[x=0,tag=CarryFB1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB1,team=!Lobby,team=!Spectator] if score FB1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute as @a[x=0,tag=CarryFB2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB2,team=!Lobby,team=!Spectator] if score FB2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"dark_aqua"},"\n"]
execute as @a[x=0,tag=CarryFY1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY1,team=!Lobby,team=!Spectator] if score FY1: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"selector":"@s","color":"blue"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]
execute as @a[x=0,tag=CarryFY2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY2,team=!Lobby,team=!Spectator] if score FY2: FlagScore matches -1 run tellraw @a[x=0] ["","\n",{"text":"Flag Restored! ","color":"gold"},{"selector":"@s","color":"blue"},{"text":" left the match while carrying a flag so the flag has been placed back at the base.","color":"yellow"},"\n"]

execute as @a[x=0,tag=CarryFB1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB1,team=!Lobby,team=!Spectator] if score FB1: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute as @a[x=0,tag=CarryFB2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB2,team=!Lobby,team=!Spectator] if score FB2: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute as @a[x=0,tag=CarryFY1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY1,team=!Lobby,team=!Spectator] if score FY1: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7
execute as @a[x=0,tag=CarryFY2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY2,team=!Lobby,team=!Spectator] if score FY2: FlagScore matches -1 as @a[x=0,team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell master @s ~ ~ ~ 1 1.7

execute as @a[x=0,tag=CarryFB1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB1,team=!Lobby,team=!Spectator] if score FB1: FlagScore matches -1 run scoreboard players set FB1: FlagScore 0
execute as @a[x=0,tag=CarryFB2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFB2,team=!Lobby,team=!Spectator] if score FB2: FlagScore matches -1 run scoreboard players set FB2: FlagScore 0
execute as @a[x=0,tag=CarryFY1,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY1,team=!Lobby,team=!Spectator] if score FY1: FlagScore matches -1 run scoreboard players set FY1: FlagScore 0
execute as @a[x=0,tag=CarryFY2,team=!Blue,team=!Yellow] unless entity @a[x=0,tag=CarryFY2,team=!Lobby,team=!Spectator] if score FY2: FlagScore matches -1 run scoreboard players set FY2: FlagScore 0

function rr_ctf:everytick/clearflagtags

scoreboard players reset @a[x=0] MinePurpleGlass
scoreboard players reset @a[x=0] MineWhiteGlass
...
effect clear @a[x=0,tag=!CarryFlag,predicate=custom:on_blue_or_yellow_team] glowing
effect clear @a[x=0,tag=!CarryFlag,predicate=custom:on_blue_or_yellow_team] resistance
effect clear @a[x=0,tag=!CarryFlag,predicate=custom:on_blue_or_yellow_team] strength
effect clear @a[x=0,tag=!CarryFlag,predicate=custom:on_blue_or_yellow_team] absorption
execute unless entity @e[x=0,type=player,team=Blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 value 0
execute unless entity @e[x=0,type=player,team=Blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 players none
execute unless entity @e[x=0,type=player,team=Blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 value 0
execute unless entity @e[x=0,type=player,team=Blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 players none
execute unless entity @e[x=0,type=player,team=Yellow,tag=CarryFB1] run bossbar set rr_ctf:fb1 value 0
execute unless entity @e[x=0,type=player,team=Yellow,tag=CarryFB1] run bossbar set rr_ctf:fb1 players none
execute unless entity @e[x=0,type=player,team=Yellow,tag=CarryFB2] run bossbar set rr_ctf:fb2 value 0
execute unless entity @e[x=0,type=player,team=Yellow,tag=CarryFB2] run bossbar set rr_ctf:fb2 players none

#Flip missile tags
tag @a[x=0,tag=CarryFlag,tag=!FlipMissile] add FlipMissile
tag @a[x=0,tag=!CarryFlag] remove FlipMissile
