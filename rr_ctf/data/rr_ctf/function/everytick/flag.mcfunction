...
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned -10 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB1: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
...
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=!custom:team/any_playing_team] ["","\n",{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/yellow] ["","\n",{"text":"✔ ","color":"green"},{"selector":"@s","color":"gold"},{"text":" lowered a ","color":"dark_aqua"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"dark_aqua"},"\n"]
execute if predicate game:phase/match/play as @e[x=0,type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..}] positioned 34 65 -64 unless block ~ ~ ~ purple_stained_glass if entity @e[type=player,predicate=custom:team/yellow,scores={MinePurpleGlass=1..},distance=..7] if score FB2: FlagScore matches 30.. run tellraw @a[x=0,predicate=custom:team/blue] ["","\n",{"text":"⚠ ","color":"red"},{"selector":"@s","color":"gold"},{"text":" lowered your flag!","color":"dark_aqua"},"\n"]
