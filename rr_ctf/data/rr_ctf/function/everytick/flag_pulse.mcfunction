...
$execute if score $stage var matches 2 positioned ~2 ~-1 ~ if block ~ ~ ~ #custom:flag_supports_replaceable run setblock ~ ~ ~ $(back) destroy
execute if score $stage var matches 2 unless predicate custom:flag_needs_ladders run return 0
...
# Ladders
execute if score $stage var matches 3.. unless predicate custom:flag_needs_ladders run return 0
...
execute if score $stage var matches 4 positioned ~ ~-2 ~ if predicate custom:flag_ladder_can_generate run function rr_ctf:everytick/flag_pulse_ladders
execute if score $stage var matches 5 positioned ~ ~-3 ~ if predicate custom:flag_ladder_can_generate run function rr_ctf:everytick/flag_pulse_ladders
execute if score $stage var matches 6 positioned ~ ~-4 ~ if predicate custom:flag_ladder_can_generate run function rr_ctf:everytick/flag_pulse_ladders
execute if score $stage var matches 7 positioned ~ ~-5 ~ if predicate custom:flag_ladder_can_generate run function rr_ctf:everytick/flag_pulse_ladders
