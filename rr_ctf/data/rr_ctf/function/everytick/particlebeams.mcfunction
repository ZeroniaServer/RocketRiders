...
execute as @a[x=0,tag=CarryFlag,team=Blue] at @s anchored eyes if score $dust CmdData matches 1 run particle minecraft:dust{color:[0,0,1],scale:1} ~ ~28 ~ 0 10 0 1 100 force @a[tag=!hideParticles,team=!Lobby,distance=10..40,predicate=custom:belowroof]
execute as @a[x=0,tag=CarryFlag,team=Yellow] at @s anchored eyes if score $dust CmdData matches 1 run particle minecraft:dust{color:[1,1,0],scale:1} ~ ~28 ~ 0 10 0 1 100 force @a[tag=!hideParticles,team=!Lobby,distance=10..40,predicate=custom:belowroof]
...
execute as @a[x=0,tag=CarryFlag,team=Yellow] at @s anchored eyes if score $dust CmdData matches 1 run particle minecraft:dust{color:[1,1,0],scale:1} ~ ~28 ~ 0.1 10 0.1 1 100 force @a[tag=!hideParticles,team=!Lobby,distance=40..80,predicate=custom:belowroof]

#distant thickest
execute as @a[x=0,tag=CarryFlag,team=Blue] at @s anchored eyes if score $dust CmdData matches 1 run particle minecraft:dust{color:[0,0,1],scale:1} ~ ~28 ~ 0.15 10 0.15 1 100 force @a[tag=!hideParticles,team=!Lobby,distance=80..,predicate=custom:belowroof]
execute as @a[x=0,tag=CarryFlag,team=Yellow] at @s anchored eyes if score $dust CmdData matches 1 run particle minecraft:dust{color:[1,1,0],scale:1} ~ ~28 ~ 0.15 10 0.15 1 100 force @a[tag=!hideParticles,team=!Lobby,distance=80..,predicate=custom:belowroof]
...
execute as @e[x=0,type=marker,tag=FlagParticleBlue,scores={CmdData=..75}] at @s if score $dust CmdData matches 1 run particle minecraft:dust{color:[0,0,1],scale:1.5} ^ ^ ^1.2 0 0 0 0 1 force @a[tag=!hideParticles,team=!Lobby,distance=2..,predicate=custom:belowroof]
