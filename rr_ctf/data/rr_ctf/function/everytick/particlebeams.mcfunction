...
execute if predicate custom:periodic_tick/3 if predicate game:gamemode_components/red_for_blue as @e[x=0,type=marker,tag=FlagParticleBlue,scores={CmdData=..74}] at @s run particle minecraft:dust{color:[1,0,0],scale:1.5} ^ ^ ^-1.2 0 0 0 0 1 force @a[tag=!hideParticles,predicate=!custom:team/lobby,distance=2..,predicate=custom:in_arena]
execute if predicate custom:periodic_tick/3 as @e[x=0,type=marker,tag=FlagParticleYellow,scores={CmdData=..74}] at @s run particle minecraft:dust{color:[1,1,0],scale:1.5} ^ ^ ^1.2 0 0 0 0 1 force @a[tag=!hideParticles,predicate=!custom:team/lobby,distance=2..,predicate=custom:in_arena]
execute if predicate custom:periodic_tick/3 as @e[x=0,type=marker,tag=FlagParticleYellow,scores={CmdData=..74}] at @s run particle minecraft:dust{color:[1,1,0],scale:1.5} ^ ^ ^-1.2 0 0 0 0 1 force @a[tag=!hideParticles,predicate=!custom:team/lobby,distance=2..,predicate=custom:in_arena]
...
execute if predicate custom:periodic_tick/3 if predicate game:gamemode_components/red_for_blue as @e[x=0,type=marker,tag=FlagParticleBlue,scores={CmdData=75..}] at @s run particle minecraft:dust{color:[1,0.5,0.5],scale:1.5} ^ ^ ^-1.2 0 0 0 0 1 force @a[tag=!hideParticles,predicate=!custom:team/lobby,distance=2..,predicate=custom:in_arena]
execute if predicate custom:periodic_tick/3 as @e[x=0,type=marker,tag=FlagParticleYellow,scores={CmdData=75..}] at @s run particle minecraft:dust{color:[1,0.75,0],scale:1.5} ^ ^ ^1.2 0 0 0 0 1 force @a[tag=!hideParticles,predicate=!custom:team/lobby,distance=2..,predicate=custom:in_arena]
execute if predicate custom:periodic_tick/3 as @e[x=0,type=marker,tag=FlagParticleYellow,scores={CmdData=75..}] at @s run particle minecraft:dust{color:[1,0.75,0],scale:1.5} ^ ^ ^-1.2 0 0 0 0 1 force @a[tag=!hideParticles,predicate=!custom:team/lobby,distance=2..,predicate=custom:in_arena]
