execute store result score $randomglass CmdData run random value 0..14
...
execute if score $randomglass CmdData matches 12 run setblock ~ ~ ~ gray_stained_glass
execute if score $randomglass CmdData matches 13 run setblock ~ ~ ~ black_stained_glass
execute if score $randomglass CmdData matches 14 run setblock ~ ~ ~ brown_stained_glass
