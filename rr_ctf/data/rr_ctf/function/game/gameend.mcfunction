...
execute if entity @s[scores={endtimer=1},tag=BlueWon] run give @a[x=0,team=Yellow] minecraft:netherite_pickaxe[custom_name={"translate":"Piercing Pickaxe","color":"gold","bold":true,"italic":false},lore=[{"translate":"A tool used both for"},{"translate":"mining and melee attacks."}],unbreakable={},enchantments={unbreaking:4},attribute_modifiers=[{operation:"add_value",amount:-2.2d,slot:"mainhand",type:"attack_speed",id:"rr_ctf:piercing_pickaxe_attack_speed"}]]
execute if entity @s[scores={endtimer=1},tag=YellowWon] run clear @a[x=0,team=Blue] netherite_pickaxe
execute if entity @s[scores={endtimer=1},tag=YellowWon] run give @a[x=0,team=Blue] minecraft:netherite_pickaxe[custom_name={"translate":"Piercing Pickaxe","color":"blue","bold":true,"italic":false},lore=[{"translate":"A tool used both for"},{"translate":"mining and melee attacks."}],unbreakable={},enchantments={unbreaking:4},attribute_modifiers=[{operation:"add_value",amount:-2.2d,slot:"mainhand",type:"attack_speed",id:"rr_ctf:piercing_pickaxe_attack_speed"}]]
