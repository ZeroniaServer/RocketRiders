...
execute if score $match_over_timer global matches 1.. run bossbar set rr_ctf:fy1 name ""
...
execute if score $match_over_timer global matches 1.. run bossbar set rr_ctf:fy2 name ""
...
execute if score $match_over_timer global matches 1.. run bossbar set rr_ctf:fb1 name ""
...
execute if score $match_over_timer global matches 1.. run bossbar set rr_ctf:fb2 name ""
