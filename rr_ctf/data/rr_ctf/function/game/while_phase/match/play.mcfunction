...
#Overtime tiebreaker
execute if score $play_time match_data matches 36000 unless predicate game:game_rules/disable_overtime/on run tag @s add CTFOvertime
...
#win
execute if score $flags_captured_by_blue match_data matches 2 if score $flags_captured_by_yellow match_data matches 2 run function game:winboth
execute unless predicate game:outcome/both_won if score $flags_captured_by_blue match_data matches 2 run function game:winblue
execute unless predicate game:outcome/both_won if score $flags_captured_by_yellow match_data matches 2 run function game:winyellow
