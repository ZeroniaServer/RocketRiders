...
scoreboard players set @e[x=0,type=marker,tag=CTFRNG,limit=1] RNGmax 4
execute as @e[x=0,type=marker,tag=CTFRNG,limit=1] store result score @s RNGscore run data get entity @s UUID[0]
execute as @e[x=0,type=marker,tag=CTFRNG,limit=1] store result score @s RNGscore run scoreboard players operation @s RNGscore %= @s RNGmax
execute if entity @s[tag=!gaveFirstItem] run scoreboard players set @e[x=0,type=marker,tag=CTFRNG,limit=1] RNGscore 3
...
execute if entity @s[tag=canopyStreaked] if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=0}] run function items:rng
execute if entity @s[tag=canopyStreaked] if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=0}] run function items:tetris
execute if entity @s[tag=canopyStreaked,scores={canopyStreak=1..}] if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=0}] run scoreboard players remove @s canopyStreak 1
execute if entity @s[tag=gaveFirstItem,tag=!canopyStreaked,scores={canopyStreak=2..}] if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=0}] run tag @s add canopyStreaked

#Select item (75% chance)
execute if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=1..3}] as @a[x=0] unless entity @s[team=!Yellow,team=!Blue] run tag @s add getItem
execute if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=1..3}] run tag @s add tetrisTime
execute if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=1..3}] run function items:tetris
execute if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=1..3}] run function items:rng
execute if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=1..3}] run function items:tetris
execute if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=1..3}] run tag @a[x=0] remove getItem
execute if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=1..3}] run tag @s remove tetrisTime
execute if entity @s[scores={canopyStreak=1..}] if entity @e[x=0,type=marker,tag=CTFRNG,limit=1,scores={RNGscore=1..3}] run scoreboard players remove @s canopyStreak 1
