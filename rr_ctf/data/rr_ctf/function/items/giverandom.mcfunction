...
execute if entity @s[tag=gaveFirstItem,tag=!canopyStreaked,scores={canopyStreak=..1}] if score $CTFRNG RNGscore matches 0 as @a[x=0,predicate=custom:team/any_playing_team] run function items:item/givecanopy
