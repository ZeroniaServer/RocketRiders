#Yellow Flag 1
execute if entity @e[x=0,type=player,team=Blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 players @a[x=0,team=!Lobby]
execute if entity @e[x=0,type=player,team=Blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 name ["",{"selector":"@e[x=0,type=player,team=Blue,tag=CarryFY1,limit=1]","color":"blue"},{"text":" is carrying a ","color":"dark_aqua"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"dark_aqua"}]
...
#Yellow Flag 2
execute if entity @e[x=0,type=player,team=Blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 players @a[x=0,team=!Lobby]
execute if entity @e[x=0,type=player,team=Blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 name ["",{"selector":"@e[x=0,type=player,team=Blue,tag=CarryFY2,limit=1]","color":"blue"},{"text":" is carrying a ","color":"dark_aqua"},{"text":"Yellow","color":"gold"},{"text":" flag!","color":"dark_aqua"}]
...
#Blue Flag 1
execute if entity @e[x=0,type=player,team=Yellow,tag=CarryFB1] run bossbar set rr_ctf:fb1 players @a[x=0,team=!Lobby]
execute if entity @e[x=0,type=player,team=Yellow,tag=CarryFB1] run bossbar set rr_ctf:fb1 name ["",{"selector":"@e[x=0,type=player,team=Yellow,tag=CarryFB1,limit=1]","color":"gold"},{"text":" is carrying a ","color":"yellow"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"yellow"}]
...
#Blue Flag 2
execute if entity @e[x=0,type=player,team=Yellow,tag=CarryFB2] run bossbar set rr_ctf:fb2 players @a[x=0,team=!Lobby]
execute if entity @e[x=0,type=player,team=Yellow,tag=CarryFB2] run bossbar set rr_ctf:fb2 name ["",{"selector":"@e[x=0,type=player,team=Yellow,tag=CarryFB2,limit=1]","color":"gold"},{"text":" is carrying a ","color":"yellow"},{"text":"Blue","color":"blue"},{"text":" flag!","color":"yellow"}]
