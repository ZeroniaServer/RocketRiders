#Yellow Flag 1
execute if entity @e[type=player,team=Blue,tag=CarryFY1] run bossbar set rr_ctf:fy1 players @a[predicate=custom:indimension,team=!Lobby]
...
#Yellow Flag 2
execute if entity @e[type=player,team=Blue,tag=CarryFY2] run bossbar set rr_ctf:fy2 players @a[predicate=custom:indimension,team=!Lobby]
...
#Blue Flag 1
execute if entity @e[type=player,team=Yellow,tag=CarryFB1] run bossbar set rr_ctf:fb1 players @a[predicate=custom:indimension,team=!Lobby]
...
#Blue Flag 2
execute if entity @e[type=player,team=Yellow,tag=CarryFB2] run bossbar set rr_ctf:fb2 players @a[predicate=custom:indimension,team=!Lobby]
