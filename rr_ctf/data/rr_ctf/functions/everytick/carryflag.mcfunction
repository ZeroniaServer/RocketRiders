...
execute as @a[tag=CarryFY1,scores={respawn=1}] run scoreboard players set FY1: FlagScore 0
execute as @a[tag=CarryFY2,scores={respawn=1}] run scoreboard players set FY2: FlagScore 0
execute as @a[tag=CarryFB1,scores={respawn=1}] run scoreboard players set FB1: FlagScore 0
execute as @a[tag=CarryFB2,scores={respawn=1}] run scoreboard players set FB2: FlagScore 0

execute as @a[tag=CarryFY1,scores={respawn=1}] run tellraw @a ["",{"text":"Flag Restored! ","color":"gold"},{"selector":"@s","color":"blue"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"yellow"}]
execute as @a[tag=CarryFY2,scores={respawn=1}] run tellraw @a ["",{"text":"Flag Restored! ","color":"gold"},{"selector":"@s","color":"blue"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"yellow"}]
execute as @a[tag=CarryFB1,scores={respawn=1}] run tellraw @a ["",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"aqua"}]
execute as @a[tag=CarryFB2,scores={respawn=1}] run tellraw @a ["",{"text":"Flag Restored! ","color":"blue"},{"selector":"@s","color":"gold"},{"text":" died while carrying a flag so the flag has been placed back at the base.","color":"aqua"}]

execute as @a[tag=CarryFY1,scores={respawn=1}] as @a[team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell player @s ~ ~ ~ 1 1.7
execute as @a[tag=CarryFY2,scores={respawn=1}] as @a[team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell player @s ~ ~ ~ 1 1.7
execute as @a[tag=CarryFB1,scores={respawn=1}] as @a[team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell player @s ~ ~ ~ 1 1.7
execute as @a[tag=CarryFB2,scores={respawn=1}] as @a[team=!Lobby] at @s run playsound minecraft:entity.evoker.cast_spell player @s ~ ~ ~ 1 1.7

tag @a[tag=CarryFlag,scores={respawn=1}] remove CarryFY1
tag @a[tag=CarryFlag,scores={respawn=1}] remove CarryFY2
tag @a[tag=CarryFlag,scores={respawn=1}] remove CarryFB1
tag @a[tag=CarryFlag,scores={respawn=1}] remove CarryFB2

#Deliver Yellow flag at Blue base
execute as @a[team=Blue,tag=CarryFY1,tag=onBlue,scores={respawn=0}] run scoreboard players add Blue: FlagDisp 1
execute as @a[team=Blue,tag=CarryFY1,tag=onBlue,scores={respawn=0}] as @a[team=Blue] at @s run playsound minecraft:block.note_block.bell player @s ~ ~ ~ 1 1.2
execute as @a[team=Blue,tag=CarryFY1,tag=onBlue,scores={respawn=0}] as @a[team=Blue] at @s run playsound minecraft:block.note_block.bell player @s ~ ~ ~ 1 0.75
...
execute as @a[team=Blue,tag=CarryFY2,tag=onBlue,scores={respawn=0}] as @a[team=Blue] at @s run playsound minecraft:block.note_block.bell player @s ~ ~ ~ 1 1.2
execute as @a[team=Blue,tag=CarryFY2,tag=onBlue,scores={respawn=0}] as @a[team=Blue] at @s run playsound minecraft:block.note_block.bell player @s ~ ~ ~ 1 0.75
...
execute as @a[team=Yellow,tag=CarryFB1,tag=onYellow,scores={respawn=0}] run scoreboard players add Yellow: FlagDisp 1
execute as @a[team=Yellow,tag=CarryFB1,tag=onYellow,scores={respawn=0}] as @a[team=Yellow] at @s run playsound minecraft:block.note_block.bell player @s ~ ~ ~ 1 1.2
execute as @a[team=Yellow,tag=CarryFB1,tag=onYellow,scores={respawn=0}] as @a[team=Yellow] at @s run playsound minecraft:block.note_block.bell player @s ~ ~ ~ 1 0.75
...
execute as @a[team=Yellow,tag=CarryFB2,tag=onYellow,scores={respawn=0}] as @a[team=Yellow] at @s run playsound minecraft:block.note_block.bell player @s ~ ~ ~ 1 1.2
execute as @a[team=Yellow,tag=CarryFB2,tag=onYellow,scores={respawn=0}] as @a[team=Yellow] at @s run playsound minecraft:block.note_block.bell player @s ~ ~ ~ 1 0.75
...
execute as @a[tag=CarryFlag,scores={FlagScore=1}] as @a[team=!Lobby] at @s run playsound entity.ender_dragon.flap player @a ~ ~ ~ 1 2
