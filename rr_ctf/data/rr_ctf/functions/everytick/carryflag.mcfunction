...
execute as @a[x=0,tag=CarryFY1,scores={FlagScore=1}] run item replace entity @s armor.head with yellow_banner{Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:7}
execute as @a[x=0,tag=CarryFY1,scores={FlagScore=1}] run fill 34 65 63 30 72 64 air replace yellow_wool
execute as @a[x=0,tag=CarryFY2,scores={FlagScore=1}] run item replace entity @s armor.head with yellow_banner{Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:7}
execute as @a[x=0,tag=CarryFY2,scores={FlagScore=1}] run fill -10 66 64 -14 65 63 air replace yellow_wool
execute as @a[x=0,tag=CarryFB1,scores={FlagScore=1}] run item replace entity @s armor.head with blue_banner{Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:7}
execute as @a[x=0,tag=CarryFB1,scores={FlagScore=1}] run fill -14 65 -64 -10 66 -65 air replace blue_wool
execute as @a[x=0,tag=CarryFB2,scores={FlagScore=1}] run item replace entity @s armor.head with blue_banner{Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:7}
