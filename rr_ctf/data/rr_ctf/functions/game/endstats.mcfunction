...
execute as @a[predicate=custom:indimension] run scoreboard players operation @s CmdData = @s FlagsCaptured
tag @a[predicate=custom:indimension,scores={CmdData=1..}] add maybeflagschamp
execute if entity @a[predicate=custom:indimension,tag=maybeflagschamp] run function everytick:pogger_calculation
tag @a[predicate=custom:indimension,scores={CmdData=0},tag=maybeflagschamp] add flagschamp
tag @a[predicate=custom:indimension] remove maybeflagschamp
...
execute if entity @a[predicate=custom:indimension,tag=flagschamp] run scoreboard players add $playercount CmdData 1
...
execute store result score $playercount CmdData if entity @a[predicate=custom:indimension,tag=flagschamp]
execute if score $playercount CmdData matches 1 if entity @a[predicate=custom:indimension,tag=flagschamp,scores={FlagsCaptured=2..}] run tellraw @a[predicate=custom:indimension] ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- ","color":"green"},{"selector":"@a[predicate=custom:indimension,tag=flagschamp]","color":"none","bold":false},{"text":" is the MVP: ","color":"green"},{"score":{"name":"@r[tag=flagschamp]","objective":"FlagsCaptured"},"color":"dark_green"},{"text":" flags captured!","color":"green"}]
execute if score $playercount CmdData matches 2.. if entity @a[predicate=custom:indimension,tag=flagschamp,scores={FlagsCaptured=2..}] run tellraw @a[predicate=custom:indimension] ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- ","color":"green"},{"selector":"@a[predicate=custom:indimension,tag=flagschamp]","color":"none","bold":false},{"text":" are the MVPs: ","color":"green"},{"score":{"name":"@r[tag=flagschamp]","objective":"FlagsCaptured"},"color":"dark_green"},{"text":" flags captured each!","color":"green"}]
execute if score $playercount CmdData matches 1 if entity @a[predicate=custom:indimension,tag=flagschamp,scores={FlagsCaptured=1}] run tellraw @a[predicate=custom:indimension] ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- ","color":"green"},{"selector":"@a[predicate=custom:indimension,tag=flagschamp]","color":"none","bold":false},{"text":" is the MVP: ","color":"green"},{"score":{"name":"@r[tag=flagschamp]","objective":"FlagsCaptured"},"color":"dark_green"},{"text":" flag captured!","color":"green"}]
execute if score $playercount CmdData matches 2.. if entity @a[predicate=custom:indimension,tag=flagschamp,scores={FlagsCaptured=1}] run tellraw @a[predicate=custom:indimension] ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- ","color":"green"},{"selector":"@a[predicate=custom:indimension,tag=flagschamp]","color":"none","bold":false},{"text":" are the MVPs: ","color":"green"},{"score":{"name":"@r[tag=flagschamp]","objective":"FlagsCaptured"},"color":"dark_green"},{"text":" flag captured each!","color":"green"}]

execute store result score $playercount CmdData if entity @a[predicate=custom:indimension,tag=killschamp]
execute if score $playercount CmdData matches 1 if entity @a[predicate=custom:indimension,tag=killschamp,scores={kills=2..}] run tellraw @a[predicate=custom:indimension] ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- ","color":"green"},{"selector":"@a[predicate=custom:indimension,tag=killschamp]","color":"none","bold":false},{"text":" is that guy that murders people: ","color":"green"},{"score":{"name":"@r[tag=killschamp]","objective":"kills"},"color":"dark_green"},{"text":" kills!","color":"green"}]
execute if score $playercount CmdData matches 2.. if entity @a[predicate=custom:indimension,tag=killschamp,scores={kills=2..}] run tellraw @a[predicate=custom:indimension] ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- ","color":"green"},{"selector":"@a[predicate=custom:indimension,tag=killschamp]","color":"none","bold":false},{"text":" are the guys that murder people: ","color":"green"},{"score":{"name":"@r[tag=killschamp]","objective":"kills"},"color":"dark_green"},{"text":" kills each!","color":"green"}]
...
scoreboard players reset @a[predicate=custom:indimension] FlagsCaptured