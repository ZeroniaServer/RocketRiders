...
execute if entity @s[scores={endtimer=2..}] run tag @a[predicate=custom:indimension] remove FlipMissile
execute if entity @s[scores={endtimer=2..}] run tag @a[predicate=custom:indimension] remove CarryFlag
execute if entity @s[scores={endtimer=2..}] run tag @a[predicate=custom:indimension] remove CarryFY1
