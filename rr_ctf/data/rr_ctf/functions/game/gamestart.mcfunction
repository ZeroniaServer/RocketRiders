...
execute as @s[scores={count=600}] run summon marker 38 63 -66 {Tags:["airDetectBlue"]}
execute as @s[scores={count=600}] run summon marker 38 63 66 {Tags:["airDetectYellow"]}
