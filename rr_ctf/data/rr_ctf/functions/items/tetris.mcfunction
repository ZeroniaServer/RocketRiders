...
tag @s[tag=givenObshield,tag=givenCanopyThrice,tag=givenSplash,tag=givenVortex,tag=givenNova,tag=givenFireballTwice,tag=givenShieldTwice] add givenAllUtil

##Condition for Tetris bag resetting
execute as @s[tag=givenAllNormal,tag=givenAllHeavy,tag=givenAllLightning,tag=givenAllUtil] run function rr_ctf:items/tetrisreset