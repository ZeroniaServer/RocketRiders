...
#Game tracking
tag @e[tag=Selection,type=armor_stand,tag=givenCanopyTwice] add givenCanopyThrice
tag @e[tag=Selection,type=armor_stand,tag=givenCanopy] add givenCanopyTwice
