...
execute if entity @e[tag=Selection,tag=rngCanopy,tag=!givenCanopyThrice,type=armor_stand] run summon area_effect_cloud 0 0 0 {Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:["rngCanopy","rng2"]}
...
execute as @e[tag=rngSelected,tag=rngCanopy,type=area_effect_cloud] as @a unless entity @s[team=!Yellow,team=!Blue] run function rr_ctf:items/util/givecanopy
