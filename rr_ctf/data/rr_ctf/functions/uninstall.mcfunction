execute as @e[type=armor_stand,tag=Selection] run function rr_ctf:disable
...
execute unless entity @e[type=marker,tag=PlacerClear] run function rr_ctf:game/gameend
