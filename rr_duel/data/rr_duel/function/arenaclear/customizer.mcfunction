...
data modify block -69 192 74 front_text.messages[1] set value {"text":"1v1 Duel","color":"red"}
...
data modify block -69 191 74 front_text.messages[1] set value {"color":"light_purple","click_event":{"action":"run_command","command":"/function rr_duel:info"},"text":"Game Mode Info"}
