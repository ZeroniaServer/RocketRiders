...
execute if entity @a[x=0,predicate=custom:team/blue,limit=1] run scoreboard players operation $CurrentYellow XP *= @s RankScore
...
scoreboard players operation @a[x=0,predicate=custom:team/blue,limit=1] ForfeitWin += $RankResult XP
...
scoreboard players operation @a[x=0,predicate=custom:team/yellow,limit=1] ForfeitLoss = $LossXP XP
...
scoreboard players operation @a[x=0,predicate=custom:team/yellow,limit=1] ForfeitWin = $Buffer XP
