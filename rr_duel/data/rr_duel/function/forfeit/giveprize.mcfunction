...
tellraw @s ["",{"text":"[FORFEIT PRIZE]","bold":true,"color":"dark_green"},{"text":" Your opponent forfeited in a 1v1 Duel match, so you gained some XP to compensate for this.","color":"green"}]
tellraw @s {italic:true,text:"elo system is disabled"}
scoreboard players reset @s ForfeitWin
