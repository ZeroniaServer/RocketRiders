...
#Bossbar
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Yellow ","color":"gold"},{"text":"player...","color":"white"}]
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame color blue
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame value 15
...
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/yellow] unless entity @a[x=0,predicate=custom:team/blue] run bossbar set rr:startgame color yellow
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] if entity @a[x=0,predicate=custom:team/yellow] unless entity @a[x=0,predicate=custom:team/blue] run bossbar set rr:startgame value 15
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame name ["",{"text":"Awaiting ","color":"white"},{"text":"Yellow ","color":"gold"},{"text":"and ","color":"white"},{"text":"Blue ","color":"blue"},{"text":"players...","color":"white"}]
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame value 0
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] unless entity @a[x=0,predicate=custom:team/blue] unless entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr:startgame color white
execute if predicate game:phase/staging if predicate game:phase/staging/queue/waiting unless entity @s[scores={endtimer=1..}] run bossbar set rr:startgame max 30
