...
#force win
execute unless predicate game:match_over if score @s ForfeitTimeout matches 1200.. if entity @a[x=0,team=Blue] unless entity @a[x=0,team=Yellow] run scoreboard players set Blue: RoundsWon 2
execute unless predicate game:match_over if score @s ForfeitTimeout matches 1200.. if entity @a[x=0,team=Blue] unless entity @a[x=0,team=Yellow] run function rr_duel:game/winblue
execute unless predicate game:match_over if score @s ForfeitTimeout matches 1200.. unless entity @a[x=0,team=Blue] if entity @a[x=0,team=Yellow] run scoreboard players set Yellow: RoundsWon 2
execute unless predicate game:match_over if score @s ForfeitTimeout matches 1200.. unless entity @a[x=0,team=Blue] if entity @a[x=0,team=Yellow] run function rr_duel:game/winyellow
