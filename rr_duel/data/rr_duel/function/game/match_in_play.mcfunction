...
execute if entity @s[tag=TimeOut] unless predicate game:phase/match/paused as @a[x=0,predicate=custom:team/any_playing_team] run function custom:reset_inventory
execute if entity @s[tag=TimeOut] unless predicate game:phase/match/paused run tp @a[x=0,predicate=custom:team/blue] 12 64 -66 0 0
execute if entity @s[tag=TimeOut] unless predicate game:phase/match/paused run tp @a[x=0,predicate=custom:team/yellow] 12 64 66 180 0
