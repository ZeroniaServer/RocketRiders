execute if score $play_time match matches 2 as @a[x=0,predicate=custom:team/any_playing_team] at @s run playsound minecraft:entity.experience_orb.pickup master @s ~ ~ ~ 1 0
