...
execute if score $forfeit_timer_seconds_remaining var matches 2.. if entity @a[x=0,predicate=custom:team/blue] run bossbar set rr_duel:forfeit_timer name [{color:"red",text:""},{color:"blue",text:"Blue"}," wins by default in ",{bold:true,color:"dark_red",score:{name:"$forfeit_timer_seconds_remaining",objective:"var"}}," seconds"]
execute if score $forfeit_timer_seconds_remaining var matches ..1 if entity @a[x=0,predicate=custom:team/blue] run bossbar set rr_duel:forfeit_timer name [{color:"red",text:""},{color:"blue",text:"Blue"}," wins by default in ",{bold:true,color:"dark_red",text:"1"}," second"]
