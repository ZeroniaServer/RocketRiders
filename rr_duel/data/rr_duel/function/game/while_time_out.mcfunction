...
execute if score $forfeit_timer_seconds_remaining var matches 2.. if entity @a[x=0,predicate=custom:team/blue] run bossbar set rr_duel:forfeit_timer name [{color:"red",text:""},[{score:{name:"#blue",objective:"text.main_color"}},{score:{name:"#blue",objective:"text.team_name"}}]," wins by default in ",{bold:true,color:"dark_red",score:{name:"$forfeit_timer_seconds_remaining",objective:"var"}}," seconds"]
execute if score $forfeit_timer_seconds_remaining var matches ..1 if entity @a[x=0,predicate=custom:team/blue] run bossbar set rr_duel:forfeit_timer name [{color:"red",text:""},[{score:{name:"#blue",objective:"text.main_color"}},{score:{name:"#blue",objective:"text.team_name"}}]," wins by default in ",{bold:true,color:"dark_red",text:"1"}," second"]
execute if score $forfeit_timer_seconds_remaining var matches 2.. if entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr_duel:forfeit_timer name [{color:"red",text:""},[{score:{name:"#yellow",objective:"text.main_color"}},{score:{name:"#yellow",objective:"text.team_name"}}]," wins by default in ",{bold:true,color:"dark_red",score:{name:"$forfeit_timer_seconds_remaining",objective:"var"}}," seconds"]
execute if score $forfeit_timer_seconds_remaining var matches ..1 if entity @a[x=0,predicate=custom:team/yellow] run bossbar set rr_duel:forfeit_timer name [{color:"red",text:""},[{score:{name:"#yellow",objective:"text.main_color"}},{score:{name:"#yellow",objective:"text.team_name"}}]," wins by default in ",{bold:true,color:"dark_red",text:"1"}," second"]
