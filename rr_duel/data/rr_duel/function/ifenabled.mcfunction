...
execute if entity @e[x=0,type=marker,tag=PlacerClear,tag=Cleared] unless predicate game:game_started run tag @s add duelLast
...
execute unless predicate game:game_started if entity @s[tag=EditedSettings] unless entity @a[x=0,team=Blue] run function game:uncancelblue
execute unless predicate game:game_started if entity @s[tag=EditedSettings] unless entity @a[x=0,team=Yellow] run function game:uncancelyellow
