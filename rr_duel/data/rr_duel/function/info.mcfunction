tellraw @s ["",{"text":"1v1 Duel Mode:","color":"red","bold":true},{"text":" The most competitive game mode!"}]
...
tellraw @s ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- Forced settings: No base details, no ties, etc."}]
