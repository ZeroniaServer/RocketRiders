#management
execute as @e[tag=rr_duel] run function gamemodes:updateid
execute if score @e[tag=Selection,tag=!duelEnabled,tag=switchGamemodes,limit=1] SetGamemode = @e[tag=rr_duel,limit=1] gamemodeID run function rr_duel:enable
execute as @e[tag=Selection,tag=duelEnabled] run function rr_duel:ifenabled
