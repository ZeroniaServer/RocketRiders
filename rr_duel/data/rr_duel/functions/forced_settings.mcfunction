...
tag @e[predicate=custom:indimension,type=marker,tag=RProjecRNG,limit=1,sort=random] add SelRRNG
...
tag @e[predicate=custom:indimension,type=marker,tag=RMisRNG,tag=!SelRRNG,limit=6,sort=random] add SelRRNG
