...
scoreboard players operation @a[team=Blue,limit=1] ForfeitWin += $RankResult XP
...
scoreboard players operation @a[team=Yellow,limit=1] ForfeitLoss = $LossXP XP
...
scoreboard players operation @a[team=Yellow,limit=1] ForfeitWin = $Buffer XP
