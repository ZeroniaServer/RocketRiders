...
tellraw @s[scores={ForfeitLoss=..0}] [{"text":"[FORFEIT PENALTY]","bold":true,"color":"dark_red"},{"text":" You left a 1v1 Duel match and didn't return in time. You have now lost some XP to compensate for this.","color":"red"}]
