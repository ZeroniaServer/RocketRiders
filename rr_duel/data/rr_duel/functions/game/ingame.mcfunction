...
execute if entity @s[tag=TimeOut] unless entity @s[scores={servermode=0},tag=!SMCustom] run tellraw @a[x=0] ["",{"text":"[FORFEIT] ","bold":true,"color":"dark_red"},{"text":"Someone left the 1v1 Duel match, so it has ended.","color":"red"}]
...
execute if entity @s[scores={servermode=0},tag=!SMCustom] as @a[x=0,tag=InRanked,tag=WasInBlue,team=Lobby,tag=!Forfeiter,limit=1] unless entity @a[x=0,team=Blue] run tellraw @s {"text":"You were added back to Blue to finish the 1v1 Duel match.","color":"red","italic":true}
execute if entity @s[scores={servermode=0},tag=!SMCustom] as @a[x=0,tag=InRanked,tag=WasInBlue,team=Lobby,tag=!Forfeiter,limit=1] unless entity @a[x=0,team=Blue] run function game:joinblue
execute if entity @s[scores={servermode=0},tag=!SMCustom] as @a[x=0,tag=InRanked,tag=WasInYellow,team=Lobby,tag=!Forfeiter,limit=1] unless entity @a[x=0,team=Yellow] run tellraw @s {"text":"You were added back to Yellow to finish the 1v1 Duel match.","color":"red","italic":true}
execute if entity @s[scores={servermode=0},tag=!SMCustom] as @a[x=0,tag=InRanked,tag=WasInYellow,team=Lobby,tag=!Forfeiter,limit=1] unless entity @a[x=0,team=Yellow] run function game:joinyellow
...
execute if entity @s[tag=TimeOut] run clear @a[x=0,team=Yellow] crossbow{nova:1b}
execute if entity @s[tag=TimeOut] run clear @a[x=0,team=Blue] #custom:clear
execute if entity @s[tag=TimeOut] run clear @a[x=0,team=Blue] crossbow{nova:1b}
...
execute if entity @s[tag=TimeOut] if entity @a[x=0,team=Blue] if entity @a[x=0,team=Yellow] run scoreboard players operation @s RandomItem += @s MaxItemTime
execute if entity @s[tag=TimeOut] if entity @a[x=0,team=Blue] if entity @a[x=0,team=Yellow] run tag @s remove TimeOut
