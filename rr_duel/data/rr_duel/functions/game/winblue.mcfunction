...
execute unless score Blue: RoundsWon matches 2.. as @s[scores={servermode=0},tag=!realms,tag=!SMCustom] run function achievements:aftergameblue
...
execute as @s[tag=!TimeOut,tag=!noYZELO] if score Blue: RoundsWon matches 2.. run function rr_duel:rankcalc/calcblue