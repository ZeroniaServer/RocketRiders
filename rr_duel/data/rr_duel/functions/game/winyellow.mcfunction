...
execute unless score Yellow: RoundsWon matches 2.. as @s[scores={servermode=0}] run function achievements:aftergameyellow
...
execute unless score Yellow: RoundsWon matches 2.. run title @a title [{"text":"Team Yellow","bold":false,"color":"gold"},{"text":" scored!","bold":false,"color":"green"}]
...
execute as @s[tag=!noYZELO] if score Yellow: RoundsWon matches 2.. run function rr_duel:rankcalc/calcyellow