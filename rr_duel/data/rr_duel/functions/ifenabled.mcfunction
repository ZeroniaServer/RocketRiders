#management
tag @e[predicate=custom:indimension,type=armor_stand,tag=rr_duel,limit=1] add enabled
tag @s remove customSpawns
execute if entity @s[tag=SignsRefreshed] run function rr_duel:arenaclear/customizer
execute unless score @s SetGamemode = @e[predicate=custom:indimension,type=armor_stand,tag=rr_duel,limit=1] gamemodeID run function rr_duel:disable
...
#reset
execute if entity @e[predicate=custom:indimension,type=marker,tag=PlacerClear,tag=Cleared] run function rr_duel:arenaclear/baseplacement
...
execute if entity @e[predicate=custom:indimension,type=marker,tag=PlacerClear,tag=Cleared] if entity @s[tag=!GameStarted] run tag @s add duelLast
