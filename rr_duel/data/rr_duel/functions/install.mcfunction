...
execute if entity @e[type=armor_stand,tag=rr_duel,limit=1] run tellraw @s {"text":"1v1 Duel Mode installed.","color":"green","bold":true}
scoreboard players add @e[type=armor_stand,tag=rr_duel,limit=1] CmdData 1
