...
execute if entity @a[predicate=custom:indimension,team=Blue,limit=1] run scoreboard players operation $CurrentYellow XP *= @a[predicate=custom:indimension,team=Blue,limit=1] RankScore
...
scoreboard players operation @a[predicate=custom:indimension,team=Blue,limit=1] XP += $RankResult XP
scoreboard players operation $NetBlue XP += $RankResult XP

#Adjust Blue XP to below 1301
execute if entity @a[predicate=custom:indimension,team=Blue,scores={XP=1301..},limit=1] run scoreboard players operation $DiffBlue XP = @a[predicate=custom:indimension,team=Blue,limit=1,scores={XP=1301..}] XP
execute if entity @a[predicate=custom:indimension,team=Blue,scores={XP=1301..},limit=1] run scoreboard players operation $DiffBlue XP -= $1300 XP
execute if entity @a[predicate=custom:indimension,team=Blue,scores={XP=1301..},limit=1] run scoreboard players operation $NetBlue XP -= $DiffBlue XP
scoreboard players set @a[predicate=custom:indimension,team=Blue,scores={XP=1301..},limit=1] XP 1300

#Announce new Blue XP
execute as @a[predicate=custom:indimension,team=Blue,limit=1] run tellraw @a[predicate=custom:indimension] ["",{"selector":"@s","color":"green"},{"text":" gained ","color":"green"},{"score":{"name":"$NetBlue","objective":"XP"},"bold":true,"color":"dark_green"},{"text":", making their XP a total of: ","color":"green"},{"score":{"name":"@s","objective":"XP"},"bold":true,"color":"light_purple"}]
...
execute if entity @a[predicate=custom:indimension,team=Yellow,limit=1] run scoreboard players operation $LossXP XP *= @a[predicate=custom:indimension,team=Yellow,limit=1] RankScore

#LossXP / 10
scoreboard players operation $LossXP XP /= $10 XP

#Subtract the LossXP score from the Yellow player
scoreboard players operation @a[predicate=custom:indimension,team=Yellow,limit=1] XP -= $LossXP XP
scoreboard players operation $NetYellow XP += $LossXP XP

#Set Buffer to current Blue XP
scoreboard players operation $Buffer XP = @a[predicate=custom:indimension,team=Blue,limit=1] XP

#Buffer * YellowRankScore
scoreboard players operation $Buffer XP *= @a[predicate=custom:indimension,team=Yellow,limit=1] RankScore

#Buffer / 600
scoreboard players operation $Buffer XP /= $600 XP

#Add the Buffer score to the Yellow player
scoreboard players operation @a[predicate=custom:indimension,team=Yellow,limit=1] XP += $Buffer XP
scoreboard players operation $NetYellow XP -= $Buffer XP

#Adjust Yellow XP to above -1
execute if entity @a[predicate=custom:indimension,team=Yellow,scores={XP=..-1},limit=1] run scoreboard players operation $NetYellow XP += @a[predicate=custom:indimension,team=Yellow,limit=1] XP
scoreboard players set @a[predicate=custom:indimension,team=Yellow,scores={XP=..-1},limit=1] XP 0

#Announce new Yellow XP
execute as @a[predicate=custom:indimension,team=Yellow,limit=1] run tellraw @a[predicate=custom:indimension] ["",{"selector":"@s","color":"red"},{"text":" lost ","color":"red"},{"score":{"name":"$NetYellow","objective":"XP"},"bold":true,"color":"dark_red"},{"text":", making their XP a total of: ","color":"red"},{"score":{"name":"@s","objective":"XP"},"bold":true,"color":"light_purple"}]
