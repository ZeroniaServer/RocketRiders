...
execute as @e[predicate=custom:indimension,type=marker,tag=SelectedTip,tag=Tip3] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"In 1v1 Duel Mode, the player who wins two out of three rounds wins the game.","color":"gray"}]
...
execute as @e[predicate=custom:indimension,type=marker,tag=SelectedTip,tag=Tip7] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"Fire Nova Rockets at enemies to launch them into the air!","color":"gray"}]
...
execute as @e[predicate=custom:indimension,type=marker,tag=SelectedTip,tag=Tip8] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"If two enemy Nova Rockets collide, they burst into an explosion of green particles.","color":"gray"}]
...
execute as @e[predicate=custom:indimension,type=marker,tag=SelectedTip,tag=Tip14] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"If a player forfeits during a 1v1 Duel, the victory goes to the remaining player.","color":"gray"}]
