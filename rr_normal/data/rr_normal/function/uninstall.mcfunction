...
execute as @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=normalLast] unless entity @e[x=0,type=marker,tag=PlacerClear] run function rr_normal:game/while_phase/match/closing
