...
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={PowerupCrystal=20..,captureYellow=98..},limit=1] unless entity @a[x=0,predicate=custom:team/blue,predicate=rr_powerups:oncrystalblue,limit=1] run kill @e[x=0,type=armor_stand,tag=PUCrystalDeco]
