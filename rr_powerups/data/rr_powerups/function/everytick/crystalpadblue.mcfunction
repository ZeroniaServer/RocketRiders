...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=21},limit=1] run summon armor_stand 12 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,equipment:{head:{id:"minecraft:glass"}}}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=25},limit=1] run summon armor_stand 11 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,equipment:{head:{id:"minecraft:glass"}}}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=25},limit=1] run summon armor_stand 13 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,equipment:{head:{id:"minecraft:glass"}}}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=30},limit=1] run summon armor_stand 11 62.2 -70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,equipment:{head:{id:"minecraft:glass"}}}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=30},limit=1] run summon armor_stand 13 62.2 -70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,equipment:{head:{id:"minecraft:glass"}}}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=35},limit=1] run summon armor_stand 11 62.2 -69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,equipment:{head:{id:"minecraft:glass"}}}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=35},limit=1] run summon armor_stand 13 62.2 -69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,equipment:{head:{id:"minecraft:glass"}}}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=40},limit=1] run summon armor_stand 12.5 62.3 -67.75 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,equipment:{head:{id:"minecraft:ghast_tear"}},Pose:{Head:[90,0,0]},Rotation:[180,0]}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=55},limit=1] run summon item_display 12 63.5 -69 {Tags:["PUCrystalAnchor","NotSet","PUCrystalEntity"],Passengers:[{id:"end_crystal",ShowBottom:0b,Invulnerable:1b,Tags:["NotSet","PUCrystal","PUCrystalEntity"]}]}
...
execute if predicate custom:periodic_tick/3 as @e[x=0,type=item_display,tag=PUCrystalAnchor,limit=1] at @s positioned ~ ~.25 ~-3 run particle minecraft:dust{color:[1,0,3],scale:1} ^0.3 ^0.4 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute if predicate custom:periodic_tick/3 as @e[x=0,type=item_display,tag=PUCrystalAnchor,limit=1] at @s positioned ~ ~.25 ~-3 run particle minecraft:dust{color:[1,0,3],scale:1} ^-0.3 ^0.4 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute as @e[x=0,type=item_display,tag=PUCrystalAnchor] unless entity @e[x=0,type=marker,tag=BlueCrystalSpot] run kill @e[x=0,type=end_crystal,tag=PUCrystal]
execute as @e[x=0,type=item_display,tag=PUCrystalAnchor] unless entity @e[x=0,type=marker,tag=BlueCrystalSpot] run kill @s
...
execute as @e[x=0,type=item_display,tag=PUCrystalAnchor,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest,distance=10..] run tp @s ^ ^ ^1 facing entity @e[x=0,type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest]
execute as @e[x=0,type=item_display,tag=PUCrystalAnchor,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest,distance=5..10] run tp @s ^ ^ ^0.75 facing entity @e[x=0,type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest]
execute as @e[x=0,type=item_display,tag=PUCrystalAnchor,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest,distance=..5] run tp @s ^ ^ ^0.5 facing entity @e[x=0,type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest]

execute as @e[x=0,type=item_display,tag=PUCrystalAnchor,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,distance=..0.5,limit=1] at @s run playsound minecraft:entity.ender_eye.death master @a[x=0] ~ ~ ~ 2 0.5
execute as @e[x=0,type=item_display,tag=PUCrystalAnchor,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,distance=..0.5,limit=1] at @s run playsound minecraft:block.beacon.power_select master @a[x=0] ~ ~ ~ 2 1.6
execute as @e[x=0,type=item_display,tag=PUCrystalAnchor,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,distance=..0.5,limit=1] run tag @e[x=0,type=end_crystal,tag=PUCrystal,limit=1,sort=nearest] add Set
...
execute as @e[x=0,type=end_crystal,tag=PUCrystal,tag=Set,tag=!PUCrystalPerma,limit=1,scores={PowerupCrystal=3..}] at @s run particle flash{color:0xFFFFFF} ~ ~ ~ 0 0 0 4 2 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
