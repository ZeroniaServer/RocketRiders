...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=21},limit=1] run summon armor_stand 12 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",count:1}]}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=25},limit=1] run summon armor_stand 11 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",count:1}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=25},limit=1] run summon armor_stand 13 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",count:1}]}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=30},limit=1] run summon armor_stand 11 62.2 -70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",count:1}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=30},limit=1] run summon armor_stand 13 62.2 -70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",count:1}]}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=35},limit=1] run summon armor_stand 11 62.2 -69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",count:1}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=35},limit=1] run summon armor_stand 13 62.2 -69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",count:1}]}
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=40},limit=1] run summon armor_stand 12 62.2 -69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:ghast_tear",count:1}]}
