...
execute if predicate custom:periodic_tick/3 as @e[x=0,type=item_display,tag=PUCrystalAnchor,limit=1] at @s positioned ~ ~.25 ~3 run particle minecraft:dust{color:[1,0,3],scale:1} ^0.3 ^0.65 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute if predicate custom:periodic_tick/3 as @e[x=0,type=item_display,tag=PUCrystalAnchor,limit=1] at @s positioned ~ ~.25 ~3 run particle minecraft:dust{color:[1,0,3],scale:1} ^-0.3 ^0.65 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
