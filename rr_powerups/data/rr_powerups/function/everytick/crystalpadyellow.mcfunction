...
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={captureBlue=96,capturePoint=1,PowerupCrystal=19..},limit=1] run tp @a[x=0,predicate=custom:team/yellow,predicate=rr_powerups:oncrystalyellow] 12 64 66 -180 0
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={captureBlue=96,capturePoint=1,PowerupCrystal=19..},limit=1] as @a[x=0,predicate=custom:team/yellow] at @s run playsound minecraft:entity.ender_eye.death master @s
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={captureBlue=96,capturePoint=1,PowerupCrystal=19..},limit=1] run tellraw @a[x=0,predicate=custom:team/yellow] {"text":"Crystal Crafter Deactivated!","color":"red","bold":true}
