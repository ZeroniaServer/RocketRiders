...
execute as @e[x=0,type=marker,tag=captureMiddle,tag=!BrokenPlatform,scores={CmdData=17..}] run fill 5 49 -7 19 58 7 air destroy
...
execute as @e[x=0,type=marker,tag=captureMiddle,tag=!BrokenPlatform,scores={CmdData=17..}] as @e[x=5,y=52,z=-7,dx=14,dy=6,dz=14,predicate=entities:type/shield] run function entities:type/shield/actions/kill
execute as @e[x=0,type=marker,tag=captureMiddle,tag=!BrokenPlatform,scores={CmdData=17..}] as @e[x=5,y=52,z=-7,dx=14,dy=6,dz=14,predicate=entities:type/stinging_shield] run function entities:type/stinging_shield/actions/kill
execute as @e[x=0,type=marker,tag=captureMiddle,tag=!BrokenPlatform,scores={CmdData=17..}] as @e[x=5,y=52,z=-7,dx=14,dy=6,dz=14,predicate=entities:type/canopy/brain] run function entities:type/canopy/actions/kill
...
execute as @e[x=0,type=marker,tag=captureMiddle,tag=!BrokenPlatform,scores={CmdData=17..}] at @s align xyz run particle minecraft:explosion_emitter ~0.5 ~0.5 ~0.5 3 1 3 0.1 20 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={CmdData=17..}] run scoreboard players remove @s captureYellow 1
execute as @e[x=0,type=marker,tag=captureMiddle,scores={CmdData=17..}] run scoreboard players remove @s captureBlue 1
...
execute as @e[x=0,type=marker,tag=captureMiddle,tag=FixPlatform] at @s align xyz run particle minecraft:falling_obsidian_tear ~0.5 ~0.5 ~0.5 3 0 3 0.1 100 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
execute as @e[x=0,type=marker,tag=captureMiddle,tag=FixPlatform] at @s align xyz run particle minecraft:explosion ~0.5 ~0.5 ~0.5 3 0 3 0.1 20 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute as @e[x=0,type=end_crystal,tag=PUCrystalPerma,scores={capturePoint=40..}] at @s run particle end_rod ~ ~1 ~ 0 0 0 0.1 10 force @a[x=0,tag=!hideParticles,predicate=custom:in_arena]
...
execute as @e[x=0,type=end_crystal,tag=PUCrystalPerma,scores={capturePoint=40..}] at @s run summon item_display ~ ~ ~ {Tags:["PUCrystalEntity","PUCrystalPerma"],Passengers:[{id:"end_crystal",Invulnerable:0b,ShowBottom:0b,Tags:["PUCrystal","PUCrystalEntity","PUCrystalPerma"]}]}
