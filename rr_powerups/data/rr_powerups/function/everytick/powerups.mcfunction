...
# execute as @a[x=0,team=Yellow,tag=Infinity,scores={infinity=600..}] run give @s minecraft:bow[unbreakable={show_in_tooltip:0b},enchantments={flame:1},attribute_modifiers=[{id:"rocketriders:saber",type:"generic.attack_damage",amount:3,operation:"add_value",slot:"mainhand"}],custom_name='{"translate":"Shooting Saber","color":"gold","bold":true,"italic":false}',lore=['{"translate":"A weapon used for both"}','{"translate":"ranged and melee attacks."}']]
# execute as @a[x=0,team=Blue,tag=Infinity,scores={infinity=600..}] run give @s minecraft:bow[unbreakable={show_in_tooltip:0b},enchantments={flame:1},attribute_modifiers=[{id:"rocketriders:saber",type:"generic.attack_damage",amount:3,operation:"add_value",slot:"mainhand"}],custom_name='{"translate":"Shooting Saber","color":"blue","bold":true,"italic":false}',lore=['{"translate":"A weapon used for both"}','{"translate":"ranged and melee attacks."}']]
