...
execute as @a[x=0,predicate=custom:on_blue_or_yellow_team,tag=BreakEly,predicate=custom:not_falling] run loot replace entity @s armor.chest loot items:armor/generic_gear/chestplate
