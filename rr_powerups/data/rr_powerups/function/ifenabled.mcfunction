...
execute if predicate game:match_in_play run function rr_powerups:game/ingame
execute if predicate game:match_over run function rr_powerups:game/gameend
