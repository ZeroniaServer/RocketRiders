execute store result score @s HasLavaSplash run clear @s splash_potion[potion_contents={potion:"minecraft:awkward"}] 0
...
clear @s[scores={HasLavaSplash=2..}] splash_potion[potion_contents={potion:"minecraft:awkward"}] 1
