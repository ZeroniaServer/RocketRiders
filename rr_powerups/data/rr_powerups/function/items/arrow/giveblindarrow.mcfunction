...
execute if score @s HasArrows matches 0 if entity @s[tag=!fullHotbar] run function items:give/tipped_arrow_blindness {count:4}
execute if score @s HasArrows matches 1 if entity @s[tag=!fullHotbar] run function items:give/tipped_arrow_blindness {count:3}
execute if score @s HasArrows matches 2 if entity @s[tag=!fullHotbar] run function items:give/tipped_arrow_blindness {count:2}
execute if score @s HasArrows matches 3 if entity @s[tag=!fullHotbar] run function items:give/tipped_arrow_blindness {count:1}
