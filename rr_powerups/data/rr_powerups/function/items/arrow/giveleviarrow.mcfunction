...
execute if score @s HasTippedArrows matches 2 if entity @s[tag=!fullHotbar] run function items:give/tipped_arrow_levitation {count:2}
execute if score @s HasTippedArrows matches 3 if entity @s[tag=!fullHotbar] run function items:give/tipped_arrow_levitation {count:1}
