...
execute if items entity @s[tag=!fullOffhand] container.* tipped_arrow[count~{max:63},potion_contents={custom_effects:[{amplifier:1b,id:"minecraft:slowness",show_icon:1b,duration:200}]}] run tag @s add fullOffhand

give @s[scores={HasTippedArrows=0},tag=!fullHotbar,tag=fullOffhand] minecraft:tipped_arrow[custom_name='{"text":"Slowness Arrow","color":"dark_purple","italic":true,"bold":true}',potion_contents={custom_effects:[{id:"minecraft:slowness",amplifier:1b,duration:200,show_particles:1b}]},hide_additional_tooltip={},custom_data={Droppable:1b}] 4
...
give @s[scores={HasTippedArrows=3},tag=!fullHotbar,tag=fullOffhand] minecraft:tipped_arrow[custom_name='{"text":"Slowness Arrow","color":"dark_purple","italic":true,"bold":true}',potion_contents={custom_effects:[{id:"minecraft:slowness",amplifier:1b,duration:200,show_particles:1b}]},hide_additional_tooltip={},custom_data={Droppable:1b}] 1
item replace entity @s[scores={HasTippedArrows=0},tag=!fullHotbar,tag=!fullOffhand] weapon.offhand with minecraft:tipped_arrow[custom_name='{"text":"Slowness Arrow","color":"dark_purple","italic":true,"bold":true}',potion_contents={custom_effects:[{id:"minecraft:slowness",amplifier:1b,duration:200,show_particles:1b}]},hide_additional_tooltip={},custom_data={Droppable:1b}] 4
