...
loot give @s[scores={HasTippedArrows=2},tag=!fullHotbar,tag=fullOffhand] loot {pools:[{rolls:1,entries:[{type:"loot_table",value:"items:misc/tipped_arrow_wither",functions:[{function:"set_count",count:2}]}]}]}
loot give @s[scores={HasTippedArrows=3},tag=!fullHotbar,tag=fullOffhand] loot {pools:[{rolls:1,entries:[{type:"loot_table",value:"items:misc/tipped_arrow_wither",functions:[{function:"set_count",count:1}]}]}]}
loot replace entity @s[scores={HasTippedArrows=0},tag=!fullHotbar,tag=!fullOffhand] weapon.offhand loot {pools:[{rolls:1,entries:[{type:"loot_table",value:"items:misc/tipped_arrow_wither",functions:[{function:"set_count",count:4}]}]}]}
loot replace entity @s[scores={HasTippedArrows=1},tag=!fullHotbar,tag=!fullOffhand] weapon.offhand loot {pools:[{rolls:1,entries:[{type:"loot_table",value:"items:misc/tipped_arrow_wither",functions:[{function:"set_count",count:3}]}]}]}
loot replace entity @s[scores={HasTippedArrows=2},tag=!fullHotbar,tag=!fullOffhand] weapon.offhand loot {pools:[{rolls:1,entries:[{type:"loot_table",value:"items:misc/tipped_arrow_wither",functions:[{function:"set_count",count:2}]}]}]}
loot replace entity @s[scores={HasTippedArrows=3},tag=!fullHotbar,tag=!fullOffhand] weapon.offhand loot {pools:[{rolls:1,entries:[{type:"loot_table",value:"items:misc/tipped_arrow_wither",functions:[{function:"set_count",count:1}]}]}]}
