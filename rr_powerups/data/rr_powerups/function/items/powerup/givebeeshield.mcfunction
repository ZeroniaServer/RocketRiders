...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] run scoreboard players operation @s HasBeeShield %=  constant
...
loot give @s[scores={HasBeeShield=0},tag=!fullHotbar] loot items:util/bee_shield
