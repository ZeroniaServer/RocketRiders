...
give @s[team=Yellow,scores={HasBeeShield=0},tag=!fullHotbar] minecraft:snowball[max_stack_size=64,custom_model_data={floats:[2]},custom_name=[{"text":"[Utility] ","color":"dark_purple","bold":true},{"text":"Stinging Shield","color":"gold","bold":true}],lore=[{"text":"Throw to deploy a Shield made of","color":"gray"},{"text":"beehives and unstable TNT!","color":"gray"}],tooltip_display={"hidden_components":["minecraft:unbreakable","minecraft:enchantments","minecraft:attribute_modifiers","minecraft:dyed_color","minecraft:can_place_on","minecraft:can_break","minecraft:fireworks","minecraft:trim","minecraft:banner_patterns"]},custom_data={BeeShield:1b},item_model="minecraft:honeycomb"] 1
