...
execute if entity @s[team=Yellow] unless predicate custom:canopy_nearblue run item replace entity @s armor.chest with minecraft:elytra[equippable={slot:"chest",damage_on_hurt:false,equip_sound:"minecraft:intentionally_empty",asset_id:"elytra"},enchantments={binding_curse:1},enchantment_glint_override=false,max_damage=7,custom_name=[{"text":"Elytra","color":"dark_purple","bold":true}],lore=[[{"text":"Useful for short flights!","italic":false,"color":"dark_gray"},{"text":"","italic":false,"color":"dark_purple"}],[{"text":"","italic":false,"color":"dark_purple"}],[{"text":"Breaks when you get near","italic":false,"color":"red"}],[{"text":"the enemy base.","italic":false,"color":"red"}]],attribute_modifiers=[{operation:"add_value",type:"armor",amount:3,slot:"chest",type:"armor",id:"rr_powerups:elytra_armor"}]] 1
