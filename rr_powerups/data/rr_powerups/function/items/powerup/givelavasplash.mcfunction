#Antidupe check
execute store result score @s HasLavaSplash run clear @s lingering_potion[custom_data~{id:"lava_splash"}] 0
...
loot give @s[scores={HasLavaSplash=0},tag=!fullHotbar] loot items:util/lava_splash
