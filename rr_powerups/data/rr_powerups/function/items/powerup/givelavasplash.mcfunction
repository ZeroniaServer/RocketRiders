#Antidupe check
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!doStacking] store result score @s HasLavaSplash run clear @s lingering_potion[custom_data~{lavasplash:1b}] 0
