...
give @s[scores={HasTotem=0},tag=!fullHotbar] minecraft:totem_of_undying[custom_name={"text":"Totem of Undying","color":"dark_purple","bold":true,"italic":true},lore=[{"text":"Hold to survive certain death.","color":"gray"},{"text":"Only good for one use.","color":"gray"},{"text":"(Does not include void deaths.)","color":"gray"}],enchantments={"minecraft:unbreaking":1}] 1
