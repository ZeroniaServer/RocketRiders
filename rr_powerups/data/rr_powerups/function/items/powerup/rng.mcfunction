...
execute unless entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] as @e[x=0,type=marker,tag=rngSelected,tag=rngBull] as @e[x=0,type=item] if items entity @s contents #custom:missile[custom_data~{spawn_egg:{type:"missile",missile:"bullet"}}] run function rr_powerups:items/deduct
execute unless entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] as @e[x=0,type=marker,tag=rngSelected,tag=rngHyper] as @e[x=0,type=item] if items entity @s contents #custom:missile[custom_data~{spawn_egg:{type:"missile",missile:"hypersonic"}}] run function rr_powerups:items/deduct
execute unless entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] as @e[x=0,type=marker,tag=rngSelected,tag=rngLavaSplash] as @e[x=0,type=item] if items entity @s contents lingering_potion[custom_data~{id:"lava_splash"}] run function rr_powerups:items/deduct
...
execute unless entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] as @e[x=0,type=marker,tag=rngSelected,tag=rngBeeShield] as @e[x=0,type=item] if items entity @s contents snowball[custom_data~{id:"stinging_shield"}] run function rr_powerups:items/deduct
execute unless entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] as @e[x=0,type=marker,tag=rngSelected,tag=rngDuplex] as @e[x=0,type=item] if items entity @s contents #custom:missile[custom_data~{spawn_egg:{type:"missile",missile:"duplex"}}] run function rr_powerups:items/deduct
execute unless entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=doStacking] as @e[x=0,type=marker,tag=rngSelected,tag=rngBroad] as @e[x=0,type=item] if items entity @s contents #custom:missile[custom_data~{spawn_egg:{type:"missile",missile:"broadsword"}}] run function rr_powerups:items/deduct
...
#item announcements
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngBull] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"[Special] ","color":"dark_purple","bold":true,"italic":true},{"text":"Bullet","color":"blue","italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngElytra] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"Elytra","color":"dark_purple","bold":true,"italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngHyper] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"[Special] ","color":"dark_purple","bold":true,"italic":true},{"text":"Hypersonic","color":"blue","italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngInfinity] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"Infinity Sabers","color":"dark_purple","bold":true,"italic":true},{"text":" (Expires in 30 seconds)","color":"red","italic":true,"bold":false}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngLavaSplash] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"[Utility] ","color":"dark_purple","bold":true,"italic":true},{"text":"Lava Splash","color":"blue","italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngSlapFish] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"Slap Fish","color":"dark_purple","bold":true,"italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngTotem] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"Totem of Undying","color":"dark_purple","bold":true,"italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngTrident] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"Trident","color":"dark_purple","bold":true,"italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngBeeShield] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"[Utility] ","color":"dark_purple","bold":true,"italic":true},{"text":"Stinging Shield","color":"blue","italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngDuplex] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"[Special] ","color":"dark_purple","bold":true,"italic":true},{"text":"Duplex","color":"blue","italic":true}]
...
execute as @e[x=0,type=marker,tag=rngSelected,tag=rngBroad] as @e[x=0,type=marker,scores={capturePoint=1}] run tellraw @a[x=0,team=!Lobby] [{"text":"Blue ","color":"blue","bold":true},{"text":"received: ","color":"dark_aqua","bold":false},{"text":"[Special] ","color":"dark_purple","bold":true,"italic":true},{"text":"Broadsword","color":"blue","italic":true}]
