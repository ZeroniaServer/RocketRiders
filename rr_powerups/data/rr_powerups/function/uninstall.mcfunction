...
execute as @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=powerupsLast] unless entity @e[x=0,type=marker,tag=PlacerClear] run function rr_powerups:game/while_phase/match/closing
