...
execute as @e[predicate=custom:indimension,type=marker,tag=BeeShield,limit=1] run data modify entity @s Pos[0] set from storage rr_powerups:beeshieldpos x[0]
execute as @e[predicate=custom:indimension,type=marker,tag=BeeShield,limit=1] run data modify entity @s Pos[1] set from storage rr_powerups:beeshieldpos y[0]
execute as @e[predicate=custom:indimension,type=marker,tag=BeeShield,limit=1] run data modify entity @s Pos[2] set from storage rr_powerups:beeshieldpos z[0]

#Remove necessary blocks
execute as @e[predicate=custom:indimension,type=marker,tag=BeeShield,limit=1] at @s run fill ~-2 ~-4 ~ ~2 ~4 ~ air
kill @e[predicate=custom:indimension,type=marker,tag=BeeShield,limit=1]
