...
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=96},limit=1] run tp @a[x=0,team=Blue,predicate=rr_powerups:oncrystalblue] 12 64 -66 0 0
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=96},limit=1] run scoreboard players reset @e[x=0,type=marker,tag=captureMiddle,limit=1] PowerupCrystal
...
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=96},limit=1] positioned 12 66 -69 run playsound minecraft:block.respawn_anchor.deplete master @a[x=0] ~ ~ ~ 2 0
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=96},limit=1] run kill @e[x=0,type=armor_stand,tag=PUCrystalDeco]
...
execute if entity @e[x=0,type=marker,tag=captureMiddle,scores={PowerupCrystal=20..,captureYellow=98..},limit=1] unless entity @a[x=0,team=Blue,predicate=rr_powerups:oncrystalblue,limit=1] run kill @e[x=0,type=armor_stand,tag=PUCrystalDeco]
execute as @e[x=0,type=marker,tag=captureMiddle,scores={PowerupCrystal=20..,captureYellow=98..},limit=1] unless entity @a[x=0,team=Blue,predicate=rr_powerups:oncrystalblue,limit=1] run scoreboard players set @s PowerupCrystal 20
...
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=21},limit=1] run summon armor_stand 12 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=21},limit=1] positioned 12 64 -70 run playsound minecraft:block.end_portal_frame.fill master @a[x=0] ~ ~ ~ 2 0.8

execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=25},limit=1] run summon armor_stand 11 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=25},limit=1] run summon armor_stand 13 62.2 -71 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=25},limit=1] positioned 12 64 -70 run playsound minecraft:block.end_portal_frame.fill master @a[x=0] ~ ~ ~ 2 0.8

execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=30},limit=1] run summon armor_stand 11 62.2 -70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=30},limit=1] run summon armor_stand 13 62.2 -70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=30},limit=1] positioned 12 64 -70 run playsound minecraft:block.end_portal_frame.fill master @a[x=0] ~ ~ ~ 2 0.9

execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=35},limit=1] run summon armor_stand 11 62.2 -69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=35},limit=1] run summon armor_stand 13 62.2 -69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=35},limit=1] positioned 12 64 -70 run playsound minecraft:block.end_portal_frame.fill master @a[x=0] ~ ~ ~ 2 1

execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=40},limit=1] run summon armor_stand 12 62.2 -69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:ghast_tear",Count:1b}]}
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=40},limit=1] positioned 12 64 -70 run playsound minecraft:block.end_portal_frame.fill master @a[x=0] ~ ~ ~ 2 1.4

execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=45},limit=1] run setblock 12 63 -70 end_portal_frame[facing=south,eye=true]
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=45},limit=1] positioned 12 64 -70 run playsound minecraft:block.end_portal_frame.fill master @a[x=0] ~ ~ ~ 2 1.2

execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=55},limit=1] run particle minecraft:end_rod 12 65 -70 1 0 1 0.1 100
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=55},limit=1] positioned 12 64 -70 run playsound minecraft:entity.shulker.shoot master @a[x=0] ~ ~ ~ 1 0.65
execute as @e[x=0,type=marker,tag=captureMiddle,scores={captureYellow=98..,PowerupCrystal=55},limit=1] run kill @e[x=0,type=armor_stand,tag=PUCrystalDeco]
...
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,limit=1] at @s positioned ~ ~.25 ~-3 if score $dust CmdData matches 1 run particle dust 1 0 3 1 ^0.3 ^0.4 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,limit=1] at @s positioned ~ ~.25 ~-3 if score $dust CmdData matches 1 run particle dust 1 0 3 1 ^-0.3 ^0.4 ^ 0 0 0 0 3 force @a[x=0,tag=!hideParticles,predicate=custom:belowroof]
...
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS] unless entity @e[x=0,type=marker,tag=BlueCrystalSpot] run kill @e[x=0,type=end_crystal,tag=PUCrystal]
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS] unless entity @e[x=0,type=marker,tag=BlueCrystalSpot] run kill @s

execute as @e[x=0,type=marker,tag=BlueCrystalSpot,tag=NotSet,limit=1] at @s run spreadplayers ~ ~ 0 4 false @s
execute as @e[x=0,type=marker,tag=BlueCrystalSpot,tag=NotSet,limit=1] at @s run tp @s ~ 54.5 ~
tag @e[x=0,type=marker,tag=BlueCrystalSpot,tag=NotSet,limit=1] remove NotSet
...
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest,distance=10..] run tp @s ^ ^ ^1 facing entity @e[x=0,type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest]
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest,distance=5..10] run tp @s ^ ^ ^0.75 facing entity @e[x=0,type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest]
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest,distance=..5] run tp @s ^ ^ ^0.5 facing entity @e[x=0,type=marker,tag=BlueCrystalSpot,limit=1,sort=nearest]

execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,distance=..0.5,limit=1] at @s run playsound minecraft:entity.ender_eye.death master @a[x=0] ~ ~ ~ 2 0.5
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,distance=..0.5,limit=1] at @s run playsound minecraft:block.beacon.power_select master @a[x=0] ~ ~ ~ 2 1.6
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,distance=..0.5,limit=1] run tag @e[x=0,type=end_crystal,tag=PUCrystal,limit=1,sort=nearest] add Set
execute as @e[x=0,type=armor_stand,tag=PUCrystalAS,tag=NotSet,limit=1] at @s if entity @e[type=marker,tag=BlueCrystalSpot,distance=..0.5,limit=1] run kill @s
