...
execute as @e[predicate=custom:indimension,type=armor_stand,tag=PUCrystalAS,limit=1] at @s positioned ~ ~.25 ~-3 if score $dust CmdData matches 1 run particle dust 1 0 3 1 ^0.3 ^0.4 ^ 0 0 0 0 3 force @a[predicate=custom:indimension,predicate=custom:belowroof]
execute as @e[predicate=custom:indimension,type=armor_stand,tag=PUCrystalAS,limit=1] at @s positioned ~ ~.25 ~-3 if score $dust CmdData matches 1 run particle dust 1 0 3 1 ^-0.3 ^0.4 ^ 0 0 0 0 3 force @a[predicate=custom:indimension,predicate=custom:belowroof]
