...
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=21},type=area_effect_cloud,limit=1] run summon armor_stand 12 65.2 70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=21},type=area_effect_cloud,limit=1] positioned 12 66 69 run playsound minecraft:block.end_portal_frame.fill master @a ~ ~ ~ 2 0.8

execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=25},type=area_effect_cloud,limit=1] run summon armor_stand 11 65.2 70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=25},type=area_effect_cloud,limit=1] run summon armor_stand 13 65.2 70 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=25},type=area_effect_cloud,limit=1] positioned 12 66 69 run playsound minecraft:block.end_portal_frame.fill master @a ~ ~ ~ 2 0.8

execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=30},type=area_effect_cloud,limit=1] run summon armor_stand 11 65.2 69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=30},type=area_effect_cloud,limit=1] run summon armor_stand 13 65.2 69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=30},type=area_effect_cloud,limit=1] positioned 12 66 69 run playsound minecraft:block.end_portal_frame.fill master @a ~ ~ ~ 2 0.9

execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=35},type=area_effect_cloud,limit=1] run summon armor_stand 11 65.2 68 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=35},type=area_effect_cloud,limit=1] run summon armor_stand 13 65.2 68 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:glass",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=35},type=area_effect_cloud,limit=1] positioned 12 66 69 run playsound minecraft:block.end_portal_frame.fill master @a ~ ~ ~ 2 1

execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=40},type=area_effect_cloud,limit=1] run summon armor_stand 12 65.2 69 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:ender_eye",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=40},type=area_effect_cloud,limit=1] positioned 12 66 69 run playsound minecraft:block.end_portal_frame.fill master @a ~ ~ ~ 2 1.2

execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=45},type=area_effect_cloud,limit=1] run summon armor_stand 12 65.2 68 {NoGravity:1b,Silent:1b,Tags:["PUCrystalDeco","PUCrystalEntity"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:ghast_tear",Count:1b}]}
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=45},type=area_effect_cloud,limit=1] positioned 12 66 69 run playsound minecraft:block.end_portal_frame.fill master @a ~ ~ ~ 2 1.4

execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=55},type=area_effect_cloud,limit=1] run particle minecraft:end_rod 12 67 69 1 0 1 0.1 100
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=55},type=area_effect_cloud,limit=1] positioned 12 66 69 run playsound minecraft:entity.shulker.shoot master @a ~ ~ ~ 1 0.65
...
execute as @e[tag=captureMiddle,scores={captureBlue=98..,PowerupCrystal=55},type=area_effect_cloud,limit=1] run summon armor_stand 12 66.5 69 {Marker:1b,Invisible:1b,NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["PUCrystalAS","NotSet","PUCrystalEntity"],Passengers:[{id:end_crystal,ShowBottom:0b,Invulnerable:1b,Tags:["NotSet","PUCrystal","PUCrystalEntity"]}]}
