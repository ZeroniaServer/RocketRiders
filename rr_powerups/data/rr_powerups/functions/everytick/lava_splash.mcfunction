...
execute as @e[tag=lavasplash_alone,type=area_effect_cloud,tag=!splashMarked] at @s if entity @e[tag=YellowSpawnZone,distance=..3,type=marker] run kill @s
execute as @e[tag=lavasplash_alone,type=area_effect_cloud,tag=!splashMarked] at @s if entity @e[tag=BlueSpawnZone,distance=..3,type=marker] run kill @s
...
execute as @s[scores={servermode=0},tag=!realms,tag=!SMCustom] as @e[tag=lavasplash_alone,type=area_effect_cloud,tag=!markedForDeath] at @s unless block ~ ~ ~ lava run data merge entity @s {Duration:100}
execute as @s[scores={servermode=0},tag=!realms,tag=!SMCustom] as @e[tag=lavasplash_alone,type=area_effect_cloud,tag=!markedForDeath] at @s unless block ~ ~ ~ lava run tag @s add markedForDeath
