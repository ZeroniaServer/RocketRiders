...
execute as @s[tag=!YellowWon] run give @a[tag=saberlessBlue,tag=Infinity] minecraft:bow{display:{Name:'{"translate":"Infinity Saber","color":"dark_purple","bold":true,"italic":false}',Lore:['{"translate":"A weapon used for both ranged and melee attacks"}']},HideFlags:4,Unbreakable:1b,Enchantments:[{id:flame,lvl:1},{id:sharpness,lvl:5},{id:infinity,lvl:1}]}
execute as @s[tag=!YellowWon] run give @a[tag=saberlessBlue,tag=!Infinity] minecraft:bow{display:{Name:'{"translate":"Shooting Saber","color":"blue","bold":true,"italic":false}',Lore:['{"translate":"A weapon used for both ranged and melee attacks"}']},HideFlags:4,Unbreakable:1b,Enchantments:[{id:flame,lvl:1},{id:sharpness,lvl:5}]}
