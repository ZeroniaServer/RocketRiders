...
execute as @e[type=arrow,tag=pickup,tag=!tippedpickup,limit=1] if data entity @s CustomPotionEffects at @s if entity @p[team=!Spectator,distance=..2,tag=!fullOffhand] run function rr_powerups:everytick/tipped_arrow_replace
