...
execute as @a[x=0,team=!Spectator] at @s as @e[x=0,type=arrow,scores={arrowtime=10..},nbt={inGround:1b},limit=1,distance=..2,sort=nearest] if data entity @s CustomPotionEffects run tag @s add tippedpickup