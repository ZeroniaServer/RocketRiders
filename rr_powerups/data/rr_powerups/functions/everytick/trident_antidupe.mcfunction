...
tag @a[tag=tridentChecked] remove tridentChecking
tag @a[tag=tridentChecked] remove tridentValid
execute if entity @a[tag=!tridentChecked] run function everytick:trident_antidupe