execute as @s[scores={captureBlue=2}] unless entity @s[tag=contested] at @s run playsound minecraft:entity.zombie_villager.converted player @a ~ ~ ~ 1 1.2
...
execute as @s[scores={captureBlue=24}] at @s unless entity @s[tag=contested] run playsound entity.evoker.cast_spell player @a ~ ~ ~ 1 0.8
...
execute as @s[scores={captureBlue=74}] at @s unless entity @s[tag=contested] run playsound entity.evoker.cast_spell player @a ~ ~ ~ 1 0.8
...
execute as @s[scores={captureBlue=98}] at @s unless entity @s[tag=contested] if entity @a[team=Blue,tag=onCapturePoint] run playsound minecraft:block.beacon.activate player @a ~ ~ ~ 1 1.2
execute as @s[scores={captureBlue=98}] at @s unless entity @s[tag=contested] unless entity @a[team=Blue,tag=onCapturePoint] run playsound minecraft:block.beacon.deactivate player @a ~ ~ ~ 1 1.2
