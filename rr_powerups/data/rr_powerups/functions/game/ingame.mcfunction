...
execute as @e[type=end_crystal,tag=PUCrystal,scores={CmdData=5}] at @s run playsound minecraft:block.beacon.ambient master @a[predicate=custom:indimension] ~ ~ ~ 0.45 1.4
scoreboard players reset @e[type=end_crystal,tag=PUCrystal,scores={CmdData=20..}] CmdData
execute unless entity @e[type=end_crystal,tag=PUCrystal] run stopsound @a[predicate=custom:indimension] master minecraft:block.beacon.ambient
...
execute if entity @a[predicate=custom:indimension,team=Blue,tag=onCapturePoint] unless entity @a[predicate=custom:indimension,team=Yellow,tag=onCapturePoint] run scoreboard players add @e[type=marker,tag=captureMiddle,tag=!BrokenPlatform,scores={captureYellow=0},tag=!contested] captureBlue 2
execute if entity @a[predicate=custom:indimension,team=Blue,tag=onCapturePoint] unless entity @a[predicate=custom:indimension,team=Yellow,tag=onCapturePoint] run tag @e[type=marker,tag=captureMiddle,tag=!BrokenPlatform] remove contested

execute if entity @a[predicate=custom:indimension,team=Yellow,tag=onCapturePoint] unless entity @a[predicate=custom:indimension,team=Blue,tag=onCapturePoint] run scoreboard players add @e[type=marker,tag=captureMiddle,tag=!BrokenPlatform,scores={captureBlue=0},tag=!contested] captureYellow 2
execute if entity @a[predicate=custom:indimension,team=Yellow,tag=onCapturePoint] unless entity @a[predicate=custom:indimension,team=Blue,tag=onCapturePoint] run tag @e[type=marker,tag=captureMiddle,tag=!BrokenPlatform] remove contested

execute unless entity @a[predicate=custom:indimension,tag=onCapturePoint] run tag @e[type=marker,tag=captureMiddle] remove contested
...
execute if entity @a[predicate=custom:indimension,team=Yellow,tag=onCapturePoint] if entity @a[predicate=custom:indimension,team=Blue,tag=onCapturePoint] if entity @e[type=marker,tag=captureMiddle,tag=!contested] run function rr_powerups:items/tetrisreset
execute if entity @a[predicate=custom:indimension,team=Yellow,tag=onCapturePoint] if entity @a[predicate=custom:indimension,team=Blue,tag=onCapturePoint] run tag @e[type=marker,tag=captureMiddle] add contested
...
execute as @e[type=marker,tag=captureMiddle,scores={captureBlue=99..}] if entity @a[predicate=custom:indimension,team=Yellow,tag=onCapturePoint] run scoreboard players remove @s captureBlue 1
execute as @e[type=marker,tag=captureMiddle,scores={captureYellow=99..}] if entity @a[predicate=custom:indimension,team=Blue,tag=onCapturePoint] run scoreboard players remove @s captureYellow 1
execute as @e[type=marker,tag=captureMiddle,scores={captureBlue=1..99}] unless entity @a[predicate=custom:indimension,team=Blue,tag=onCapturePoint] run scoreboard players remove @s captureBlue 1
execute as @e[type=marker,tag=captureMiddle,scores={captureYellow=1..99}] unless entity @a[predicate=custom:indimension,team=Yellow,tag=onCapturePoint] run scoreboard players remove @s captureYellow 1
...
execute as @e[type=marker,tag=captureMiddle,tag=!BrokenPlatform] at @s run function rr_powerups:everytick/powerup_platform
...
execute as @e[type=marker,tag=captureMiddle,tag=!BrokenPlatform] if score @s captureBlue >= @s captureYellow store result bossbar rr_powerups:capture_progress value run scoreboard players get @s captureBlue
execute as @e[type=marker,tag=captureMiddle,tag=!contested,tag=!BrokenPlatform] if score @s captureBlue > @s captureYellow run bossbar set rr_powerups:capture_progress color blue
execute as @e[type=marker,tag=captureMiddle,tag=!BrokenPlatform] if score @s captureYellow >= @s captureBlue store result bossbar rr_powerups:capture_progress value run scoreboard players get @s captureYellow
execute as @e[type=marker,tag=captureMiddle,tag=!contested,tag=!BrokenPlatform] if score @s captureYellow > @s captureBlue run bossbar set rr_powerups:capture_progress color yellow
execute as @e[type=marker,tag=captureMiddle,tag=!contested,tag=!BrokenPlatform] if score @s captureBlue matches ..0 if score @s captureYellow matches ..0 run bossbar set rr_powerups:capture_progress color white
execute as @e[type=marker,tag=captureMiddle,tag=contested,tag=!BrokenPlatform] run bossbar set rr_powerups:capture_progress color red

execute as @e[type=marker,tag=captureMiddle,tag=!contested,tag=!BrokenPlatform,limit=1] if score @s capturePoint matches 0 if score @s captureBlue >= @s captureYellow if score @s captureBlue matches 1.. run bossbar set rr_powerups:capture_progress name [{"text":"Blue Capturing...","color":"blue","bold":true}]
execute as @e[type=marker,tag=captureMiddle,tag=!contested,tag=!BrokenPlatform,limit=1] if score @s capturePoint matches 0 if score @s captureYellow >= @s captureBlue if score @s captureYellow matches 1.. run bossbar set rr_powerups:capture_progress name [{"text":"Yellow Capturing...","color":"yellow","bold":true}]
execute as @e[type=marker,tag=captureMiddle,tag=!contested,tag=!BrokenPlatform,limit=1] if score @s capturePoint matches 0 if score @s captureBlue matches ..0 if score @s captureYellow matches ..0 run bossbar set rr_powerups:capture_progress name [{"text":"Capture Progress","color":"white","bold":true}]
execute as @e[type=marker,tag=captureMiddle,tag=contested,tag=!BrokenPlatform] run bossbar set rr_powerups:capture_progress name [{"text":"Contested!","color":"dark_red","bold":true}]

execute as @e[type=marker,tag=captureMiddle,tag=!contested,tag=!BrokenPlatform,limit=1] if score @s capturePoint matches 1 run bossbar set rr_powerups:capture_progress name [{"text":"Blue Captured!","color":"blue","bold":true}]
execute as @e[type=marker,tag=captureMiddle,tag=!contested,tag=!BrokenPlatform,limit=1] if score @s capturePoint matches 2 run bossbar set rr_powerups:capture_progress name [{"text":"Yellow Captured!","color":"yellow","bold":true}]
...
execute if score $infinity PowerupDisplay matches 0 as @e[type=item,nbt={Item:{id:"minecraft:bow"}}] run function rr_powerups:items/killinfinitysaber
