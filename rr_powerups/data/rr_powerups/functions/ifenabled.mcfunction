...
execute if entity @e[tag=PlacerClear,tag=Cleared] if entity @s[tag=!GameStarted] run tellraw @a[team=Lobby] {"text":"Powerups Mode is enabled.","color":"light_purple","bold":"true"}
