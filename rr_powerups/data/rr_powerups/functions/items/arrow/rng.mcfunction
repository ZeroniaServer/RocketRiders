...
summon area_effect_cloud 0 0 0 {Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:["rngPoisArrow","rng2"]}
...
execute as @e[tag=rngSelected,tag=rngPoisArrow] as @e[scores={capturePoint=1}] as @a[team=Blue] run function rr_powerups:items/arrow/givepoisarrow
execute as @e[tag=rngSelected,tag=rngPoisArrow] as @e[scores={capturePoint=2}] as @a[team=Yellow] run function rr_powerups:items/arrow/givepoisarrow
