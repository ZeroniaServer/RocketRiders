...
execute if entity @s[scores={HasElytra=1..}] run title @s actionbar {"text":"Elytra repaired.","color":"aqua"}
execute if entity @s[scores={HasElytra=1..}] run tag @s add DelayActionbar
execute if entity @s[scores={HasElytra=1..}] run scoreboard players set @s actionbardelay 0
execute if entity @s[scores={HasElytra=1..}] run clear @s elytra
