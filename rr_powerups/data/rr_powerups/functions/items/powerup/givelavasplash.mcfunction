#Antidupe check
execute if entity @e[x=0,type=armor_stand,tag=Selection,tag=!doStacking] store result score @s HasLavaSplash run clear @s lingering_potion[potion_contents={potion:"minecraft:awkward"}] 0
