...
summon area_effect_cloud 0 0 0 {Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:["rngBeeShield","rng2"]}
...
execute as @e[tag=rngSelected,tag=rngLavaSplash] as @e[scores={capturePoint=1}] run tellraw @a[team=!Lobby] [{"text":"Blue received: ","color":"aqua","bold":"true"},{"text":"[Utility] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Bee Shield","color":"blue","italic":"true"}]
execute as @e[tag=rngSelected,tag=rngLavaSplash] as @e[scores={capturePoint=2}] run tellraw @a[team=!Lobby] [{"text":"Yellow received: ","color":"yellow","bold":"true"},{"text":"[Utility] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Bee Shield","color":"gold","italic":"true"}]