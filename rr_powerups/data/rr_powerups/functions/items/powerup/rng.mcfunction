...
execute as @e[tag=rngSelected,tag=rngBull] as @e[scores={capturePoint=1}] as @a[team=Blue] run function items:missile/special/givebull
execute as @e[tag=rngSelected,tag=rngBull] as @e[scores={capturePoint=2}] as @a[team=Yellow] run function items:missile/special/givebull
...
execute as @e[tag=rngSelected,tag=rngHyper] as @e[scores={capturePoint=1}] as @a[team=Blue] run function items:missile/special/givehyper
execute as @e[tag=rngSelected,tag=rngHyper] as @e[scores={capturePoint=2}] as @a[team=Yellow] run function items:missile/special/givehyper
...
execute as @e[tag=rngSelected,tag=rngDuplex] as @e[scores={capturePoint=1}] as @a[team=Blue] run function items:missile/special/giveduplex
execute as @e[tag=rngSelected,tag=rngDuplex] as @e[scores={capturePoint=2}] as @a[team=Yellow] run function items:missile/special/giveduplex
execute as @e[tag=rngSelected,tag=rngBroad] as @e[scores={capturePoint=1}] as @a[team=Blue] run function items:missile/special/givebroad
execute as @e[tag=rngSelected,tag=rngBroad] as @e[scores={capturePoint=2}] as @a[team=Yellow] run function items:missile/special/givebroad

#item announcements
execute as @e[tag=rngSelected,tag=rngBull] as @e[scores={capturePoint=1}] run tellraw @a[team=!Lobby] [{"text":"Blue received: ","color":"aqua","bold":"true"},{"text":"[Special] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Bullet","color":"blue","italic":"true"}]
execute as @e[tag=rngSelected,tag=rngBull] as @e[scores={capturePoint=2}] run tellraw @a[team=!Lobby] [{"text":"Yellow received: ","color":"yellow","bold":"true"},{"text":"[Special] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Bullet","color":"gold","italic":"true"}]
...
execute as @e[tag=rngSelected,tag=rngHyper] as @e[scores={capturePoint=1}] run tellraw @a[team=!Lobby] [{"text":"Blue received: ","color":"aqua","bold":"true"},{"text":"[Special] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Hypersonic","color":"blue","italic":"true"}]
execute as @e[tag=rngSelected,tag=rngHyper] as @e[scores={capturePoint=2}] run tellraw @a[team=!Lobby] [{"text":"Yellow received: ","color":"yellow","bold":"true"},{"text":"[Special] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Hypersonic","color":"gold","italic":"true"}]
...
execute as @e[tag=rngSelected,tag=rngBeeShield] as @e[scores={capturePoint=1}] run tellraw @a[team=!Lobby] [{"text":"Blue received: ","color":"aqua","bold":"true"},{"text":"[Utility] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Stinging Shield","color":"blue","italic":"true"}]
execute as @e[tag=rngSelected,tag=rngBeeShield] as @e[scores={capturePoint=2}] run tellraw @a[team=!Lobby] [{"text":"Yellow received: ","color":"yellow","bold":"true"},{"text":"[Utility] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Stinging Shield","color":"gold","italic":"true"}]
execute as @e[tag=rngSelected,tag=rngDuplex] as @e[scores={capturePoint=1}] run tellraw @a[team=!Lobby] [{"text":"Blue received: ","color":"aqua","bold":"true"},{"text":"[Special] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Duplex","color":"blue","italic":"true"}]
execute as @e[tag=rngSelected,tag=rngDuplex] as @e[scores={capturePoint=2}] run tellraw @a[team=!Lobby] [{"text":"Yellow received: ","color":"yellow","bold":"true"},{"text":"[Special] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Duplex","color":"gold","italic":"true"}]
execute as @e[tag=rngSelected,tag=rngBroad] as @e[scores={capturePoint=1}] run tellraw @a[team=!Lobby] [{"text":"Blue received: ","color":"aqua","bold":"true"},{"text":"[Special] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Broadsword","color":"blue","italic":"true"}]
execute as @e[tag=rngSelected,tag=rngBroad] as @e[scores={capturePoint=2}] run tellraw @a[team=!Lobby] [{"text":"Yellow received: ","color":"yellow","bold":"true"},{"text":"[Special] ","color":"dark_purple","bold":"true","italic":"true"},{"text":"Broadsword","color":"gold","italic":"true"}]