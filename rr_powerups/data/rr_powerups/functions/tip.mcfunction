...
execute as @e[type=marker,tag=SelectedTip,tag=Tip19] as @a[tag=!hideTips] unless entity @s[scores={GamesPlayed=10..}] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"Once you capture the Powerup Platform, it will stay captured even if you leave it until the enemy team steps on top.","color":"gray"}]
