...
data modify block -69 192 74 front_text.messages[1] set value {"text":"PVE","color":"light_purple","click_event":{"action":"run_command","command":"/execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={refreshsigns=..0}] run playsound ui.button.click master @a[x=0] ~ ~ ~ 1 1"}}
...
data modify block -69 191 74 front_text.messages[1] set value {"color":"light_purple","click_event":{"action":"run_command","command":"/function rr_pve:info"},"text":"Gamemode Info"}
