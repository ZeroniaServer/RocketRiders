...
execute as @e[x=0,type=marker,tag=SelectedTip,tag=Tip8,limit=1] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"You can drop arrows to share them with your teammates!","color":"gray"}]
...
execute unless entity @s[scores={servermode=1..}] unless entity @s[tag=realms] as @e[x=0,type=marker,tag=SelectedTip,tag=Tip9] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"There are four Special missiles which you can play with when you turn on the Chaos Modifier. Use them all to earn the Veteran achievement!","color":"gray"}]
execute if entity @s[scores={servermode=1..}] as @e[x=0,type=marker,tag=SelectedTip,tag=Tip9] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"There are four Special missiles which you can play with when you turn on the Chaos Modifier!","color":"gray"}]
execute if entity @s[tag=realms] as @e[x=0,type=marker,tag=SelectedTip,tag=Tip9] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"There are four Special missiles which you can play with when you turn on the Chaos Modifier!","color":"gray"}]
...
execute as @e[x=0,type=marker,tag=SelectedTip,tag=Tip16] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"A Vortex blows up when enemies get near it, missiles pass through it, or it gets shot by projectiles. It can also chain react with another Vortex or TNT explosion.","color":"gray"}]
execute as @e[x=0,type=marker,tag=SelectedTip,tag=Tip16] run tag @e[x=0,type=armor_stand,tag=Selection,limit=1] add Tip16

execute as @e[x=0,type=marker,tag=SelectedTip,tag=Tip17] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"Bots are able to ride missiles! Be careful that they don't make it to your base.","color":"gray"}]
...
execute as @e[x=0,type=marker,tag=SelectedTip,tag=Tip19] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"The leaves in a Canopy will burn when shot by flame arrows or disintegrate when shot by Fireballs.","color":"gray"}]
execute as @e[x=0,type=marker,tag=SelectedTip,tag=Tip19] run tag @e[x=0,type=armor_stand,tag=Selection,limit=1] add Tip19

execute unless entity @s[scores={servermode=1..}] unless entity @s[tag=realms] as @e[x=0,type=marker,tag=SelectedTip,tag=Tip20] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"If you win against the Bots, you get a special achievement: Superior Players!","color":"gray"}]
execute if entity @s[scores={servermode=1..}] as @e[x=0,type=marker,tag=SelectedTip,tag=Tip20] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"If you win against the Bots, you will no longer have to take any CAPTCHA tests to prove you are a human ever again. This is a certified fact.","color":"gray"}]
execute if entity @s[tag=realms] as @e[x=0,type=marker,tag=SelectedTip,tag=Tip20] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"If you win against the Bots, you will no longer have to take any CAPTCHA tests to prove you are a human ever again. This is a certified fact.","color":"gray"}]
