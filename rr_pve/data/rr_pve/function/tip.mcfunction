...
execute if predicate rr:has_achievements as @e[x=0,type=marker,tag=SelectedTip,tag=Tip9] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"There are four Special missiles which you can play with when you turn on the Special Treatment Modifier. Use them all to earn the Veteran achievement!","color":"gray"}]
execute unless predicate rr:has_achievements as @e[x=0,type=marker,tag=SelectedTip,tag=Tip9] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"There are four Special missiles which you can play with when you turn on the Special Treatment Modifier!","color":"gray"}]
...
execute if predicate rr:has_achievements as @e[x=0,type=marker,tag=SelectedTip,tag=Tip20] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"If you win against the Bots, you get a special achievement: Superior Players!","color":"gray"}]
execute unless predicate rr:has_achievements as @e[x=0,type=marker,tag=SelectedTip,tag=Tip20] as @a[x=0,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"If you win against the Bots, you will no longer have to take any CAPTCHA tests to prove you are a human ever again. This is a certified fact.","color":"gray"}]
