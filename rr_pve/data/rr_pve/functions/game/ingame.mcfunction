...
execute if entity @s[tag=!YellowWon] unless block 11 38 -74 nether_portal run function rr_pve:game/winyellow
execute if entity @s[tag=!YellowWon] unless block 13 38 -74 nether_portal run function rr_pve:game/winyellow