execute unless entity @e[type=armor_stand,tag=rr_pve,limit=1] run summon armor_stand 25 184 -6 {Tags:["rr_pve","gamemodeAS"],Marker:1b,Invisible:1b,Invulnerable:1b,CustomNameVisible:0b,CustomName:'{"text":"PVE Mode"}'}
