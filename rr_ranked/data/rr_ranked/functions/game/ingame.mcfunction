...
##forfeit
#initial condition
execute unless entity @a[scores={RoundsWon=2..}] if entity @a[team=Yellow] unless entity @a[team=Blue] run tag @s add TimeOut
execute unless entity @a[scores={RoundsWon=2..}] unless entity @a[team=Yellow] if entity @a[team=Blue] run tag @s add TimeOut
...
#force win
execute as @s[scores={ForfeitTimeout=1200..}] if entity @a[team=Blue] unless entity @a[team=Yellow] run scoreboard players set @a[team=Blue] RoundsWon 1
execute as @s[scores={ForfeitTimeout=1200..}] if entity @a[team=Blue] unless entity @a[team=Yellow] run tag @a[team=Blue] add WonARound
...
execute as @s[scores={ForfeitTimeout=1200..}] unless entity @a[team=Blue] if entity @a[team=Yellow] run scoreboard players set @a[team=Yellow] RoundsWon 1
execute as @s[scores={ForfeitTimeout=1200..}] unless entity @a[team=Blue] if entity @a[team=Yellow] run tag @a[team=Yellow] add WonARound
