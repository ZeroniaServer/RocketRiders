...
execute if entity @a[team=Blue,scores={RoundsWon=1}] if entity @a[team=Yellow,scores={RoundsWon=0}] run title @a subtitle ["",{"text":"1","bold":true,"color":"blue"},{"text":" - ","bold":true,"color":"green"},{"text":"0","bold":true,"color":"gold"}]
