...
#Store yellow's current XP in LossXP as 'CurrentBlue' will be modified in the next line
scoreboard players operation LossXP XP = CurrentBlue XP

#Set rankresult to 80
scoreboard players set RankResult XP 80

#CurrentBlue / 10
scoreboard players operation CurrentBlue XP /= 10 XP
