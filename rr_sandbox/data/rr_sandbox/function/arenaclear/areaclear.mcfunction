execute unless entity @e[x=0,type=armor_stand,tag=Selection,tag=sandboxEnabled] run function rr_sandbox:arenaclear/resetportal
...
#ICBM reset
execute as @e[x=0,type=armor_stand,tag=Selection] run tag @s remove givenICBM
