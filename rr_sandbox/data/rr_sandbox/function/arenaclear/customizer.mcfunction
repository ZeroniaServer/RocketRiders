...
data modify block -69 192 74 front_text.messages[1] set value {"text":"Sandbox","color":"light_purple"}
...
data modify block -69 191 74 front_text.messages[1] set value {"color":"light_purple","click_event":{"action":"run_command","command":"/function rr_sandbox:info"},"text":"Game Mode Info"}
