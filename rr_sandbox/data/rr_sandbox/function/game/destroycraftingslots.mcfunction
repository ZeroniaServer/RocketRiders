...
execute if items entity @s player.crafting.* written_book run tag @s add mainweapon
execute if items entity @s[tag=mainweapon] player.crafting.0 * unless items entity @s player.crafting.0 written_book run tag @s remove mainweapon
execute if items entity @s[tag=mainweapon] player.crafting.1 * unless items entity @s player.crafting.1 written_book run tag @s remove mainweapon
execute if items entity @s[tag=mainweapon] player.crafting.2 * unless items entity @s player.crafting.2 written_book run tag @s remove mainweapon
execute if items entity @s[tag=mainweapon] player.crafting.3 * unless items entity @s player.crafting.3 written_book run tag @s remove mainweapon

#> Ensure player doesn't lose main weapon
execute if items entity @s player.crafting.0 written_book run item replace entity @s player.cursor from entity @s player.crafting.0
execute if items entity @s player.crafting.0 written_book run item replace entity @s player.crafting.0 with air
execute if items entity @s player.crafting.1 written_book run item replace entity @s player.cursor from entity @s player.crafting.1
execute if items entity @s player.crafting.1 written_book run item replace entity @s player.crafting.1 with air
execute if items entity @s player.crafting.2 written_book run item replace entity @s player.cursor from entity @s player.crafting.2
execute if items entity @s player.crafting.2 written_book run item replace entity @s player.crafting.2 with air
execute if items entity @s player.crafting.3 written_book run item replace entity @s player.cursor from entity @s player.crafting.3
execute if items entity @s player.crafting.3 written_book run item replace entity @s player.crafting.3 with air
