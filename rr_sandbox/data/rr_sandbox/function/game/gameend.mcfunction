...
execute if entity @s[scores={endtimer=1..}] as @e[x=0,type=fireball,tag=endFireball] run data merge entity @s {ExplosionPower:0,Motion:[0.0d,0.0d,0.0d],acceleration_power:0d}
