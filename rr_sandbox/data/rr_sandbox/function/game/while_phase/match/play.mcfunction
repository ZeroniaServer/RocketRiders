...
#nomicon
scoreboard players enable @a[x=0,predicate=custom:player/can_use_nomicon] nomicon
scoreboard players reset @a[predicate=!custom:in_overworld] nomicon
scoreboard players reset @a[x=0,predicate=!custom:player/can_use_nomicon] nomicon
