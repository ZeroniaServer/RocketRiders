...
function rr_sandbox:nomicon/load_pages/append_item_give_one {dialog_name: "weapons_and_tools", trigger_input_id: 42, item_loot_table: "items:misc/shooting_saber", indefinite_article: "a", item_plain_name: "Shooting Saber", color: "white"}
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "weapons_and_tools", trigger_input_id: 21, item_loot_table: "items:misc/arrow", item_plain_name_singular: "Arrow", item_plain_name_plural: "Arrows", color: "light_purple"}
function rr_sandbox:nomicon/load_pages/append_item_give_one {dialog_name: "weapons_and_tools", trigger_input_id: 43, item_loot_table: "items:misc/piercing_pickaxe", indefinite_article: "a", item_plain_name: "Piercing Pickaxe", color: "white"}
...
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "missiles", trigger_input_id: 7, item_loot_table: "items:missile/normal/chronullifier", item_plain_name_singular: "Chronullifier", item_plain_name_plural: "Chronullifiers", color: "green"}
...
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "missiles", trigger_input_id: 8, item_loot_table: "items:missile/normal/elder_guardian", item_plain_name_singular: "Elder Guardian", item_plain_name_plural: "Elder Guardians", color: "green"}
...
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "missiles", trigger_input_id: 16, item_loot_table: "items:missile/heavy/juggerbuster", item_plain_name_singular: "Juggerbuster", item_plain_name_plural: "Juggerbusters", color: "dark_red"}
...
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "utilities", trigger_input_id: 21, item_loot_table: "items:misc/arrow", item_plain_name_singular: "Arrow", item_plain_name_plural: "Arrows", color: "light_purple"}
...
function rr_sandbox:nomicon/load_pages/append_item_limited {dialog_name: "utilities", trigger_input_id: 25, item_loot_table: "items:util/nova_rocket", item_plain_name_singular: "Nova Rocket", item_plain_name_plural: "Nova Rockets", color: "light_purple"}
...
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "powerups", trigger_input_id: 38, item_loot_table: "items:misc/tipped_arrow_blindness", item_plain_name_singular: "Blindness Arrow", item_plain_name_plural: "Blindness Arrows", color: "dark_purple"}
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "powerups", trigger_input_id: 39, item_loot_table: "items:misc/tipped_arrow_levitation", item_plain_name_singular: "Levitation Arrow", item_plain_name_plural: "Levitation Arrows", color: "dark_purple"}
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "powerups", trigger_input_id: 40, item_loot_table: "items:misc/tipped_arrow_slowness", item_plain_name_singular: "Slowness Arrow", item_plain_name_plural: "Slowness Arrows", color: "dark_purple"}
...
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "experimental", trigger_input_id: 59, item_loot_table: "items:experimental/booster_rocket", item_plain_name_singular: "Elytra Booster Rocket", item_plain_name_plural: "Elytra Booster Rockets", color: "light_purple"}
...
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "experimental", trigger_input_id: 52, item_loot_table: "items:experimental/spectral_arrow", item_plain_name_singular: "Spectral Arrow", item_plain_name_plural: "Spectral Arrows", color: "dark_purple"}
