...
function rr_sandbox:nomicon/load_pages/append_item {dialog_name: "missiles", trigger_input_id: 49, item_loot_table: "items:missile/surprise", item_plain_name_singular: "Surprise Egg", item_plain_name_plural: "Surprise Eggs", color: "white", include_in_full_list: true}
