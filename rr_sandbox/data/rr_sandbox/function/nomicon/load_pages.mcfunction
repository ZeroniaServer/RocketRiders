...
function rr_sandbox:nomicon/load_pages/append_item_limited {dialog_name: "weapons_and_tools", trigger_input_id: 47, item_loot_table: "rr_crusade:book_icon", item_plain_name_singular: "Spell Book", item_plain_name_plural: "Spell Books", color: "light_purple", include_in_full_list: true}
...
function rr_sandbox:nomicon/load_pages/append_item_limited {dialog_name: "utilities", trigger_input_id: 25, item_loot_table: "items:util/nova_rocket", item_plain_name_singular: "Nova Rocket", item_plain_name_plural: "Nova Rockets", color: "light_purple", include_in_full_list: true}
...
function rr_sandbox:nomicon/load_pages/append_item_activate {dialog_name: "powerups", trigger_input_id: 35, item_loot_table: "items:misc/elytra", item_plain_name: "Elytra", color: "dark_purple", include_in_full_list: true}
...
function rr_sandbox:nomicon/load_pages/append_item_limited {dialog_name: "experimental", trigger_input_id: 60, item_loot_table: "items:experimental/lunging_spear", item_plain_name_singular: "Lunging Spear", item_plain_name_plural: "Lunging Spears", color: "white", include_in_full_list: true}
