...
function rr_sandbox:nomicon/load_pages/append_item_elytra {dialog_name: "powerups", normal_trigger_input_id: 35, permanent_trigger_input_id: 60, color: "dark_purple", include_in_full_list: true}
