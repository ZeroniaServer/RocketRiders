...
function rr_sandbox:nomicon/load_pages/append_item_limited {dialog_name: "weapons_and_tools", trigger_input_id: 47, item_loot_table: "items:misc/spell_book", item_plain_name_singular: "Spell Book", item_plain_name_plural: "Spell Books", color: "light_purple", include_in_full_list: true}
...
function rr_sandbox:nomicon/load_pages/append_lunging_spear {dialog_name: "experimental", include_in_full_list: true}
