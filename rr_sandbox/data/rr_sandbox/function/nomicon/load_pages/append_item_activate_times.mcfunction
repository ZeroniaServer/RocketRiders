# dialog_name, 30_seconds_trigger_input_id, permanent_trigger_input_id, deactivate_trigger_input_id, item_loot_table, item_plain_name, color, include_in_full_list
  ...
  "description": [\
    ...
    [\
        ...
        {\
          ...
          "click_event": {\
            "action": "run_command",\
            "command": "/trigger sandbox.rocket_nomicon set $(30_seconds_trigger_input_id)01"\
          }\
        },\
        " ",\
        {\
          ...
          "click_event": {\
            "action": "run_command",\
            "command": "/trigger sandbox.rocket_nomicon set $(permanent_trigger_input_id)01"\
          }\
        },\
        " ",\
        {\
