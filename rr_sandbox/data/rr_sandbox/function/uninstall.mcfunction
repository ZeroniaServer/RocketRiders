...
execute as @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=sandboxLast] unless entity @e[x=0,type=marker,tag=PlacerClear] run function rr_sandbox:game/while_phase/match/over
