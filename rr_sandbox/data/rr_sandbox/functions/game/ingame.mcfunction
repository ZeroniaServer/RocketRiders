...
#smart clear stuff
execute as @a[team=Yellow] unless entity @s[scores={SBplaceSlime=0,SBplaceRS=0,SBplacePiston=0,SBplaceSPiston=0,SBplaceObs=0,SBplaceTNT=0,SBplaceBGlass=0,SBplaceYGlass=0,SBplaceBGlaze=0,SBplaceYGlaze=0,SBplaceBCon=0,SBplaceYCon=0}] at @s unless entity @e[type=marker,tag=SmartClearAECyellow,limit=1,sort=nearest,distance=..6] run summon marker ~ ~ ~ {Tags:["SmartClearAECyellow"]}
execute as @a[team=Blue] unless entity @s[scores={SBplaceSlime=0,SBplaceRS=0,SBplacePiston=0,SBplaceSPiston=0,SBplaceObs=0,SBplaceTNT=0,SBplaceBGlass=0,SBplaceYGlass=0,SBplaceBGlaze=0,SBplaceYGlaze=0,SBplaceBCon=0,SBplaceYCon=0}] at @s unless entity @e[type=marker,tag=SmartClearAECblue,limit=1,sort=nearest,distance=..6] run summon marker ~ ~ ~ {Tags:["SmartClearAECblue"]}
execute as @a unless entity @s[team=!Yellow,team=!Blue] unless entity @s[scores={SBplaceScaf=0}] at @s unless entity @e[type=marker,tag=SmartClearScaf,limit=1,sort=nearest,distance=..6] run summon marker ~ ~ ~ {Tags:["SmartClearScaf"]}
