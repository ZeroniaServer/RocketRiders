...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=Hardcore] run fill -14 63 65 38 34 65 orange_stained_glass replace white_stained_glass
...
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=Hardcore] run fill -14 63 -65 38 34 -65 white_stained_glass replace black_stained_glass
execute if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=Hardcore] run fill -14 63 -64 38 34 -64 light_blue_stained_glass replace blue_stained_glass
