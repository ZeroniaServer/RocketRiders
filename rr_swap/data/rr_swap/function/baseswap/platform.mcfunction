...
execute if score BossbarA swapside matches 20.. if score BossbarB swapside matches 1..5 as @a[x=0,team=!Lobby] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.5
execute if score BossbarA swapside matches 20.. if score BossbarB swapside matches 6 as @a[x=0,team=!Lobby] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.6
execute if score BossbarA swapside matches 20.. if score BossbarB swapside matches 7 as @a[x=0,team=!Lobby] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.7
execute if score BossbarA swapside matches 20.. if score BossbarB swapside matches 8 as @a[x=0,team=!Lobby] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.8
execute if score BossbarA swapside matches 20.. if score BossbarB swapside matches 9 as @a[x=0,team=!Lobby] at @s run playsound block.note_block.hat master @s ~ ~ ~ 100 0.9
