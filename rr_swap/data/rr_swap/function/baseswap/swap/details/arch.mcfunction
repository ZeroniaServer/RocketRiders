...
$fill -160 184 -160 -140 190 -156 $(blue_back_panes_new) replace $(blue_back_panes_old)
...
$fill -160 184 -160 -140 190 -156 $(yellow_back_panes_new) replace $(yellow_back_panes_old)
