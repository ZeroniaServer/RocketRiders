...
execute if predicate game:game_started if score @s gametime matches 3..20 if score SwapSide swapside matches 1 run function rr_swap:items/givefirstdarkblue
