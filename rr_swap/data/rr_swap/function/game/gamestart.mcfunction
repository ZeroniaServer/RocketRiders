...
execute unless predicate game:match_over if score @s count matches 600 run scoreboard players set QuickSwap swapside 0
execute unless predicate game:match_over if score @s count matches 600 run scoreboard players set SwapPlatformSec swapside 60
execute unless predicate game:match_over if score @s count matches 600 run scoreboard players set SwapPlatformTick swapside 0
execute unless predicate game:match_over if score @s count matches 600 run function rr_swap:items/tetrisreset
