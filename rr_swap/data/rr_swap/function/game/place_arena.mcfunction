...
#1 = darkblue
execute if predicate rr_swap:blue_team_is_dark unless predicate game:gamemode_components/red_for_blue run fill 38 34 -61 -14 63 -57 black_stained_glass replace cyan_stained_glass
execute if predicate rr_swap:blue_team_is_dark if predicate game:gamemode_components/red_for_blue run fill 38 34 -61 -14 63 -57 black_stained_glass replace pink_stained_glass
...
execute if predicate game:modifiers/hardcore/on if predicate rr_swap:blue_team_is_dark unless predicate game:gamemode_components/red_for_blue run fill -14 63 -65 38 34 -65 black_stained_glass replace cyan_stained_glass
execute if predicate game:modifiers/hardcore/on if predicate rr_swap:blue_team_is_dark if predicate game:gamemode_components/red_for_blue run fill -14 63 -65 38 34 -65 black_stained_glass replace pink_stained_glass
...
execute if predicate game:modifiers/hardcore/on if predicate rr_swap:yellow_team_is_dark unless predicate game:gamemode_components/red_for_blue run fill -14 63 -65 38 34 -65 white_stained_glass replace cyan_stained_glass
execute if predicate game:modifiers/hardcore/on if predicate rr_swap:yellow_team_is_dark if predicate game:gamemode_components/red_for_blue run fill -14 63 -65 38 34 -65 white_stained_glass replace pink_stained_glass
execute if predicate game:modifiers/hardcore/on if predicate rr_swap:yellow_team_is_dark unless predicate game:gamemode_components/red_for_blue run fill -14 63 -64 38 34 -64 light_blue_stained_glass replace blue_stained_glass
execute if predicate game:modifiers/hardcore/on if predicate rr_swap:yellow_team_is_dark if predicate game:gamemode_components/red_for_blue run fill -14 63 -64 38 34 -64 pink_stained_glass replace red_stained_glass
