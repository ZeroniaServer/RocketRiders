...
execute unless predicate game:modifiers/hardcore/on if predicate rr_swap:blue_team_is_dark unless predicate game:gamemode_components/red_for_blue run fill -89 201 65 -101 195 64 blue_stained_glass
execute unless predicate game:modifiers/hardcore/on if predicate rr_swap:blue_team_is_dark if predicate game:gamemode_components/red_for_blue run fill -89 201 65 -101 195 64 red_stained_glass

execute unless predicate game:modifiers/hardcore/on if predicate rr_swap:yellow_team_is_dark unless predicate game:gamemode_components/red_for_blue run fill -89 201 65 -101 195 64 light_blue_stained_glass
execute unless predicate game:modifiers/hardcore/on if predicate rr_swap:yellow_team_is_dark if predicate game:gamemode_components/red_for_blue run fill -89 201 65 -101 195 64 pink_stained_glass
...
execute if predicate game:modifiers/hardcore/on if predicate rr_swap:yellow_team_is_dark unless predicate game:gamemode_components/red_for_blue run fill -89 201 62 -101 195 62 light_blue_stained_glass
execute if predicate game:modifiers/hardcore/on if predicate rr_swap:yellow_team_is_dark if predicate game:gamemode_components/red_for_blue run fill -89 201 62 -101 195 62 pink_stained_glass
