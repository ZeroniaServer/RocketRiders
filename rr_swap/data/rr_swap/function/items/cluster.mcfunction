...
execute if entity @s[scores={SDtime=1}] as @e[x=0,type=fireball,tag=endFireball2] at @s run item replace entity @s contents from entity @n[type=fireball,scores={endFireball=1},distance=..1] Item
