...
execute if entity @s[tag=rngWar] as @a[x=0,predicate=custom:team/blue,tag=getItem] run function items:missile/heavy/givewar
execute if entity @s[tag=rngICBM] as @a[x=0,predicate=custom:team/blue,tag=getItem] run function items:util/giveicbm
...
execute if entity @s[tag=rngThun] as @a[x=0,predicate=custom:team/yellow,tag=getItem] run function items:missile/lightning/givethun
execute if entity @s[tag=rngFireball] as @a[x=0,predicate=custom:team/yellow,tag=getItem] run function items:util/giveclusterfireball
execute if entity @s[tag=rngObshield] as @a[x=0,predicate=custom:team/yellow,tag=getItem] run function items:util/giveobshield