...
execute if predicate game:item_pool/missile/bullet as @e[x=0,type=item] if items entity @s contents *[custom_data~{id:"missile/bullet"}] run function rr_swap:items/lightbluededuct
...
execute if predicate game:item_pool/missile/hurricane as @e[x=0,type=item] if items entity @s contents *[custom_data~{id:"missile/hurricane"}] run function rr_swap:items/lightbluededuct
execute if predicate game:item_pool/missile/thunderbolt as @e[x=0,type=item] if items entity @s contents *[custom_data~{id:"missile/thunderbolt"}] run function rr_swap:items/lightbluededuct
execute if predicate game:item_pool/fireball as @e[x=0,type=item] if items entity @s contents *[custom_data~{id:"cluster_fireball"}] run function rr_swap:items/lightbluededuct
execute if predicate game:item_pool/obsidian_shield as @e[x=0,type=item] if items entity @s contents *[custom_data~{id:"obsidian_shield"}] run function rr_swap:items/lightbluededuct
