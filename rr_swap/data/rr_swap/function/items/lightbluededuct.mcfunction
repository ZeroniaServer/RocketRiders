...
execute if items entity @s contents snowball[custom_data~{shield:1b}] if entity @a[x=0,team=Yellow,predicate=custom:matches_uuid] run function items:deduct
...
execute if items entity @s contents pig_spawn_egg[custom_data~{spawn_egg:{type:"cluster_fireball"}}] if entity @a[x=0,team=Blue,predicate=custom:matches_uuid] run function items:deduct
execute if items entity @s contents pig_spawn_egg[custom_data~{spawn_egg:{type:"obsidian_shield"}}] if entity @a[x=0,team=Blue,predicate=custom:matches_uuid] run function items:deduct
