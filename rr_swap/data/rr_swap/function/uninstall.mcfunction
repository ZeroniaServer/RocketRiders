...
execute as @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=swapLast] unless entity @e[x=0,type=marker,tag=PlacerClear] run function rr_swap:game/while_phase/match/closing
