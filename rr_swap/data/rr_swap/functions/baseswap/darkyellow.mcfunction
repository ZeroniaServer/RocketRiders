...
execute if entity @e[type=armor_stand,tag=Selection,scores={MiddleDeco=3}] run fill -14 34 -51 38 63 -49 light_blue_stained_glass replace minecraft:blue_stained_glass
...
execute if entity @e[type=armor_stand,tag=Selection,tag=Hardcore] run fill -14 63 65 38 34 65 orange_stained_glass replace white_stained_glass
...
execute if entity @e[type=armor_stand,tag=Selection,tag=Hardcore] run fill -14 63 -65 38 34 -65 white_stained_glass replace black_stained_glass
execute if entity @e[type=armor_stand,tag=Selection,tag=Hardcore] run fill -14 63 -64 38 34 -64 light_blue_stained_glass replace blue_stained_glass
