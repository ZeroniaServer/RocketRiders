...
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,scores={MiddleDeco=3}] run fill -14 34 -51 38 63 -49 blue_stained_glass replace minecraft:light_blue_stained_glass
...
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=Hardcore] run fill -14 63 73 38 34 66 white_concrete replace black_concrete
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=Hardcore] run fill -14 63 65 38 34 65 white_stained_glass replace orange_stained_glass
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=Hardcore] run fill -14 63 -73 38 34 -66 black_concrete replace white_concrete
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=Hardcore] run fill -14 63 -65 38 34 -65 black_stained_glass replace white_stained_glass
execute if entity @e[predicate=custom:indimension,type=armor_stand,tag=Selection,tag=Hardcore] run fill -14 63 -64 38 34 -64 blue_stained_glass replace light_blue_stained_glass
