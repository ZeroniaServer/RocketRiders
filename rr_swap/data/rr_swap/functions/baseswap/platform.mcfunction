...
execute if score QuickSwap swapside matches 0 if score SwapPlatform swapside matches 1200.. run tag @e[tag=swapplatform,type=area_effect_cloud] add SwappingSides
...
execute if score QuickSwap swapside matches 1 if score SwapPlatform swapside matches 400.. run tag @e[tag=swapplatform,type=area_effect_cloud] add SwappingSides
