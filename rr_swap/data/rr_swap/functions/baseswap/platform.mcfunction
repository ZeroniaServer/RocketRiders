...
execute if score QuickSwap swapside matches 0 if score SwapPlatform swapside matches 1200.. run tag @e[tag=swapplatform,type=marker] add SwappingSides
...
execute if score QuickSwap swapside matches 1 if score SwapPlatform swapside matches 400.. run tag @e[tag=swapplatform,type=marker] add SwappingSides
...
execute if entity @e[tag=SwappingSides,type=marker] if score QuickSwap swapside matches 0 run scoreboard players set SwapPlatformSec swapside 60
execute if entity @e[tag=SwappingSides,type=marker] if score QuickSwap swapside matches 1 run scoreboard players set SwapPlatformSec swapside 20
execute if entity @e[tag=SwappingSides,type=marker] run scoreboard players set SwapPlatformTick swapside 0
execute if entity @e[tag=SwappingSides,type=marker] as @a[team=!Lobby] at @s run playsound entity.zombie_villager.converted master @s ~ ~ ~ 1 1.2
execute if score SwapSide swapside matches 0 as @e[tag=SwappingSides,type=marker] run function rr_swap:baseswap/lightyellow
execute if score SwapSide swapside matches 1 as @e[tag=SwappingSides,type=marker] run function rr_swap:baseswap/darkyellow