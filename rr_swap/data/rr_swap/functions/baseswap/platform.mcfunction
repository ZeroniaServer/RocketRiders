...
execute if entity @e[type=armor_stand,tag=Selection,scores={SDtime=1..}] unless score QuickSwap swapside matches 1 run scoreboard players set SwapSide swapside 0
execute if entity @e[type=armor_stand,tag=Selection,scores={SDtime=1..}] unless score QuickSwap swapside matches 1 run scoreboard players set SwapPlatform swapside 0
execute if entity @e[type=armor_stand,tag=Selection,scores={SDtime=1..}] unless score QuickSwap swapside matches 1 run scoreboard players set BossbarA swapside 0
execute if entity @e[type=armor_stand,tag=Selection,scores={SDtime=1..}] run scoreboard players set QuickSwap swapside 1
...
execute if score QuickSwap swapside matches 0 if score SwapPlatform swapside matches 1200.. run tag @e[type=marker,tag=swapplatform] add SwappingSides
...
execute if score QuickSwap swapside matches 1 if score SwapPlatform swapside matches 400.. run tag @e[type=marker,tag=swapplatform] add SwappingSides
...
execute if entity @e[type=marker,tag=SwappingSides] if score QuickSwap swapside matches 0 run scoreboard players set SwapPlatformSec swapside 60
execute if entity @e[type=marker,tag=SwappingSides] if score QuickSwap swapside matches 1 run scoreboard players set SwapPlatformSec swapside 20
execute if entity @e[type=marker,tag=SwappingSides] run scoreboard players set SwapPlatformTick swapside 0
execute if entity @e[type=marker,tag=SwappingSides] as @a[predicate=custom:indimension,team=!Lobby] at @s run playsound entity.zombie_villager.converted master @s ~ ~ ~ 1 1.2
execute if score SwapSide swapside matches 0 as @e[type=marker,tag=SwappingSides] run function rr_swap:baseswap/lightyellow
execute if score SwapSide swapside matches 1 as @e[type=marker,tag=SwappingSides] run function rr_swap:baseswap/darkyellow