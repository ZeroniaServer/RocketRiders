...
execute if entity @s[scores={endtimer=1}] as @e[type=fireball,tag=StillCluster] run scoreboard players add @s endFireball 1
execute if entity @s[scores={endtimer=1}] as @e[type=fireball,tag=ClusterStarter,tag=Still] run scoreboard players add @s endFireball 1
...
execute if entity @s[scores={endtimer=1}] as @e[type=fireball,tag=endFireball] at @s run data modify entity @s Owner set from entity @e[type=fireball,scores={endFireball=1},limit=1,sort=nearest,distance=..1] Owner
...
execute if entity @s[scores={endtimer=1}] as @e[type=fireball,tag=endFireball] at @s store result score @s Clustertime run scoreboard players get @e[type=fireball,scores={endFireball=1},limit=1,sort=nearest,distance=..1] Clustertime
