...
tellraw @s ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- Light team gets Lightning Missiles and punchable utilities"}]
tellraw @s ["",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"- Dark team gets Heavy Missiles and throwable utilities"}]
