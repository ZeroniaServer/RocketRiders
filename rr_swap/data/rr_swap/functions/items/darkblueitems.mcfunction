...
execute as @e[tag=SelectedSwapRNG,tag=swapRNG4] run execute as @a[team=Blue] run function rr_swap:items/givevortex
execute as @e[tag=SelectedSwapRNG,tag=swapRNG4] run execute as @a[team=Yellow] run function rr_swap:items/givefireball
...
execute as @e[tag=SelectedSwapRNG,tag=swapRNG6] run execute as @a[team=Blue] run function items:util/giveshield
execute as @e[tag=SelectedSwapRNG,tag=swapRNG6] run execute as @a[team=Yellow] run function items:util/giveobshield