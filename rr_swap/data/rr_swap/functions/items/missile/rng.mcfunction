...
execute if entity @e[tag=Selection,tag=!givenDuplex] run summon area_effect_cloud 0 0 0 {Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:["rngDuplex","swapRNGD"]}
...
execute if entity @e[tag=Selection,tag=!givenBroad] run summon area_effect_cloud 0 0 0 {Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:["rngBroad","swapRNGL"]}
