...
execute if entity @s[tag=rngUtil,tag=!utilOff] unless entity @s[tag=givenAllDUtil,tag=givenAllLUtil] unless entity @s[tag=!gaveFirstItem] run summon area_effect_cloud 0 0 0 {Radius:0f,RadiusPerTick:-1f,Duration:1,Tags:["rngUtil","swapRNG1"]}
