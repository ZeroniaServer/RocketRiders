...
execute as @s[scores={HasVortex=1..},tag=!fullHotbar] at @s run playsound minecraft:block.note_block.bass player @s ~ ~ ~ 1 1
title @s[scores={HasVortex=0},tag=!fullHotbar] actionbar {"text":"ICBM obtained.","color":"aqua"}
give @s[team=Yellow,scores={HasVortex=0},tag=!fullHotbar] egg{CustomModelData:3,display:{Name:'[{"text":"[Utility] ","color":"light_purple","bold":"true"},{"text":"ICBM","color":"gold","bold":"true"}]',Lore:['{"text":"An intercontinental ballistic missile.","color":"gray"}','{"text":"Blows up upon impact.","color":"gray"}']},Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],HideFlags:7} 1
