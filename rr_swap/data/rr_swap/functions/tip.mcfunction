...
execute as @e[type=marker,tag=SelectedTip,tag=Tip5] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"In Swap Mode, players on the light team receive faster missiles and punchable utilities.","color":"gray"}]
...
execute as @e[type=marker,tag=SelectedTip,tag=Tip7] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"In Swap Mode, players on the dark team receive heavier missiles and throwable utilities.","color":"gray"}]
...
execute if entity @s[tag=!SMActive] as @e[type=marker,tag=SelectedTip,tag=Tip9] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"There are four Special missiles which you can play with in Swap Mode. Use them all to earn the Veteran achievement!","color":"gray"}]
execute if entity @s[tag=SMActive] as @e[type=marker,tag=SelectedTip,tag=Tip9] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"There are four Special missiles which you can play with in Swap Mode!","color":"gray"}]
...
execute as @e[type=marker,tag=SelectedTip,tag=Tip18] as @a[predicate=custom:indimension,tag=!hideTips] run tellraw @s ["",{"text":"<","color":"dark_gray"},{"text":"TIP!","bold":true,"color":"green"},{"text":"> ","color":"dark_gray"},{"text":"The Bullet and the Broadsword are exclusive missiles in Swap Mode with a lot of trigger TNT!","color":"gray"}]
