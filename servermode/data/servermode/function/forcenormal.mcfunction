...
execute if predicate rr:server_mode/cubekrowd_voting run scoreboard players set @e[x=0,type=armor_stand,tag=Selection,limit=1] TopDeco 1
execute if predicate rr:server_mode/cubekrowd_voting run scoreboard players set @e[x=0,type=armor_stand,tag=Selection,limit=1] TopCorner 1
execute if predicate rr:server_mode/cubekrowd_voting run scoreboard players set @e[x=0,type=armor_stand,tag=Selection,limit=1] MiddleDeco 1
execute if predicate rr:server_mode/cubekrowd_voting run scoreboard players set @e[x=0,type=armor_stand,tag=Selection,limit=1] BottomDeco 1
execute if predicate rr:server_mode/cubekrowd_voting run scoreboard players set @e[x=0,type=armor_stand,tag=Selection,limit=1] PortalDeco 1
