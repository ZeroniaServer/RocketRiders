...
execute if entity @s[predicate=custom:team/yellow,tag=JoinBlue] unless predicate game:team_count/blue_is_larger unless predicate game:team_count/yellow_is_larger run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Teams Balanced!","color":"red","bold":true},"\n",{"text":"Stay where you are to keep the game fair.","color":"gray"}]
...
execute if entity @s[tag=JoinBlue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!EditedSettings] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Cannot Join Team!","color":"red","bold":true},"\n",{"text":"Wait until game settings are confirmed first.","color":"gray"}]
...
execute if entity @s[tag=JoinBlue] if entity @e[x=0,type=marker,tag=join_pad.blue,tag=CancelJoin] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Cannot Join Team!","color":"red","bold":true}]
...
execute if entity @s[tag=JoinBlue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=BlueFull] if entity @e[x=0,type=marker,tag=join_pad.blue,tag=!CancelJoin] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Team Full!","color":"red","bold":true}]
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin,predicate=!custom:team/yellow] if entity @e[x=0,type=marker,tag=join_pad.yellow,tag=CancelJoin] run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin,predicate=!custom:team/yellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=YellowFull] run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin,predicate=!custom:team/yellow] unless predicate game:team_count/blue_is_larger run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]

#Resolution message: yellow joinpad is disabled, so stay put or spectate instead
execute if entity @s[tag=JoinBlue,tag=cannotJoin,predicate=custom:team/yellow] if entity @e[x=0,type=marker,tag=join_pad.yellow,tag=CancelJoin] run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
execute if entity @s[tag=JoinBlue,tag=cannotJoin,predicate=custom:team/yellow] if entity @e[x=0,type=marker,tag=join_pad.yellow,tag=CancelJoin] run tag @s remove JoinBlue

#Resolution message: yellow is full, so stay put or spectate instead
execute if entity @s[tag=JoinBlue,tag=cannotJoin,predicate=custom:team/yellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=YellowFull] run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
execute if entity @s[tag=JoinBlue,tag=cannotJoin,predicate=custom:team/yellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=YellowFull] run tag @s remove JoinBlue

#Resolution message: yellow is imbalanced, so stay put or spectate instead
execute if entity @s[tag=JoinBlue,tag=cannotJoin,predicate=custom:team/yellow] unless predicate game:team_count/blue_is_larger run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
...
execute if entity @s[predicate=custom:team/blue,tag=JoinYellow] unless predicate game:team_count/blue_is_larger unless predicate game:team_count/yellow_is_larger run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Teams Balanced!","color":"red","bold":true},"\n",{"text":"Stay where you are to keep the game fair.","color":"gray"}]
...
#Joining before settings have been confirmed
execute if entity @s[tag=JoinYellow] unless predicate game:match_over if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!EditedSettings] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Cannot Join Team!","color":"red","bold":true},"\n",{"text":"Wait until game settings are confirmed first.","color":"gray"}]
execute if entity @s[tag=JoinYellow] if predicate game:match_over if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=!EditedSettings] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Cannot Join Team!","color":"red","bold":true},"\n",{"text":"Wait until a new game has started.","color":"gray"}]
...
execute if entity @s[tag=JoinYellow] if entity @e[x=0,type=marker,tag=join_pad.yellow,tag=CancelJoin] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Cannot Join Team!","color":"red","bold":true}]
...
execute if entity @s[tag=JoinYellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=YellowFull] if entity @e[x=0,type=marker,tag=join_pad.yellow,tag=!CancelJoin] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Team Full!","color":"red","bold":true}]
...
#Resolution message: yellow joinpad is disabled, so spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,predicate=!custom:team/blue] if entity @e[x=0,type=marker,tag=join_pad.blue,tag=CancelJoin] run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
#Resolution message: yellow is full, so spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,predicate=!custom:team/blue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=BlueFull] run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
#Resolution message: yellow is imbalanced, so spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,predicate=!custom:team/blue] unless predicate game:team_count/yellow_is_larger run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]

#Resolution message: yellow joinpad is disabled, so stay put or spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,predicate=custom:team/blue] if entity @e[x=0,type=marker,tag=join_pad.blue,tag=CancelJoin] run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
execute if entity @s[tag=JoinYellow,tag=cannotJoin,predicate=custom:team/blue] if entity @e[x=0,type=marker,tag=join_pad.blue,tag=CancelJoin] run tag @s remove JoinYellow

#Resolution message: yellow is full, so stay put or spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,predicate=custom:team/blue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=BlueFull] run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
execute if entity @s[tag=JoinYellow,tag=cannotJoin,predicate=custom:team/blue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=BlueFull] run tag @s remove JoinYellow

#Resolution message: yellow is imbalanced, so stay put or spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,predicate=custom:team/blue] unless predicate game:team_count/yellow_is_larger run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
