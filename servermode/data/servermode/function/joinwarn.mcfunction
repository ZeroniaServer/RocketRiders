...
execute if entity @s[team=Yellow,tag=JoinBlue] unless predicate game:team_count/blue_is_larger unless predicate game:team_count/yellow_is_larger run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Teams Balanced!","color":"red","bold":true},"\n",{"text":"Stay where you are to keep the game fair.","color":"gray"}]
execute if entity @s[team=Yellow,tag=JoinBlue] unless predicate game:team_count/blue_is_larger unless predicate game:team_count/yellow_is_larger run return run tag @s remove JoinBlue
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin,team=!Yellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=YellowFull] run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin,team=!Yellow] unless predicate game:team_count/blue_is_larger run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin,team=Yellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=YellowFull] run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
execute if entity @s[tag=JoinBlue,tag=cannotJoin,team=Yellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=YellowFull] run tag @s remove JoinBlue

#Resolution message: yellow is imbalanced, so stay put or spectate instead
execute if entity @s[tag=JoinBlue,tag=cannotJoin,team=Yellow] unless predicate game:team_count/blue_is_larger run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
...
execute if entity @s[team=Blue,tag=JoinYellow] unless predicate game:team_count/blue_is_larger unless predicate game:team_count/yellow_is_larger run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Teams Balanced!","color":"red","bold":true},"\n",{"text":"Stay where you are to keep the game fair.","color":"gray"}]
execute if entity @s[team=Blue,tag=JoinYellow] unless predicate game:team_count/blue_is_larger unless predicate game:team_count/yellow_is_larger run return run tag @s remove JoinYellow
...
#Resolution message: yellow is full, so spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,team=!Blue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=BlueFull] run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
#Resolution message: yellow is imbalanced, so spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,team=!Blue] unless predicate game:team_count/yellow_is_larger run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
#Resolution message: yellow is full, so stay put or spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,team=Blue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=BlueFull] run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
execute if entity @s[tag=JoinYellow,tag=cannotJoin,team=Blue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,tag=BlueFull] run tag @s remove JoinYellow

#Resolution message: yellow is imbalanced, so stay put or spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,team=Blue] unless predicate game:team_count/yellow_is_larger run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
