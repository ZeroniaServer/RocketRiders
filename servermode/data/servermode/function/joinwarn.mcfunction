...
execute if entity @s[team=Yellow,tag=JoinBlue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=0}] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Teams Balanced!","color":"red","bold":true},"\n",{"text":"Stay where you are to keep the game fair.","color":"gray"}]
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin,team=!Yellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=-1..0}] run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
execute if entity @s[tag=JoinBlue,tag=cannotJoin,team=Yellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=-1..0}] run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
...
execute if entity @s[team=Blue,tag=JoinYellow] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=0}] run tellraw @s [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{"text":"Teams Balanced!","color":"red","bold":true},"\n",{"text":"Stay where you are to keep the game fair.","color":"gray"}]
...
#Resolution message: yellow is imbalanced, so spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,team=!Blue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=0..1}] run tellraw @s ["",{"text":"Feel free to spectate instead.","color":"gray","bold":false}]
...
#Resolution message: yellow is imbalanced, so stay put or spectate instead
execute if entity @s[tag=JoinYellow,tag=cannotJoin,team=Blue] if entity @e[x=0,type=armor_stand,tag=Selection,limit=1,scores={largerTeam=0..1}] run tellraw @s ["",{"text":"Feel free to stay where you are or spectate instead.","color":"gray","bold":false}]
