...
execute if predicate game:phase/match/closing/outcome run tellraw @s [{color:"dark_gray",text:"["},{bold:true,color:"red",text:"!"},{color:"dark_gray",text:"] "},{color:"gray",text:"Wait until a new game has started."}]
