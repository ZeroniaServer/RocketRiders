...
execute if score $winners VoteServerMode matches 2.. run tag @e[type=marker,tag=ServerMode,tag=Set,scores={VoteServerMode=0}] add TiedVote
...
# Announce winner
execute if score $winners VoteServerMode matches 1 if score @e[type=marker,tag=ServerMode,tag=Set,tag=WonVote,limit=1] FinalVote matches 1 run tellraw @a ["",{"selector":"@e[type=marker,tag=ServerMode,tag=Set,tag=WonVote,limit=1]","color":"gold","bold":true},{"text":" won with ","color":"dark_green"},{"text":"1","color":"green"},{"text":" vote!","color":"dark_green"}]
execute if score $winners VoteServerMode matches 1 if score @e[type=marker,tag=ServerMode,tag=Set,tag=WonVote,limit=1] FinalVote matches 2.. run tellraw @a ["",{"selector":"@e[type=marker,tag=ServerMode,tag=Set,tag=WonVote,limit=1]","color":"gold","bold":true},{"text":" won with ","color":"dark_green"},{"score":{"name":"@e[type=marker,tag=ServerMode,tag=Set,tag=WonVote,limit=1]","objective":"FinalVote"},"color":"green"},{"text":" votes!","color":"dark_green"}]
execute if score $winners VoteServerMode matches 2.. run tellraw @a ["",{"text":"There was a tie vote with the following game modes: ","color":"dark_green"},{"selector":"@e[type=marker,tag=ServerMode,tag=Set,tag=TiedVote]","color":"green","bold":true,"separator":{"text":", ","color":"gray","bold":false}}]
...
execute unless entity @e[type=marker,tag=WonVote,tag=!CrusadeMode,tag=!ChaseMode] run tag @e[type=armor_stand,tag=Selection] add doStacking
execute if entity @e[type=marker,tag=WonVote,tag=!CrusadeMode,tag=!ChaseMode] run tag @e[type=armor_stand,tag=Selection] remove doStacking
